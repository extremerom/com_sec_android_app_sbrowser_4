...
.method private static getDefaultQuickAccessInfo()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/sec/android/app/sbrowser/quickaccess/controller/QuickAccessController;->getItems()Lcom/sec/android/app/sbrowser/common/model/quickaccess/MutableListLiveData;

    move-result-object v1

    invoke-virtual {v1}, Lcom/sec/android/app/sbrowser/common/model/quickaccess/MutableListLiveData;->getValue()Ljava/util/List;
...
.method private static getDefaultSearchEngineInfo(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p0}, LJ7/b;->r(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method private static getSettings(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0, v1, v3}, Lcom/sec/android/app/sbrowser/dump/data/DumpData;->getPreferenceString(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v2, v3}, Lcom/sec/android/app/sbrowser/dump/data/DumpData;->getPreferenceString(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v2, v3, v4}, Lcom/sec/android/app/sbrowser/dump/data/DumpData;->getPreferenceBoolean(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    const-string v3, "Allow javascript"

    invoke-static {v3, v2}, Lcom/sec/android/app/sbrowser/dump/data/DumpData;->getText(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    const-string v3, "Allow third-party cookies"
    ...
    const-string v3, "Block opening external apps"
    ...
    const-string v3, "open_links_from_other_apps_in_secret_mode"
    ...
    const-string v3, "Allow autoplay"
    ...
    const-string v3, "Video assistant"
    ...
    const-string v3, "enable_content_blocker"

    const/4 v5, 0x0

    invoke-static {p0, v2, v3, v5}, Lcom/sec/android/app/sbrowser/dump/data/DumpData;->getPreferenceBoolean(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-virtual {v2, v5}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->getAntiTrackingLevel(Z)I
    ...
    invoke-static {v1, v6, v2}, Landroidx/appcompat/graphics/drawable/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v6, v4}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->getAntiTrackingLevel(Z)I
    ...
    :cond_5
    :goto_1
    invoke-static {v1, v7, v2}, Landroidx/appcompat/graphics/drawable/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v4, "Block unwanted web pages"

    invoke-static {v4, v3}, Lcom/sec/android/app/sbrowser/dump/data/DumpData;->getText(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    const-string v3, "Download storage"

    const-string v4, "download_default_storyage"

    invoke-static {p0, v3, v4}, Lcom/sec/android/app/sbrowser/dump/data/DumpData;->getPreferenceString(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v3, "Block auto download"

    const-string v4, "block_auto_download"

    invoke-static {p0, v3, v4, v5}, Lcom/sec/android/app/sbrowser/dump/data/DumpData;->getPreferenceBoolean(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    const-string v3, "User agent policy"

    const-string v4, "pref_desktop_website_for_multi_fold"

    invoke-static {p0, v3, v4, v5}, Lcom/sec/android/app/sbrowser/dump/data/DumpData;->getPreferenceInt(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    const-string v3, "Always desktop"

    const-string v4, "pref_desktop_website"
    ...
    invoke-virtual {v3}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->isForceZoomEnabled()Z

    move-result v3

    const-string v4, "Force zoom"
    ...
    const-string v3, "Text scale"

    const-string/jumbo v4, "text_scale"

    invoke-static {p0, v3, v4}, Lcom/sec/android/app/sbrowser/dump/data/DumpData;->getPreferenceFloat(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v4, "PREF_COMMON_ZOOM_VALUE_MOBILE"
    ...
    const-string v3, "Use system font"

    const-string v4, "pref_use_system_font"
    ...
    const-string v3, "System font path"
    ...
    invoke-static {v4}, Lcom/sec/android/app/sbrowser/system_font/SystemFont;->getCurrentFontName(Landroid/content/Context;)Ljava/lang/String;
    ...
    :catch_0
    invoke-static {v1, v0, v2}, Landroidx/appcompat/graphics/drawable/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v1, v2, v5}, Lcom/sec/android/app/sbrowser/dump/data/DumpData;->getPreferenceBoolean(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
...
.method private static getSyncInfo()Ljava/lang/String;
    ...
    const-string/jumbo v1, "signed in: true"

    invoke-virtual {v0, v1}, Lcom/sec/android/app/sbrowser/common/utils/IndentingStringWriter;->println(Ljava/lang/String;)V

    new-instance v1, Ljava/lang/StringBuilder;

    const-string/jumbo v2, "sync on: "
    ...
    const-string/jumbo v2, "success time: "

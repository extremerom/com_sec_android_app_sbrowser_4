...
# direct methods
.method public constructor <init>(Landroid/content/Context;LR0/a;Lcom/github/mikephil/charting/animation/ChartAnimator;LV0/h;)V
    .locals 0

    invoke-direct {p0, p2, p3, p4}, LU0/b;-><init>(LR0/a;Lcom/github/mikephil/charting/animation/ChartAnimator;LV0/h;)V
    ...
    iput-object p2, p0, LU0/b;->mChart:LR0/a;

    iget-object p2, p0, LU0/b;->mBarBorderPaint:Landroid/graphics/Paint;
    ...
    iget-object p1, p0, LU0/b;->mBarBorderPaint:Landroid/graphics/Paint;
...
.method public drawDataSet(Landroid/graphics/Canvas;LS0/a;I)V
    ...
    iget-object v3, v0, LU0/b;->mChart:LR0/a;

    move-object v4, v2

    check-cast v4, LO0/b;

    iget-object v5, v4, LO0/b;->d:LN0/p;

    check-cast v3, LM0/c;

    invoke-virtual {v3, v5}, LM0/c;->f(LN0/p;)LV0/f;

    move-result-object v3

    iget-object v5, v0, LU0/e;->mAnimator:Lcom/github/mikephil/charting/animation/ChartAnimator;
    ...
    invoke-virtual/range {p0 .. p0}, LU0/b;->initBuffers()V

    iget-object v7, v0, LU0/b;->mBarBuffers:[LL0/a;

    aget-object v7, v7, p3

    iput-object v7, v0, Lcom/sec/android/app/sbrowser/blockers/content_block/view/RoundedBarRenderer;->mBuffer:LL0/a;

    iput v5, v7, LL0/a;->c:F

    iput v6, v7, LL0/a;->d:F

    iget-object v5, v0, LU0/b;->mChart:LR0/a;

    check-cast v5, LM0/c;

    iget-object v4, v4, LO0/b;->d:LN0/p;

    invoke-virtual {v5, v4}, LM0/c;->g(LN0/p;)V

    invoke-virtual {v7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v4, v0, Lcom/sec/android/app/sbrowser/blockers/content_block/view/RoundedBarRenderer;->mBuffer:LL0/a;
    ...
    iput v5, v4, LL0/a;->f:F

    iget-object v4, v0, Lcom/sec/android/app/sbrowser/blockers/content_block/view/RoundedBarRenderer;->mBuffer:LL0/a;

    invoke-virtual {v4, v2}, LL0/a;->b(LS0/a;)V

    iget-object v2, v0, Lcom/sec/android/app/sbrowser/blockers/content_block/view/RoundedBarRenderer;->mBuffer:LL0/a;

    iget-object v2, v2, LL0/a;->b:[F

    invoke-virtual {v3, v2}, LV0/f;->d([F)V

    const/4 v2, 0x0

    :goto_0
    iget-object v3, v0, Lcom/sec/android/app/sbrowser/blockers/content_block/view/RoundedBarRenderer;->mBuffer:LL0/a;

    iget-object v3, v3, LL0/a;->b:[F
    ...
    iget-object v4, v4, LL0/a;->b:[F

    aget v4, v4, v12

    invoke-virtual {v3, v4}, LV0/h;->a(F)Z
    ...
    invoke-virtual {v3, v4}, LV0/h;->b(F)Z
    ...
    iget-object v5, v0, Lcom/sec/android/app/sbrowser/blockers/content_block/view/RoundedBarRenderer;->mBuffer:LL0/a;

    iget-object v5, v5, LL0/a;->b:[F
...
.method public setBarColor(I)V
    ...
    iget-object p0, p0, LU0/e;->mRenderPaint:Landroid/graphics/Paint;

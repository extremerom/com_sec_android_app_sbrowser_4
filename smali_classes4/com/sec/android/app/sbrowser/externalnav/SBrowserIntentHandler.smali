...
.method public static getExtraHeadersFromIntent(Landroid/content/Intent;)Ljava/lang/String;
    ...
    invoke-static {v1, v3, v5, v4}, Landroidx/compose/ui/input/pointer/a;->x(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private static getReferrerUrl(Landroid/content/Intent;)Ljava/lang/String;
    ...
    invoke-static {p0}, Landroidx/browser/customtabs/CustomTabsSessionToken;->getSessionTokenFromIntent(Landroid/content/Intent;)Landroidx/browser/customtabs/CustomTabsSessionToken;
    ...
    invoke-virtual {v2, v1}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabsConnection;->getDefaultReferrerForSession(Landroidx/browser/customtabs/CustomTabsSessionToken;)Lcom/sec/terrace/browser/TerraceReferrer;
...
.method private static getUrlFromText(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v2, "SBrowserIntentHandler"

    if-nez v0, :cond_1

    const-string p0, "getUrlFromText TerraceHelper not initialized! nothing done!"
    ...
    const-string v0, "search engine setting is not done, replace it to baidu at CHN region"

    invoke-static {v2, v0}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    const-string v0, "http://m5.baidu.com/s?from=124n&word=%s"
...
.method public static getUrlFromVoiceSearchResult(Landroid/content/Intent;)Ljava/lang/String;
    ...
    invoke-static {v0}, Landroidx/compose/ui/input/pointer/a;->o(Ljava/lang/String;)Ljava/util/ArrayList;

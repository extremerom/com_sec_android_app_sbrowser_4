...
.field private mPopupWindowQueueScheduler:Lcom/sec/android/app/sbrowser/help_intro/popup/PopupWindowQueueScheduler;

.field private mUpdateDialog:Landroidx/appcompat/app/AlertDialog;
...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->mUpdateDialog:Landroidx/appcompat/app/AlertDialog;
...
.method public static synthetic c(Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;Landroid/content/DialogInterface;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->lambda$updateDailogForCN$3(Landroid/content/DialogInterface;I)V
...
.method public static synthetic d(Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;Landroid/content/DialogInterface;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->lambda$updateDailogForCN$2(Landroid/content/DialogInterface;I)V

    return-void
.end method

.method public static getSecondaryPageForSettingActivityIntent(Landroid/app/Activity;I)Landroid/content/Intent;
    .locals 2

    new-instance v0, Lcom/sec/android/app/sbrowser/help_intro/SecondaryPageForSettingActivity;

    invoke-direct {v0}, Lcom/sec/android/app/sbrowser/help_intro/SecondaryPageForSettingActivity;-><init>()V

    new-instance v0, Landroid/content/Intent;

    const-class v1, Lcom/sec/android/app/sbrowser/help_intro/SecondaryPageForSettingActivity;

    invoke-direct {v0, p0, v1}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    const-string p0, "help_intro_secondary_page_function_type"
...
.method private isNeedDirectSearchPopup()Z
    .locals 0

    invoke-static {}, Lcom/sec/android/app/sbrowser/directsearch/common/DirectSearchUtils;->isFeatureEnabled()Z
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->is3rdAccessNoticeDirectSearchChnNeedShowed()Z
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->is3rdAccessNoticeDirectSearchChnEnabled()Z
...
.method private isNeedShowNewsPopup()Z
    .locals 1
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->is3rdAccessNoticeNewsFeedChnNeedShowed()Z
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->isNewsFeedService3rdStatementChnEnabled()Z
...
.method private synthetic lambda$updateDailogForCN$2(Landroid/content/DialogInterface;I)V
    .locals 0
...
.method private synthetic lambda$updateDailogForCN$3(Landroid/content/DialogInterface;I)V
    .locals 0

    const-string p1, "HelpIntroHelper"

    const-string p2, "Disagree by user,finishAffinity"
...
.method public static launchSecondaryPageForSettingActivity(Landroid/app/Activity;I)V
    .locals 0

    invoke-static {p0, p1}, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->getSecondaryPageForSettingActivityIntent(Landroid/app/Activity;I)Landroid/content/Intent;
...
.method public static launchSecondaryPageForSettingActivity(Landroidx/activity/result/ActivityResultLauncher;Landroid/app/Activity;I)V
    .locals 0
    ...
    invoke-static {p1, p2}, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->getSecondaryPageForSettingActivityIntent(Landroid/app/Activity;I)Landroid/content/Intent;
...
.method private onVersionUpdateInternally(ZZ)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->createUpdateDialog(ZZ)Landroidx/appcompat/app/AlertDialog;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->mUpdateDialog:Landroidx/appcompat/app/AlertDialog;
...
.method private shouldLaunchHelpIntro(Lcom/sec/android/app/sbrowser/common/model/main/MainActivityDelegate;)Lcom/sec/android/app/sbrowser/common/model/global_config/HelpIntroConstants$ViewType;
    ...
    invoke-direct {v2, v3, p0, p1}, Lcom/sec/android/app/sbrowser/download/d;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public static showRemoteConsentDialog(Landroidx/fragment/app/FragmentActivity;)V
    .locals 0
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/parental_control/RemoteConsentManager;->showRemoteConsentDialog(Landroidx/fragment/app/FragmentManager;)V

    return-void
.end method

.method private showThirdPartyAccessNoticePopupIfNeeded()V
    .locals 3

    const-string v0, "HelpIntroHelper"

    const-string/jumbo v1, "showThirdPartyAccessNoticePopupIfNeeded"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->mPopupWindowQueueScheduler:Lcom/sec/android/app/sbrowser/help_intro/popup/PopupWindowQueueScheduler;

    if-nez v0, :cond_0

    new-instance v0, Lcom/sec/android/app/sbrowser/help_intro/popup/PopupWindowQueueScheduler;

    invoke-direct {v0}, Lcom/sec/android/app/sbrowser/help_intro/popup/PopupWindowQueueScheduler;-><init>()V

    iput-object v0, p0, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->mPopupWindowQueueScheduler:Lcom/sec/android/app/sbrowser/help_intro/popup/PopupWindowQueueScheduler;

    new-instance v1, Lcom/sec/android/app/sbrowser/help_intro/popup/NewsFeedPopupWindow;

    iget-object v2, p0, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->mActivity:Landroid/app/Activity;

    invoke-direct {v1, v2}, Lcom/sec/android/app/sbrowser/help_intro/popup/NewsFeedPopupWindow;-><init>(Landroid/app/Activity;)V

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->isNeedShowNewsPopup()Z

    move-result v2

    invoke-virtual {v0, v1, v2}, Lcom/sec/android/app/sbrowser/help_intro/popup/PopupWindowQueueScheduler;->addPopupWindow(Lcom/sec/android/app/sbrowser/help_intro/popup/AccessNoticeBasePopupWindow;Z)Lcom/sec/android/app/sbrowser/help_intro/popup/PopupWindowQueueScheduler;

    move-result-object v0

    new-instance v1, Lcom/sec/android/app/sbrowser/help_intro/popup/DirectSearchPopupWindow;

    iget-object v2, p0, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->mActivity:Landroid/app/Activity;

    invoke-direct {v1, v2}, Lcom/sec/android/app/sbrowser/help_intro/popup/DirectSearchPopupWindow;-><init>(Landroid/app/Activity;)V

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->isNeedDirectSearchPopup()Z

    move-result p0

    invoke-virtual {v0, v1, p0}, Lcom/sec/android/app/sbrowser/help_intro/popup/PopupWindowQueueScheduler;->addPopupWindow(Lcom/sec/android/app/sbrowser/help_intro/popup/AccessNoticeBasePopupWindow;Z)Lcom/sec/android/app/sbrowser/help_intro/popup/PopupWindowQueueScheduler;

    move-result-object p0

    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/help_intro/popup/PopupWindowQueueScheduler;->run()V

    :cond_0
    return-void
.end method

.method private updateDailogForCN(Landroidx/appcompat/app/AlertDialog$Builder;)V
    .locals 3
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/help_intro/c;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/sec/android/app/sbrowser/help_intro/c;-><init>(Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;I)V
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/help_intro/c;

    const/4 v2, 0x1

    invoke-direct {v1, p0, v2}, Lcom/sec/android/app/sbrowser/help_intro/c;-><init>(Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;I)V
...
# virtual methods
.method public createUpdateDialog(Landroid/app/Activity;ZZ)Landroidx/appcompat/app/AlertDialog;
    .locals 0
    ...
    invoke-virtual {p0, p2, p3}, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->createUpdateDialog(ZZ)Landroidx/appcompat/app/AlertDialog;
...
.method public createUpdateDialog(ZZ)Landroidx/appcompat/app/AlertDialog;
    .locals 9
    ...
    invoke-direct {v1, v2, p0, p1}, Lcom/sec/android/app/sbrowser/download/ui/A;-><init>(ILjava/lang/Object;Z)V
    ...
    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->updateDailogForCN(Landroidx/appcompat/app/AlertDialog$Builder;)V
...
.method public dismissUpdateDialog()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->mUpdateDialog:Landroidx/appcompat/app/AlertDialog;
...
.method public handleSecondaryActivityResult(Landroid/app/Activity;I)V
    .locals 0
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->showThirdPartyAccessNoticePopupIfNeeded()V
...
.method public launchHelpIntroIfNeeded(Lcom/sec/android/app/sbrowser/common/model/main/MainActivityDelegate;)Z
    ...
    invoke-static {v0}, Lcom/sec/android/app/sbrowser/help_intro/utils/HelpIntroUtil;->saveAgreementUpdate(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Lcom/sec/android/app/sbrowser/help_intro/utils/HelpIntroUtil;->isWelcomePageCHNAlreadyShown(Landroid/content/Context;)Z
    ...
    invoke-virtual {p1}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->isHelpIntroSecondaryChnEnabled()Z
    ...
    invoke-virtual {p1}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->isNewsFeedServiceUpgradeChnNeedShowed()Z
    ...
    invoke-virtual {p1}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->isNewsFeedServiceChnEnabled()Z
    ...
    invoke-static {p1, v2}, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->getSecondaryPageForSettingActivityIntent(Landroid/app/Activity;I)Landroid/content/Intent;
    ...
    invoke-virtual {p0, v4}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->setNewsFeedServiceUpgradeChnNeedShowed(Z)V
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->isSetDefaultHomePageInRetailModeChnEnabled()Z
    ...
    invoke-virtual {p0, p1}, Lcom/sec/android/app/sbrowser/homepage/HomePageSettings;->setHomePageType(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->setNewsFeedServiceChnEnabled(Z)V

    invoke-static {}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->getInstance()Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;

    move-result-object p0

    invoke-virtual {p0, v4}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->set3rdAccessNoticeNewsFeedChnNeedShowed(Z)V

    invoke-static {}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->getInstance()Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;

    move-result-object p0

    invoke-virtual {p0, v2}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->setNewsFeedService3rdStatementChnEnabled(Z)V

    invoke-static {}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->getInstance()Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;

    move-result-object p0

    invoke-virtual {p0, v4}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->set3rdAccessNoticeDirectSearchChnNeedShowed(Z)V

    invoke-static {}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->getInstance()Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;

    move-result-object p0

    invoke-virtual {p0, v2}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->set3rdAccessNoticeDirectSearchChnEnabled(Z)V

    invoke-static {}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->getInstance()Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;

    move-result-object p0

    invoke-virtual {p0, v2}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->setDirectSearchEnabled(Z)V

    invoke-static {}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->getInstance()Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;

    move-result-object p0

    invoke-virtual {p0, v4}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->setDefaultHomePageInRetailModeChnEnabled(Z)V

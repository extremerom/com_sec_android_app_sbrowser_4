...
.field private final mSession:Landroidx/browser/customtabs/CustomTabsSessionToken;
...
.field private final mTrustedWebActivityDisplayMode:Landroidx/browser/trusted/TrustedWebActivityDisplayMode;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Intent;Landroid/content/Context;I)V
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mMenuEntries:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mToolbarButtons:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mBottombarButtons:Ljava/util/List;

    iput-object p1, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mIntent:Landroid/content/Intent;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mSession:Landroidx/browser/customtabs/CustomTabsSessionToken;
    ...
    iput-boolean v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mIsTrustedIntent:Z

    const-string v3, "android.support.customtabs.extra.EXIT_ANIMATION_BUNDLE"

    invoke-static {p1, v3}, Lcom/sec/android/app/sbrowser/common/utils/SBrowserIntentUtils;->safeGetBundleExtra(Landroid/content/Intent;Ljava/lang/String;)Landroid/os/Bundle;

    move-result-object v3

    iput-object v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mAnimationBundle:Landroid/os/Bundle;

    const-string v3, "android.support.customtabs.extra.KEEP_ALIVE"

    invoke-static {p1, v3}, Lcom/sec/android/app/sbrowser/common/utils/SBrowserIntentUtils;->safeGetParcelableExtra(Landroid/content/Intent;Ljava/lang/String;)Landroid/os/Parcelable;

    move-result-object v3

    check-cast v3, Landroid/content/Intent;

    iput-object v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mKeepAliveServiceIntent:Landroid/content/Intent;

    const-string v3, "androidx.browser.customtabs.extra.NETWORK"
    ...
    iput-object v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mNetwork:Landroid/net/Network;
    ...
    iput-boolean v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mIsOpenedBySBrowser:Z

    const-string v3, "com.sec.android.app.sbrowser.customtabs.EXTRA_UI_TYPE"

    const/4 v4, 0x0

    invoke-static {p1, v3, v4}, Lcom/sec/android/app/sbrowser/common/utils/SBrowserIntentUtils;->safeGetIntExtra(Landroid/content/Intent;Ljava/lang/String;I)I

    move-result v3

    invoke-direct {p0, v3}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->verifiedUiType(I)I

    move-result v3

    iput v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mUiType:I

    new-instance v3, Lcom/sec/android/app/sbrowser/customtabs/CustomTabColorProviderImpl;

    invoke-direct {v3, p1, p2, p3}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabColorProviderImpl;-><init>(Landroid/content/Intent;Landroid/content/Context;I)V

    iput-object v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mColorProvider:Lcom/sec/terrace/browser/browserservices/intents/TerraceColorProvider;

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->retrieveCustomButtons(Landroid/content/Intent;Landroid/content/Context;)V

    const-string v3, "android.support.customtabs.extra.ENABLE_URLBAR_HIDING"

    invoke-static {p1, v3, v4}, Lcom/sec/android/app/sbrowser/common/utils/SBrowserIntentUtils;->safeGetBooleanExtra(Landroid/content/Intent;Ljava/lang/String;Z)Z

    move-result v3

    iput-boolean v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mEnableUrlBarHiding:Z

    invoke-static {p1}, Lcom/sec/android/app/sbrowser/customtabs/features/partialcustomtab/PartialCustomTabIntentUtils;->getContentScrollMayResizeTab(Landroid/content/Intent;)Z

    move-result v3

    iput-boolean v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mContentScrollMayResizeTab:Z
    ...
    invoke-direct {p0, p2, v5}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->checkCloseButtonSize(Landroid/content/Context;Landroid/graphics/Bitmap;)Z

    move-result v7

    if-nez v7, :cond_0

    invoke-static {p1, v3}, Lcom/sec/android/app/sbrowser/common/utils/SBrowserIntentUtils;->safeRemoveExtra(Landroid/content/Intent;Ljava/lang/String;)V
    ...
    iput-object v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mCloseButtonIcon:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v3}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->updateExtraMenuItems(Ljava/util/List;)V

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->addShareOption(Landroid/content/Intent;Landroid/content/Context;)V
    ...
    :goto_0
    iput v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mActivityType:I

    const-string v3, "android.support.customtabs.extra.ADDITIONAL_TRUSTED_ORIGINS"

    invoke-static {p1, v3}, Lcom/sec/android/app/sbrowser/common/utils/SBrowserIntentUtils;->safeGetStringArrayListExtra(Landroid/content/Intent;Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v3

    iput-object v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mTrustedWebActivityAdditionalOrigins:Ljava/util/List;

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->resolveTwaDisplayMode()Landroidx/browser/trusted/TrustedWebActivityDisplayMode;

    move-result-object v3

    iput-object v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mTrustedWebActivityDisplayMode:Landroidx/browser/trusted/TrustedWebActivityDisplayMode;
    ...
    iput v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mTitleVisibilityState:I

    const-string v3, "android.support.customtabs.extra.EXTRA_REMOTEVIEWS"
    ...
    iput-object v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mRemoteViews:Landroid/widget/RemoteViews;

    const-string v3, "android.support.customtabs.extra.EXTRA_REMOTEVIEWS_VIEW_IDS"

    invoke-static {p1, v3}, Lcom/sec/android/app/sbrowser/common/utils/SBrowserIntentUtils;->safeGetIntArrayExtra(Landroid/content/Intent;Ljava/lang/String;)[I

    move-result-object v3

    iput-object v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mClickableViewIds:[I

    const-string v3, "android.support.customtabs.extra.EXTRA_REMOTEVIEWS_PENDINGINTENT"
    ...
    iput-object v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mRemoteViewsPendingIntent:Landroid/app/PendingIntent;

    invoke-static {p1}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->getSecondaryToolbarSwipeUpGesture(Landroid/content/Intent;)Landroid/app/PendingIntent;

    move-result-object v3

    iput-object v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mSecondaryToolbarSwipeUpPendingIntent:Landroid/app/PendingIntent;
    ...
    const-string v3, "com.sec.android.app.sbrowser.customtabs.MEDIA_VIEWER_URL"

    invoke-static {p1, v3}, Lcom/sec/android/app/sbrowser/common/utils/SBrowserIntentUtils;->safeGetStringExtra(Landroid/content/Intent;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    :cond_3
    iput-object v6, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mMediaViewerUrl:Ljava/lang/String;
    ...
    const-string v3, "com.sec.android.app.sbrowser.customtabs.EXTRA_ENABLE_EMBEDDED_MEDIA_EXPERIENCE"
    ...
    :goto_1
    iput-boolean v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mEnableEmbeddedMediaExperience:Z
    ...
    const-string v3, "com.sec.android.app.sbrowser.customtabs.EXTRA_BROWSER_LAUNCH_SOURCE"

    const/4 v5, -0x1

    invoke-static {p1, v3, v5}, Lcom/sec/android/app/sbrowser/common/utils/SBrowserIntentUtils;->safeGetIntExtra(Landroid/content/Intent;Ljava/lang/String;I)I
    ...
    :goto_2
    iput-boolean v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mIsFromMediaLauncherActivity:Z

    invoke-static {p1}, Landroidx/browser/customtabs/CustomTabsIntent;->isBookmarksButtonEnabled(Landroid/content/Intent;)Z

    move-result v3

    xor-int/2addr v3, v1

    iput-boolean v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mDisableStar:Z

    invoke-static {p1}, Landroidx/browser/customtabs/CustomTabsIntent;->isDownloadButtonEnabled(Landroid/content/Intent;)Z

    move-result v3

    xor-int/2addr v3, v1

    iput-boolean v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mDisableDownload:Z

    invoke-static {p1}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->getTranslateLanguage(Landroid/content/Intent;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mTranslateLanguage:Ljava/lang/String;

    const-string v3, "androidx.browser.customtabs.extra.AUTO_TRANSLATE_LANGUAGE"

    invoke-static {p1, v3}, Lcom/sec/android/app/sbrowser/common/utils/SBrowserIntentUtils;->safeGetStringExtra(Landroid/content/Intent;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mAutoTranslateLanguage:Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->convertOrientationType(I)I

    move-result v3

    iput v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mDefaultOrientation:I

    const-string v3, "org.chromium.chrome.browser.customtabs.AGA_EXPERIMENT_IDS"

    invoke-static {p1, v3}, Lcom/sec/android/app/sbrowser/common/utils/SBrowserIntentUtils;->safeGetIntArrayExtra(Landroid/content/Intent;Ljava/lang/String;)[I

    move-result-object v3

    iput-object v3, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mGsaExperimentIds:[I
    ...
    invoke-virtual {v3, p1}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabsConnection;->setupDynamicFeatures(Landroid/content/Intent;)Z

    move-result v3

    invoke-static {p1}, Lcom/sec/android/app/sbrowser/customtabs/features/partialcustomtab/PartialCustomTabIntentUtils;->getActivityBreakPointFromIntent(Landroid/content/Intent;)I

    move-result v5

    iput v5, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mBreakPointDp:I
    ...
    iput v5, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mInitialActivityHeight:I
    ...
    iput v5, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mInitialActivityWidth:I

    invoke-static {p2, p1}, Lcom/sec/android/app/sbrowser/customtabs/features/partialcustomtab/PartialCustomTabIntentUtils;->getToolbarCornerRadiusFromIntent(Landroid/content/Context;Landroid/content/Intent;)I

    move-result p2

    iput p2, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mPartialTabToolbarCornerRadius:I

    const-string p2, "androidx.browser.customtabs.extra.ACTIVITY_HEIGHT_RESIZE_BEHAVIOR"

    invoke-static {p1, p2, v4}, Lcom/sec/android/app/sbrowser/common/utils/SBrowserIntentUtils;->safeGetIntExtra(Landroid/content/Intent;Ljava/lang/String;I)I
    ...
    :goto_3
    iput-boolean p2, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mIsPartialCustomTabFixedHeight:Z

    invoke-static {p1}, Landroidx/browser/customtabs/CustomTabsIntent;->isBackgroundInteractionEnabled(Landroid/content/Intent;)Z

    move-result p2

    iput-boolean p2, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mInteractWithBackground:Z

    invoke-static {p1}, Lcom/sec/android/app/sbrowser/customtabs/features/partialcustomtab/PartialCustomTabIntentUtils;->hasBackgroundInteractBehavior(Landroid/content/Intent;)Z

    move-result p2

    if-eqz p2, :cond_8

    invoke-static {p1}, Lcom/sec/android/app/sbrowser/customtabs/features/partialcustomtab/PartialCustomTabIntentUtils;->getBackgroundInteractBehavior(Landroid/content/Intent;)I
    ...
    :cond_7
    iput-boolean v4, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mInteractWithBackground:Z

    :cond_8
    invoke-static {p1}, Lcom/sec/android/app/sbrowser/customtabs/features/partialcustomtab/PartialCustomTabIntentUtils;->getActivitySideSheetDecorationTypeFromIntent(Landroid/content/Intent;)I

    move-result p2

    iput p2, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mSideSheetDecorationType:I

    invoke-static {p1}, Lcom/sec/android/app/sbrowser/customtabs/features/partialcustomtab/PartialCustomTabIntentUtils;->getActivitySideSheetRoundedCornersPositionFromIntent(Landroid/content/Intent;)I

    move-result p2

    iput p2, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mSideSheetRoundedCornersPosition:I
    ...
    const-string p2, "androidx.browser.trusted.extra.SHARE_TARGET"

    invoke-static {p1, p2}, Lcom/sec/android/app/sbrowser/common/utils/SBrowserIntentUtils;->safeGetBundleExtra(Landroid/content/Intent;Ljava/lang/String;)Landroid/os/Bundle;

    move-result-object p2

    if-eqz p2, :cond_9

    invoke-static {p2}, Landroidx/browser/trusted/sharing/ShareTarget;->fromBundle(Landroid/os/Bundle;)Landroidx/browser/trusted/sharing/ShareTarget;

    move-result-object p2

    invoke-direct {p0, p2}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->retrieveShareTarget(Landroidx/browser/trusted/sharing/ShareTarget;)Lcom/sec/terrace/browser/browserservices/intents/TerraceWebApkShareTarget;

    move-result-object p2

    iput-object p2, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mShareTarget:Lcom/sec/terrace/browser/browserservices/intents/TerraceWebApkShareTarget;

    const-string p2, "androidx.browser.trusted.extra.SHARE_DATA"
    ...
    invoke-static {p2}, Landroidx/browser/trusted/sharing/ShareData;->fromBundle(Landroid/os/Bundle;)Landroidx/browser/trusted/sharing/ShareData;

    move-result-object p2

    iput-object p2, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mShareData:Landroidx/browser/trusted/sharing/ShareData;

    iput-boolean v1, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mIsShareIntent:Z

    :cond_9
    const-string p2, "isTrustedWebActivity = true"

    invoke-static {v2, p2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    :cond_a
    invoke-direct {p0, p1, p3, v3}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->logCustomTabFeatures(Landroid/content/Intent;IZ)V

    invoke-static {p1, v0}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->getClientPackageNameFromSessionOrCallingActivity(Landroid/content/Intent;Landroidx/browser/customtabs/CustomTabsSessionToken;)Ljava/lang/String;

    move-result-object p0

    new-instance p1, Ljava/lang/StringBuilder;

    const-string p2, "hasNonSpoofablePackageName = "
    ...
    invoke-static {v2, p1, p0}, Landroidx/appcompat/graphics/drawable/a;->z(Ljava/lang/String;Ljava/lang/StringBuilder;Z)V
...
.method private static convertOrientationType(I)I
    ...
    invoke-static {p0, v1, v2}, Landroidx/compose/ui/input/pointer/a;->p(ILjava/lang/String;Ljava/lang/String;)V
...
.method private static getClientPackageNameFromSessionOrCallingActivity(Landroid/content/Intent;Landroidx/browser/customtabs/CustomTabsSessionToken;)Ljava/lang/String;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-virtual {v0, p1}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabsConnection;->getClientPackageNameForSession(Landroidx/browser/customtabs/CustomTabsSessionToken;)Ljava/lang/String;
    ...
    :cond_0
    const-string p1, "com.sec.android.app.sbrowser.calling_activity_package"
...
.method private static getSecondaryToolbarSwipeUpGesture(Landroid/content/Intent;)Landroid/app/PendingIntent;
    ...
    invoke-static {p0}, Landroidx/browser/customtabs/CustomTabsIntent;->getSecondaryToolbarSwipeUpGesture(Landroid/content/Intent;)Landroid/app/PendingIntent;
...
.method private static getTranslateLanguage(Landroid/content/Intent;)Ljava/lang/String;
    ...
    invoke-static {p0}, Landroidx/browser/customtabs/CustomTabsIntent;->getTranslateLocale(Landroid/content/Intent;)Ljava/util/Locale;
...
.method public static isTrustedCustomTab(Landroid/content/Intent;Landroidx/browser/customtabs/CustomTabsSessionToken;)Z
    .locals 2
    ...
    const-string v0, "com.sec.android.app.sbrowser.customtabs.EXTRA_LAUNCH_WITH_READ_ARTICLES_ALOUD"
    ...
    :cond_0
    invoke-static {p0, p1}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->getClientPackageNameFromSessionOrCallingActivity(Landroid/content/Intent;Landroidx/browser/customtabs/CustomTabsSessionToken;)Ljava/lang/String;
...
.method private logCustomTabFeatures(Landroid/content/Intent;IZ)V
    ...
    :cond_12
    const-string p2, "com.sec.android.app.sbrowser.calling_activity_package"
...
.method private resolveTwaDisplayMode()Landroidx/browser/trusted/TrustedWebActivityDisplayMode;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    :cond_0
    :try_start_0
    invoke-static {p0}, Landroidx/browser/trusted/TrustedWebActivityDisplayMode;->fromBundle(Landroid/os/Bundle;)Landroidx/browser/trusted/TrustedWebActivityDisplayMode;
...
.method private retrieveShareTarget(Landroidx/browser/trusted/sharing/ShareTarget;)Lcom/sec/terrace/browser/browserservices/intents/TerraceWebApkShareTarget;
    .locals 10
    ...
    :cond_0
    iget-object p0, p1, Landroidx/browser/trusted/sharing/ShareTarget;->params:Landroidx/browser/trusted/sharing/ShareTarget$Params;

    iget-object v1, p1, Landroidx/browser/trusted/sharing/ShareTarget;->action:Ljava/lang/String;

    iget-object v2, p0, Landroidx/browser/trusted/sharing/ShareTarget$Params;->title:Ljava/lang/String;

    iget-object v3, p0, Landroidx/browser/trusted/sharing/ShareTarget$Params;->text:Ljava/lang/String;

    iget-object v0, p1, Landroidx/browser/trusted/sharing/ShareTarget;->encodingType:Ljava/lang/String;

    iget-object p1, p1, Landroidx/browser/trusted/sharing/ShareTarget;->method:Ljava/lang/String;
    ...
    :goto_1
    iget-object v0, p0, Landroidx/browser/trusted/sharing/ShareTarget$Params;->files:Ljava/util/List;
    ...
    iget-object v4, p0, Landroidx/browser/trusted/sharing/ShareTarget$Params;->files:Ljava/util/List;
    ...
    iget-object v9, v4, Landroidx/browser/trusted/sharing/ShareTarget$FileFormField;->name:Ljava/lang/String;
    ...
    :cond_4
    new-instance p0, Lcom/sec/terrace/browser/browserservices/intents/TerraceWebApkShareTarget;
...
.method private static toLanguageTag(Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-static {v0, p0, v1}, Landroidx/appcompat/graphics/drawable/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public getClientPackageName()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mSession:Landroidx/browser/customtabs/CustomTabsSessionToken;

    invoke-static {v0, p0}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->getClientPackageNameFromSessionOrCallingActivity(Landroid/content/Intent;Landroidx/browser/customtabs/CustomTabsSessionToken;)Ljava/lang/String;
...
.method public getSession()Landroidx/browser/customtabs/CustomTabsSessionToken;
    .locals 0
...
.method public getShareData()Landroidx/browser/trusted/sharing/ShareData;
    ...
    :cond_0
    :try_start_0
    invoke-static {p0}, Landroidx/browser/trusted/sharing/ShareData;->fromBundle(Landroid/os/Bundle;)Landroidx/browser/trusted/sharing/ShareData;
...
.method public getSideSheetPosition()I
    ...
    invoke-static {p0}, Landroidx/browser/customtabs/CustomTabsIntent;->getActivitySideSheetPosition(Landroid/content/Intent;)I
...
.method public getTwaDisplayMode()Landroidx/browser/trusted/TrustedWebActivityDisplayMode;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mTrustedWebActivityDisplayMode:Landroidx/browser/trusted/TrustedWebActivityDisplayMode;
...
.method public isPostShareTarget(Lcom/sec/terrace/Terrace;)Z
    ...
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mShareData:Landroidx/browser/trusted/sharing/ShareData;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/customtabs/CustomTabIntentDataProvider;->mShareData:Landroidx/browser/trusted/sharing/ShareData;

    invoke-static {v0, v1, p0, p1}, Lcom/sec/terrace/browser/webapps/TerraceWebApkPostShareTargetNavigator;->navigateIfPostShareTarget(Ljava/lang/String;Lcom/sec/terrace/browser/browserservices/intents/TerraceWebApkShareTarget;Landroidx/browser/trusted/sharing/ShareData;Lcom/sec/terrace/Terrace;)Z

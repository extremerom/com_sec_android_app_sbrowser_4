...
.method private declared-synchronized callOnSession(Landroidx/browser/customtabs/CustomTabsSessionToken;Ljava/lang/Object;Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParamsCallback;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private declared-synchronized callOnSession(Landroidx/browser/customtabs/CustomTabsSessionToken;Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParamsRunnable;)V
    .locals 1
...
.method private cleanupSessionInternal(Landroidx/browser/customtabs/CustomTabsSessionToken;)V
    .locals 2
    ...
    invoke-direct {p0, p1, v0}, Lcom/sec/android/app/sbrowser/customtabs/ClientManager;->callOnSession(Landroidx/browser/customtabs/CustomTabsSessionToken;Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParamsRunnable;)V
...
.method public static synthetic g(Lcom/sec/android/app/sbrowser/customtabs/ClientManager;Landroidx/browser/customtabs/CustomTabsSessionToken;Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParams;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/customtabs/ClientManager;->lambda$cleanupSessionInternal$9(Landroidx/browser/customtabs/CustomTabsSessionToken;Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParams;)V
...
.method private synthetic lambda$bindToPostMessageServiceForSession$1(Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParams;)Ljava/lang/Boolean;
    ...
    iget-object p1, p1, Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParams;->serviceConnection:Landroidx/browser/customtabs/PostMessageServiceConnection;

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/customtabs/ClientManager;->mContext:Landroid/content/Context;

    invoke-virtual {p1, p0}, Landroidx/browser/customtabs/PostMessageServiceConnection;->bindSessionToPostMessageService(Landroid/content/Context;)Z
...
.method private synthetic lambda$cleanupSessionInternal$9(Landroidx/browser/customtabs/CustomTabsSessionToken;Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParams;)V
    .locals 2
    ...
    iget-object v0, p2, Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParams;->serviceConnection:Landroidx/browser/customtabs/PostMessageServiceConnection;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/customtabs/ClientManager;->mContext:Landroid/content/Context;

    invoke-virtual {v0, v1}, Landroidx/browser/customtabs/PostMessageServiceConnection;->cleanup(Landroid/content/Context;)V
    ...
    invoke-interface {v0, p1}, Lcom/sec/android/app/sbrowser/customtabs/ClientManager$DisconnectCallback;->run(Landroidx/browser/customtabs/CustomTabsSessionToken;)V
...
.method private synthetic lambda$validateRelationshipInternal$3(Lcom/sec/terrace/browser/customtabs/TerraceOrigin;Landroidx/browser/customtabs/CustomTabsSessionToken;IZLcom/sec/terrace/browser/customtabs/TerraceOrigin;Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParams;Ljava/lang/String;Lcom/sec/terrace/browser/customtabs/TerraceOrigin;ZLjava/lang/Boolean;)V
    ...
    invoke-virtual {p0, p2}, Lcom/sec/android/app/sbrowser/customtabs/ClientManager;->getCallbackForSession(Landroidx/browser/customtabs/CustomTabsSessionToken;)Landroidx/browser/customtabs/CustomTabsCallback;
    ...
    invoke-virtual {p0, p3, p1, p9, p2}, Landroidx/browser/customtabs/CustomTabsCallback;->onRelationshipValidationResult(ILandroid/net/Uri;ZLandroid/os/Bundle;)V
...
.method private declared-synchronized validateRelationshipInternal(Landroidx/browser/customtabs/CustomTabsSessionToken;ILcom/sec/terrace/browser/customtabs/TerraceOrigin;Lcom/sec/terrace/browser/customtabs/TerraceOrigin;Z)Z
    .locals 10
...
# virtual methods
.method public bindToPostMessageServiceForSession(Landroidx/browser/customtabs/CustomTabsSessionToken;)Z
    .locals 3
    .annotation build Landroid/annotation/SuppressLint;
        value = {
            "RestrictedApi"
    ...
    invoke-direct {v1, p0, v2}, Lcom/sec/android/app/sbrowser/customtabs/c;-><init>(Ljava/lang/Object;I)V

    invoke-direct {p0, p1, v0, v1}, Lcom/sec/android/app/sbrowser/customtabs/ClientManager;->callOnSession(Landroidx/browser/customtabs/CustomTabsSessionToken;Ljava/lang/Object;Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParamsCallback;)Ljava/lang/Object;
...
.method public declared-synchronized cleanupSession(Landroidx/browser/customtabs/CustomTabsSessionToken;)V
    .locals 1
    .annotation build Landroid/annotation/SuppressLint;
        value = {
            "RestrictedApi"
    ...
    :try_start_0
    invoke-virtual {p1}, Landroidx/browser/customtabs/CustomTabsSessionToken;->hasId()Z
    ...
    invoke-virtual {p1, v0}, Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParams;->setCustomTabsCallback(Landroidx/browser/customtabs/CustomTabsCallback;)V
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/customtabs/ClientManager;->cleanupSessionInternal(Landroidx/browser/customtabs/CustomTabsSessionToken;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized cleanupUnusedSessions()V
    ...
    invoke-virtual {v2}, Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParams;->getCustomTabsCallback()Landroidx/browser/customtabs/CustomTabsCallback;

    move-result-object v2

    if-nez v2, :cond_0

    invoke-direct {p0, v1}, Lcom/sec/android/app/sbrowser/customtabs/ClientManager;->cleanupSessionInternal(Landroidx/browser/customtabs/CustomTabsSessionToken;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized dontKeepAliveForSession(Landroidx/browser/customtabs/CustomTabsSessionToken;)V
    .locals 2
...
.method public getCallbackForSession(Landroidx/browser/customtabs/CustomTabsSessionToken;)Landroidx/browser/customtabs/CustomTabsCallback;
    .locals 2
    ...
    invoke-direct {p0, p1, v1, v0}, Lcom/sec/android/app/sbrowser/customtabs/ClientManager;->callOnSession(Landroidx/browser/customtabs/CustomTabsSessionToken;Ljava/lang/Object;Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParamsCallback;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroidx/browser/customtabs/CustomTabsCallback;
...
.method public declared-synchronized getDefaultReferrerForSession(Landroidx/browser/customtabs/CustomTabsSessionToken;)Lcom/sec/terrace/browser/TerraceReferrer;
    .locals 0
...
.method public initializeWithPostMessageOriginForSession(Landroidx/browser/customtabs/CustomTabsSessionToken;Landroid/net/Uri;Landroid/net/Uri;)V
    .locals 2
...
.method public declared-synchronized keepAliveForSession(Landroidx/browser/customtabs/CustomTabsSessionToken;Landroid/content/Intent;)Z
    .locals 4
...
.method public declared-synchronized newSession(Landroidx/browser/customtabs/CustomTabsSessionToken;ILcom/sec/android/app/sbrowser/customtabs/ClientManager$DisconnectCallback;Lcom/sec/terrace/browser/customtabs/TerracePostMessageHandler;Landroidx/browser/customtabs/PostMessageServiceConnection;)Z
    .locals 8
    .param p4    # Lcom/sec/terrace/browser/customtabs/TerracePostMessageHandler;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p5    # Landroidx/browser/customtabs/PostMessageServiceConnection;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    :try_start_0
    invoke-virtual {p1}, Landroidx/browser/customtabs/CustomTabsSessionToken;->getCallback()Landroidx/browser/customtabs/CustomTabsCallback;
    ...
    invoke-virtual {p2, p1}, Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParams;->setCustomTabsCallback(Landroidx/browser/customtabs/CustomTabsCallback;)V
    ...
    invoke-direct/range {v0 .. v6}, Lcom/sec/android/app/sbrowser/customtabs/ClientManager$SessionParams;-><init>(Landroid/content/Context;ILandroidx/browser/customtabs/CustomTabsCallback;Lcom/sec/android/app/sbrowser/customtabs/ClientManager$DisconnectCallback;Lcom/sec/terrace/browser/customtabs/TerracePostMessageHandler;Landroidx/browser/customtabs/PostMessageServiceConnection;)V
...
.method public postMessage(Landroidx/browser/customtabs/CustomTabsSessionToken;Ljava/lang/String;)I
    .locals 3
    ...
    invoke-direct {v1, p2, v2}, Lcom/sec/android/app/sbrowser/customtabs/c;-><init>(Ljava/lang/Object;I)V
...
.method public resetPostMessageHandlerForSession(Landroidx/browser/customtabs/CustomTabsSessionToken;Lcom/sec/terrace/Terrace;)V
    ...
    invoke-direct {v0, p2, v1}, Lcom/sec/android/app/sbrowser/customtabs/c;-><init>(Ljava/lang/Object;I)V
...
.method public declared-synchronized updateStatsAndReturnWhetherAllowed(Landroidx/browser/customtabs/CustomTabsSessionToken;ILjava/lang/String;Z)Z
    .locals 5
...
.method public declared-synchronized validateRelationship(Landroidx/browser/customtabs/CustomTabsSessionToken;ILcom/sec/terrace/browser/customtabs/TerraceOrigin;Landroid/os/Bundle;)Z
    .locals 6
    ...
    :try_start_0
    invoke-direct/range {v0 .. v5}, Lcom/sec/android/app/sbrowser/customtabs/ClientManager;->validateRelationshipInternal(Landroidx/browser/customtabs/CustomTabsSessionToken;ILcom/sec/terrace/browser/customtabs/TerraceOrigin;Lcom/sec/terrace/browser/customtabs/TerraceOrigin;Z)Z
...
.method public declared-synchronized verifyAndInitializeWithPostMessageOriginForSession(Landroidx/browser/customtabs/CustomTabsSessionToken;Lcom/sec/terrace/browser/customtabs/TerraceOrigin;Lcom/sec/terrace/browser/customtabs/TerraceOrigin;I)V
    .locals 6

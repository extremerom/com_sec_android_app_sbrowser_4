...
.method private createTerrace()Lcom/sec/terrace/Terrace;
    ...
    invoke-virtual {v3}, Lcom/sec/terrace/browser/browserservices/intents/TerraceBrowserServicesIntentDataProvider;->getSession()Landroidx/browser/customtabs/CustomTabsSessionToken;

    move-result-object v3

    invoke-virtual {v2, v3, v0, v1}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabsConnection;->takePrerenderedUrl(Landroidx/browser/customtabs/CustomTabsSessionToken;Ljava/lang/String;Ljava/lang/String;)Lcom/sec/terrace/Terrace;
...
.method private sendCustomTabsCallback(ILandroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/sec/terrace/browser/browserservices/intents/TerraceBrowserServicesIntentDataProvider;->getSession()Landroidx/browser/customtabs/CustomTabsSessionToken;
    ...
    invoke-virtual {v0, p0, p1, p2}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabsConnection;->notifyNavigationEvent(Landroidx/browser/customtabs/CustomTabsSessionToken;ILandroid/os/Bundle;)Z
...
.method public initializeTab(Landroid/content/Context;Lcom/sec/terrace/Terrace;)V
    ...
    invoke-virtual {p1, v0}, Lcom/sec/android/app/sbrowser/customtabs/CustomTabsConnection;->getClientPackageNameForSession(Landroidx/browser/customtabs/CustomTabsSessionToken;)Ljava/lang/String;
...
.method public onStartContentIntent(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    invoke-static {p1, p2, p0}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->n(Landroid/content/ActivityNotFoundException;Ljava/lang/StringBuilder;Ljava/lang/String;)V

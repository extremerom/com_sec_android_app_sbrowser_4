...
.field private final mImmersiveMode:Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;
...
.method public constructor <init>(Landroid/app/Activity;Lcom/sec/android/app/sbrowser/customtabs/TrustedWebActivityCoordinator$Delegate;Lcom/sec/android/app/sbrowser/customtabs/ClientAppDataRecorder;Lcom/sec/terrace/browser/browserservices/TerraceInstalledWebappRegistrar;)V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/customtabs/TrustedWebActivityCoordinator;->computeImmersiveMode()Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/sbrowser/customtabs/TrustedWebActivityCoordinator;->mImmersiveMode:Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;
...
.method private computeImmersiveMode()Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;
    .locals 2
    ...
    invoke-interface {p0}, Lcom/sec/android/app/sbrowser/customtabs/TrustedWebActivityCoordinator$Delegate;->getTwaDisplayMode()Landroidx/browser/trusted/TrustedWebActivityDisplayMode;

    move-result-object p0

    instance-of v0, p0, Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;

    if-eqz v0, :cond_1

    move-object v1, p0

    check-cast v1, Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;
...
.method public attemptVerificationForInitialUrl(Ljava/lang/String;Lcom/sec/android/app/sbrowser/customtabs/SCustomTab;)V
    ...
    :try_start_0
    new-instance v8, Lcom/sec/terrace/browser/customtabs/TerraceOrigin;

    invoke-direct {v8, p1}, Lcom/sec/terrace/browser/customtabs/TerraceOrigin;-><init>(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0

    new-instance p1, Ljava/lang/StringBuilder;

    const-string v2, "[attemptVerificationForInitialUrl] packageName:"
    ...
    const-string v2, "[attemptVerificationForInitialUrl] origin:"
    ...
    invoke-direct/range {v2 .. v7}, LZ6/a;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/String;I)V
    ...
    invoke-virtual {p1, v8}, Lcom/sec/terrace/browser/customtabs/TerraceOriginVerifier;->start(Lcom/sec/terrace/browser/customtabs/TerraceOrigin;)V
...
.method public updateImmersiveMode(Z)V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/customtabs/TrustedWebActivityCoordinator;->mImmersiveMode:Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/customtabs/TrustedWebActivityCoordinator;->mImmersiveMode:Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;

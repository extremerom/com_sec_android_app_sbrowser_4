...
.method public static synthetic a(Lcom/samsung/android/sdk/bixby2/action/ResponseCallback;)V
    .locals 0

    invoke-static {p0}, Lcom/sec/android/app/sbrowser/capsule/BixbyActionHandler;->lambda$getCurrentUrl$1(Lcom/samsung/android/sdk/bixby2/action/ResponseCallback;)V

    return-void
.end method

.method public static synthetic b(Lcom/sec/android/app/sbrowser/capsule/BixbyActionHandler;Landroid/content/Context;Landroid/os/Bundle;Lcom/samsung/android/sdk/bixby2/action/ResponseCallback;)V
    .locals 0
...
.method private getCurrentUrl(Landroid/content/Context;Lcom/samsung/android/sdk/bixby2/action/ResponseCallback;)V
    .locals 1

    new-instance v0, Lcom/sec/android/app/sbrowser/capsule/a;

    invoke-direct {v0, p2}, Lcom/sec/android/app/sbrowser/capsule/a;-><init>(Lcom/samsung/android/sdk/bixby2/action/ResponseCallback;)V
...
.method private static synthetic lambda$getCurrentUrl$1(Lcom/samsung/android/sdk/bixby2/action/ResponseCallback;)V
    .locals 5
    ...
    const-string p0, "[getCurrentUrl] : currentTabManager is null"
    ...
    invoke-virtual {v3}, Lcom/sec/android/app/sbrowser/multi_cp_native/newsfeed/news_details/TTNewDetailsFragment;->getCurrentUrl()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/sec/android/app/sbrowser/multi_cp_native/newsfeed/news_details/TTNewDetailsFragment;->getTitle()Ljava/lang/String;
    ...
    const-string p0, "[getCurrentUrl] : current tab is null"
...
.method private searchBookmarkItem(Landroid/content/Context;Landroid/os/Bundle;Lcom/samsung/android/sdk/bixby2/action/ResponseCallback;)V
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Lcom/sec/android/app/sbrowser/capsule/b;-><init>(Lcom/sec/android/app/sbrowser/capsule/BixbyActionHandler;Landroid/content/Context;Landroid/os/Bundle;Lcom/samsung/android/sdk/bixby2/action/ResponseCallback;)V
...
.method public executeAction(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Lcom/samsung/android/sdk/bixby2/action/ResponseCallback;)V
    ...
    :pswitch_2
    invoke-direct {p0, p1, p4}, Lcom/sec/android/app/sbrowser/capsule/BixbyActionHandler;->getCurrentUrl(Landroid/content/Context;Lcom/samsung/android/sdk/bixby2/action/ResponseCallback;)V
    ...
    :sswitch_data_0
    .sparse-switch
        -0x3174aeeb -> :sswitch_3
        -0x2308a6f4 -> :sswitch_2

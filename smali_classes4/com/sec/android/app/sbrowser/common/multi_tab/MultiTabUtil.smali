...
.method public static findStartAndEndIndexes(IIZ)Landroidx/core/util/Pair;
    .locals 3
...
.method public static setGroupFavicon(Landroid/view/View;Ljava/lang/String;)V
    ...
    invoke-direct {v2, p0, p1}, Lt6/a;-><init>(Landroid/widget/ImageView;Ljava/lang/String;)V
...
.method public static showCloseAllDialog(Landroid/content/Context;Landroid/view/View;ZLandroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog;
    .locals 8
...
.method public static showCloseAllWithGroupDialog(Landroid/content/Context;Landroid/view/View;ZLandroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog;
    .locals 8
    ...
    invoke-direct {v5, p3, p2, v0}, Lt6/b;-><init>(Landroid/content/DialogInterface$OnClickListener;ZI)V

    new-instance v7, Lt6/b;

    const/4 p3, 0x3

    invoke-direct {v7, p4, p2, p3}, Lt6/b;-><init>(Landroid/content/DialogInterface$OnClickListener;ZI)V
...
.method public static showCloseGroupDialog(Landroid/content/Context;Landroid/view/View;Ljava/lang/String;ZLandroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog;
    ...
    invoke-direct {v5, p4, p3, v0}, Lt6/b;-><init>(Landroid/content/DialogInterface$OnClickListener;ZI)V

    new-instance v7, Lt6/b;

    const/4 p4, 0x5

    invoke-direct {v7, p5, p3, p4}, Lt6/b;-><init>(Landroid/content/DialogInterface$OnClickListener;ZI)V
...
.method public static showCloseTabsWithGroupDialog(Landroid/content/Context;Landroid/view/View;ZLandroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog;
    .locals 8

...
.method public static synthetic a(Lcom/sec/android/app/sbrowser/common/stub/StubUtil$PlayListener;Lv2/a;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/sec/android/app/sbrowser/common/stub/StubUtil;->lambda$checkUpdateOnGooglePlay$1(Lcom/sec/android/app/sbrowser/common/stub/StubUtil$PlayListener;Lv2/a;)V
...
.method public static checkUpdateOnGooglePlay(Lcom/sec/android/app/sbrowser/common/stub/StubUtil$PlayListener;)V
    ...
    invoke-direct {v2, v0, v3}, LM/e;-><init>(Landroid/content/Context;I)V

    new-instance v0, Lg3/c;

    invoke-direct {v0, v2}, Lg3/c;-><init>(LM/e;)V

    sput-object v0, Lv2/c;->a:Lg3/c;
    ...
    iget-object v1, v0, Lv2/e;->b:Landroid/content/Context;
    ...
    iget-object v0, v0, Lv2/e;->a:Lv2/h;

    iget-object v3, v0, Lv2/h;->a:Lw2/m;
    ...
    invoke-static {v2, v3, v1}, Lp4/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lk2/l;->h(Ljava/lang/Exception;)V
    ...
    invoke-virtual {v2, v5, v4}, Lp4/a;->a(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v4, v0, v2, v1, v2}, Lv2/f;-><init>(Lv2/h;Lk2/f;Ljava/lang/String;Lk2/f;)V

    new-instance v0, Lv2/f;

    invoke-direct {v0, v3, v2, v2, v4}, Lv2/f;-><init>(Lw2/m;Lk2/f;Lk2/f;Lv2/f;)V

    invoke-virtual {v3}, Lw2/m;->a()Landroid/os/Handler;

    move-result-object v1

    invoke-virtual {v1, v0}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    iget-object v0, v2, Lk2/f;->a:Lk2/l;

    :goto_1
    new-instance v1, Lv6/a;

    invoke-direct {v1, p0}, Lv6/a;-><init>(Lcom/sec/android/app/sbrowser/common/stub/StubUtil$PlayListener;)V

    invoke-virtual {v0, v1}, Lk2/l;->a(Lk2/b;)Lk2/l;

    new-instance v1, Lv6/a;

    invoke-direct {v1, p0}, Lv6/a;-><init>(Lcom/sec/android/app/sbrowser/common/stub/StubUtil$PlayListener;)V

    invoke-virtual {v0, v1}, Lk2/l;->c(Lk2/c;)Lk2/l;
...
.method public static getAbiType()Ljava/lang/String;
    ...
    const-string/jumbo v0, "support 64bit"
    ...
    const-string/jumbo v0, "support 32bit"
...
.method private static getBetaInstallAppStoreName(Landroid/content/Context;)Ljava/lang/String;
    ...
    :try_start_1
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/device/a;->b(Landroid/content/pm/PackageManager;)Landroid/content/pm/InstallSourceInfo;

    move-result-object p0

    if-eqz p0, :cond_1

    invoke-static {p0}, Lcom/google/android/material/color/a;->s(Landroid/content/pm/InstallSourceInfo;)Ljava/lang/String;
...
.method public static getForceUpdateVersion()Ljava/lang/String;
    ...
    const-string/jumbo v2, "update_popup_preferences"
...
.method private static getStubDownloadUrl(Ljava/lang/String;ZLjava/lang/String;I)Ljava/lang/String;
    ...
    const-string v0, "https://cn-ms.galaxyappstore.com/vas/stub/stubDownload.as"
...
.method private static getStubUpdateUrl(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v0, "https://cn-ms.galaxyappstore.com/vas/stub/stubUpdateCheck.as"
...
.method public static getUpdatePopupShowedCount()I
    ...
    const-string/jumbo v1, "update_popup_preferences"
...
.method public static getUpdateVersion()J
    ...
    const-string/jumbo v1, "update_vesion"
...
.method public static is24HoursPassedAfterLastChecking()Ljava/lang/Boolean;
    ...
    const-string/jumbo v4, "update_check_last_time"
...
.method public static isSatisfiedDurationOfPopup()Ljava/lang/Boolean;
    ...
    const-string/jumbo v3, "update_check_last_time"
...
.method private static lambda$checkUpdateOnGooglePlay$1(Lcom/sec/android/app/sbrowser/common/stub/StubUtil$PlayListener;Lv2/a;)V
    .locals 4

    iget v0, p1, Lv2/a;->b:I
    ...
    :cond_2
    iget-object v1, p1, Lv2/a;->c:Landroid/app/PendingIntent;
    ...
    const-string/jumbo v1, "updateAvailability : "
...
.method private static resetLastCheckTime()V
    ...
    const-string/jumbo v2, "update_check_last_time"
...
.method public static setForceUpdateVersion(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "setForceUpdateVersion :"
...
.method public static setGooglePlayUpdateAvailable(Z)V
    ...
    const-string/jumbo v1, "setGooglePlayUpdateAvailable : "
...
.method public static setLastCheckTime()V
    ...
    const-string/jumbo v2, "setLastCheckTime :"
...
.method public static setUTcheck(Z)V
    ...
    const-string/jumbo v1, "setUTcheck : "
...
.method public static setUpdateVersion(J)V
    ...
    const-string/jumbo v1, "setUpdateVersion :"

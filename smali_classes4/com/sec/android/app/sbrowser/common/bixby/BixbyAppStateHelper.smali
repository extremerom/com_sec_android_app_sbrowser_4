...
.method private static getAppStateWithLlm(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v1, "{    \"concepts\":[        {            \"type\":\"viv.samsungInternetApp.AppState\",            \"values\":[                \"Internet\"            ]        }    ],    \"llmContext\":[        {            \"type\":\"WebpageInfo\",            \"value\":{                \"title\":\""
...
.method public static updateAppState(Lcom/sec/android/app/sbrowser/common/model/sbrowser_tab/SBrowserTabDelegate;)V
    ...
    const-string/jumbo v0, "updateAppState"
    ...
    :catch_0
    const-string/jumbo p0, "updateAppState : The Sbixby instance is NULL"

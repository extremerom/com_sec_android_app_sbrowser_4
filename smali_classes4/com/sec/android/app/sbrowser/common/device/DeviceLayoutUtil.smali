...
.method private static applyNavigationBarInset(Landroid/view/View;Landroid/view/WindowInsets;)V
    ...
    invoke-static {p1, v1}, Landroidx/core/view/t;->q(Landroid/view/WindowInsets;I)Z
...
.method public static getCurrentDisplayType(Landroid/content/Context;)I
    ...
    const-string/jumbo v0, "si__DeviceLayoutUtil"
...
.method private static getDisplayCutout(Landroid/content/Context;)Landroid/view/DisplayCutout;
    ...
    :cond_2
    invoke-static {p0}, Landroidx/reflect/view/SeslWindowInsetsReflector;->getDisplayCutoutForUdc(Landroid/view/WindowInsets;)Landroid/view/DisplayCutout;
...
.method public static getNavigationBarHeight(Landroid/view/View;)I
    ...
    invoke-static {p0, v0}, LT3/a;->d(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
...
.method private static getNavigationBarView(Landroid/view/Window;)Landroid/view/View;
    .locals 3
...
.method public static getStatusBarHeightIgnoringVisibility(Landroid/view/View;)I
    ...
    invoke-static {p0, v0}, Landroidx/core/view/t;->d(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
...
.method private static getStatusBarView(Landroid/view/Window;)Landroid/view/View;
    .locals 3
    .annotation build Landroidx/annotation/RequiresApi;
        value = 0x1e
    .end annotation
...
.method public static getWidth(Landroid/content/Context;)I
    ...
    invoke-static {v1, v3}, LT3/a;->d(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
...
.method public static isDisplayTypeMain(Landroid/content/Context;)Z
    ...
    const-string/jumbo v2, "si__DeviceLayoutUtil"

    invoke-static {p0, v1, v2}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->B(Lcom/sec/sbrowser/spl/util/FallbackException;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public static isFlipCoverScreen(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/device/a;->g(Landroid/content/Context;)Landroid/view/Display;
...
.method public static isToolbarAtBottom(Landroid/content/Context;)Z
    .locals 2
...
.method public static setFadeNavigationBar(Landroid/content/Context;)V
    .locals 0
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->setFadeNavigationBar(Landroid/view/Window;)V

    return-void
.end method

.method public static setFadeNavigationBar(Landroid/view/Window;)V
    .locals 2
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->getNavigationBarView(Landroid/view/Window;)Landroid/view/View;
...
.method public static setFadeStatusBar(Landroid/content/Context;)V
    .locals 0
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->setFadeStatusBar(Landroid/view/Window;)V

    return-void
.end method

.method public static setFadeStatusBar(Landroid/view/Window;)V
    .locals 2
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->getStatusBarView(Landroid/view/Window;)Landroid/view/View;
...
.method public static setNavigationBarColor(Landroid/content/Context;Landroid/view/Window;Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil$NavigationBarState;)V
    ...
    const-string/jumbo v2, "setNavigationBarColor, state = "
...
.method public static setSPenHoverIcon(Landroid/view/View;Landroid/content/Context;I)V
    ...
    const-string/jumbo v1, "si__DeviceLayoutUtil"
...
.method public static setShowTransientBarsBySwipe(Landroid/app/Activity;)V
    ...
    :cond_2
    invoke-static {p0}, Landroidx/work/impl/utils/a;->u(Landroid/view/WindowInsetsController;)V
...
.method public static setStatusBarVisible(Landroid/content/Context;Z)V
    ...
    const-string/jumbo v0, "setStatusBarVisible = "

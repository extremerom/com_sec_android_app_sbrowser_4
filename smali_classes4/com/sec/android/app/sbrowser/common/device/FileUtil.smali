...
.method public static getDataFromRawFile(I)Ljava/lang/String;
    .locals 5
    ...
    const-string v1, "get data from html failed."
...
.method public static getFileDir(Ljava/lang/String;)Ljava/io/File;
    .locals 3
    ...
    const-string p0, "getFileDir Directory is not exist."
    ...
    const-string p0, "getFileDir Directory is not created."
...
.method public static read(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, v1}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->u(Ljava/io/IOException;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public static saveDataToFileDir(Ljava/lang/String;Ljava/lang/String;)V
    .locals 5
    ...
    const-string v0, "save file successful, file name="
    ...
    invoke-static {v3}, Lcom/sec/android/app/sbrowser/common/device/FileUtil;->getFileDir(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct {p1, v3, v4}, Ljava/io/OutputStreamWriter;-><init>(Ljava/io/OutputStream;Ljava/nio/charset/Charset;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :catch_0
    const-string p0, "save data to file dir fails"
    ...
    :cond_1
    :goto_4
    const-string p0, "data or filename is null"

...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput p1, p0, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom;->mAlphaValue:F
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v0, p0, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom;->mAlphaValue:F
...
.method public onBindViewHolder(Landroidx/preference/PreferenceViewHolder;)V
    ...
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom;->mIconFrameLayoutDefault:Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom$IconFrameLayout;

    const/4 v2, 0x0

    if-nez v1, :cond_0

    new-instance v1, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom$IconFrameLayout;

    invoke-direct {v1, v2}, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom$IconFrameLayout;-><init>(I)V

    iput-object v1, p0, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom;->mIconFrameLayoutDefault:Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom$IconFrameLayout;

    invoke-virtual {v0}, Landroid/view/View;->getPaddingEnd()I

    move-result v3

    iput v3, v1, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom$IconFrameLayout;->mPaddingEnd:I
    ...
    iput v3, v1, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom$IconFrameLayout;->mMinWidth:I

    :cond_0
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom;->mIconPaddingEnd:Ljava/lang/Integer;

    if-nez v1, :cond_1

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom;->mIconFrameLayoutDefault:Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom$IconFrameLayout;

    iget v1, v1, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom$IconFrameLayout;->mPaddingEnd:I

    invoke-virtual {v0, v2, v2, v1, v2}, Landroid/view/View;->setPaddingRelative(IIII)V

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom;->mIconFrameLayoutDefault:Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom$IconFrameLayout;

    iget v1, v1, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom$IconFrameLayout;->mMinWidth:I
    ...
    iget p0, p0, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom;->mAlphaValue:F

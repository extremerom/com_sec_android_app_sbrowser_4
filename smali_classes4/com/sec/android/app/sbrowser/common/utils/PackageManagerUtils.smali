...
.method public static enableGCMReceiver(Landroid/content/Context;)V
    .locals 11
    ...
    const-string v2, "PackageManagerUtils"

    const/4 v3, 0x1

    if-ne p0, v3, :cond_0

    const-string p0, "GCMReceiver is already enabled"
    ...
    :cond_0
    :try_start_0
    const-string p0, "com.google.android.gsf"
    ...
    :cond_3
    const-string p0, "GCMReceiver is successfully enabled"
    ...
    const-string v1, "EnableGCMReceiver failed "

...
.method private filterLaunchDomain(Ljava/util/List;)V
    ...
    const-string/jumbo v1, "si__ReadArticlesAloudRecommender"
    ...
    invoke-direct {v0, p0, v1}, Lcom/sec/android/app/sbrowser/artificial_intelligence/read_aloud/E;-><init>(Ljava/lang/Object;I)V
...
.method private isPassIntervalLimit()Z
    ...
    invoke-static {v3, v4, p0, v1}, Landroidx/glance/oneui/template/layout/glance/a;->p(JLjava/lang/String;Ljava/lang/String;)V
...
.method private sortHistoryItem(Ljava/util/List;)Ljava/util/List;
    ...
    :cond_0
    new-instance v1, Lcom/sec/android/app/sbrowser/artificial_intelligence/read_aloud/W;

    const/4 v2, 0x0

    invoke-direct {v1, v2}, Lcom/sec/android/app/sbrowser/artificial_intelligence/read_aloud/W;-><init>(I)V
    ...
    new-instance p1, Lcom/sec/android/app/sbrowser/artificial_intelligence/read_aloud/W;

    const/4 v0, 0x3

    invoke-direct {p1, v0}, Lcom/sec/android/app/sbrowser/artificial_intelligence/read_aloud/W;-><init>(I)V
...
.method public onHistoryDataReceived(Ljava/util/List;)V
    ...
    const-string/jumbo v0, "si__ReadArticlesAloudRecommender"
    ...
    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/artificial_intelligence/read_aloud/U;-><init>(Lcom/sec/android/app/sbrowser/artificial_intelligence/read_aloud/ReadArticlesAloudRecommender;)V

    invoke-interface {p1, v1}, Ljava/util/stream/Stream;->map(Ljava/util/function/Function;)Ljava/util/stream/Stream;

    move-result-object p1

    new-instance v1, Lcom/sec/android/app/sbrowser/artificial_intelligence/read_aloud/V;

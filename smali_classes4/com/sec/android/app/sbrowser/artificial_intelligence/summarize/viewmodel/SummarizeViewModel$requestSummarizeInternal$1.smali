...
.field final synthetic $tmpSummaryCacheList:Ljava/util/Queue;
...
# direct methods
.method public constructor <init>(JLcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;Ljava/util/Queue;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    iput-wide p1, p0, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel$requestSummarizeInternal$1;->$requestCode:J

    iput-object p3, p0, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel$requestSummarizeInternal$1;->this$0:Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;

    iput-object p4, p0, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel$requestSummarizeInternal$1;->$tmpSummaryCacheList:Ljava/util/Queue;

    iput-object p5, p0, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel$requestSummarizeInternal$1;->$text:Ljava/lang/String;

    iput-object p6, p0, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel$requestSummarizeInternal$1;->$languageCode:Ljava/lang/String;
...
.method public onAuthTokenExpiredFailure()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel$requestSummarizeInternal$1;->$text:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;->clearSummarizeCacheCN(Ljava/lang/String;)V
...
.method public onFailure(Ljava/lang/String;I)V
    ...
    :cond_0
    const-string/jumbo v0, "summarize failed : "
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel$requestSummarizeInternal$1;->$text:Ljava/lang/String;

    invoke-virtual {p1, v0}, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;->clearSummarizeCacheCN(Ljava/lang/String;)V

    iget-object p1, p0, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel$requestSummarizeInternal$1;->this$0:Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;

    invoke-static {p1}, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;->access$get_dtoResult$p(Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;)Landroidx/lifecycle/MutableLiveData;
...
.method public onSuccess(Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/model/dto/SCSSummarizeResultDto;II)V
    ...
    iget-wide p2, p0, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel$requestSummarizeInternal$1;->$requestCode:J

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel$requestSummarizeInternal$1;->this$0:Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;

    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;->getLastRequestCode()J

    move-result-wide v0

    cmp-long p2, p2, v0

    const-string p3, "SummarizeViewModel"

    if-eqz p2, :cond_0

    const-string/jumbo p0, "skip because the response come from expired request"
    ...
    :cond_0
    const-string/jumbo p2, "summarize success"
    ...
    const-string v0, "raw data from scs is "

    invoke-static {v0, p2, p3}, LJ7/b;->D(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel$requestSummarizeInternal$1;->this$0:Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;

    new-instance v1, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/model/dto/SummarizeResult$Success;

    invoke-direct {v1, p1}, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/model/dto/SummarizeResult$Success;-><init>(Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/model/dto/SCSSummarizeResultDto;)V
    ...
    :goto_0
    const-string v0, "result send: "

    invoke-static {v0, p1, p3}, LJ7/b;->D(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, p0, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel$requestSummarizeInternal$1;->$tmpSummaryCacheList:Ljava/util/Queue;
    ...
    invoke-static {p1}, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;->access$getSummaryContentQueue$p(Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;)Ljava/util/Queue;
    ...
    invoke-static {p1}, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;->access$getSTREAM_END$p(Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;)Ljava/lang/String;

    move-result-object p1

    const/4 v0, 0x0

    invoke-static {p2, p1, v0}, Lca/k;->w(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z

    move-result p1

    if-eqz p1, :cond_3

    iget-object p1, p0, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel$requestSummarizeInternal$1;->$text:Ljava/lang/String;

    invoke-static {}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->getInstance()Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;

    move-result-object p2

    invoke-virtual {p2}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->getBrowsingAssistSummaryStyle()I
    ...
    const-string/jumbo p2, "update summary cached"
    ...
    invoke-static {p2}, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;->access$getSummaryCacheCN$p(Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel;)Ljava/util/Map;

    move-result-object p2

    iget-object p3, p0, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/viewmodel/SummarizeViewModel$requestSummarizeInternal$1;->$tmpSummaryCacheList:Ljava/util/Queue;

...
.field private mPreference:Landroidx/preference/PreferenceFragmentCompat;
...
# direct methods
.method public constructor <init>(Landroid/app/Activity;Landroidx/preference/PreferenceFragmentCompat;)V
    .locals 1
    ...
    iput-object p2, p0, Lcom/sec/android/app/sbrowser/extensions/SixPreferencesManager;->mPreference:Landroidx/preference/PreferenceFragmentCompat;
...
.method private generateSquircleIcon(Landroid/content/Context;Landroid/graphics/Bitmap;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, p2, p0}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->B(Lcom/sec/sbrowser/spl/util/FallbackException;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private hideFloatingButton()V
    .locals 1

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/extensions/SixPreferencesManager;->mFloatingButtonLayout:Landroid/view/View;
...
.method private showFloatingButton()V
    .locals 1
...
.method private updateDownloadedIcon(Ljava/lang/String;)V
    ...
    const-string/jumbo p0, "updateDownloadedIcon - In bg now. Aborting"
    ...
    const-string/jumbo p0, "updateDownloadedIcon - Given pickKey is null. Aborting"
    ...
    :cond_1
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/extensions/SixPreferencesManager;->mPreference:Landroidx/preference/PreferenceFragmentCompat;
    ...
    const-string/jumbo p0, "updateDownloadedIcon - Aborting. Failed to find pref: "

    invoke-static {p0, p1, v1}, Landroidx/compose/ui/input/pointer/a;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo p0, "updateDownloadedIcon - No icon to draw. Aborting"
    ...
    const-string/jumbo v3, "updateDownloadedIcon - running for "
...
.method private updateLoadedIcon(Ljava/lang/String;Landroid/graphics/Bitmap;)V
    ...
    const-string/jumbo p0, "updateLoadedIcon - In bg now. Aborting"
    ...
    const-string/jumbo p0, "updateLoadedIcon - Aborting. Failed to find pref: "
    ...
    const-string/jumbo p2, "updateLoadedIcon - No icon for "
    ...
    :cond_2
    const-string/jumbo v2, "updateLoadedIcon - Drawing icon for "
...
.method private updateMoreAddOnsButton()V
    ...
    const-string/jumbo v0, "updateMoreAddOnsButton - Get more Add-ons NOT Found"
...
.method private updateSixInstalledList()V
    ...
    :cond_0
    iget-object v3, p0, Lcom/sec/android/app/sbrowser/extensions/SixPreferencesManager;->mPreference:Landroidx/preference/PreferenceFragmentCompat;
    ...
    const-string/jumbo v4, "updateSixInstalledList - Remove Failed : "
    ...
    const-string/jumbo v4, "updateSixInstalledList - Removed : "
    ...
    const-string/jumbo v5, "updateSixInstalledList - Empty Key, Skipping : "
    ...
    const-string/jumbo v5, "updateSixInstalledList - skip creating pref: "
    ...
    const-string/jumbo v6, "updateSixInstalledList - Pref Creating for "
    ...
    iget-object v8, p0, Lcom/sec/android/app/sbrowser/extensions/SixPreferencesManager;->mPreference:Landroidx/preference/PreferenceFragmentCompat;
    ...
    const-string/jumbo v5, "updateSixInstalledList - showing N : "
    ...
    :cond_c
    const-string/jumbo v3, "updateSixInstalledList - cannot create SwitchPreference, skipping"
    ...
    :cond_e
    :goto_4
    const-string/jumbo p0, "updateSixInstalledList - No six apps to display"
...
.method private updateSixSuggestedList()V
    ...
    :cond_1
    iget-object v4, p0, Lcom/sec/android/app/sbrowser/extensions/SixPreferencesManager;->mPreference:Landroidx/preference/PreferenceFragmentCompat;
    ...
    const-string/jumbo v5, "updateSixSuggestedList - failed to remove pref: "
    ...
    const-string/jumbo v4, "updateSixSuggestedList - NO key to created"
    ...
    const-string/jumbo v4, "updateSixSuggestedList - cannot create pref: "

    invoke-static {v4, v5, v3}, LJ7/b;->D(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v10, "updateSixSuggestedList - show N badge : "
    ...
    :cond_a
    :goto_3
    iget-object v5, p0, Lcom/sec/android/app/sbrowser/extensions/SixPreferencesManager;->mPreference:Landroidx/preference/PreferenceFragmentCompat;
...
.method public onViewCreated(Landroid/view/View;)V
    ...
    const-string p0, "onViewCreated - Activity is null, cannot add floating button."
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/extensions/SixPreferencesManager;->mFloatingButtonLayout:Landroid/view/View;
    ...
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/extensions/SixPreferencesManager;->mFloatingButtonLayout:Landroid/view/View;
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/extensions/SixPreferencesManager;->showFloatingButton()V

    goto :goto_0

    :cond_1
    const-string p0, "onViewCreated - Failed to inflate button layout."
...
.method public runPreferenceClick(Landroidx/preference/Preference;Lcom/sec/android/app/sbrowser/common/extensions/SixAppData;Z)Z
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/extensions/SixPreferencesManager;->hideFloatingButton()V
...
.method public updatePreferences()V
    ...
    const-string/jumbo v0, "updatePreferences - No callback to update pref category"
...
.method public updateSixPreferences()V
    ...
    const-string/jumbo v0, "updateSixPreferences - In bg now. Aborting UX update."

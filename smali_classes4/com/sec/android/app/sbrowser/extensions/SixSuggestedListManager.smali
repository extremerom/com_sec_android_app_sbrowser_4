...
.method public static getFixedSlots(Landroid/content/Context;)I
    ...
    :cond_0
    const-string/jumbo v1, "six_data"

    invoke-virtual {p0, v1, v0}, Landroid/content/Context;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;

    move-result-object p0

    const-string/jumbo v1, "six_suggested_fixed_slots"
...
.method public static getIsForcedToRefresh(Landroid/content/Context;)Z
    ...
    const-string/jumbo v1, "six_suggested_force_refresh"
...
.method public static getMaxSlots(Landroid/content/Context;)I
    ...
    const-string/jumbo v1, "six_suggested_max_slots"
...
.method public static getNBadgeEverShownList(Landroid/content/Context;)Ljava/util/Set;
    ...
    const-string/jumbo v2, "six_suggested_ever_n_list"
...
.method public static getSuggestedList(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    :cond_0
    const-string/jumbo v2, "six_data"
    ...
    const-string/jumbo v2, "six_suggested_apps_list"
...
.method public static getUpdateRate(Landroid/content/Context;)I
    ...
    const-string/jumbo v1, "six_suggested_update_rate"
...
.method public static setFixedSlots(Landroid/content/Context;I)V
    ...
    const-string/jumbo p1, "setFixedSlots - context is null. Aborting"
    ...
    :cond_0
    const-string/jumbo v0, "six_data"
    ...
    const-string/jumbo v0, "six_suggested_fixed_slots"
...
.method public static setIsForcedToRefresh(Landroid/content/Context;Z)V
    ...
    const-string/jumbo p1, "setIsForcedToRefresh - context is null. Aborting"
    ...
    const-string/jumbo v0, "six_suggested_force_refresh"
...
.method public static setMaxSlots(Landroid/content/Context;I)V
    ...
    const-string/jumbo p1, "setMaxSlots - context is null. Aborting"
    ...
    const-string/jumbo v0, "six_suggested_max_slots"
...
.method public static setNBadgeEverShownList(Landroid/content/Context;Ljava/util/Set;)V
    ...
    const-string/jumbo p1, "setNBadgeEverShownList - context is null. Aborting"
    ...
    const-string/jumbo v0, "six_suggested_ever_n_list"
...
.method public static setSuggestedList(Landroid/content/Context;Ljava/util/ArrayList;)V
    ...
    const-string/jumbo p0, "setSuggestedList - context is null. Aborting"
    ...
    const-string/jumbo v2, "setSuggestedList - exception: "
    ...
    const-string/jumbo v0, "six_suggested_apps_list"
...
.method public static setUpdateRate(Landroid/content/Context;I)V
    ...
    const-string/jumbo p1, "setUpdateRate - context is null. Aborting"
    ...
    const-string/jumbo v0, "six_suggested_update_rate"
...
.method private updateCandidateList(Landroid/content/Context;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    const-string/jumbo v1, "updateCandidateList - No pkg names were retrieved"
    ...
    const-string/jumbo v4, "updateCandidateList - extMap: "
    ...
    const-string/jumbo v4, "updateCandidateList - removed from candidates: "
    ...
    :cond_8
    :goto_3
    const-string/jumbo p0, "updateCandidateList - No lists to work. Aborting."
...
.method private updateFromTheBeginning(ILjava/util/ArrayList;ILjava/util/ArrayList;)V
    ...
    const-string/jumbo v0, "updateFromTheBeginning - start from the beginning"
    ...
    const-string/jumbo p3, "updateFromTheBeginning - finally mPickedList: "

    const-string p4, "+"

    const-string v0, "="

    invoke-static {p2, p1, p3, p4, v0}, Landroidx/appsearch/platformstorage/e;->u(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method private updatePreviousList(Landroid/content/Context;Ljava/util/ArrayList;ILjava/util/ArrayList;IILjava/util/ArrayList;)V
    ...
    const-string/jumbo v0, "updatePreviousList - picking extensions"
    ...
    const-string/jumbo v4, "updatePreviousList - oldFixedList: "
    ...
    const-string/jumbo v4, "updatePreviousList - oldPickedList: "
    ...
    const-string/jumbo v0, "updatePreviousList - updating old fixed list"
    ...
    :cond_7
    const-string/jumbo v0, "updatePreviousList - adding fixed list"
    ...
    const-string/jumbo v1, "updatePreviousList - fill fixed list more"
    ...
    invoke-static {v12, v1}, Landroidx/compose/foundation/layout/a;->m(ILjava/util/ArrayList;)Ljava/lang/Object;
    ...
    const-string/jumbo v2, "updatePreviousList - let normal ones fill: "

    invoke-static {v1, v2, v10}, Landroidx/appcompat/graphics/drawable/a;->x(ILjava/lang/String;Ljava/lang/String;)V
    ...
    :goto_4
    const-string/jumbo v0, "updatePreviousList - pick normal list for "

    invoke-static {v8, v0, v10}, Landroidx/compose/ui/input/pointer/a;->B(ILjava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "updatePreviousList - picked so far: "

    invoke-static {v1, v2, v10}, Landroidx/appcompat/graphics/drawable/a;->x(ILjava/lang/String;Ljava/lang/String;)V

    if-ge v0, v8, :cond_c

    const-string/jumbo v2, "updatePreviousList - slots were not filled yet"
    ...
    :cond_c
    const-string/jumbo v1, "updatePreviousList - finally mPickedList: "

    const-string v2, "+"

    const-string v3, "="

    invoke-static {v9, v0, v1, v2, v3}, Landroidx/appsearch/platformstorage/e;->u(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method private updateSuggestedExtList(Landroid/content/Context;IIIZLjava/util/ArrayList;)V
    ...
    const-string/jumbo v3, "updateSuggestedExtList - picked list: "
    ...
    :cond_8
    :goto_5
    const-string/jumbo v0, "updateSuggestedExtList - no suggested list was given. aborting."

...
.method private fetchBlocklist(Landroid/content/Context;)V
    ...
    const-string/jumbo v2, "sixBlacklistData"
...
.method private fetchFirstPartyList(Landroid/content/Context;)V
    ...
    const-string/jumbo v2, "sixFirstPartyList"
...
.method private fetchSuggestedList(Landroid/content/Context;)V
    ...
    const-string/jumbo v2, "sixSuggestedlistData"
...
.method public static isSupportedByConfig(Landroid/content/Context;)Z
    ...
    const-string/jumbo v2, "sixSupported"
...
.method private storeBlocklist(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "storeBlocklist - storing listData: "
    ...
    :cond_1
    const-string/jumbo p0, "storeBlocklist - listData is empty. does nothing."
...
.method private storeFetchedFirstPartyList(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string/jumbo p0, "storeFetchedFirstPartyList - listData is empty. aborting"
    ...
    const-string/jumbo v1, "storeFetchedFirstPartyList - storing listData: "
    ...
    const-string/jumbo p0, "storeFetchedFirstPartyList - init SixManager"
    ...
    :cond_4
    :goto_1
    const-string/jumbo p0, "storeFetchedFirstPartyList - no installed six apps. aborting"

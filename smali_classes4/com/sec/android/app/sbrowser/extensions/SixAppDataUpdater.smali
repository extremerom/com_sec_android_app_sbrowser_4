...
.method private createSixAppData(Lcom/sec/android/app/sbrowser/common/extensions/SixAppData;Lcom/sec/android/app/sbrowser/common/extensions/SixAppData;)Lcom/sec/android/app/sbrowser/common/extensions/SixAppData;
    ...
    const-string/jumbo v0, "web_store_from_six"
    ...
    const-string/jumbo v0, "web_store"
...
.method private removeNotToShowItems(Ljava/util/HashMap;)I
    ...
    invoke-static {v5, v4, v1}, LJ7/b;->D(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private setUnsupportedIfNeeded(Landroid/content/Context;Lcom/sec/android/app/sbrowser/common/extensions/SixAppData;)V
    ...
    const-string/jumbo v0, "updateSixAppData - should be unsupported: "
    ...
    const-string/jumbo p1, "updateSixAppData - Allowed to be supported: "

    invoke-static {p1, p0, v1}, LJ7/b;->C(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private shouldBeUnsupported(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string/jumbo p0, "shouldBeUnsupported - No pkg name was given."
    ...
    :cond_3
    const-string/jumbo p0, "shouldBeUnsupported - Unsupported: "

    invoke-static {p0, p2, v1}, LJ7/b;->D(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_4
    :goto_0
    const-string/jumbo p0, "shouldBeUnsupported - No stored extensions list."
...
.method private syncOnOffStatus(Lcom/sec/android/app/sbrowser/common/extensions/SixAppData;Lcom/sec/android/app/sbrowser/common/extensions/SixAppData;)Z
    ...
    const-string/jumbo p2, "syncOnOffStatus - turning OFF as blocked: "
...
.method private updateAppsWithMapToInstall()V
    ...
    const-string/jumbo v11, "updateAppsWithMapToInstall - "
    ...
    invoke-static {v11, v8, v13, v7, v12}, Landroidx/appsearch/platformstorage/e;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v11, v8, v13, v7, v9}, Landroidx/appsearch/platformstorage/e;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v4, "updateAppsWithMapToInstall - %s,%s,%s,%s,%s,%s,%d,%s,%s,%s"
    ...
    :cond_e
    const-string/jumbo v0, "updateAppsWithMapToInstall - no updates"
    ...
    :cond_10
    :goto_b
    const-string/jumbo v0, "updateAppsWithMapToInstall - No mapToInstall to update. Aborting."
...
.method private updateAppsWithMapToShow()V
    ...
    const-string/jumbo v14, "updateAppsWithMapToShow - found: "

    const-string v15, ", "

    invoke-static {v14, v9, v15, v10, v15}, Landroidx/appcompat/graphics/drawable/a;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    const-string/jumbo v5, "updateAppsWithMapToShow - Not Found in mSixAppData. Added: "

    invoke-static {v5, v9, v2}, LJ7/b;->C(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "updateAppsWithMapToShow - %s,%s,%s,%s,%s,%s,%d,%s,%s,%s"
    ...
    :cond_c
    const-string/jumbo v0, "updateAppsWithMapToShow - no updates"
    ...
    :cond_e
    :goto_d
    const-string/jumbo v0, "updateAppsWithMapToShow - empty mapToShow. nothing to do."
...
.method private updateBlockedExtLogging(Z)V
    ...
    const-string/jumbo v1, "updateBlockedExtensions - %s,%s,%s,%s,%s,%s,%d,%s,%s,%s"
    ...
    :cond_4
    const-string/jumbo p0, "updateBlockedExtensions - no updates"
...
.method private updateExceptionalInfo(Lcom/sec/android/app/sbrowser/common/extensions/SixAppData;Lcom/sec/android/app/sbrowser/common/extensions/SixAppData;)Z
    ...
    const-string/jumbo v1, "updateExceptionalInfo - ON but no permission grant: "
    ...
    const-string/jumbo v1, "updateExceptionalInfo - Found N badge again case: "
    ...
    const-string/jumbo v1, "updateExceptionalInfo - updating package name: "
    ...
    const-string/jumbo v1, "updateExceptionalInfo - updating extension name: "
    ...
    const-string/jumbo v1, "updateExceptionalInfo - updating description: "
...
.method private updateInstallingIfInstalled(Lcom/sec/android/app/sbrowser/common/extensions/SixAppData;Lcom/sec/android/app/sbrowser/common/extensions/SixAppData;)Z
    ...
    const-string/jumbo v4, "updateInstallingIfInstalled - found: %s,%s,%s,%s,%d,%s,%s,%s"
    ...
    const-string/jumbo v3, "updateInstallingIfInstalled - handled: %s,%s,%s,%s,%d,%s,%s,%s"
...
.method private updateLimitedExtensions(Landroid/content/Context;)V
    ...
    const-string/jumbo v0, "updateLimitedExtensions - context is null. Aborting"
    ...
    const-string/jumbo v6, "updateLimitedExtensions - "

    invoke-static {v6, v0, v2}, Landroidx/compose/ui/input/pointer/a;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v0, "updateLimitedExtensions - Failed to get current SI version. Aborting"
    ...
    const-string/jumbo v14, "updateLimitedExtensions - limited ext.: "
    ...
    :cond_5
    const-string/jumbo v8, "updateLimitedExtensions - wrong status!"
    ...
    const-string/jumbo v4, "updateLimitedExtensions - %s,%s,%s,%s,%s,%s,%d,%s,%s,%s"
    ...
    :cond_b
    const-string/jumbo v0, "updateLimitedExtensions - no updates"
    ...
    :cond_d
    :goto_c
    const-string/jumbo v0, "updateLimitedExtensions - no ext to work. Aborting"
...
.method public getSixAppDataList(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    const-string/jumbo v4, "stored:%s,%s,%s,%s,%s,%s,%d,%s,%s,%s,%s"
...
.method public handleInstallFailed(Landroid/content/Context;Ljava/lang/String;ZZLjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, p6, v1}, Landroidx/glance/oneui/template/layout/glance/a;->A(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, p2, v1}, Landroidx/compose/ui/input/pointer/a;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public removeDuplicatedItemIfExists()V
    ...
    invoke-static {v5, v0, v2}, Landroidx/compose/ui/input/pointer/a;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public removeSixAppData(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2, v1}, Landroidx/compose/ui/input/pointer/a;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public updateBlockedExtensions(Lcom/sec/android/app/sbrowser/common/extensions/SixBlocklistData;)Z
    ...
    const-string/jumbo v6, "updateBlockedExtensions - blocklist: "

    invoke-static {v6, v5, v2}, LJ7/b;->C(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v10, "updateBlockedExtensions - found: "

    const-string v11, ", "

    invoke-static {v10, v7, v11, v9, v2}, Lf/a;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v7}, Lcom/sec/android/app/sbrowser/common/extensions/SixUtil;->getNativeExtVer(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7, v9}, Lcom/sec/android/app/sbrowser/common/extensions/SixUtil;->compareExtVersions(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string/jumbo v9, "updateBlockedExtensions - blocked. unblock:"
    ...
    const-string/jumbo v8, "updateBlockedExtensions - blocked: "

    invoke-static {v8, v5, v11, v7, v2}, Landroidx/compose/ui/input/pointer/a;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v8, "updateBlockedExtensions - exception: "

    invoke-static {v8, v7, v2}, Landroidx/compose/ui/input/pointer/a;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v5, "updateBlockedExtensions - Not found and reset."
    ...
    :cond_b
    :goto_5
    const-string/jumbo p1, "updateBlockedExtensions - no blocklist. reset all."
    ...
    :cond_f
    :goto_7
    const-string/jumbo p0, "updateBlockedExtensions - no ext to work. returning false."
...
.method public updateSixAppData(Landroid/content/Context;Lcom/sec/android/app/sbrowser/common/extensions/SixAppData;)V
    ...
    const-string/jumbo v0, "updateSixAppData with"
    ...
    const-string/jumbo v0, "updateSixAppData - mSixAppData was null, initialized"
    ...
    const-string/jumbo v5, "updateSixAppData - found: "

    const-string v6, ", "

    invoke-static {v5, v4, v6, v0, v1}, Lf/a;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "updateSixAppData - updated"
    ...
    const-string/jumbo v5, "updateSixAppData - added: "

    const-string v6, ","

    invoke-static {v5, v0, v6, v3, v6}, Landroidx/appcompat/graphics/drawable/a;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    invoke-static {v0, v4, v1}, Landroidx/compose/ui/input/pointer/a;->w(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)V
...
.method public updateUnsupportedExtensions(Ljava/util/ArrayList;)V
    ...
    const-string/jumbo p0, "updateUnsupportedExtensions - No pkg names were retrieved. Aborting."
    ...
    const-string/jumbo v4, "updateUnsupportedExtensions - supported ext: "

    invoke-static {v4, v3, v1}, LJ7/b;->C(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "updateUnsupportedExtensions - Unsupported: "

    invoke-static {v2, p1, v1}, LJ7/b;->C(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_e
    :goto_4
    const-string/jumbo p0, "updateUnsupportedExtensions - No six app data to work. Aborting."

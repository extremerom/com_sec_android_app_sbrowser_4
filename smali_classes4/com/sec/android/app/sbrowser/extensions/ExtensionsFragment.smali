...
.method public static bridge synthetic f(Lcom/sec/android/app/sbrowser/extensions/ExtensionsFragment;)V
    .locals 0
...
.method public static bridge synthetic g(Lcom/sec/android/app/sbrowser/extensions/ExtensionsFragment;)V
    .locals 0
...
.method private removePrefFromSortedPreferences(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/preference/PreferenceManager;->findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;
...
.method private sortPreferences()V
    ...
    const-string/jumbo v6, "sortPreferences Exception: "
...
.method private updatePreferenceCategory()V
    ...
    const-string/jumbo p0, "updatePreferenceCategory - In bg now. Aborting UX update."
    ...
    invoke-virtual {v0, v2}, Landroidx/preference/PreferenceManager;->findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;
    ...
    const-string/jumbo p0, "updatePreferenceCategory - all default, hidden"
    ...
    :cond_7
    :goto_1
    const-string/jumbo p0, "updatePreferenceCategory - no six apps, hidden"
...
.method private updateStatus(Landroidx/preference/Preference;ILjava/lang/String;)V
    ...
    invoke-virtual {v2, p2, p0, p3, v7}, Landroid/text/SpannableStringBuilder;->setSpan(Ljava/lang/Object;III)V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    :goto_0
    invoke-virtual {p0, v6}, Landroidx/preference/PreferenceFragmentCompat;->setDivider(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p2, p0, Lcom/sec/android/app/sbrowser/extensions/ExtensionsFragment;->mListView:Landroid/widget/ListView;
    ...
    invoke-virtual {v2, p2, v3, v1}, Landroid/widget/ListView;->addFooterView(Landroid/view/View;Ljava/lang/Object;Z)V

    iget-object p2, p0, Lcom/sec/android/app/sbrowser/extensions/ExtensionsFragment;->mListView:Landroid/widget/ListView;
    ...
    invoke-virtual {p2, v1}, Lcom/sec/android/app/sbrowser/common/extensions/SixStatus;->isDefaultExtEnabled(Z)Z
    ...
    invoke-virtual {p2}, Lcom/sec/android/app/sbrowser/extensions/SixManager;->isInitialized()Z
    ...
    invoke-direct {p2, v0, p0}, Lcom/sec/android/app/sbrowser/extensions/SixPreferencesManager;-><init>(Landroid/app/Activity;Landroidx/preference/PreferenceFragmentCompat;)V

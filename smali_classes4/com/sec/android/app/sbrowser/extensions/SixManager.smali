...
.method private initializeInternal()V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/extensions/SixManager;->updateIsDefaultTranslatorInstalled()V
...
.method private registerBroadcastReceiver(Landroid/content/Context;)V
    ...
    const-string v4, "com.sec.android.app.sbrowser.pending_intent.SIX"
...
.method private registerSixSAIntentsReceiver(Landroid/content/Context;)V
    ...
    const-string/jumbo v1, "six_sa_update"
...
.method private showBlockedPopupIfNeeded(Landroid/content/Context;)V
    ...
    const-string/jumbo p0, "showBlockedPopupIfNeeded - context is null. Aborting"
    ...
    :cond_4
    :goto_1
    const-string/jumbo p0, "showBlockedPopupIfNeeded - no sixappdata to work"
...
.method private unregisterBroadcastReceiver(Landroid/content/Context;)V
    ...
    const-string/jumbo p0, "unregisterBroadcastReceiver - context is null. Aborting"
    ...
    const-string/jumbo p0, "unregisterBroadcastReceiver - already unregistered."
...
.method private updateIsDefaultTranslatorInstalled()V
    .locals 1
    ...
    invoke-virtual {v0, p0}, Lcom/sec/android/app/sbrowser/common/extensions/SixStatus;->setIsDefaultTranslatorInstalled(Z)V
...
.method public changeDefaultTranslatorStatus(Z)Z
    ...
    invoke-static {p0, v5, v1}, Landroidx/compose/ui/input/pointer/a;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v5, p1}, LJ7/b;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public isDefaultTranslatorInstalled()Z
    ...
    invoke-static {p0, v0, v1}, Landroidx/compose/ui/input/pointer/a;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public isPrivacyPopupEnabled()Z
    ...
    const-string/jumbo v1, "sixPrivacyPopup"
...
.method public setFirstLaunchToFalse(Ljava/lang/String;)V
    ...
    const-string/jumbo p0, "setFirstLaunchToFalse - No extension ID, aborting.."
    ...
    :cond_2
    const-string/jumbo p0, "setFirstLaunchToFalse - Not found: "

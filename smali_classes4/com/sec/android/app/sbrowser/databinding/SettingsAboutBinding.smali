...
# instance fields
.field public final aboutLayoutLand:Landroid/widget/LinearLayout;
...
.field public final aboutScrollviewLand:Landroidx/core/widget/NestedScrollView;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
.end field
...
.field public final appFilingNumber:Landroid/widget/TextView;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
.end field
...
# direct methods
.method private constructor <init>(Landroid/widget/LinearLayout;Landroid/widget/LinearLayout;Landroid/widget/LinearLayout;Landroid/view/View;Landroidx/core/widget/NestedScrollView;Landroidx/core/widget/NestedScrollView;Landroid/widget/LinearLayout;Landroid/widget/TextView;Lcom/sec/android/app/sbrowser/common/widget/AutoScaleTextView;Landroid/widget/TextView;Landroid/widget/Button;Landroid/widget/Button;Landroid/widget/LinearLayout;Landroid/widget/LinearLayout;Landroidx/appcompat/widget/SeslProgressBar;Landroid/widget/Button;Landroid/widget/Button;Landroid/widget/Button;Landroid/widget/FrameLayout;Landroid/widget/TextView;)V
    .locals 2
    ...
    .param p8    # Landroid/widget/TextView;
        ...
        .end annotation
    .end param
    .param p9    # Lcom/sec/android/app/sbrowser/common/widget/AutoScaleTextView;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    .param p14    # Landroid/widget/LinearLayout;
        ...
        .end annotation
    .end param
    .param p15    # Landroidx/appcompat/widget/SeslProgressBar;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    iput-object v1, v0, Lcom/sec/android/app/sbrowser/databinding/SettingsAboutBinding;->aboutLayoutLand:Landroid/widget/LinearLayout;
    ...
    iput-object v1, v0, Lcom/sec/android/app/sbrowser/databinding/SettingsAboutBinding;->aboutScrollviewLand:Landroidx/core/widget/NestedScrollView;
    ...
    iput-object v1, v0, Lcom/sec/android/app/sbrowser/databinding/SettingsAboutBinding;->appFilingNumber:Landroid/widget/TextView;
...
.method public static bind(Landroid/view/View;)Lcom/sec/android/app/sbrowser/databinding/SettingsAboutBinding;
    ...
    check-cast v18, Landroidx/appcompat/widget/SeslProgressBar;
    ...
    invoke-direct/range {v3 .. v23}, Lcom/sec/android/app/sbrowser/databinding/SettingsAboutBinding;-><init>(Landroid/widget/LinearLayout;Landroid/widget/LinearLayout;Landroid/widget/LinearLayout;Landroid/view/View;Landroidx/core/widget/NestedScrollView;Landroidx/core/widget/NestedScrollView;Landroid/widget/LinearLayout;Landroid/widget/TextView;Lcom/sec/android/app/sbrowser/common/widget/AutoScaleTextView;Landroid/widget/TextView;Landroid/widget/Button;Landroid/widget/Button;Landroid/widget/LinearLayout;Landroid/widget/LinearLayout;Landroidx/appcompat/widget/SeslProgressBar;Landroid/widget/Button;Landroid/widget/Button;Landroid/widget/Button;Landroid/widget/FrameLayout;Landroid/widget/TextView;)V

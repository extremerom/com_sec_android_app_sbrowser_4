...
.method private setDefaultSatLevels()V
    ...
    const-string/jumbo v2, "tracking_protection"

    invoke-virtual {p0, v2}, Lorg/json/JSONObject;->getJSONObject(Ljava/lang/String;)Lorg/json/JSONObject;

    move-result-object p0

    const-string/jumbo v2, "setting_default_level"
...
.method private updateAllowlistIfRequired()V
    ...
    const-string/jumbo v1, "whitelist-major-version"
    ...
    const-string/jumbo v1, "whitelist-minor-version"
...
.method public fetchAllowlist()V
    ...
    const-string/jumbo p0, "whitelist-file"

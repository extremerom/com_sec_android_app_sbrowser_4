...
.method public static synthetic f(Lcom/sec/android/app/sbrowser/backup/InstantBackupRestoreService;Landroid/content/Intent;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/backup/InstantBackupRestoreService;->lambda$onStartCommand$3(Landroid/content/Intent;)V
...
.method private getDbFileSize()Ljava/lang/Long;
    ...
    invoke-direct {v1, p0, v2}, LV3/b;-><init>(Ljava/lang/Object;I)V

    invoke-interface {v0, v1}, Ljava/util/stream/Stream;->map(Ljava/util/function/Function;)Ljava/util/stream/Stream;

    move-result-object p0

    new-instance v0, Lcom/sec/android/app/sbrowser/backup/c;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/sec/android/app/sbrowser/backup/c;-><init>(I)V
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/backup/b;

    const/4 v2, 0x0

    invoke-direct {v1, v2}, Lcom/sec/android/app/sbrowser/backup/b;-><init>(I)V
...
.method private getFileSizes()Ljava/util/List;
    ...
    :goto_0
    invoke-static {v0}, Lt5/c;->O0(Ljava/io/File;)Ljava/util/ArrayList;
...
.method private synthetic lambda$onStartCommand$3(Landroid/content/Intent;)V
    .locals 2
    ...
    const-string v1, "PREPARE_RESTORE"

    invoke-virtual {v1, p1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z

    move-result p1

    invoke-virtual {v0, p1}, Lcom/sec/android/app/sbrowser/backup/SmartSwitchUtil;->enableBnRDocumentProvider(Z)V
...
.method private makeSnapShotJson()V
    ...
    invoke-direct {v0, v1, v2}, Lt5/b;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v3, v2}, Lt5/c;-><init>(Landroid/content/ContentResolver;Ljava/lang/String;)V
    ...
    invoke-static {v4, v5, v6}, LJ7/b;->o(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v3}, Lt5/b;->a(Landroid/content/Intent;Ljava/io/File;)I
    :try_end_0
    ...
    invoke-static {v8}, Lt5/c;->O0(Ljava/io/File;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v3, v4}, Lt5/c;->V0(Ljava/io/File;Ljava/lang/String;)Z
...
.method private prepare()V
    ...
    new-instance v8, Lcom/sec/android/app/sbrowser/backup/b;

    const/4 v9, 0x0

    invoke-direct {v8, v9}, Lcom/sec/android/app/sbrowser/backup/b;-><init>(I)V
    ...
    new-instance v2, Lcom/sec/android/app/sbrowser/backup/b;

    const/4 v3, 0x1

    invoke-direct {v2, v3}, Lcom/sec/android/app/sbrowser/backup/b;-><init>(I)V
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    iput-object v4, p0, Lcom/sec/android/app/sbrowser/backup/InstantBackupRestoreService;->mBasePath:Ljava/lang/String;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p0, v4}, Lcom/sec/android/app/sbrowser/backup/InstantBackupRestoreService;->startForegroundInternal(Lcom/sec/android/app/sbrowser/backup/BackupRestoreConstants$CopyMode;)V
    ...
    :sswitch_0
    const-string v5, "com.samsung.android.intent.action.NOTICE_INSTANT_TASK_CANCELED"
    ...
    :sswitch_1
    const-string v5, "com.samsung.android.intent.action.REQUEST_INSTANT_RESTORE"
    ...
    :sswitch_2
    const-string v5, "com.samsung.android.intent.action.REQUEST_PREPARE_SBROWSER"
    ...
    :sswitch_3
    const-string v5, "com.samsung.android.intent.action.NOTICE_INSTANT_UPLOAD_DONE"
    ...
    :sswitch_4
    const-string v5, "com.samsung.android.intent.action.REQUEST_INSTANT_SNAPSHOT"
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/backup/a;

    invoke-direct {v0, p0, p2}, Lcom/sec/android/app/sbrowser/backup/a;-><init>(Lcom/sec/android/app/sbrowser/backup/InstantBackupRestoreService;I)V
    ...
    new-instance p2, Lcom/sec/android/app/sbrowser/backup/a;

    invoke-direct {p2, p0, v3}, Lcom/sec/android/app/sbrowser/backup/a;-><init>(Lcom/sec/android/app/sbrowser/backup/InstantBackupRestoreService;I)V

...
.method static constructor <clinit>()V
    ...
    const-string v82, "pref_smart_tab_delete_suggestion_first_time_use"

    const-string v83, "pref_stay_in_secret_mode_after_closing_internet"
    ...
    const-string/jumbo v9, "show_tab_bar"

    const-string/jumbo v10, "show_tab_bar_enabled_by_user"

    const-string/jumbo v11, "show_tab_bar_setting_restored"

    const-string/jumbo v12, "show_tab_bar_setting_switch"

    const-string/jumbo v13, "show_bookmark_bar_setting_for_normal"

    const-string/jumbo v14, "show_bookmark_bar_setting_for_dex"
    ...
    const-string/jumbo v36, "third_party_cookies"
    ...
    const-string v43, "pref_compact_menu_customized"
    ...
    const-string/jumbo v53, "show_news_feed"
    ...
    const-string/jumbo v66, "translator_on_device_mode"

    const-string v67, "pref_migrate_history_db_done"

    const-string v68, "block_tracking_popup"

    const-string v69, "news_feed_service_chn"

    const-string v70, "news_feed_service_3rd_statement_chn"

    const-string v71, "need_show_3rd_access_notice_news_feed_chn_v6"

    const-string v72, "homepage_force_changed_to_multi_cp"

    const-string v73, "pref_direct_search"

    const-string v74, "3rd_access_notice_direct_search_chn"

    const-string v75, "need_show_3rd_access_notice_direct_search_chn"

    const-string v76, "allow_screenshots_in_secret_mode"

    const-string v77, "pref_fix_toolbar"

    const-string v78, "pref_trans_split_scroll_sync"

    const-string v79, "private_access_token"

    const-string v80, "pref_auto_close_unused_tabs_visited"

    const-string v81, "pref_auto_close_unused_tabs_set_manually"
    ...
    const-string v20, "bookmark_widget_ids"

    const-string v21, "pref_auto_close_unused_tabs"
    ...
    const-string v5, "compact_available_menu_item_list"

    const-string v6, "compact_toolbar_l_item"

    const-string v7, "compact_toolbar_r_item"

    const-string/jumbo v8, "standard_available_menu_item_list"

    const-string v9, "new_toolbar_l_item"

    const-string v10, "new_toolbar_r_item"

    const-string v11, "pref_multi_tab_mode"

    const-string v12, "pref_system_font_dir"

    const-string v13, "pref_toolbar_layout_type"

    const-string v14, "pref_layout_one_bar_type"

    const-string v15, "pref_address_bar_layout"

    const-string v16, "PREF_COMMON_ZOOM_VALUE_DEX"

    const-string v17, "PREF_COMMON_ZOOM_VALUE_MOBILE"

    const-string v18, "pref_read_aloud_language"

    const-string v19, "backup_read_aloud_voices_key"
...
.method public static getBooleanValueFromXml(Ljava/io/File;Ljava/lang/String;Z)Z
    ...
    :goto_3
    const-string/jumbo p1, "si__BackupRestoreXmlUtil"
...
.method public static restoreSettingsXml(Landroid/content/Context;Ljava/io/File;)V
    ...
    const-string/jumbo v0, "si__BackupRestoreXmlUtil"
...
.method private static setBookmarkWidgetPreferences(Ljava/lang/String;Landroid/content/SharedPreferences$Editor;)V
    ...
    const-string/jumbo v1, "si__BackupRestoreXmlUtil"
...
.method private static setVoiceVariants(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "setVoiceVariants(): languageKeys -> "

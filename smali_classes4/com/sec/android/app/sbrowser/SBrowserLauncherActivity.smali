...
.method private handleAddons()V
    ...
    const-string/jumbo v1, "si__SBrowserLauncherActivity"

    invoke-static {p0, v0, v1}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->n(Landroid/content/ActivityNotFoundException;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private handleBrowsingAssist()V
    ...
    const-string/jumbo v0, "si__SBrowserLauncherActivity"
...
.method private handleDeepLinkIntent(Landroid/content/Intent;)Z
    ...
    const-string/jumbo v2, "si__SBrowserLauncherActivity"
    ...
    :sswitch_1
    const-string/jumbo v1, "toolbar_custom"
    ...
    :sswitch_6
    const-string/jumbo v1, "site_and_download"
    ...
    :sswitch_7
    const-string/jumbo v1, "useful_features"
    ...
    :sswitch_a
    const-string/jumbo v1, "settings_privacy"
    ...
    :sswitch_c
    const-string/jumbo v1, "settings_appearance"
    ...
    :pswitch_b
    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/SBrowserLauncherActivity;->handleUrlToAppFiling(Landroid/net/Uri;)V
    ...
    :sswitch_data_0
    .sparse-switch
        -0x59513241 -> :sswitch_d
        -0x4c108e00 -> :sswitch_c
        -0x4bf75cc7 -> :sswitch_b
...
.method private handleOpenUrl(Landroid/net/Uri;)V
    ...
    const-string v4, "com.sec.android.app.sbrowser.ACTION_DEEP_LINK"
...
.method private handleSearchKeyword(Landroid/net/Uri;)V
    ...
    const-string v2, "com.sec.android.app.sbrowser.ACTION_DEEP_LINK"
...
.method private handleSettingsAppearance()V
    ...
    const-string/jumbo v2, "settings_appearance"
...
.method private handleSiteNDownload()V
    ...
    const-string/jumbo v2, "site_and_download"
...
.method private handleToolbarCustom()V
    ...
    const-string/jumbo v2, "toolbar_custom"
...
.method private handleUrlToAppFiling(Landroid/net/Uri;)V
    .locals 4
    ...
    const-string v3, "filing"

    invoke-virtual {v1, v2, v3}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const-string/jumbo v2, "url"

    const-string v3, "beian.miit.gov.cn"
    ...
    const-string/jumbo v3, "si__SBrowserLauncherActivity"

    if-nez v2, :cond_0

    const-string/jumbo v2, "target : "

    invoke-static {v2, p1, v3}, LJ7/b;->D(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, v3}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->n(Landroid/content/ActivityNotFoundException;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private handleUsefulFeatures()V
    ...
    const-string/jumbo v2, "useful_features"

...
.method private checkDangerousDownloadFilename(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p0, p2}, Landroidx/appcompat/graphics/drawable/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private checkDownloadPermission(Landroid/app/Activity;)Z
    ...
    invoke-static {v3, v4, v5}, Landroidx/compose/ui/input/pointer/a;->B(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v5, v2}, Landroidx/glance/oneui/template/layout/glance/a;->y(Ljava/lang/String;Ljava/lang/String;Z)V
...
.method public static chooseActivity(Landroid/app/Activity;Landroid/content/pm/ResolveInfo;Lcom/sec/terrace/browser/download/TerraceDownloadInfo;J)Z
    ...
    :cond_4
    const-string/jumbo v0, "starting Activity"
    ...
    invoke-direct {v0, v6, v1}, Landroidx/appcompat/app/AlertDialog$Builder;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {v14, v10, v15}, Landroidx/appcompat/app/AlertDialog$Builder;->setNegativeButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog$Builder;

    move-result-object v0

    new-instance v1, Lcom/sec/android/app/sbrowser/download/DownloadHandler$3;

    invoke-direct {v1, v7, v6, v8, v9}, Lcom/sec/android/app/sbrowser/download/DownloadHandler$3;-><init>(Lcom/sec/terrace/browser/download/TerraceDownloadInfo;Landroid/app/Activity;J)V
...
.method public static requestDownload(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    .locals 1
    ...
    invoke-virtual {v0, p0}, Lcom/sec/android/app/sbrowser/download/DownloadParams$Builder;->setFileUrl(Ljava/lang/String;)Lcom/sec/android/app/sbrowser/download/DownloadParams$Builder;
    ...
    invoke-virtual {p0, p1}, Lcom/sec/android/app/sbrowser/download/DownloadParams$Builder;->setFileName(Ljava/lang/String;)Lcom/sec/android/app/sbrowser/download/DownloadParams$Builder;

    move-result-object p0

    invoke-virtual {p0, p4}, Lcom/sec/android/app/sbrowser/download/DownloadParams$Builder;->setFeatureId(I)Lcom/sec/android/app/sbrowser/download/DownloadParams$Builder;

    move-result-object p0

    invoke-virtual {p0, p3}, Lcom/sec/android/app/sbrowser/download/DownloadParams$Builder;->setHeaders(Ljava/lang/String;)Lcom/sec/android/app/sbrowser/download/DownloadParams$Builder;
...
.method private showDangerousDownloadWarningPopup(Landroid/app/Activity;)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/download/DownloadHandler;->mDialog:Landroidx/appcompat/app/AlertDialog;

    invoke-static {p1}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->setSEP10Dialog(Landroid/app/Dialog;)V

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/download/DownloadHandler;->mDialog:Landroidx/appcompat/app/AlertDialog;
...
.method private startSaveAsActivity(Landroid/app/Activity;)V
    ...
    invoke-static {v1, v2, v0}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->v(Ljava/lang/RuntimeException;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private truncateFilename(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, v2}, Landroidx/compose/ui/input/pointer/a;->h(IILjava/lang/String;)Ljava/lang/String;
...
.method public checkConditionsAndStartDownload(Landroid/app/Activity;)V
    ...
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/download/DownloadHandler;->mDownloadCallback:Lcom/sec/android/app/sbrowser/download_intercept/ui/DownloadFileController$DownloadCallback;

    invoke-static {p1, v0, v1}, Lcom/sec/android/app/sbrowser/apk_download_install/APKDownloadHandler;->interceptDownloadPopup(Landroid/app/Activity;Lcom/sec/android/app/sbrowser/common/download/PreDownloadInfo;Lcom/sec/android/app/sbrowser/download_intercept/ui/DownloadFileController$DownloadCallback;)Z
...
.method public createRetryConfirmDialog(Landroid/app/Activity;Lcom/sec/terrace/browser/download/TerraceDownloadInfo;)V
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/download/DownloadHandler$20;

    invoke-direct {v0, p0}, Lcom/sec/android/app/sbrowser/download/DownloadHandler$20;-><init>(Lcom/sec/android/app/sbrowser/download/DownloadHandler;)V
...
.method public destroyDialogIfExisted()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/download/DownloadHandler;->mDialog:Landroidx/appcompat/app/AlertDialog;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/download/DownloadHandler;->mDialog:Landroidx/appcompat/app/AlertDialog;

    :cond_0
    invoke-static {}, Lcom/sec/android/app/sbrowser/apk_download_install/APKDownloadHandler;->destroyDialogIfExisted()V
...
.method public requestNotificationPermission(Landroid/app/Activity;Ljava/lang/Runnable;)V
    ...
    const-string v2, "pref_req_permission_notification_download"
...
.method public shouldIgnoreDownload(Landroid/app/Activity;Lcom/sec/terrace/browser/download/TerraceDownloadInfo;)Z
    ...
    const-string/jumbo p2, "shouldIgnoreDownload mimetypeForDisableChooser : mimeType"
    ...
    const-string/jumbo v1, "shouldIgnoreDownload : "
...
.method public showPermissionAlert(Landroid/app/Activity;[Ljava/lang/String;)V
    ...
    invoke-virtual {p2, v2, v1}, Landroidx/appcompat/app/AlertDialog$Builder;->setNegativeButton(ILandroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog$Builder;

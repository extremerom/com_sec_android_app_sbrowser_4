...
.field private mExtensionChangeDialog:Landroidx/appcompat/app/AlertDialog;
...
.method private synthetic lambda$doneButtonSelected$1(I)V
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/download/ui/v;

    const/4 v1, 0x1

    invoke-direct {v0, p0, v1}, Lcom/sec/android/app/sbrowser/download/ui/v;-><init>(Lcom/sec/android/app/sbrowser/download/ui/RenameDownloadDialog;I)V
...
.method private synthetic lambda$showExtensionChangeDialog$10(ZLandroid/content/DialogInterface;I)V
    ...
    iget-object p2, p0, Lcom/sec/android/app/sbrowser/download/ui/RenameDownloadDialog;->mDialog:Landroidx/appcompat/app/AlertDialog;
...
.method private synthetic lambda$showRenameDialog$5(ZLandroid/widget/TextView;ILandroid/view/KeyEvent;)Z
    ...
    iget-object p1, p0, Lcom/sec/android/app/sbrowser/download/ui/RenameDownloadDialog;->mDialog:Landroidx/appcompat/app/AlertDialog;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/download/ui/RenameDownloadDialog;->mDialog:Landroidx/appcompat/app/AlertDialog;
...
.method private showExtensionChangeDialog(Z)V
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/download/ui/w;

    const/4 v2, 0x1

    invoke-direct {v1, p0, v2}, Lcom/sec/android/app/sbrowser/download/ui/w;-><init>(Ljava/lang/Object;I)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/download/ui/RenameDownloadDialog;->mExtensionChangeDialog:Landroidx/appcompat/app/AlertDialog;

    invoke-static {p1}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->setSEP10Dialog(Landroid/app/Dialog;)V

    iget-object p1, p0, Lcom/sec/android/app/sbrowser/download/ui/RenameDownloadDialog;->mExtensionChangeDialog:Landroidx/appcompat/app/AlertDialog;
...
.method private startRename(Z)V
    ...
    :cond_4
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/download/ui/RenameDownloadDialog;->mDialog:Landroidx/appcompat/app/AlertDialog;
...
.method public showRenameDialog(Lcom/sec/android/app/sbrowser/download/ui/DownloadHistoryItemWrapper;)V
    ...
    invoke-direct {v7, v8, v9}, Landroidx/appcompat/app/AlertDialog$Builder;-><init>(Landroid/content/Context;I)V
    ...
    new-instance v9, Lcom/sec/android/app/sbrowser/download/ui/b;

    invoke-direct {v9, p0, v1}, Lcom/sec/android/app/sbrowser/download/ui/b;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-virtual {v7, v9}, Landroidx/appcompat/app/AlertDialog$Builder;->setTitle(Ljava/lang/CharSequence;)Landroidx/appcompat/app/AlertDialog$Builder;
    ...
    new-instance p1, Lcom/sec/android/app/sbrowser/download/ui/w;

    invoke-direct {p1, p0, v3}, Lcom/sec/android/app/sbrowser/download/ui/w;-><init>(Ljava/lang/Object;I)V

    const v6, 0x7f14025d

    invoke-virtual {v7, v6, p1}, Landroidx/appcompat/app/AlertDialog$Builder;->setNegativeButton(ILandroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog$Builder;

    new-instance p1, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/view/z;

    invoke-direct {p1, v0}, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/view/z;-><init>(I)V

    const v0, 0x7f140c50

    invoke-virtual {v7, v0, p1}, Landroidx/appcompat/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog$Builder;

    invoke-virtual {v7}, Landroidx/appcompat/app/AlertDialog$Builder;->create()Landroidx/appcompat/app/AlertDialog;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/sbrowser/download/ui/RenameDownloadDialog;->mDialog:Landroidx/appcompat/app/AlertDialog;

    invoke-static {p1}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->setSEP10Dialog(Landroid/app/Dialog;)V

    iget-object p1, p0, Lcom/sec/android/app/sbrowser/download/ui/RenameDownloadDialog;->mEditDownloadView:Landroid/widget/EditText;

    new-instance v0, Lcom/sec/android/app/sbrowser/download/ui/x;

    invoke-direct {v0, p0, v2}, Lcom/sec/android/app/sbrowser/download/ui/x;-><init>(Lcom/sec/android/app/sbrowser/download/ui/RenameDownloadDialog;Z)V
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/download/ui/y;

    invoke-direct {v0, p0}, Lcom/sec/android/app/sbrowser/download/ui/y;-><init>(Lcom/sec/android/app/sbrowser/download/ui/RenameDownloadDialog;)V
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/download/ui/z;

    invoke-direct {v0, v3, p0, v2}, Lcom/sec/android/app/sbrowser/download/ui/z;-><init>(ILjava/lang/Object;Z)V
    ...
    invoke-virtual {v0, v3, p1}, Landroid/widget/EditText;->setSelection(II)V

    :cond_3
    iget-object p1, p0, Lcom/sec/android/app/sbrowser/download/ui/RenameDownloadDialog;->mEditDownloadView:Landroid/widget/EditText;

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/download/ui/RenameDownloadDialog;->mTextWatcher:Landroid/text/TextWatcher;

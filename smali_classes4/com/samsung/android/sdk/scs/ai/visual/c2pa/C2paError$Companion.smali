...
.method public final fromErrorString(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-direct {v5, v6}, Lca/j;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v6, v5, p1, v2}, Lca/h;-><init>(Lca/j;Ljava/lang/String;I)V

    sget-object v5, Lca/i;->a:Lca/i;

    new-instance v7, Lba/c;

    invoke-direct {v7, v6, v5}, Lba/c;-><init>(LL8/a;LL8/k;)V
    ...
    invoke-static {v7, v5}, Lba/o;->p(Lba/l;LL8/k;)Lba/t;
    ...
    iget-object v6, v4, Lba/t;->a:Lba/l;

    invoke-interface {v6}, Lba/l;->iterator()Ljava/util/Iterator;
    ...
    iget-object v8, v4, Lba/t;->b:LL8/k;

    invoke-interface {v8, v7}, LL8/k;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

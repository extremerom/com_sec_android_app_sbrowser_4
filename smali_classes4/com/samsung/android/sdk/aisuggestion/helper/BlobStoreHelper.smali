...
.field private static final isBuildTypeUser$delegate:Lw8/h;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lcom/samsung/android/sdk/aisuggestion/helper/BlobStoreHelper$Companion;-><init>(Lkotlin/jvm/internal/i;)V
    ...
    sput-object v0, Lcom/samsung/android/sdk/aisuggestion/helper/BlobStoreHelper;->isBuildTypeUser$delegate:Lw8/h;
...
.method public static final synthetic access$isBuildTypeUser$delegate$cp()Lw8/h;
    .locals 1

    sget-object v0, Lcom/samsung/android/sdk/aisuggestion/helper/BlobStoreHelper;->isBuildTypeUser$delegate:Lw8/h;
...
.method public final downloadBlobBitmap(Landroid/app/blob/BlobHandle;)Landroid/graphics/Bitmap;
    ...
    invoke-static {}, Lcom/google/android/material/color/a;->q()Ljava/lang/Class;
    ...
    invoke-static {p0}, Lcom/google/android/material/color/a;->h(Ljava/lang/Object;)Landroid/app/blob/BlobStoreManager;
    ...
    invoke-static {p0, p1}, Lcom/google/android/material/color/a;->n(Landroid/app/blob/BlobStoreManager;Landroid/app/blob/BlobHandle;)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {v1, p0}, Ly8/P;->b(Ljava/io/FileInputStream;Ljava/io/OutputStream;)V
...
.method public final uploadToBlobStore([BLjava/lang/String;Ljava/util/concurrent/Executor;J)Landroid/app/blob/BlobHandle;
    ...
    invoke-static {v0, v1, p4, p5, p2}, Lcom/google/android/material/color/a;->e([BLjava/lang/String;JLjava/lang/String;)Landroid/app/blob/BlobHandle;
    ...
    invoke-static {p0, p2}, Lcom/google/android/material/color/a;->b(Landroid/app/blob/BlobStoreManager;Landroid/app/blob/BlobHandle;)J

    move-result-wide p4

    invoke-static {p0, p4, p5}, Lcom/google/android/material/color/a;->f(Landroid/app/blob/BlobStoreManager;J)Landroid/app/blob/BlobStoreManager$Session;

    move-result-object p0

    :try_start_0
    invoke-static {p0}, Lcom/google/android/material/color/a;->g(Ljava/lang/Object;)Landroid/app/blob/BlobStoreManager$Session;
    ...
    invoke-static {p4, v0, v1}, Lcom/google/android/material/color/a;->m(Landroid/app/blob/BlobStoreManager$Session;J)Landroid/os/ParcelFileDescriptor;
    ...
    :try_start_3
    invoke-static {v0, p1}, Lb2/i2;->e(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_1

    :try_start_4
    invoke-static {p5, p1}, Lb2/i2;->e(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {p4, v0}, Lcom/google/android/material/color/a;->v(Landroid/app/blob/BlobStoreManager$Session;[B)V
    ...
    invoke-static {p4, p5}, Lcom/google/android/material/color/a;->D(Landroid/app/blob/BlobStoreManager$Session;[B)V

    new-instance p5, Landroidx/appcompat/animation/a;

    const/4 v0, 0x3

    invoke-direct {p5, v0}, Landroidx/appcompat/animation/a;-><init>(I)V

    invoke-static {p4, p3, p5}, Lcom/google/android/material/color/a;->u(Landroid/app/blob/BlobStoreManager$Session;Ljava/util/concurrent/Executor;Landroidx/appcompat/animation/a;)V
    :try_end_4

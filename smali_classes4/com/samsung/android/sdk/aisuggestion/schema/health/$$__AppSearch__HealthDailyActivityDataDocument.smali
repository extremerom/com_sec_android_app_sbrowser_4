...
# virtual methods
.method public fromGenericDocument(Landroidx/appsearch/app/GenericDocument;Ljava/util/Map;)Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthDailyActivityDataDocument;
    .locals 37
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_3
    const-string v9, "heartGraph"

    invoke-virtual {v0, v9}, Landroidx/appsearch/app/GenericDocument;->getPropertyDocument(Ljava/lang/String;)Landroidx/appsearch/app/GenericDocument;
    ...
    invoke-virtual {v9, v10, v1}, Landroidx/appsearch/app/GenericDocument;->toDocumentClass(Ljava/lang/Class;Ljava/util/Map;)Ljava/lang/Object;

    move-result-object v9

    check-cast v9, Lcom/samsung/android/sdk/aisuggestion/schema/core/ImageResourceDataDocument;
    ...
    :goto_4
    const-string v11, "motionTypeIcon"
    ...
    invoke-virtual {v11, v10, v1}, Landroidx/appsearch/app/GenericDocument;->toDocumentClass(Ljava/lang/Class;Ljava/util/Map;)Ljava/lang/Object;

    move-result-object v11

    check-cast v11, Lcom/samsung/android/sdk/aisuggestion/schema/core/ImageResourceDataDocument;
    ...
    :goto_5
    const-string v15, "motionValue"

    invoke-virtual {v0, v15}, Landroidx/appsearch/app/GenericDocument;->getPropertyLong(Ljava/lang/String;)J

    move-result-wide v15

    const-string v5, "motionTarget"

    invoke-virtual {v0, v5}, Landroidx/appsearch/app/GenericDocument;->getPropertyLong(Ljava/lang/String;)J

    move-result-wide v17

    const-string v5, "motionUnit"
    ...
    :goto_6
    const-string/jumbo v5, "timeTypeIcon"
    ...
    invoke-virtual {v5, v10, v1}, Landroidx/appsearch/app/GenericDocument;->toDocumentClass(Ljava/lang/Class;Ljava/util/Map;)Ljava/lang/Object;
    ...
    :goto_7
    const-string/jumbo v5, "timeValue"

    invoke-virtual {v0, v5}, Landroidx/appsearch/app/GenericDocument;->getPropertyLong(Ljava/lang/String;)J

    move-result-wide v21

    const-string/jumbo v5, "timeTarget"
    ...
    :goto_8
    const-string v5, "calorieTypeIcon"
    ...
    :goto_a
    new-instance v14, Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthDailyActivityDataDocument;
...
.method public bridge synthetic fromGenericDocument(Landroidx/appsearch/app/GenericDocument;Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/sdk/aisuggestion/schema/health/$$__AppSearch__HealthDailyActivityDataDocument;->fromGenericDocument(Landroidx/appsearch/app/GenericDocument;Ljava/util/Map;)Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthDailyActivityDataDocument;
...
.method public toGenericDocument(Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthDailyActivityDataDocument;)Landroidx/appsearch/app/GenericDocument;
    .locals 5
...
.method public bridge synthetic toGenericDocument(Ljava/lang/Object;)Landroidx/appsearch/app/GenericDocument;
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/aisuggestion/schema/health/$$__AppSearch__HealthDailyActivityDataDocument;->toGenericDocument(Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthDailyActivityDataDocument;)Landroidx/appsearch/app/GenericDocument;

...
.method private getClickPendingIntent(Landroid/content/Context;Ljava/lang/String;ILjava/util/ArrayList;)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, p2, p4, v0}, Lcom/samsung/android/sdk/smp/marketing/MarketingLinkProcessor;->getClickIntent(Landroid/content/Context;Ljava/lang/String;Ljava/util/ArrayList;Z)Lcom/samsung/android/sdk/smp/marketing/MarketingLinkProcessor$ClickIntent;

    move-result-object p4

    invoke-virtual {p4}, Lcom/samsung/android/sdk/smp/marketing/MarketingLinkProcessor$ClickIntent;->isLaunchable()Z

    move-result v0

    sput-boolean v0, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->mIsClickIntentLaunchable:Z

    invoke-virtual {p4}, Lcom/samsung/android/sdk/smp/marketing/MarketingLinkProcessor$ClickIntent;->needDeleteIntent()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-direct {p0, p1, p2, p3}, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->getDeletePendingIntent(Landroid/content/Context;Ljava/lang/String;I)Landroid/app/PendingIntent;
    ...
    :cond_1
    invoke-virtual {p4}, Lcom/samsung/android/sdk/smp/marketing/MarketingLinkProcessor$ClickIntent;->getClickIntent()Landroid/content/Intent;

    move-result-object p0

    invoke-static {p1, p3, p0, v1}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    :cond_2
    :goto_0
    invoke-static {p1, p2, p4}, Lcom/samsung/android/sdk/smp/display/DisplayManager;->getClickIntent(Landroid/content/Context;Ljava/lang/String;Ljava/util/ArrayList;)Landroid/content/Intent;
    ...
    invoke-static {p1, p3, p0, v1}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method private getNotification(Landroid/content/Context;Landroid/os/Bundle;I)Landroid/app/Notification;
    ...
    invoke-static {p1, v4, v5}, Lcom/samsung/android/sdk/smp/common/constants/MarketingConstants$NotificationConst;->isSupportType(Landroid/content/Context;II)Z
    ...
    invoke-direct {p0, p1, v0, p3, v1}, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->getClickPendingIntent(Landroid/content/Context;Ljava/lang/String;ILjava/util/ArrayList;)Landroid/app/PendingIntent;
...
.method private getNotificationButtonClickIntentUnderS(Ljava/lang/String;ILjava/util/ArrayList;ILandroid/content/Context;)Landroid/content/Intent;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private getNotificationButtonClickPendingIntent(Ljava/lang/String;ILjava/util/ArrayList;ILandroid/content/Context;)Landroid/app/PendingIntent;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p5, p1, p3, p2}, Lcom/samsung/android/sdk/smp/marketing/MarketingLinkProcessor;->getClickIntent(Landroid/content/Context;Ljava/lang/String;Ljava/util/ArrayList;Z)Lcom/samsung/android/sdk/smp/marketing/MarketingLinkProcessor$ClickIntent;

    move-result-object p2

    invoke-virtual {p2}, Lcom/samsung/android/sdk/smp/marketing/MarketingLinkProcessor$ClickIntent;->needDeleteIntent()Z

    move-result p3

    if-eqz p3, :cond_1

    invoke-direct {p0, p5, p1, p4}, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->getDeletePendingIntent(Landroid/content/Context;Ljava/lang/String;I)Landroid/app/PendingIntent;
    ...
    :cond_1
    invoke-virtual {p2}, Lcom/samsung/android/sdk/smp/marketing/MarketingLinkProcessor$ClickIntent;->getClickIntent()Landroid/content/Intent;

    move-result-object p0

    invoke-static {p5, p4, p0, v1}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    :cond_2
    :goto_0
    invoke-direct/range {p0 .. p5}, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->getNotificationButtonClickIntentUnderS(Ljava/lang/String;ILjava/util/ArrayList;ILandroid/content/Context;)Landroid/content/Intent;

    move-result-object p0

    invoke-static {p5, p4, p0, v1}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method private setBigPictureBuilder(Landroid/content/Context;Landroid/app/Notification$Builder;Landroid/os/Bundle;)V
    ...
    const-string/jumbo p0, "sub_content_text"
...
.method private setNotificationButtonBuilder(Landroid/app/Notification$Builder;Landroid/os/Bundle;ILandroid/content/Context;)V
    ...
    const-string v7, "noti_button"

    invoke-static {p2, v7}, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->getNotificationButtonList(Landroid/os/Bundle;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {p2, v7, v9}, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->getNotificationButtonLinkList(Landroid/os/Bundle;Ljava/lang/String;I)Ljava/util/ArrayList;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/samsung/android/sdk/smp/display/NotificationDisplayManager;->getNotificationButtonClickPendingIntent(Ljava/lang/String;ILjava/util/ArrayList;ILandroid/content/Context;)Landroid/app/PendingIntent;
    ...
    invoke-direct {v2, v3, v10, v1}, Landroid/app/Notification$Action$Builder;-><init>(Landroid/graphics/drawable/Icon;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V
...
.method private setNotificationConfigs(Landroid/content/Context;Landroid/app/Notification;)V
    ...
    iput p0, p2, Landroid/app/Notification;->flags:I
    ...
    iput p0, p2, Landroid/app/Notification;->color:I
    ...
    iput p0, p2, Landroid/app/Notification;->priority:I
...
.method public display(Landroid/content/Context;Landroid/os/Bundle;Lcom/samsung/android/sdk/smp/display/DisplayResultHandler;)V
    ...
    const-string p2, "app_icon_not_cound"

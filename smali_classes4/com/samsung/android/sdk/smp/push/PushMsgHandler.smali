...
.method private handleSmpMessage(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/push/PushMsgHandler$ISmpPushInterface;)Z
    ...
    const-string p0, "Invalid message. wrong type : "
    ...
    :try_start_1
    invoke-interface {p3, p0}, Lcom/samsung/android/sdk/smp/push/PushMsgHandler$ISmpPushInterface;->isMarketingDisplayEnabledImpl(Ljava/lang/String;)Z
    ...
    :try_start_2
    sget-object v4, Lcom/samsung/android/sdk/smp/push/PushMsgHandler;->TAG:Ljava/lang/String;
    ...
    invoke-static {v4, v1}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->he(Ljava/lang/String;Ljava/lang/String;)V

    move v1, v3

    :goto_2
    invoke-static {p1, p2, v1}, Lcom/samsung/android/sdk/smp/marketing/MarketingManager;->handleMessage(Landroid/content/Context;Ljava/lang/String;Z)V
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_0

    :try_start_3
    invoke-interface {p3, p2, p0}, Lcom/samsung/android/sdk/smp/push/PushMsgHandler$ISmpPushInterface;->marketingMessageReceivedImpl(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3
...
.method private sendMessageAck(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object p2, Lcom/samsung/android/sdk/smp/task/STask$CommonAction;->SEND_ACK:Lcom/samsung/android/sdk/smp/task/STask$CommonAction;

    const/4 p3, 0x0

    invoke-direct {p0, p2, p3}, Lcom/samsung/android/sdk/smp/task/STask;-><init>(Lcom/samsung/android/sdk/smp/task/STask$Action;Landroid/os/Bundle;)V

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p2

    invoke-static {p2, p0}, Lcom/samsung/android/sdk/smp/task/STaskDispatcher;->cancelDispatchAlarm(Landroid/content/Context;Lcom/samsung/android/sdk/smp/task/STask;)V

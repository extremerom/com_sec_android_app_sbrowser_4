...
.method private adjustDisplayTimeRange()Ljava/util/List;
    ...
    const-string/jumbo v2, "updated display range : "
...
.method private applyRandomTimeForDisplay(Ljava/util/Calendar;IIJI)V
    ...
    invoke-static {p6, p2, p3, p4}, LJ7/b;->n(Ljava/lang/StringBuilder;JLjava/lang/String;)Ljava/lang/String;
...
.method public static getMarketingByMarketingType(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Lcom/samsung/android/sdk/smp/marketing/Marketing;
    ...
    :cond_0
    invoke-static {p0}, Lcom/samsung/android/sdk/smp/common/util/DeviceInfoUtil;->isAndroidWear(Landroid/content/Context;)Z
...
.method private needRandomDisplay(Landroid/content/Context;)Z
    ...
    const-string/jumbo v0, "skip random display : test message"
    ...
    const-string/jumbo v0, "skip random display : real time marketing"
...
.method public static setToGone(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    sget-object v3, Lcom/samsung/android/sdk/smp/common/constants/MarketingState;->GONE:Lcom/samsung/android/sdk/smp/common/constants/MarketingState;
    ...
    invoke-virtual {v1, p1, v4, v5}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->updateMarketingClickedTime(Ljava/lang/String;J)Z

    :cond_4
    invoke-virtual {v1, p1, v3}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->updateMarketingState(Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/MarketingState;)Z
    ...
    invoke-direct {p2, v2, v0, p1}, Lcom/samsung/android/sdk/smp/task/SMarketingTask;-><init>(Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;Landroid/os/Bundle;Ljava/lang/String;)V
...
.method public isSupportType(Landroid/content/Context;)Z
    .locals 1
...
.method public requestDownloadResource(Landroid/content/Context;)V
    ...
    invoke-static {p1, v3}, Lcom/samsung/android/sdk/smp/common/util/FilePathUtil;->getResDirectory(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
...
.method public setAlarmForScreenOnListener(Landroid/content/Context;)V
    ...
    invoke-static {v4, v5}, Landroidx/glance/oneui/template/layout/glance/a;->e(Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;
...
.method public updateExpectedDisplayTime(Landroid/content/Context;)V
    ...
    const-string/jumbo v2, "update expected display time:"

...
.method private declared-synchronized countAppStartData()I
    ...
    :try_start_0
    const-string v3, "SELECT COUNT (*) FROM start"
    ...
    const-string v4, "fail to find and move cursor."

    invoke-static {v3, v4}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
...
.method private getStringValueFromDbWithMid(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p4, v0, p5}, Landroidx/appcompat/graphics/drawable/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    const-string p5, "=?"

    invoke-static {p3, p5}, Landroidx/appcompat/graphics/drawable/a;->B(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private updateMarketingDbValueWithMid(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p4, p2}, LJ7/b;->r(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public declared-synchronized countExternalFeedbackData()I
    ...
    :try_start_0
    const-string v3, "SELECT COUNT (*) FROM externalfeedback"
...
.method public declared-synchronized countIncompletedMarketings()J
    ...
    const-string/jumbo v5, "state=? OR state=? OR state=? OR state=?"
...
.method public declared-synchronized deleteAllAppFilter()V
    ...
    const-string v0, "clear all app filter error. "
...
.method public declared-synchronized getDirectMids(J)Lorg/json/JSONArray;
    ...
    const-string v2, "SELECT mid FROM card WHERE mct< ? AND mct> ?"
...
.method public declared-synchronized getIndirectMids(J)Lorg/json/JSONArray;
    ...
    sget-wide v5, Lcom/samsung/android/sdk/smp/common/constants/Constants;->INDIRECT_TIME_BOUNDARY:J
    ...
    const-string v2, "SELECT mid FROM card WHERE NOT (mct NOT NULL  AND mct< ? AND mct> ? ) AND mdt< ? AND mdt> ?"

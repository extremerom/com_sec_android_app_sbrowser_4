...
.field private final mListener:LC/s;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LC/s;"
        }
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;LC/s;LC/r;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v0, p1, p5}, LC/p;-><init>(ILjava/lang/String;LC/r;)V
    ...
    iput-object p4, p0, Lcom/samsung/android/sdk/smp/common/network/NetworkManager$CDNVolleyRequest;->mListener:LC/s;
...
.method public deliverResponse(Ljava/io/File;)V
    ...
    iget-object p0, p0, Lcom/samsung/android/sdk/smp/common/network/NetworkManager$CDNVolleyRequest;->mListener:LC/s;
...
.method public parseNetworkResponse(LC/k;)LC/t;
    ...
    invoke-direct {p1, p0}, LC/t;-><init>(LC/x;)V
    ...
    invoke-direct {p1, p0}, LC/x;-><init>(Ljava/lang/String;)V

    new-instance p0, LC/t;

    invoke-direct {p0, p1}, LC/t;-><init>(LC/x;)V

...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Lcom/samsung/android/sdk/smp/common/util/DeviceInfoUtil;->isAndroidWear(Landroid/content/Context;)Z
...
.method public static getInstance(Landroid/content/Context;)Lcom/samsung/android/sdk/smp/data/UsageManager;
    .locals 2
...
.method public static saveAppUsage(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    const-string v0, "Indirect App Start : "

    const-string v1, "Direct App Start : "
    ...
    invoke-virtual {p0, v2, v3}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->getDirectMids(J)Lorg/json/JSONArray;

    move-result-object v7

    invoke-virtual {p0, v2, v3}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->getIndirectMids(J)Lorg/json/JSONArray;
    ...
    sget-object v2, Lcom/samsung/android/sdk/smp/data/UsageManager;->TAG:Ljava/lang/String;
    ...
    invoke-static {v1, v0}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->d(Ljava/lang/String;Ljava/lang/String;)V

    :cond_1
    invoke-virtual {p0, v9}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->addAppStartData(Lorg/json/JSONObject;)V
    :try_end_0
    ...
    invoke-virtual {p0, v6, p1}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->addSessionData(Ljava/lang/String;I)V
...
.method public activityCreated(Landroid/app/Activity;)V
    ...
    iget p0, p0, Lcom/samsung/android/sdk/smp/data/UsageManager;->mActivityCount:I
    ...
    const-string/jumbo v1, "upload clients because data/power save mode on"
...
.method public activityStarted(Landroid/app/Activity;)V
    ...
    iget-boolean v5, p0, Lcom/samsung/android/sdk/smp/data/UsageManager;->mIsAppUsageEnabled:Z
    ...
    invoke-virtual {v4, v6}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->setUploadFailCount(I)V
...
.method public activityStopped(Landroid/app/Activity;)V
    ...
    iget-boolean p1, p0, Lcom/samsung/android/sdk/smp/data/UsageManager;->mIsAppUsageEnabled:Z
    ...
    iget-wide v9, p0, Lcom/samsung/android/sdk/smp/data/UsageManager;->mAppStartTime:J
    ...
    invoke-virtual {p1, v8, v0, v1}, Landroid/os/BaseBundle;->putLong(Ljava/lang/String;J)V

...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;
    ...
    invoke-direct {v1, v4, v2, v3}, Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;->CLEAR:Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;

    new-instance v2, Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;

    const/4 v3, 0x2

    const v4, 0x8963e0

    const-string v5, "CUSTOM_FEEDBACK"

    invoke-direct {v2, v5, v3, v4}, Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;->CUSTOM_FEEDBACK:Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;

    new-instance v3, Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;
    ...
    invoke-direct {v3, v6, v4, v5}, Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;->SCREEN_ON:Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;

    new-instance v4, Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;

    const/4 v5, 0x4

    const v6, 0x896bb0

    const-string v7, "CHECK_NOTIFICATION_CLEARED"

    invoke-direct {v4, v7, v5, v6}, Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;->CHECK_NOTIFICATION_CLEARED:Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;
...
.method public id()I
    ...
    iget p0, p0, Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;->id:I

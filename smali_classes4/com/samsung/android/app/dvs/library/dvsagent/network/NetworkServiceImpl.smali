...
.method private final getDvsService()Lcom/samsung/android/app/dvs/library/dvsagent/network/DvsService;
    ...
    sget-object v0, LOa/a;->BODY:LOa/a;

    invoke-virtual {p0, v0}, LOa/c;->c(LOa/a;)V
    ...
    invoke-direct {v0, v2}, LAa/t;-><init>(Ljava/util/concurrent/ExecutorService;)V

    monitor-enter v0

    :try_start_0
    iput v1, v0, LAa/t;->a:I
    :try_end_0
    ...
    invoke-direct {v1, v2, v3, v4}, Lg3/c;-><init>(JLjava/util/concurrent/TimeUnit;)V

    new-instance v2, LAa/K;

    invoke-direct {v2}, LAa/K;-><init>()V

    invoke-virtual {v2, p0}, LAa/K;->a(LAa/F;)V

    iput-object v0, v2, LAa/K;->a:LAa/t;

    iput-object v1, v2, LAa/K;->b:Lg3/c;

    sget-object p0, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    const-wide/16 v0, 0xa

    invoke-virtual {v2, v0, v1, p0}, LAa/K;->d(JLjava/util/concurrent/TimeUnit;)V

    const-wide/16 v0, 0x4

    invoke-virtual {v2, v0, v1, p0}, LAa/K;->f(JLjava/util/concurrent/TimeUnit;)V

    const-wide/16 v0, 0x8

    invoke-virtual {v2, v0, v1, p0}, LAa/K;->e(JLjava/util/concurrent/TimeUnit;)V

    const/4 p0, 0x1

    iput-boolean p0, v2, LAa/K;->f:Z
    ...
    invoke-direct {v0, v2}, LAa/L;-><init>(LAa/K;)V

    invoke-virtual {p0, v0}, Lretrofit2/Retrofit$Builder;->client(LAa/L;)Lretrofit2/Retrofit$Builder;
...
.method public attestSAK(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lretrofit2/Response;->headers()LAa/B;

    move-result-object p0

    const-string/jumbo p1, "x-session-token"

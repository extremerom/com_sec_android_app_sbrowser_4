...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lkotlin/Function0;",
        "onFinished",
        "(Landroid/content/Context;LL8/k;LL8/k;LL8/k;LL8/a;)V",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lcom/samsung/android/app/dvs/library/dvsagent/DvsAgent$Companion;-><init>(Lkotlin/jvm/internal/i;)V
...
.method public static synthetic attestDevice$default(Lcom/samsung/android/app/dvs/library/dvsagent/DvsAgent;Landroid/content/Context;LL8/k;LL8/k;LL8/k;LL8/a;ILjava/lang/Object;)V
    .locals 7
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/samsung/android/app/dvs/library/dvsagent/DvsAgent;->attestDevice(Landroid/content/Context;LL8/k;LL8/k;LL8/k;LL8/a;)V
...
.method public final attestDevice(Landroid/content/Context;LL8/k;LL8/k;LL8/k;LL8/a;)V
    .locals 10
    .param p1    # Landroid/content/Context;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-direct {v0, p1, v1}, Lcom/samsung/android/app/dvs/library/dvsagent/DvsAgent$attestDevice$1;-><init>(Landroid/content/Context;LB8/d;)V

    invoke-virtual {p0, v0}, Lcom/samsung/android/app/dvs/library/dvsagent/utils/CoroutineSwitcher$Chain;->onIO(LL8/n;)Lcom/samsung/android/app/dvs/library/dvsagent/utils/CoroutineSwitcher$Chain;

    move-result-object v2

    new-instance v4, Lcom/samsung/android/app/dvs/library/dvsagent/DvsAgent$attestDevice$2;

    invoke-direct {v4, p2}, Lcom/samsung/android/app/dvs/library/dvsagent/DvsAgent$attestDevice$2;-><init>(LL8/k;)V

    new-instance v5, Lcom/samsung/android/app/dvs/library/dvsagent/DvsAgent$attestDevice$3;

    invoke-direct {v5, p3}, Lcom/samsung/android/app/dvs/library/dvsagent/DvsAgent$attestDevice$3;-><init>(LL8/k;)V

    new-instance v6, Lcom/samsung/android/app/dvs/library/dvsagent/DvsAgent$attestDevice$4;

    invoke-direct {v6, p4}, Lcom/samsung/android/app/dvs/library/dvsagent/DvsAgent$attestDevice$4;-><init>(LL8/k;)V

    new-instance v7, Lcom/samsung/android/app/dvs/library/dvsagent/DvsAgent$attestDevice$5;

    invoke-direct {v7, p5}, Lcom/samsung/android/app/dvs/library/dvsagent/DvsAgent$attestDevice$5;-><init>(LL8/a;)V
    ...
    invoke-static/range {v2 .. v9}, Lcom/samsung/android/app/dvs/library/dvsagent/utils/CoroutineSwitcher$Chain;->start$default(Lcom/samsung/android/app/dvs/library/dvsagent/utils/CoroutineSwitcher$Chain;Lfa/E;LL8/k;LL8/k;LL8/k;LL8/a;ILjava/lang/Object;)Lfa/m0;

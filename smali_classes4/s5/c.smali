...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ls5/c;->mExtraInfo:Landroid/os/Bundle;
...
.method public attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)V
    ...
    invoke-super {p0, p1, p2}, Ls5/a;->attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)V

    invoke-virtual {p0}, Ls5/c;->secQueryGetFingerprint()Ljava/lang/String;
    ...
    iput-object p1, p0, Ls5/c;->mAuthority:Ljava/lang/String;
    ...
    iput-object p1, p0, Ls5/c;->mMatcher:Landroid/content/UriMatcher;

    iget-object p2, p0, Ls5/c;->mAuthority:Ljava/lang/String;
    ...
    iget-object p1, p0, Ls5/c;->mMatcher:Landroid/content/UriMatcher;

    iget-object p0, p0, Ls5/c;->mAuthority:Ljava/lang/String;
...
.method public call(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    iget-object v4, p0, Ls5/c;->mExtraInfo:Landroid/os/Bundle;
    ...
    invoke-virtual {p0, p3}, Ls5/c;->secQueryAvailability(Landroid/os/Bundle;)I
...
.method public getType(Landroid/net/Uri;)Ljava/lang/String;
    ...
    iget-object v0, p0, Ls5/c;->mMatcher:Landroid/content/UriMatcher;
    ...
    invoke-super {p0, p1}, Ls5/a;->getType(Landroid/net/Uri;)Ljava/lang/String;
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    :goto_1
    iget-object v3, p0, Ls5/c;->mExtraInfo:Landroid/os/Bundle;
    ...
    invoke-super/range {p0 .. p5}, Ls5/a;->query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    :cond_4
    invoke-virtual {p0, v2}, Ls5/c;->secQueryVariableRawData([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    :cond_7
    invoke-virtual {p0, v2, p3}, Ls5/c;->secQueryNonIndexableKeys([Ljava/lang/String;Landroid/os/Bundle;)Landroid/database/Cursor;
...
.method public secQueryAvailability(Landroid/os/Bundle;)I
    ...
    sget-object v3, Ls5/b;->c:[Ljava/lang/String;

    if-eqz v1, :cond_1

    invoke-virtual {p0, v3, p1}, Ls5/c;->secQueryNonIndexableKeys([Ljava/lang/String;Landroid/os/Bundle;)Landroid/database/Cursor;
    ...
    :cond_1
    invoke-virtual {p0, v3}, Ls5/a;->queryNonIndexableKeys([Ljava/lang/String;)Landroid/database/Cursor;
...
.method public secQueryNonIndexableKeys([Ljava/lang/String;Landroid/os/Bundle;)Landroid/database/Cursor;
    ...
    invoke-virtual {p0, p1}, Ls5/a;->queryNonIndexableKeys([Ljava/lang/String;)Landroid/database/Cursor;

...
# direct methods
.method public constructor <init>(Landroidx/compose/runtime/Recomposer;Lkotlin/jvm/internal/F;Lia/n0;Landroidx/glance/session/Session;Landroid/content/Context;Landroidx/glance/EmittableWithChildren;Landroidx/glance/session/TimerScope;Landroidx/glance/session/TimeoutOptions;Lfa/E;LB8/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "LB8/d<",
            "-",
            "Landroidx/glance/session/SessionWorkerKt$runSession$4$1;",
            ">;)V"
        }
    .end annotation
    ...
    iput-object p2, p0, Landroidx/glance/session/SessionWorkerKt$runSession$4$1;->$lastRecomposeCount:Lkotlin/jvm/internal/F;

    iput-object p3, p0, Landroidx/glance/session/SessionWorkerKt$runSession$4$1;->$uiReady:Lia/n0;
    ...
    iput-object p9, p0, Landroidx/glance/session/SessionWorkerKt$runSession$4$1;->$$this$launch:Lfa/E;

    const/4 p1, 0x2

    invoke-direct {p0, p1, p10}, LD8/i;-><init>(ILB8/d;)V
...
.method public final create(Ljava/lang/Object;LB8/d;)LB8/d;
    ...
    iget-object v2, p0, Landroidx/glance/session/SessionWorkerKt$runSession$4$1;->$lastRecomposeCount:Lkotlin/jvm/internal/F;

    iget-object v3, p0, Landroidx/glance/session/SessionWorkerKt$runSession$4$1;->$uiReady:Lia/n0;
    ...
    iget-object v9, p0, Landroidx/glance/session/SessionWorkerKt$runSession$4$1;->$$this$launch:Lfa/E;

    move-object v0, v11

    move-object v10, p2

    invoke-direct/range {v0 .. v10}, Landroidx/glance/session/SessionWorkerKt$runSession$4$1;-><init>(Landroidx/compose/runtime/Recomposer;Lkotlin/jvm/internal/F;Lia/n0;Landroidx/glance/session/Session;Landroid/content/Context;Landroidx/glance/EmittableWithChildren;Landroidx/glance/session/TimerScope;Landroidx/glance/session/TimeoutOptions;Lfa/E;LB8/d;)V
...
.method public final invoke(Landroidx/compose/runtime/Recomposer$State;LB8/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/glance/session/SessionWorkerKt$runSession$4$1;->create(Ljava/lang/Object;LB8/d;)LB8/d;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/glance/session/SessionWorkerKt$runSession$4$1;->invoke(Landroidx/compose/runtime/Recomposer$State;LB8/d;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_3
    iget-object p0, p0, Landroidx/glance/session/SessionWorkerKt$runSession$4$1;->$$this$launch:Lfa/E;
    ...
    iget-object p1, p0, Landroidx/glance/session/SessionWorkerKt$runSession$4$1;->$lastRecomposeCount:Lkotlin/jvm/internal/F;

    iget-wide v7, p1, Lkotlin/jvm/internal/F;->a:J

    cmp-long p1, v5, v7

    if-gtz p1, :cond_5

    iget-object p1, p0, Landroidx/glance/session/SessionWorkerKt$runSession$4$1;->$uiReady:Lia/n0;
    ...
    invoke-virtual {p1, v1, v5, p0}, Landroidx/glance/session/Session;->processEmittableTree(Landroid/content/Context;Landroidx/glance/EmittableWithChildren;LB8/d;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Landroidx/glance/session/SessionWorkerKt$runSession$4$1;->$uiReady:Lia/n0;

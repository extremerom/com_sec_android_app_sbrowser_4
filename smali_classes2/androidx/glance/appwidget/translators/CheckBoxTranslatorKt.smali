...
.method public static final translateEmittableCheckBox(Landroid/widget/RemoteViews;Landroidx/glance/appwidget/TranslationContext;Landroidx/glance/appwidget/EmittableCheckBox;)V
    ...
    .param p1    # Landroidx/glance/appwidget/TranslationContext;
        ...
        .end annotation
    .end param
    .param p2    # Landroidx/glance/appwidget/EmittableCheckBox;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    :cond_0
    sget-object v2, Landroidx/glance/appwidget/LayoutType;->CheckBoxBackport:Landroidx/glance/appwidget/LayoutType;
    ...
    invoke-static {v11, v12, v2, v3}, Landroidx/glance/appwidget/LayoutSelectionKt;->insertView(Landroid/widget/RemoteViews;Landroidx/glance/appwidget/TranslationContext;Landroidx/glance/appwidget/LayoutType;Landroidx/glance/GlanceModifier;)Landroidx/glance/appwidget/InsertedViewInfo;
    ...
    invoke-virtual {v1, v11, v0, v2}, Landroidx/glance/appwidget/translators/CompoundButtonApi31Impl;->setCompoundButtonChecked(Landroid/widget/RemoteViews;IZ)V
    ...
    invoke-static {v1, v2}, Landroidx/glance/appwidget/translators/CompoundButtonTranslatorKt;->toDayNightColorStateList(Landroidx/glance/appwidget/unit/CheckedUncheckedColorProvider;Landroid/content/Context;)Landroidx/glance/appwidget/translators/DayNightColorStateList;
    ...
    invoke-static {v11, v0, v2, v1}, Landroidx/core/widget/RemoteViewsCompat;->setCompoundButtonTintList(Landroid/widget/RemoteViews;ILandroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v11, v0, v1}, Landroidx/core/widget/RemoteViewsCompat;->setCompoundButtonTintList(Landroid/widget/RemoteViews;II)V
    ...
    :cond_3
    sget v2, Landroidx/glance/appwidget/R$id;->checkBoxIcon:I
    ...
    sget v2, Landroidx/glance/appwidget/R$id;->checkBoxText:I
    ...
    invoke-static {v11, v7, v2}, Landroidx/glance/appwidget/UtilsKt;->setViewEnabled(Landroid/widget/RemoteViews;IZ)V

    invoke-virtual/range {p2 .. p2}, Landroidx/glance/appwidget/EmittableCheckBox;->getColors()Landroidx/glance/appwidget/CheckBoxColors;

    move-result-object v2

    invoke-virtual {v2}, Landroidx/glance/appwidget/CheckBoxColors;->getCheckBox$glance_appwidget_release()Landroidx/glance/appwidget/unit/CheckableColorProvider;
    ...
    invoke-static {v2, v3, v4}, Landroidx/glance/appwidget/translators/CompoundButtonTranslatorKt;->getColor(Landroidx/glance/appwidget/unit/CheckableColorProvider;Landroid/content/Context;Z)J

    move-result-wide v2

    invoke-static {v11, v7, v2, v3}, Landroidx/glance/appwidget/translators/CompoundButtonTranslatorKt;->setImageViewColorFilter-mxwnekA(Landroid/widget/RemoteViews;IJ)V

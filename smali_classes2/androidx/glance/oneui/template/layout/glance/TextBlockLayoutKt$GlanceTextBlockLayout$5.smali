...
.method public constructor <init>(Landroidx/glance/oneui/template/TextBlockItem;Landroidx/glance/oneui/template/TextBlockItem;Landroidx/glance/unit/ColorProvider;LL8/n;LL8/n;)V
    ...
    iput-object p4, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$mainContent:LL8/n;

    iput-object p5, p0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$subContent:LL8/n;
...
.method public final invoke(Landroidx/glance/layout/RowScope;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v3, "androidx.glance.oneui.template.layout.glance.GlanceTextBlockLayout.<anonymous> (TextBlockLayout.kt:127)"
    ...
    new-instance v2, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5$1;

    iget-object v4, v0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$mainItem:Landroidx/glance/oneui/template/TextBlockItem;

    iget-object v5, v0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$mainContent:LL8/n;

    invoke-direct {v2, v4, v5}, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5$1;-><init>(Landroidx/glance/oneui/template/TextBlockItem;LL8/n;)V
    ...
    iget-object v2, v0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$mainItem:Landroidx/glance/oneui/template/TextBlockItem;

    invoke-virtual {v2}, Landroidx/glance/oneui/template/TextBlockItem;->getApplyInverseColor()Z

    move-result v2

    iget-object v3, v0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$subItem:Landroidx/glance/oneui/template/TextBlockItem;
    ...
    :cond_1
    iget-object v2, v0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$dividerColor:Landroidx/glance/unit/ColorProvider;

    const/16 v3, 0x46

    const/4 v4, 0x0

    invoke-static {v14, v2, v11, v3, v4}, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt;->GlanceDivider(ZLandroidx/glance/unit/ColorProvider;Landroidx/compose/runtime/Composer;II)V
    ...
    new-instance v2, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5$2;

    iget-object v3, v0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$subItem:Landroidx/glance/oneui/template/TextBlockItem;

    iget-object v0, v0, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5;->$subContent:LL8/n;

    invoke-direct {v2, v3, v0}, Landroidx/glance/oneui/template/layout/glance/TextBlockLayoutKt$GlanceTextBlockLayout$5$2;-><init>(Landroidx/glance/oneui/template/TextBlockItem;LL8/n;)V

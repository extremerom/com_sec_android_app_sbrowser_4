...
.method public static final SimpleComplicationTemplate(Landroidx/glance/oneui/template/legacy/SimpleTemplateItem;Landroidx/glance/action/Action;Ljava/lang/String;Landroidx/compose/runtime/Composer;II)V
    .locals 9
    .param p0    # Landroidx/glance/oneui/template/legacy/SimpleTemplateItem;
    ...
    invoke-virtual {v0}, Landroidx/glance/oneui/template/legacy/ComposableSingletons$SimpleComplicationTemplateKt;->getLambda-1$glance_oneui_template_release()LL8/n;
    ...
    invoke-static/range {v1 .. v6}, Landroidx/glance/oneui/template/legacy/SimpleComplicationTemplateKt;->WidgetLayoutSmall(Landroidx/glance/oneui/template/legacy/SimpleTemplateItem;Landroidx/glance/action/Action;Ljava/lang/String;Landroidx/compose/runtime/Composer;II)V
    ...
    invoke-static/range {v1 .. v6}, Landroidx/glance/oneui/template/legacy/SimpleComplicationTemplateKt;->WidgetLayoutTiny(Landroidx/glance/oneui/template/legacy/SimpleTemplateItem;Landroidx/glance/action/Action;Ljava/lang/String;Landroidx/compose/runtime/Composer;II)V
...
.method public static final SimpleComplicationTemplate(Ljava/util/List;Landroidx/glance/action/Action;Ljava/lang/String;Landroidx/compose/runtime/Composer;II)V
    ...
    invoke-virtual {v0}, Landroidx/glance/oneui/template/legacy/ComposableSingletons$SimpleComplicationTemplateKt;->getLambda-2$glance_oneui_template_release()LL8/n;
    ...
    invoke-static/range {v1 .. v6}, Landroidx/glance/oneui/template/legacy/SimpleComplicationTemplateKt;->WidgetLayoutSmall(Ljava/util/List;Landroidx/glance/action/Action;Ljava/lang/String;Landroidx/compose/runtime/Composer;II)V
...
.method private static final WidgetLayoutSmall(Landroidx/glance/oneui/template/legacy/SimpleTemplateItem;Landroidx/glance/action/Action;Ljava/lang/String;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string/jumbo v2, "templateName=simple, size=small dataType=single action="
...
.method private static final WidgetLayoutSmall(Ljava/util/List;Landroidx/glance/action/Action;Ljava/lang/String;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string/jumbo v2, "templateName=simple size=small dataType=multiple action="
...
.method private static final WidgetLayoutTiny(Landroidx/glance/oneui/template/legacy/SimpleTemplateItem;Landroidx/glance/action/Action;Ljava/lang/String;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string/jumbo v2, "templateName=simple size=tiny dataType=single action="

...
.method public declared-synchronized onFailed(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Landroid/net/http/HttpException;)V
    ...
    :cond_0
    :try_start_1
    invoke-static {p3}, Landroidx/core/app/b;->x(Ljava/lang/Object;)Z

    move-result p1

    if-eqz p1, :cond_1

    invoke-static {p3}, Landroidx/core/app/b;->h(Ljava/lang/Object;)Landroid/net/http/NetworkException;

    move-result-object p1

    invoke-static {p1}, Landroidx/core/app/b;->c(Landroid/net/http/NetworkException;)I
...
.method public declared-synchronized onRedirectReceived(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Ljava/lang/String;)V
    ...
    invoke-static {p2}, Landroidx/core/app/b;->d(Landroid/net/http/UrlResponseInfo;)I
    ...
    invoke-static {p2}, Landroidx/core/app/b;->n(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;

    move-result-object v3

    invoke-static {p2}, Landroidx/core/app/b;->f(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object p2

    invoke-static {p2}, Landroidx/core/app/b;->p(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
    ...
    invoke-static {p1}, Landroidx/core/app/b;->v(Landroid/net/http/UrlRequest;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    :cond_6
    :try_start_4
    invoke-static {p1}, Landroidx/core/app/b;->C(Landroid/net/http/UrlRequest;)V

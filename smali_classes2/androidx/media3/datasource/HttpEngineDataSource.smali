...
.field private contentTypePredicate:Lcom/google/common/base/u;
...
.method public constructor <init>(Landroid/net/http/HttpEngine;Ljava/util/concurrent/Executor;IIIZZLjava/lang/String;Landroidx/media3/datasource/HttpDataSource$RequestProperties;Lcom/google/common/base/u;Z)V
    .locals 1
    ...
    .param p9    # Landroidx/media3/datasource/HttpDataSource$RequestProperties;
        ...
        .end annotation
    .end param
    .param p10    # Lcom/google/common/base/u;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    .annotation build Landroidx/media3/common/util/UnstableApi;
    ...
    invoke-static {p1}, Landroidx/core/app/b;->g(Ljava/lang/Object;)Landroid/net/http/HttpEngine;
    ...
    iput-object p10, p0, Landroidx/media3/datasource/HttpEngineDataSource;->contentTypePredicate:Lcom/google/common/base/u;
...
.method private buildRequestBuilder(Landroidx/media3/datasource/DataSpec;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {v0, v1, v2, p2}, Landroidx/core/app/b;->i(Landroid/net/http/HttpEngine;Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;

    move-result-object p2

    iget v0, p0, Landroidx/media3/datasource/HttpEngineDataSource;->requestPriority:I

    invoke-static {p2, v0}, Landroidx/core/app/b;->k(Landroid/net/http/UrlRequest$Builder;I)Landroid/net/http/UrlRequest$Builder;

    move-result-object p2

    invoke-static {p2}, Landroidx/core/app/b;->j(Landroid/net/http/UrlRequest$Builder;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v3, v2}, Landroidx/core/app/b;->u(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, p1, v1, p2}, Landroidx/media3/datasource/HttpEngineDataSource$OpenException;-><init>(Ljava/lang/String;Landroidx/media3/datasource/DataSpec;II)V
    ...
    invoke-static {p2, v0}, Landroidx/core/app/b;->D(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p2, v0}, Landroidx/core/app/b;->t(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p2, v0}, Landroidx/core/app/b;->B(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p2, v0, p0}, Landroidx/core/app/b;->s(Landroid/net/http/UrlRequest$Builder;Landroid/net/http/UploadDataProvider;Ljava/util/concurrent/Executor;)V
...
.method private buildRequestWrapper(Landroidx/media3/datasource/DataSpec;)Landroidx/media3/datasource/HttpEngineDataSource$UrlRequestWrapper;
    ...
    invoke-static {p0}, Landroidx/core/app/b;->l(Landroid/net/http/UrlRequest$Builder;)Landroid/net/http/UrlRequest;
...
.method private static isCompressed(Landroid/net/http/UrlResponseInfo;)Z
    ...
    invoke-static {p0}, Landroidx/core/app/b;->f(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object p0

    invoke-static {p0}, Landroidx/core/app/b;->o(Landroid/net/http/HeaderBlock;)Ljava/util/List;
...
.method public getResponseCode()I
    ...
    invoke-static {v0}, Landroidx/core/app/b;->d(Landroid/net/http/UrlResponseInfo;)I
    ...
    invoke-static {p0}, Landroidx/core/app/b;->d(Landroid/net/http/UrlResponseInfo;)I
...
.method public getResponseHeaders()Ljava/util/Map;
    ...
    invoke-static {p0}, Landroidx/core/app/b;->p(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
...
.method public getUri()Landroid/net/Uri;
    ...
    :cond_0
    invoke-static {p0}, Landroidx/core/app/b;->z(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
...
.method public open(Landroidx/media3/datasource/DataSpec;)J
    ...
    invoke-static {v1}, Landroidx/core/app/b;->m(Ljava/lang/Object;)Landroid/net/http/UrlResponseInfo;

    move-result-object v1

    invoke-static {v1}, Landroidx/core/app/b;->d(Landroid/net/http/UrlResponseInfo;)I

    move-result v3

    invoke-static {v1}, Landroidx/core/app/b;->f(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object v4

    invoke-static {v4}, Landroidx/core/app/b;->p(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
    ...
    :cond_2
    iget-object v12, v0, Landroidx/media3/datasource/HttpEngineDataSource;->contentTypePredicate:Lcom/google/common/base/u;
    ...
    invoke-interface {v12, v13}, Lcom/google/common/base/u;->apply(Ljava/lang/Object;)Z
    ...
    invoke-static {v1}, Landroidx/core/app/b;->n(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;

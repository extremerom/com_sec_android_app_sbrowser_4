...
# static fields
.field private static final COMMA_JOINER:Lcom/google/common/base/q;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/media3/exoplayer/upstream/CmcdData;->COMMA_JOINER:Lcom/google/common/base/q;
...
.method public addToDataSpec(Landroidx/media3/datasource/DataSpec;)Landroidx/media3/datasource/DataSpec;
    ...
    invoke-virtual {v1, v0}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdObject;->populateCmcdDataMap(Lcom/google/common/collect/t;)V
    ...
    invoke-virtual {v1, v0}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdRequest;->populateCmcdDataMap(Lcom/google/common/collect/t;)V
    ...
    invoke-virtual {v1, v0}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdSession;->populateCmcdDataMap(Lcom/google/common/collect/t;)V
    ...
    invoke-virtual {v1, v0}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdStatus;->populateCmcdDataMap(Lcom/google/common/collect/t;)V
    ...
    invoke-virtual {v0, v2}, Lcom/google/common/collect/d;->get(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v3

    invoke-static {v3}, Ljava/util/Collections;->sort(Ljava/util/List;)V

    sget-object v4, Landroidx/media3/exoplayer/upstream/CmcdData;->COMMA_JOINER:Lcom/google/common/base/q;

    invoke-virtual {v4, v3}, Lcom/google/common/base/q;->b(Ljava/lang/Iterable;)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p0, v2, v3}, Lcom/google/common/collect/T;->b(Ljava/lang/Object;Ljava/lang/Object;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0}, Lcom/google/common/collect/T;->a()Lcom/google/common/collect/G0;
    ...
    invoke-virtual {v0}, Lcom/google/common/collect/s;->a()Ljava/util/Map;
    ...
    sget-object v1, Landroidx/media3/exoplayer/upstream/CmcdData;->COMMA_JOINER:Lcom/google/common/base/q;

    invoke-virtual {v1, p0}, Lcom/google/common/base/q;->b(Ljava/lang/Iterable;)Ljava/lang/String;

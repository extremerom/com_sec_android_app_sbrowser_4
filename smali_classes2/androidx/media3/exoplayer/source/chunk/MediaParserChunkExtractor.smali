...
.method public constructor <init>(ILandroidx/media3/common/Format;Ljava/util/List;Landroidx/media3/exoplayer/analytics/PlayerId;)V
    ...
    invoke-static {p1, v0}, Landroidx/media3/exoplayer/source/f;->n(Ljava/lang/String;Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;)Landroid/media/MediaParser;
    ...
    invoke-static {p1}, Landroidx/media3/exoplayer/source/f;->A(Landroid/media/MediaParser;)V

    invoke-static {p1}, Landroidx/media3/exoplayer/source/f;->y(Landroid/media/MediaParser;)V

    invoke-static {p1}, Landroidx/media3/exoplayer/source/f;->z(Landroid/media/MediaParser;)V

    invoke-static {p1}, Landroidx/media3/exoplayer/source/f;->q(Landroid/media/MediaParser;)V

    invoke-static {p1}, Landroidx/media3/exoplayer/source/f;->B(Landroid/media/MediaParser;)V

    invoke-static {p1}, Landroidx/media3/exoplayer/source/f;->C(Landroid/media/MediaParser;)V

    invoke-static {p1}, Landroidx/media3/exoplayer/source/f;->D(Landroid/media/MediaParser;)V
    ...
    invoke-static {p2, p1}, Landroidx/media3/exoplayer/source/f;->t(Landroid/media/MediaParser;Ljava/util/ArrayList;)V
...
.method private maybeExecutePendingSeek()V
    ...
    invoke-static {v0, v1, v2}, Landroidx/media3/exoplayer/source/f;->o(Landroid/media/MediaParser$SeekMap;J)Landroid/util/Pair;

    move-result-object v0

    iget-object v0, v0, Landroid/util/Pair;->first:Ljava/lang/Object;

    invoke-static {v0}, Landroidx/media3/exoplayer/source/f;->l(Ljava/lang/Object;)Landroid/media/MediaParser$SeekPoint;

    move-result-object v0

    invoke-static {v5, v0}, Landroidx/media3/exoplayer/source/f;->r(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekPoint;)V
...
.method public read(Landroidx/media3/extractor/ExtractorInput;)Z
    ...
    invoke-static {p1, p0}, Landroidx/core/view/t;->p(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekableInputReader;)Z

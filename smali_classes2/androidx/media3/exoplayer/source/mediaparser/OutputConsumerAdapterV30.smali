...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Landroidx/media3/exoplayer/source/f;->k()Landroid/media/MediaParser$SeekPoint;
...
.method private static toExoPlayerDrmInitData(Ljava/lang/String;Landroid/media/DrmInitData;)Landroidx/media3/common/DrmInitData;
    ...
    :cond_0
    invoke-static {p1}, Landroidx/media3/exoplayer/source/f;->b(Landroid/media/DrmInitData;)I
    ...
    invoke-static {p1, v2}, Landroidx/media3/exoplayer/source/f;->g(Landroid/media/DrmInitData;I)Landroid/media/DrmInitData$SchemeInitData;

    move-result-object v3

    new-instance v4, Landroidx/media3/common/DrmInitData$SchemeData;

    invoke-static {v3}, Landroidx/media3/exoplayer/source/f;->p(Landroid/media/DrmInitData$SchemeInitData;)Ljava/util/UUID;
...
.method private toExoPlayerFormat(Landroid/media/MediaParser$TrackData;)Landroidx/media3/common/Format;
    ...
    invoke-static {p1}, Landroidx/media3/exoplayer/source/f;->i(Landroid/media/MediaParser$TrackData;)Landroid/media/MediaFormat;
    ...
    invoke-static {p1}, Landroidx/media3/exoplayer/source/f;->h(Landroid/media/MediaParser$TrackData;)Landroid/media/DrmInitData;
...
.method public getSeekPoints(J)Landroid/util/Pair;
    ...
    invoke-static {p0, p1, p2}, Landroidx/media3/exoplayer/source/f;->o(Landroid/media/MediaParser$SeekMap;J)Landroid/util/Pair;
...
.method public onSampleDataFound(ILandroid/media/MediaParser$InputReader;)V
    ...
    invoke-static {p2}, Landroidx/media3/exoplayer/source/f;->d(Landroid/media/MediaParser$InputReader;)J
...
.method public onSeekMapFound(Landroid/media/MediaParser$SeekMap;)V
    ...
    invoke-static {p1}, Landroidx/media3/exoplayer/source/f;->e(Landroid/media/MediaParser$SeekMap;)J
...
.method public onTrackDataFound(ILandroid/media/MediaParser$TrackData;)V
    ...
    invoke-static {p2}, Landroidx/media3/exoplayer/source/f;->i(Landroid/media/MediaParser$TrackData;)Landroid/media/MediaFormat;

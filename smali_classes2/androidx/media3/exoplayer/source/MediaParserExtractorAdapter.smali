...
.method private constructor <init>(Landroidx/media3/exoplayer/analytics/PlayerId;Ljava/util/Map;)V
    ...
    invoke-static {v0, v1}, Landroidx/media3/exoplayer/source/f;->m(Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;[Ljava/lang/String;)Landroid/media/MediaParser;
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/source/f;->q(Landroid/media/MediaParser;)V

    invoke-static {v0}, Landroidx/media3/exoplayer/source/f;->y(Landroid/media/MediaParser;)V

    invoke-static {v0}, Landroidx/media3/exoplayer/source/f;->z(Landroid/media/MediaParser;)V
    ...
    invoke-static {v1, v2, v0}, Landroidx/core/view/t;->j(Landroid/media/MediaParser;Ljava/lang/String;Ljava/lang/Object;)V
...
.method private static synthetic lambda$static$0(Landroidx/media3/exoplayer/analytics/PlayerId;)Landroidx/media3/exoplayer/source/ProgressiveMediaExtractor;
    ...
    sget-object v1, Lcom/google/common/collect/G0;->g:Lcom/google/common/collect/G0;
...
.method public init(Landroidx/media3/common/DataReader;Landroid/net/Uri;Ljava/util/Map;JJLandroidx/media3/extractor/ExtractorOutput;)V
    ...
    invoke-static {p1}, Landroidx/core/view/t;->h(Landroid/media/MediaParser;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Landroidx/media3/exoplayer/source/f;->s(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekableInputReader;)V
...
.method public read(Landroidx/media3/extractor/PositionHolder;)I
    ...
    invoke-static {v0, v1}, Landroidx/core/view/t;->p(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekableInputReader;)Z
...
.method public release()V
    ...
    invoke-static {p0}, Landroidx/core/view/t;->i(Landroid/media/MediaParser;)V
...
.method public seek(JJ)V
    ...
    invoke-static {p4}, Landroidx/media3/exoplayer/source/f;->l(Ljava/lang/Object;)Landroid/media/MediaParser$SeekPoint;

    move-result-object p4

    invoke-static {p4}, Landroidx/media3/exoplayer/source/f;->f(Landroid/media/MediaParser$SeekPoint;)J
    ...
    :goto_0
    invoke-static {p1}, Landroidx/media3/exoplayer/source/f;->l(Ljava/lang/Object;)Landroid/media/MediaParser$SeekPoint;
    ...
    :goto_1
    invoke-static {p0, p1}, Landroidx/media3/exoplayer/source/f;->r(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekPoint;)V

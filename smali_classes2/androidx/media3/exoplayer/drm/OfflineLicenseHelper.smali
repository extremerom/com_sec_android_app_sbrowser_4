...
.method public static synthetic a(Landroidx/media3/exoplayer/drm/DrmSession;Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/I;)V
    .locals 0

    invoke-direct {p1, p0, p2}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$acquireFirstSessionOnHandlerThread$3(Landroidx/media3/exoplayer/drm/DrmSession;Lcom/google/common/util/concurrent/I;)V
...
.method private acquireFirstSessionOnHandlerThread(I[BLandroidx/media3/common/Format;)Landroidx/media3/exoplayer/drm/DrmSession;
    ...
    iget-object v8, p0, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->handler:Landroid/os/Handler;
    ...
    invoke-direct/range {v1 .. v7}, LQ6/g;-><init>(Ljava/lang/Object;ILjava/io/Serializable;Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    invoke-direct {v0, p1, p0, p2}, Landroidx/media3/exoplayer/drm/j;-><init>(Landroidx/media3/exoplayer/drm/DrmSession;Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/I;)V

    invoke-virtual {p3, v0}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    :try_start_1
    invoke-virtual {p2}, Lcom/google/common/util/concurrent/o;->get()Ljava/lang/Object;
...
.method private acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread(I[BLandroidx/media3/common/Format;)[B
    ...
    invoke-direct {v0, p0, p2, p1, v1}, Landroidx/media3/exoplayer/drm/j;-><init>(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/I;Landroidx/media3/exoplayer/drm/DrmSession;I)V
...
.method public static synthetic b(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/I;)V
    .locals 0

    invoke-direct {p0, p1}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$releaseManagerOnHandlerThread$4(Lcom/google/common/util/concurrent/I;)V

    return-void
.end method

.method public static synthetic c(Landroidx/media3/exoplayer/drm/DrmSession;Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/I;)V
    .locals 0

    invoke-direct {p1, p2, p0}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread$1(Lcom/google/common/util/concurrent/I;Landroidx/media3/exoplayer/drm/DrmSession;)V

    return-void
.end method

.method public static synthetic d(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;I[BLcom/google/common/util/concurrent/I;Landroidx/media3/common/Format;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$acquireFirstSessionOnHandlerThread$2(I[BLcom/google/common/util/concurrent/I;Landroidx/media3/common/Format;)V

    return-void
.end method

.method public static synthetic e(Landroidx/media3/exoplayer/drm/DrmSession;Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/I;)V
    .locals 0

    invoke-direct {p1, p2, p0}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$getLicenseDurationRemainingSec$0(Lcom/google/common/util/concurrent/I;Landroidx/media3/exoplayer/drm/DrmSession;)V

    return-void
.end method

.method private synthetic lambda$acquireFirstSessionOnHandlerThread$2(I[BLcom/google/common/util/concurrent/I;Landroidx/media3/common/Format;)V
    .locals 3
    ...
    invoke-virtual {p3, p1}, Lcom/google/common/util/concurrent/o;->k(Ljava/lang/Object;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {p3, p0}, Lcom/google/common/util/concurrent/o;->l(Ljava/lang/Throwable;)Z

    :goto_0
    return-void
.end method

.method private synthetic lambda$acquireFirstSessionOnHandlerThread$3(Landroidx/media3/exoplayer/drm/DrmSession;Lcom/google/common/util/concurrent/I;)V
    .locals 3
    ...
    :cond_0
    :goto_0
    invoke-virtual {p2, v0}, Lcom/google/common/util/concurrent/o;->k(Ljava/lang/Object;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_1
    invoke-virtual {p2, v0}, Lcom/google/common/util/concurrent/o;->l(Ljava/lang/Throwable;)Z
...
.method private synthetic lambda$acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread$1(Lcom/google/common/util/concurrent/I;Landroidx/media3/exoplayer/drm/DrmSession;)V
    .locals 1
    ...
    invoke-virtual {p1, v0}, Lcom/google/common/util/concurrent/o;->k(Ljava/lang/Object;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_1
    invoke-virtual {p1, v0}, Lcom/google/common/util/concurrent/o;->l(Ljava/lang/Throwable;)Z
    :try_end_1
...
.method private synthetic lambda$getLicenseDurationRemainingSec$0(Lcom/google/common/util/concurrent/I;Landroidx/media3/exoplayer/drm/DrmSession;)V
    .locals 1
...
.method private synthetic lambda$releaseManagerOnHandlerThread$4(Lcom/google/common/util/concurrent/I;)V
    .locals 0
    ...
    invoke-virtual {p1, p0}, Lcom/google/common/util/concurrent/o;->k(Ljava/lang/Object;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized getLicenseDurationRemainingSec([B)Landroid/util/Pair;
    ...
    invoke-direct {v2, p0, v0, p1, v3}, Landroidx/media3/exoplayer/drm/j;-><init>(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/I;Landroidx/media3/exoplayer/drm/DrmSession;I)V

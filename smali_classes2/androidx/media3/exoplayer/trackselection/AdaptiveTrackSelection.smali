...
# instance fields
.field private final adaptationCheckpoints:Lcom/google/common/collect/P;
...
.method public constructor <init>(Landroidx/media3/common/TrackGroup;[IILandroidx/media3/exoplayer/upstream/BandwidthMeter;JJJIIFFLjava/util/List;Landroidx/media3/common/util/Clock;)V
    ...
    invoke-static/range {p15 .. p15}, Lcom/google/common/collect/P;->t(Ljava/util/Collection;)Lcom/google/common/collect/P;

    move-result-object v1

    iput-object v1, v0, Landroidx/media3/exoplayer/trackselection/AdaptiveTrackSelection;->adaptationCheckpoints:Lcom/google/common/collect/P;
...
.method public constructor <init>(Landroidx/media3/common/TrackGroup;[ILandroidx/media3/exoplayer/upstream/BandwidthMeter;)V
    ...
    sget-object v16, Lcom/google/common/collect/B0;->e:Lcom/google/common/collect/B0;
...
.method public static synthetic access$000([Landroidx/media3/exoplayer/trackselection/ExoTrackSelection$Definition;)Lcom/google/common/collect/P;
    .locals 0

    invoke-static {p0}, Landroidx/media3/exoplayer/trackselection/AdaptiveTrackSelection;->getAdaptationCheckpoints([Landroidx/media3/exoplayer/trackselection/ExoTrackSelection$Definition;)Lcom/google/common/collect/P;
...
.method private static addCheckpoint(Ljava/util/List;[J)V
    ...
    check-cast v3, Lcom/google/common/collect/M;
    ...
    invoke-virtual {v3, v4}, Lcom/google/common/collect/J;->a(Ljava/lang/Object;)V
...
.method private static getAdaptationCheckpoints([Landroidx/media3/exoplayer/trackselection/ExoTrackSelection$Definition;)Lcom/google/common/collect/P;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    invoke-static {}, Lcom/google/common/collect/P;->s()Lcom/google/common/collect/M;
    ...
    invoke-virtual {v3, v4}, Lcom/google/common/collect/M;->c(Ljava/lang/Object;)V
    ...
    invoke-static {v2}, Landroidx/media3/exoplayer/trackselection/AdaptiveTrackSelection;->getSwitchOrder([[J)Lcom/google/common/collect/P;
    ...
    check-cast v2, Lcom/google/common/collect/M;
    ...
    :cond_7
    invoke-virtual {v2}, Lcom/google/common/collect/M;->g()Lcom/google/common/collect/B0;

    move-result-object v2

    :goto_7
    invoke-virtual {p0, v2}, Lcom/google/common/collect/M;->c(Ljava/lang/Object;)V
...
.method private getAllocatedBandwidth(J)J
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/trackselection/AdaptiveTrackSelection;->adaptationCheckpoints:Lcom/google/common/collect/P;
    ...
    :goto_0
    iget-object v2, p0, Landroidx/media3/exoplayer/trackselection/AdaptiveTrackSelection;->adaptationCheckpoints:Lcom/google/common/collect/P;
    ...
    iget-object p0, p0, Landroidx/media3/exoplayer/trackselection/AdaptiveTrackSelection;->adaptationCheckpoints:Lcom/google/common/collect/P;
...
.method private getLastChunkDurationUs(Ljava/util/List;)J
    ...
    :cond_0
    invoke-static {p1}, Lcom/google/common/collect/w;->k(Ljava/lang/Iterable;)Ljava/lang/Object;
...
.method private static getSwitchOrder([[J)Lcom/google/common/collect/P;
    .locals 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([[J)",
    ...
    invoke-static {v2, v1}, Lcom/google/common/collect/w;->d(ILjava/lang/String;)V
    ...
    invoke-direct {v2, v1}, Lcom/google/common/collect/d;-><init>(Ljava/util/Map;)V

    iput-object v0, v2, Lcom/google/common/collect/x0;->g:Lcom/google/common/collect/v0;
    ...
    invoke-virtual {v2, v10, v11}, Lcom/google/common/collect/d;->put(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :cond_5
    invoke-virtual {v2}, Lcom/google/common/collect/s;->values()Ljava/util/Collection;

    move-result-object p0

    invoke-static {p0}, Lcom/google/common/collect/P;->t(Ljava/util/Collection;)Lcom/google/common/collect/P;
...
.method public evaluateQueueSize(JLjava/util/List;)I
    ...
    :cond_1
    invoke-static {p3}, Lcom/google/common/collect/w;->k(Ljava/lang/Iterable;)Ljava/lang/Object;
...
.method public updateSelectedTrack(JJJLjava/util/List;[Landroidx/media3/exoplayer/source/chunk/MediaChunkIterator;)V
    ...
    :cond_1
    invoke-static {p7}, Lcom/google/common/collect/w;->k(Ljava/lang/Iterable;)Ljava/lang/Object;

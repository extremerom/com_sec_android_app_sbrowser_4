...
.method public static create(Landroid/content/Context;)Landroidx/media3/exoplayer/analytics/MediaMetricsListener;
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/analytics/x;->a(Ljava/lang/Object;)Landroid/media/metrics/MediaMetricsManager;
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/analytics/x;->l(Landroid/media/metrics/MediaMetricsManager;)Landroid/media/metrics/PlaybackSession;
...
.method private finishCurrentSession()V
    ...
    invoke-static {v0, v2}, Landroidx/media3/exoplayer/analytics/x;->A(Landroid/media/metrics/PlaybackMetrics$Builder;I)V

    iget-object v0, p0, Landroidx/media3/exoplayer/analytics/MediaMetricsListener;->metricsBuilder:Landroid/media/metrics/PlaybackMetrics$Builder;

    iget v2, p0, Landroidx/media3/exoplayer/analytics/MediaMetricsListener;->droppedFrames:I

    invoke-static {v0, v2}, Landroidx/media3/exoplayer/analytics/x;->B(Landroid/media/metrics/PlaybackMetrics$Builder;I)V

    iget-object v0, p0, Landroidx/media3/exoplayer/analytics/MediaMetricsListener;->metricsBuilder:Landroid/media/metrics/PlaybackMetrics$Builder;

    iget v2, p0, Landroidx/media3/exoplayer/analytics/MediaMetricsListener;->playedFrames:I

    invoke-static {v0, v2}, Landroidx/media3/exoplayer/analytics/x;->C(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
    ...
    :goto_0
    invoke-static {v2, v5, v6}, Landroidx/media3/exoplayer/analytics/x;->v(Landroid/media/metrics/PlaybackMetrics$Builder;J)V
    ...
    :goto_1
    invoke-static {v2, v5, v6}, Landroidx/media3/exoplayer/analytics/x;->z(Landroid/media/metrics/PlaybackMetrics$Builder;J)V
    ...
    :goto_2
    invoke-static {v2, v0}, Landroidx/media3/exoplayer/analytics/x;->D(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
    ...
    invoke-static {v2}, Landroidx/media3/exoplayer/analytics/x;->k(Landroid/media/metrics/PlaybackMetrics$Builder;)Landroid/media/metrics/PlaybackMetrics;

    move-result-object v2

    invoke-static {v0, v2}, Landroidx/media3/exoplayer/analytics/y;->t(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/PlaybackMetrics;)V
...
.method private static getDrmInitData(Lcom/google/common/collect/P;)Landroidx/media3/common/DrmInitData;
    .locals 4
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method private maybeReportNetworkChange(J)V
    ...
    invoke-static {}, Landroidx/media3/exoplayer/analytics/y;->g()Landroid/media/metrics/NetworkEvent$Builder;

    move-result-object v2

    invoke-static {v2, v0}, Landroidx/media3/exoplayer/analytics/x;->b(Landroid/media/metrics/NetworkEvent$Builder;I)Landroid/media/metrics/NetworkEvent$Builder;
    ...
    invoke-static {v0, p1, p2}, Landroidx/media3/exoplayer/analytics/x;->c(Landroid/media/metrics/NetworkEvent$Builder;J)Landroid/media/metrics/NetworkEvent$Builder;

    move-result-object p0

    invoke-static {p0}, Landroidx/media3/exoplayer/analytics/x;->d(Landroid/media/metrics/NetworkEvent$Builder;)Landroid/media/metrics/NetworkEvent;

    move-result-object p0

    invoke-static {v1, p0}, Landroidx/media3/exoplayer/analytics/x;->o(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/NetworkEvent;)V
...
.method private maybeReportPlaybackError(J)V
    ...
    invoke-static {}, Landroidx/media3/exoplayer/analytics/y;->h()Landroid/media/metrics/PlaybackErrorEvent$Builder;
    ...
    invoke-static {v3, p1, p2}, Landroidx/media3/exoplayer/analytics/x;->f(Landroid/media/metrics/PlaybackErrorEvent$Builder;J)Landroid/media/metrics/PlaybackErrorEvent$Builder;

    move-result-object p1

    iget p2, v1, Landroidx/media3/exoplayer/analytics/MediaMetricsListener$ErrorInfo;->errorCode:I

    invoke-static {p1, p2}, Landroidx/media3/exoplayer/analytics/x;->e(Landroid/media/metrics/PlaybackErrorEvent$Builder;I)Landroid/media/metrics/PlaybackErrorEvent$Builder;

    move-result-object p1

    iget p2, v1, Landroidx/media3/exoplayer/analytics/MediaMetricsListener$ErrorInfo;->subErrorCode:I

    invoke-static {p1, p2}, Landroidx/media3/exoplayer/analytics/x;->s(Landroid/media/metrics/PlaybackErrorEvent$Builder;I)Landroid/media/metrics/PlaybackErrorEvent$Builder;

    move-result-object p1

    invoke-static {p1, v0}, Landroidx/media3/exoplayer/analytics/x;->g(Landroid/media/metrics/PlaybackErrorEvent$Builder;Ljava/lang/Exception;)Landroid/media/metrics/PlaybackErrorEvent$Builder;

    move-result-object p1

    invoke-static {p1}, Landroidx/media3/exoplayer/analytics/x;->h(Landroid/media/metrics/PlaybackErrorEvent$Builder;)Landroid/media/metrics/PlaybackErrorEvent;

    move-result-object p1

    invoke-static {v2, p1}, Landroidx/media3/exoplayer/analytics/x;->p(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/PlaybackErrorEvent;)V
...
.method private maybeReportPlaybackStateChange(Landroidx/media3/common/Player;Landroidx/media3/exoplayer/analytics/AnalyticsListener$Events;J)V
    ...
    invoke-static {}, Landroidx/media3/exoplayer/analytics/y;->j()Landroid/media/metrics/PlaybackStateEvent$Builder;

    move-result-object p2

    iget v0, p0, Landroidx/media3/exoplayer/analytics/MediaMetricsListener;->currentPlaybackState:I

    invoke-static {p2, v0}, Landroidx/media3/exoplayer/analytics/y;->k(Landroid/media/metrics/PlaybackStateEvent$Builder;I)Landroid/media/metrics/PlaybackStateEvent$Builder;
    ...
    invoke-static {p2, p3, p4}, Landroidx/media3/exoplayer/analytics/y;->l(Landroid/media/metrics/PlaybackStateEvent$Builder;J)Landroid/media/metrics/PlaybackStateEvent$Builder;

    move-result-object p0

    invoke-static {p0}, Landroidx/media3/exoplayer/analytics/y;->m(Landroid/media/metrics/PlaybackStateEvent$Builder;)Landroid/media/metrics/PlaybackStateEvent;

    move-result-object p0

    invoke-static {p1, p0}, Landroidx/media3/exoplayer/analytics/y;->u(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/PlaybackStateEvent;)V
...
.method private maybeUpdateMetricsBuilderValues(Landroidx/media3/common/Player;Landroidx/media3/exoplayer/analytics/AnalyticsListener$Events;)V
    ...
    invoke-static {p1}, Landroidx/media3/exoplayer/analytics/MediaMetricsListener;->getDrmInitData(Lcom/google/common/collect/P;)Landroidx/media3/common/DrmInitData;
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/analytics/x;->j(Ljava/lang/Object;)Landroid/media/metrics/PlaybackMetrics$Builder;
    ...
    invoke-static {v0, p1}, Landroidx/media3/exoplayer/analytics/x;->y(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
...
.method private maybeUpdateTimelineMetadata(Landroidx/media3/common/Timeline;Landroidx/media3/exoplayer/source/MediaSource$MediaPeriodId;)V
    ...
    invoke-static {v0, p1}, Landroidx/media3/exoplayer/analytics/x;->m(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
    ...
    invoke-static {v0, p1, p2}, Landroidx/media3/exoplayer/analytics/x;->n(Landroid/media/metrics/PlaybackMetrics$Builder;J)V
    ...
    :goto_0
    invoke-static {v0, p1}, Landroidx/media3/exoplayer/analytics/x;->u(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
...
.method private reportTrackChangeEvent(IJLandroidx/media3/common/Format;I)V
    ...
    invoke-static {p1}, Landroidx/media3/exoplayer/analytics/y;->n(I)Landroid/media/metrics/TrackChangeEvent$Builder;
    ...
    invoke-static {p1, p2, p3}, Landroidx/core/view/b;->f(Landroid/media/metrics/TrackChangeEvent$Builder;J)Landroid/media/metrics/TrackChangeEvent$Builder;

    move-result-object p1

    if-eqz p4, :cond_9

    invoke-static {p1}, Landroidx/media3/exoplayer/analytics/y;->D(Landroid/media/metrics/TrackChangeEvent$Builder;)V

    invoke-static {p5}, Landroidx/media3/exoplayer/analytics/MediaMetricsListener;->getTrackChangeReason(I)I

    move-result p2

    invoke-static {p1, p2}, Landroidx/media3/exoplayer/analytics/y;->y(Landroid/media/metrics/TrackChangeEvent$Builder;I)V

    iget-object p2, p4, Landroidx/media3/common/Format;->containerMimeType:Ljava/lang/String;

    if-eqz p2, :cond_0

    invoke-static {p1, p2}, Landroidx/core/view/b;->o(Landroid/media/metrics/TrackChangeEvent$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Landroidx/core/view/b;->D(Landroid/media/metrics/TrackChangeEvent$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Landroidx/core/view/b;->n(Landroid/media/metrics/TrackChangeEvent$Builder;I)V
    ...
    invoke-static {p1, p2}, Landroidx/core/view/b;->A(Landroid/media/metrics/TrackChangeEvent$Builder;I)V
    ...
    invoke-static {p1, p2}, Landroidx/core/view/b;->C(Landroid/media/metrics/TrackChangeEvent$Builder;I)V
    ...
    invoke-static {p1, p2}, Landroidx/media3/exoplayer/analytics/x;->q(Landroid/media/metrics/TrackChangeEvent$Builder;I)V
    ...
    invoke-static {p1, p2}, Landroidx/media3/exoplayer/analytics/x;->w(Landroid/media/metrics/TrackChangeEvent$Builder;I)V
    ...
    invoke-static {p1, p3}, Landroidx/media3/exoplayer/analytics/x;->r(Landroid/media/metrics/TrackChangeEvent$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Landroidx/media3/exoplayer/analytics/x;->x(Landroid/media/metrics/TrackChangeEvent$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Landroidx/media3/exoplayer/analytics/y;->x(Landroid/media/metrics/TrackChangeEvent$Builder;F)V

    goto :goto_0

    :cond_9
    invoke-static {p1}, Landroidx/media3/exoplayer/analytics/y;->w(Landroid/media/metrics/TrackChangeEvent$Builder;)V
    ...
    invoke-static {p1}, Landroidx/media3/exoplayer/analytics/y;->o(Landroid/media/metrics/TrackChangeEvent$Builder;)Landroid/media/metrics/TrackChangeEvent;

    move-result-object p1

    invoke-static {p0, p1}, Landroidx/media3/exoplayer/analytics/y;->v(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/TrackChangeEvent;)V
...
.method public getLogSessionId()Landroid/media/metrics/LogSessionId;
    ...
    invoke-static {p0}, Landroidx/media3/exoplayer/analytics/y;->f(Landroid/media/metrics/PlaybackSession;)Landroid/media/metrics/LogSessionId;
...
.method public onSessionActive(Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;Ljava/lang/String;)V
    ...
    invoke-static {}, Landroidx/media3/exoplayer/analytics/y;->i()Landroid/media/metrics/PlaybackMetrics$Builder;

    move-result-object p2

    invoke-static {p2}, Landroidx/media3/exoplayer/analytics/x;->i(Landroid/media/metrics/PlaybackMetrics$Builder;)Landroid/media/metrics/PlaybackMetrics$Builder;

    move-result-object p2

    invoke-static {p2}, Landroidx/media3/exoplayer/analytics/x;->t(Landroid/media/metrics/PlaybackMetrics$Builder;)Landroid/media/metrics/PlaybackMetrics$Builder;

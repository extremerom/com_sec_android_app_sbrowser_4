...
# virtual methods
.method public addObserver(Lorg/chromium/components/signin/identitymanager/IdentityManager$Observer;)V
    .locals 0
...
.method public findExtendedAccountInfoByEmailAddress(Ljava/lang/String;)Lorg/chromium/components/signin/base/AccountInfo;
    .locals 3
    ...
    invoke-interface {v0, v1, v2, p1}, Lorg/chromium/components/signin/identitymanager/IdentityManager$Natives;->findExtendedAccountInfoByEmailAddress(JLjava/lang/String;)Lorg/chromium/components/signin/base/AccountInfo;
...
.method public getPrimaryAccountInfo(I)Lorg/chromium/components/signin/base/CoreAccountInfo;
    .locals 3
    ...
    invoke-interface {v0, v1, v2, p1}, Lorg/chromium/components/signin/identitymanager/IdentityManager$Natives;->getPrimaryAccountInfo(JI)Lorg/chromium/components/signin/base/CoreAccountInfo;
...
.method public hasPrimaryAccount(I)Z
    .locals 0

    invoke-virtual {p0, p1}, Lorg/chromium/components/signin/identitymanager/IdentityManager;->getPrimaryAccountInfo(I)Lorg/chromium/components/signin/base/CoreAccountInfo;
...
.method public invalidateAccessToken(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lorg/chromium/components/signin/identitymanager/IdentityManager;->mProfileOAuth2TokenServiceDelegate:Lorg/chromium/components/signin/identitymanager/ProfileOAuth2TokenServiceDelegate;

    invoke-virtual {p0, p1}, Lorg/chromium/components/signin/identitymanager/ProfileOAuth2TokenServiceDelegate;->invalidateAccessToken(Ljava/lang/String;)V

    return-void
.end method

.method public isClearPrimaryAccountAllowed()Z
    .locals 3
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/components/signin/identitymanager/IdentityManager$Natives;->isClearPrimaryAccountAllowed(J)Z
...
.method public refreshAccountInfoIfStale(Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-wide v2, p0, Lorg/chromium/components/signin/identitymanager/IdentityManager;->mNativeIdentityManager:J
    ...
    invoke-interface {v1, v2, v3, v0}, Lorg/chromium/components/signin/identitymanager/IdentityManager$Natives;->refreshAccountInfoIfStale(JLorg/chromium/components/signin/base/CoreAccountId;)V
...
.method public removeObserver(Lorg/chromium/components/signin/identitymanager/IdentityManager$Observer;)V
    .locals 0
...
.method public setRefreshTokenUpdateObserverForTests(Lorg/chromium/base/Callback;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lorg/chromium/components/signin/identitymanager/IdentityManager;->mRefreshTokenUpdateObserver:Lorg/chromium/base/Callback;

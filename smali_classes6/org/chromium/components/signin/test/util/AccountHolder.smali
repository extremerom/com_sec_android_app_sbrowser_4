...
.method public constructor <init>(Lorg/chromium/components/signin/base/AccountInfo;)V
    ...
    iput-object v0, p0, Lorg/chromium/components/signin/test/util/AccountHolder;->mAccessTokens:Ljava/util/Map;

    iput-object p1, p0, Lorg/chromium/components/signin/test/util/AccountHolder;->mAccountInfo:Lorg/chromium/components/signin/base/AccountInfo;
...
.method public getAccountCapabilities()Lorg/chromium/components/signin/base/AccountCapabilities;
    ...
    invoke-virtual {p0}, Lorg/chromium/components/signin/base/AccountInfo;->getAccountCapabilities()Lorg/chromium/components/signin/base/AccountCapabilities;
...
.method public setAccountCapabilities(Lorg/chromium/components/signin/base/AccountCapabilities;)V
    .locals 2

    invoke-static {}, Lorg/chromium/base/ThreadUtils;->checkUiThread()V

    iget-object v0, p0, Lorg/chromium/components/signin/test/util/AccountHolder;->mAccountInfo:Lorg/chromium/components/signin/base/AccountInfo;

    new-instance v1, Lorg/chromium/components/signin/base/AccountInfo$Builder;

    invoke-direct {v1, v0}, Lorg/chromium/components/signin/base/AccountInfo$Builder;-><init>(Lorg/chromium/components/signin/base/AccountInfo;)V

    invoke-virtual {v1, p1}, Lorg/chromium/components/signin/base/AccountInfo$Builder;->accountCapabilities(Lorg/chromium/components/signin/base/AccountCapabilities;)Lorg/chromium/components/signin/base/AccountInfo$Builder;

    move-result-object p1

    invoke-virtual {p1}, Lorg/chromium/components/signin/base/AccountInfo$Builder;->build()Lorg/chromium/components/signin/base/AccountInfo;

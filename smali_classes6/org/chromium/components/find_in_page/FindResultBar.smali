...
.field private static final VISIBILITY_ANIMATION_DURATION_MS:I = 0xc8
...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/FrameLayout;Lorg/chromium/ui/base/WindowAndroid;Lorg/chromium/components/find_in_page/FindInPageBridge;)V
    .locals 6
    ...
    iput v0, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mRectsVersion:I

    const/4 v1, 0x0

    new-array v2, v1, [Landroid/graphics/RectF;

    iput-object v2, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mMatches:[Landroid/graphics/RectF;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2, v1}, Ljava/util/ArrayList;-><init>(I)V

    iput-object v2, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mTickmarks:Ljava/util/ArrayList;
    ...
    sget v3, Lorg/chromium/components/find_in_page/R$color;->find_result_bar_background_color:I

    invoke-virtual {p1, v3}, Landroid/content/Context;->getColor(I)I

    move-result v3

    iput v3, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mBackgroundColor:I

    sget v3, Lorg/chromium/components/find_in_page/R$color;->find_result_bar_background_border_color:I

    invoke-virtual {p1, v3}, Landroid/content/Context;->getColor(I)I

    move-result v3

    iput v3, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mBackgroundBorderColor:I

    sget v3, Lorg/chromium/components/find_in_page/R$color;->find_result_bar_result_color:I

    invoke-virtual {p1, v3}, Landroid/content/Context;->getColor(I)I

    move-result v3

    iput v3, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mResultColor:I

    sget v3, Lorg/chromium/components/find_in_page/R$color;->find_result_bar_result_border_color:I

    invoke-virtual {p1, v3}, Landroid/content/Context;->getColor(I)I

    move-result v3

    iput v3, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mResultBorderColor:I

    sget v3, Lorg/chromium/components/find_in_page/R$color;->find_result_bar_active_color:I

    invoke-virtual {p1, v3}, Landroid/content/Context;->getColor(I)I

    move-result v3

    iput v3, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mActiveColor:I

    sget v3, Lorg/chromium/components/find_in_page/R$color;->find_result_bar_active_border_color:I

    invoke-virtual {p1, v3}, Landroid/content/Context;->getColor(I)I

    move-result p1

    iput p1, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mActiveBorderColor:I

    sget p1, Lorg/chromium/components/find_in_page/R$dimen;->find_result_bar_touch_width:I

    invoke-virtual {v2, p1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result p1

    iput p1, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mBarTouchWidth:I

    sget v3, Lorg/chromium/components/find_in_page/R$dimen;->find_result_bar_draw_width:I

    invoke-virtual {v2, v3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    sget v4, Lorg/chromium/components/find_in_page/R$dimen;->find_result_bar_separator_width:I
    ...
    iput v4, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mBarDrawWidth:I

    sget v3, Lorg/chromium/components/find_in_page/R$dimen;->find_result_bar_result_min_height:I

    invoke-virtual {v2, v3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    iput v3, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mResultMinHeight:I

    sget v3, Lorg/chromium/components/find_in_page/R$dimen;->find_result_bar_active_min_height:I

    invoke-virtual {v2, v3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    iput v3, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mActiveMinHeight:I

    sget v3, Lorg/chromium/components/find_in_page/R$dimen;->find_result_bar_vertical_padding:I

    invoke-virtual {v2, v3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    iput v3, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mBarVerticalPadding:I

    sget v3, Lorg/chromium/components/find_in_page/R$dimen;->find_result_bar_min_gap_between_stacks:I

    invoke-virtual {v2, v3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    iput v3, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mMinGapBetweenStacks:I

    sget v3, Lorg/chromium/components/find_in_page/R$dimen;->find_result_bar_stacked_result_height:I

    invoke-virtual {v2, v3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v2

    iput v2, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mStackedResultHeight:I

    new-instance v2, Landroid/graphics/Paint;

    invoke-direct {v2}, Landroid/graphics/Paint;-><init>()V

    iput-object v2, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mFillPaint:Landroid/graphics/Paint;

    new-instance v3, Landroid/graphics/Paint;

    invoke-direct {v3}, Landroid/graphics/Paint;-><init>()V

    iput-object v3, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mStrokePaint:Landroid/graphics/Paint;
    ...
    iput-object p4, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mFindInPageBridge:Lorg/chromium/components/find_in_page/FindInPageBridge;
    ...
    invoke-static {p1, p2}, Lorg/chromium/base/MathUtils;->flipSignIf(IZ)I
    ...
    iput-object p1, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mVisibilityAnimation:Landroid/animation/Animator;

    const-wide/16 v0, 0xc8

    invoke-virtual {p1, v0, v1}, Landroid/animation/Animator;->setDuration(J)Landroid/animation/Animator;

    iget-object p1, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mVisibilityAnimation:Landroid/animation/Animator;

    sget-object p2, Lorg/chromium/ui/interpolators/Interpolators;->LINEAR_OUT_SLOW_IN_INTERPOLATOR:Landroidx/interpolator/view/animation/LinearOutSlowInInterpolator;

    invoke-virtual {p1, p2}, Landroid/animation/Animator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iput-object p3, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mWindowAndroid:Lorg/chromium/ui/base/WindowAndroid;

    if-eqz p3, :cond_0

    iget-object p0, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mVisibilityAnimation:Landroid/animation/Animator;

    invoke-virtual {p3, p0}, Lorg/chromium/ui/base/WindowAndroid;->startAnimationOverContent(Landroid/animation/Animator;)V
    ...
    const-string p1, "WindowAndroid must be non null."
...
.method private calculateTickmarks()V
    ...
    invoke-static {v7, v4}, Landroidx/compose/foundation/layout/a;->m(ILjava/util/ArrayList;)Ljava/lang/Object;
...
.method public clearMatchRects()V
    ...
    invoke-virtual {p0, v2, v0, v1}, Lorg/chromium/components/find_in_page/FindResultBar;->setMatchRects(I[Landroid/graphics/RectF;Landroid/graphics/RectF;)V
...
.method public dismiss()V
    ...
    iput-boolean v0, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mDismissing:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mFindInPageBridge:Lorg/chromium/components/find_in_page/FindInPageBridge;

    iget-object v1, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mVisibilityAnimation:Landroid/animation/Animator;
    ...
    iget v2, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mBarTouchWidth:I

    invoke-static {}, Lorg/chromium/ui/base/LocalizationUtils;->isLayoutRtl()Z

    move-result v3

    invoke-static {v2, v3}, Lorg/chromium/base/MathUtils;->flipSignIf(IZ)I
    ...
    iput-object v0, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mVisibilityAnimation:Landroid/animation/Animator;

    const-wide/16 v1, 0xc8

    invoke-virtual {v0, v1, v2}, Landroid/animation/Animator;->setDuration(J)Landroid/animation/Animator;

    iget-object v0, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mVisibilityAnimation:Landroid/animation/Animator;

    sget-object v1, Lorg/chromium/ui/interpolators/Interpolators;->FAST_OUT_LINEAR_IN_INTERPOLATOR:Landroidx/interpolator/view/animation/FastOutLinearInInterpolator;
    ...
    new-instance v1, Lorg/chromium/components/find_in_page/FindResultBar$2;

    invoke-direct {v1, p0}, Lorg/chromium/components/find_in_page/FindResultBar$2;-><init>(Lorg/chromium/components/find_in_page/FindResultBar;)V
...
.method public onFindResult()V
    .locals 1

    const/4 v0, 0x0

    iput-boolean v0, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mWaitingForActivateAck:Z
...
.method public setMatchRects(I[Landroid/graphics/RectF;Landroid/graphics/RectF;)V
    ...
    iget v0, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mRectsVersion:I

    if-eq v0, p1, :cond_0

    iput p1, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mRectsVersion:I

    iput-object p2, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mMatches:[Landroid/graphics/RectF;
    ...
    sget-object p2, Lorg/chromium/components/find_in_page/FindResultBar;->sComparator:Ljava/util/Comparator;

    invoke-static {p1, p2}, Ljava/util/Arrays;->sort([Ljava/lang/Object;Ljava/util/Comparator;)V

    const/4 p1, -0x1

    iput p1, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mBarHeightForWhichTickmarksWereCached:I

    :cond_0
    iput-object p3, p0, Lorg/chromium/components/find_in_page/FindResultBar;->mActiveMatch:Landroid/graphics/RectF;

...
.field private static final KEY_RAW_DATA:Ljava/lang/String; = "rawData"

.field private static final KEY_SENDER_ID:Ljava/lang/String; = "senderId"

.field private static final KEY_VERSION:Ljava/lang/String; = "version"

.field private static final SERIALIZATION_CHARSET:Ljava/lang/String; = "ISO-8859-1"

.field private static final TAG:Ljava/lang/String; = "GCMMessage"
...
.method public static createFromBundle(Landroid/os/Bundle;)Lorg/chromium/components/gcm_driver/GCMMessage;
    .locals 2

    new-instance v0, Lorg/chromium/components/gcm_driver/GCMMessage$BundleReader;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lorg/chromium/components/gcm_driver/GCMMessage$BundleReader;-><init>(I)V
...
.method public static createFromPersistableBundle(Landroid/os/PersistableBundle;)Lorg/chromium/components/gcm_driver/GCMMessage;
    .locals 2

    new-instance v0, Lorg/chromium/components/gcm_driver/GCMMessage$PersistableBundleReader;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lorg/chromium/components/gcm_driver/GCMMessage$PersistableBundleReader;-><init>(I)V
...
.method public static peekCollapseKey(Lorg/json/JSONObject;)Ljava/lang/String;
    .locals 2
...
.method private serialize(Lorg/chromium/components/gcm_driver/GCMMessage$Writer;)Ljava/lang/Object;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-interface {p1}, Lorg/chromium/components/gcm_driver/GCMMessage$Writer;->createOutputObject()Ljava/lang/Object;
    ...
    invoke-interface {p1, v0, v1, v2}, Lorg/chromium/components/gcm_driver/GCMMessage$Writer;->writeString(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "senderId"

    iget-object v2, p0, Lorg/chromium/components/gcm_driver/GCMMessage;->mSenderId:Ljava/lang/String;

    invoke-interface {p1, v0, v1, v2}, Lorg/chromium/components/gcm_driver/GCMMessage$Writer;->writeString(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "appId"

    iget-object v2, p0, Lorg/chromium/components/gcm_driver/GCMMessage;->mAppId:Ljava/lang/String;

    invoke-interface {p1, v0, v1, v2}, Lorg/chromium/components/gcm_driver/GCMMessage$Writer;->writeString(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "collapseKey"

    iget-object v2, p0, Lorg/chromium/components/gcm_driver/GCMMessage;->mCollapseKey:Ljava/lang/String;

    invoke-interface {p1, v0, v1, v2}, Lorg/chromium/components/gcm_driver/GCMMessage$Writer;->writeString(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "originalPriority"

    iget-object v2, p0, Lorg/chromium/components/gcm_driver/GCMMessage;->mOriginalPriority:Ljava/lang/String;

    invoke-interface {p1, v0, v1, v2}, Lorg/chromium/components/gcm_driver/GCMMessage$Writer;->writeString(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "messageId"

    iget-object v2, p0, Lorg/chromium/components/gcm_driver/GCMMessage;->mMessageId:Ljava/lang/String;

    invoke-interface {p1, v0, v1, v2}, Lorg/chromium/components/gcm_driver/GCMMessage$Writer;->writeString(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lorg/chromium/components/gcm_driver/GCMMessage;->mRawData:[B
    ...
    invoke-interface {p1, v0, v2, v3}, Lorg/chromium/components/gcm_driver/GCMMessage$Writer;->writeString(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p1, v0, v2, v1}, Lorg/chromium/components/gcm_driver/GCMMessage$Writer;->writeString(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p1, v0, v1, p0}, Lorg/chromium/components/gcm_driver/GCMMessage$Writer;->writeStringArray(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/String;)V
...
.method public getOriginalPriority()I
    ...
    iget-object p0, p0, Lorg/chromium/components/gcm_driver/GCMMessage;->mOriginalPriority:Ljava/lang/String;
...
.method public toBundle()Landroid/os/Bundle;
    ...
    new-instance v0, Lorg/chromium/components/gcm_driver/GCMMessage$BundleWriter;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lorg/chromium/components/gcm_driver/GCMMessage$BundleWriter;-><init>(I)V

    invoke-direct {p0, v0}, Lorg/chromium/components/gcm_driver/GCMMessage;->serialize(Lorg/chromium/components/gcm_driver/GCMMessage$Writer;)Ljava/lang/Object;
...
.method public toJSON()Lorg/json/JSONObject;
    ...
    new-instance v0, Lorg/chromium/components/gcm_driver/GCMMessage$JSONWriter;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lorg/chromium/components/gcm_driver/GCMMessage$JSONWriter;-><init>(I)V
...
.method public toPersistableBundle()Landroid/os/PersistableBundle;
    ...
    new-instance v0, Lorg/chromium/components/gcm_driver/GCMMessage$PersistableBundleWriter;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lorg/chromium/components/gcm_driver/GCMMessage$PersistableBundleWriter;-><init>(I)V

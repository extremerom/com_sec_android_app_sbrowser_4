...
# static fields
.field private static final FCM_LAZY_SUBSCRIPTIONS:Ljava/lang/String; = "fcm_lazy_subscriptions"
...
.field private static final PREF_PACKAGE:Ljava/lang/String; = "org.chromium.components.gcm_driver.lazy_subscriptions"

.field private static final SUBSCRIPTIONS_WITH_PERSISTED_MESSAGES_KEY:Ljava/lang/String; = "subscriptions_with_persisted_messages"

.field private static final TAG:Ljava/lang/String; = "LazySubscriptions"
...
.method private static filterMessageBasedOnCollapseKey(Lorg/json/JSONArray;Ljava/lang/String;)Lorg/json/JSONArray;
    .locals 5
    ...
    invoke-static {v2}, Lorg/chromium/components/gcm_driver/GCMMessage;->peekCollapseKey(Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lorg/chromium/components/gcm_driver/GCMMessage;->peekSenderId(Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    invoke-static {v3, v2}, Lorg/chromium/base/Log;->i(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static persistMessage(Ljava/lang/String;Lorg/chromium/components/gcm_driver/GCMMessage;)V
    .locals 8

    const-string v0, "LazySubscriptions"

    const-string v1, "Dropping GCM Message due queue size limit. Sender id:"
    ...
    invoke-virtual {p1}, Lorg/chromium/components/gcm_driver/GCMMessage;->getCollapseKey()Ljava/lang/String;
    ...
    invoke-static {v5, v3}, Lorg/chromium/components/gcm_driver/LazySubscriptionsManager;->filterMessageBasedOnCollapseKey(Lorg/json/JSONArray;Ljava/lang/String;)Lorg/json/JSONArray;
    ...
    invoke-static {v1}, Lorg/chromium/components/gcm_driver/GCMMessage;->peekSenderId(Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    :cond_2
    invoke-virtual {p1}, Lorg/chromium/components/gcm_driver/GCMMessage;->toJSON()Lorg/json/JSONObject;
    ...
    invoke-static {p0, v7}, Lorg/chromium/components/gcm_driver/LazySubscriptionsManager;->storeHasPersistedMessagesForSubscription(Ljava/lang/String;Z)V
    :try_end_0
    ...
    :goto_2
    const-string v1, "Error when parsing the persisted message queue for subscriber:"

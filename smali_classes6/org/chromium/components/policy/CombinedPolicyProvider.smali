...
.field private static final TAG:Ljava/lang/String; = "CombinedPProvider"
...
.method public static synthetic a(Lorg/chromium/components/policy/CombinedPolicyProvider;)V
    .locals 0

    invoke-static {p0}, Lorg/chromium/components/policy/CombinedPolicyProvider;->lambda$setForTesting$0(Lorg/chromium/components/policy/CombinedPolicyProvider;)V
...
.method private static synthetic lambda$setForTesting$0(Lorg/chromium/components/policy/CombinedPolicyProvider;)V
    .locals 0
...
.method public addPolicyChangeListener(Lorg/chromium/components/policy/CombinedPolicyProvider$PolicyChangeListener;)V
    ...
    iget-object p0, p0, Lorg/chromium/components/policy/CombinedPolicyProvider;->mPolicyChangeListeners:Ljava/util/List;
...
.method public getPolicyProvidersForTesting()Ljava/util/List;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public terminateIncognitoSession()V
    ...
    check-cast v0, Lorg/chromium/components/policy/CombinedPolicyProvider$PolicyChangeListener;

    invoke-interface {v0}, Lorg/chromium/components/policy/CombinedPolicyProvider$PolicyChangeListener;->terminateIncognitoSession()V

...
.method public static createOneOffTask(IJ)Lorg/chromium/components/background_task_scheduler/TaskInfo$Builder;
    .locals 1
    ...
    invoke-virtual {v0, p1, p2}, Lorg/chromium/components/background_task_scheduler/TaskInfo$OneOffInfo$Builder;->setWindowEndTimeMs(J)Lorg/chromium/components/background_task_scheduler/TaskInfo$OneOffInfo$Builder;
...
.method public static createPeriodicTask(IJJ)Lorg/chromium/components/background_task_scheduler/TaskInfo$Builder;
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
    ...
    invoke-virtual {v0, p1, p2}, Lorg/chromium/components/background_task_scheduler/TaskInfo$PeriodicInfo$Builder;->setIntervalMs(J)Lorg/chromium/components/background_task_scheduler/TaskInfo$PeriodicInfo$Builder;

    move-result-object p1

    invoke-virtual {p1, p3, p4}, Lorg/chromium/components/background_task_scheduler/TaskInfo$PeriodicInfo$Builder;->setFlexMs(J)Lorg/chromium/components/background_task_scheduler/TaskInfo$PeriodicInfo$Builder;

    move-result-object p1

    invoke-virtual {p1}, Lorg/chromium/components/background_task_scheduler/TaskInfo$PeriodicInfo$Builder;->build()Lorg/chromium/components/background_task_scheduler/TaskInfo$PeriodicInfo;
...
.method public getOneOffInfo()Lorg/chromium/components/background_task_scheduler/TaskInfo$OneOffInfo;
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
    ...
    instance-of v0, p0, Lorg/chromium/components/background_task_scheduler/TaskInfo$OneOffInfo;

    if-eqz v0, :cond_0

    check-cast p0, Lorg/chromium/components/background_task_scheduler/TaskInfo$OneOffInfo;
...
.method public getPeriodicInfo()Lorg/chromium/components/background_task_scheduler/TaskInfo$PeriodicInfo;
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
    ...
    instance-of v0, p0, Lorg/chromium/components/background_task_scheduler/TaskInfo$PeriodicInfo;

    if-eqz v0, :cond_0

    check-cast p0, Lorg/chromium/components/background_task_scheduler/TaskInfo$PeriodicInfo;
...
.method public isPeriodic()Z
    ...
    instance-of p0, p0, Lorg/chromium/components/background_task_scheduler/TaskInfo$PeriodicInfo;

...
.method public static synthetic a(Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma;)V
    .locals 0

    invoke-static {p0}, Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma;->lambda$setInstanceForTesting$0(Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma;)V
...
.method private static synthetic lambda$setInstanceForTesting$0(Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma;)V
    .locals 0

    sput-object p0, Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma;->sInstance:Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma;
...
.method public static setInstanceForTesting(Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma;)V
    .locals 2
...
# virtual methods
.method public assertNativeIsLoaded()V
    .locals 0
...
.method public flushStats()V
    .locals 6

    invoke-virtual {p0}, Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma;->assertNativeIsLoaded()V
    ...
    invoke-static {v0}, Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma;->getCachedUmaEntries(Landroid/content/SharedPreferences;)Ljava/util/Set;
    ...
    invoke-static {v1}, Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma$CachedUmaEntry;->parseEntry(Ljava/lang/String;)Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma$CachedUmaEntry;
    ...
    :goto_1
    invoke-virtual {v1}, Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma$CachedUmaEntry;->getCount()I

    move-result v3

    if-ge v2, v3, :cond_0

    invoke-virtual {v1}, Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma$CachedUmaEntry;->getEvent()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1}, Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma$CachedUmaEntry;->getValue()I

    move-result v4

    const/16 v5, 0x22

    invoke-virtual {p0, v3, v4, v5}, Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma;->recordEnumeratedHistogram(Ljava/lang/String;II)V
    ...
    :cond_2
    invoke-virtual {p0}, Lorg/chromium/components/background_task_scheduler/internal/BackgroundTaskSchedulerUma;->removeCachedStats()V
...
.method public removeCachedStats()V
    .locals 1
...
.method public reportExactTaskCreated(I)V
    .locals 1

    const-string v0, "Android.BackgroundTaskScheduler.ExactTaskCreated"
...
.method public reportNotificationWasSet(IJ)V
    .locals 9

    new-instance v0, Ljava/lang/StringBuilder;

    const-string v1, "Android.BackgroundTaskScheduler.SetNotification."
...
.method public reportStartupMode(I)V
    .locals 1
...
.method public reportTaskCanceled(I)V
    .locals 1

    const-string v0, "Android.BackgroundTaskScheduler.TaskCanceled"
...
.method public reportTaskExpired(I)V
    .locals 1
...
.method public reportTaskRescheduled()V
    .locals 2
...
.method public reportTaskScheduled(IZ)V
    .locals 0

    if-eqz p2, :cond_0

    const-string p2, "Android.BackgroundTaskScheduler.TaskScheduled.Success"
    ...
    :cond_0
    const-string p2, "Android.BackgroundTaskScheduler.TaskScheduled.Failure"
...
.method public reportTaskStarted(I)V
    .locals 1
...
.method public reportTaskStopped(I)V
    .locals 1

...
.field private static final TAG:Ljava/lang/String; = "DWServiceBinder"
...
.method private onWindowFocusLost(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p1}, Landroid/widget/directwriting/a;->w(Ljava/lang/String;)V
    :try_end_0
...
.method private updateConfiguration()V
    ...
    invoke-virtual {v2, v1}, Landroid/widget/directwriting/a;->p(Landroid/os/Bundle;)V
...
.method public hideDwToolbar()V
    ...
    invoke-virtual {v2, v1}, Landroid/widget/directwriting/a;->s(Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/DeadObjectException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onDispatchEvent(Landroid/view/MotionEvent;Landroid/view/View;)V
    ...
    invoke-virtual {v1, p1}, Landroid/widget/directwriting/a;->r(Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/DeadObjectException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onStopRecognition(Landroid/view/MotionEvent;Landroid/graphics/Rect;Landroid/view/View;)V
    ...
    invoke-virtual {p2, p1}, Landroid/widget/directwriting/a;->u(Landroid/os/Bundle;)Z
    :try_end_0
    .catch Landroid/os/DeadObjectException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public registerCallback()V
    ...
    invoke-virtual {v3, v1, v2}, Landroid/widget/directwriting/a;->x(Lorg/chromium/components/stylus_handwriting/DirectWritingServiceCallback;Ljava/lang/String;)Z
...
.method public setRemoteServiceForTest(Landroid/widget/directwriting/c;)V
    .locals 0
...
.method public setTriggerCallbackForTest(Lorg/chromium/components/stylus_handwriting/DirectWritingServiceBinder$DirectWritingTriggerCallback;)V
    .locals 0

    iput-object p1, p0, Lorg/chromium/components/stylus_handwriting/DirectWritingServiceBinder;->mTriggerCallback:Lorg/chromium/components/stylus_handwriting/DirectWritingServiceBinder$DirectWritingTriggerCallback;
...
.method public startRecognition(Landroid/graphics/Rect;Landroid/view/MotionEvent;Landroid/view/View;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/widget/directwriting/a;->t(Landroid/os/Bundle;)Z
    :try_end_0
    .catch Landroid/os/DeadObjectException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public unregisterCallback()V
    ...
    invoke-virtual {v2, v1}, Landroid/widget/directwriting/a;->y(Lorg/chromium/components/stylus_handwriting/DirectWritingServiceCallback;)Z
...
.method public updateEditableBounds(Landroid/graphics/Rect;Landroid/view/View;Z)V
    ...
    invoke-virtual {v1, p1}, Landroid/widget/directwriting/a;->q(Landroid/os/Bundle;)Z
    :try_end_0
    .catch Landroid/os/DeadObjectException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public updateEditorInfo(Landroid/view/inputmethod/EditorInfo;)V
    ...
    invoke-virtual {v1, p1}, Landroid/widget/directwriting/a;->v(I)V
    :try_end_0
    .catch Landroid/os/DeadObjectException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

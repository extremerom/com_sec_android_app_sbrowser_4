...
# direct methods
.method public constructor <init>(Lorg/chromium/base/UnguessableToken;Lorg/chromium/components/paintpreview/player/frame/PlayerFrameViewport;Landroid/util/Size;Lorg/chromium/components/paintpreview/player/PlayerCompositorDelegate;Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediatorDelegate;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapStateController;->mGuid:Lorg/chromium/base/UnguessableToken;

    iput-object p2, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapStateController;->mViewport:Lorg/chromium/components/paintpreview/player/frame/PlayerFrameViewport;

    iput-object p3, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapStateController;->mContentSize:Landroid/util/Size;

    iput-object p4, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapStateController;->mCompositorDelegate:Lorg/chromium/components/paintpreview/player/PlayerCompositorDelegate;

    if-eqz p4, :cond_0

    new-instance p1, Lorg/chromium/components/paintpreview/player/frame/a;

    const/4 p2, 0x1

    invoke-direct {p1, p0, p2}, Lorg/chromium/components/paintpreview/player/frame/a;-><init>(Ljava/lang/Object;I)V

    invoke-interface {p4, p1}, Lorg/chromium/components/paintpreview/player/PlayerCompositorDelegate;->addMemoryPressureListener(Ljava/lang/Runnable;)V

    :cond_0
    iput-object p5, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapStateController;->mMediatorDelegate:Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediatorDelegate;
...
.method public onMemoryPressure()V
    ...
    :cond_0
    invoke-virtual {v0}, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapState;->releaseNotVisibleTiles()V

    iget-object v0, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapStateController;->mVisibleBitmapState:Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapState;

    invoke-virtual {p0, v0}, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapStateController;->stateUpdated(Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapState;)V
...
.method public swapForTest()V
    ...
    invoke-virtual {p0, v0}, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapStateController;->swap(Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapState;)V

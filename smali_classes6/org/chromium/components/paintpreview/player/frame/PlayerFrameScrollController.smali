...
# direct methods
.method public constructor <init>(Landroid/widget/OverScroller;Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediatorDelegate;Ljava/lang/Runnable;Ljava/lang/Runnable;)V
    .locals 1
    ...
    iput-object v0, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameScrollController;->mScrollerHandler:Landroid/os/Handler;

    iput-object p1, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameScrollController;->mScroller:Landroid/widget/OverScroller;

    invoke-interface {p2}, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediatorDelegate;->getViewport()Lorg/chromium/components/paintpreview/player/frame/PlayerFrameViewport;

    move-result-object p1

    iput-object p1, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameScrollController;->mViewport:Lorg/chromium/components/paintpreview/player/frame/PlayerFrameViewport;

    invoke-interface {p2}, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediatorDelegate;->getContentSize()Landroid/util/Size;

    move-result-object p1

    iput-object p1, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameScrollController;->mContentSize:Landroid/util/Size;

    iput-object p2, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameScrollController;->mMediatorDelegate:Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediatorDelegate;

    iput-object p3, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameScrollController;->mOnScrollListener:Ljava/lang/Runnable;

    iput-object p4, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameScrollController;->mOnFlingListener:Ljava/lang/Runnable;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameScrollController;->mAcceptUserInput:Z
...
.method private handleFling()V
    ...
    invoke-direct {v1, p0, v2}, Lorg/chromium/components/paintpreview/player/frame/a;-><init>(Ljava/lang/Object;I)V
...
.method public onFling(FF)Z
    ...
    invoke-direct {p2, p0, v0}, Lorg/chromium/components/paintpreview/player/frame/a;-><init>(Ljava/lang/Object;I)V
...
.method public setOverscrollHandler(Lorg/chromium/components/paintpreview/player/OverscrollHandler;)V
    .locals 0

    iput-object p1, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameScrollController;->mOverscrollHandler:Lorg/chromium/components/paintpreview/player/OverscrollHandler;

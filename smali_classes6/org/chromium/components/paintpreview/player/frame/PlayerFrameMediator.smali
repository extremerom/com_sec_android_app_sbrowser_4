...
# direct methods
.method public constructor <init>(Lorg/chromium/ui/modelutil/PropertyModel;Lorg/chromium/components/paintpreview/player/PlayerCompositorDelegate;Lorg/chromium/components/paintpreview/player/PlayerGestureListener;Lorg/chromium/base/UnguessableToken;Landroid/util/Size;IIFLjava/lang/Runnable;)V
    .locals 9
    ...
    iput-object v1, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mSubFrameViews:Ljava/util/List;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mSubFrameRects:Ljava/util/List;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mSubFrameMediators:Ljava/util/List;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mSubFrameScaledRects:Ljava/util/List;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mScaledRectIntersection:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Matrix;

    invoke-direct {v1}, Landroid/graphics/Matrix;-><init>()V

    iput-object v1, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mBitmapScaleMatrix:Landroid/graphics/Matrix;

    new-instance v2, Landroid/graphics/Point;

    invoke-direct {v2}, Landroid/graphics/Point;-><init>()V

    iput-object v2, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mOffsetForScaling:Landroid/graphics/Point;

    iput-object v0, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mModel:Lorg/chromium/ui/modelutil/PropertyModel;

    sget-object v2, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameProperties;->SCALE_MATRIX:Lorg/chromium/ui/modelutil/PropertyModel$WritableObjectPropertyKey;

    invoke-virtual {p1, v2, v1}, Lorg/chromium/ui/modelutil/PropertyModel;->set(Lorg/chromium/ui/modelutil/PropertyModel$WritableObjectPropertyKey;Ljava/lang/Object;)V

    move-object v4, p2

    iput-object v4, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mCompositorDelegate:Lorg/chromium/components/paintpreview/player/PlayerCompositorDelegate;

    move-object v0, p3

    iput-object v0, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mGestureListener:Lorg/chromium/components/paintpreview/player/PlayerGestureListener;

    new-instance v7, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameViewport;

    invoke-direct {v7}, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameViewport;-><init>()V

    iput-object v7, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mViewport:Lorg/chromium/components/paintpreview/player/frame/PlayerFrameViewport;

    const/4 v0, 0x0

    iput-boolean v0, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mIsSubframe:Z

    move/from16 v0, p8

    iput v0, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mInitialScaleFactor:F

    move-object v1, p4

    iput-object v1, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mGuid:Lorg/chromium/base/UnguessableToken;

    move-object v3, p5

    iput-object v3, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mContentSize:Landroid/util/Size;

    new-instance v8, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapStateController;
    ...
    invoke-direct/range {v0 .. v5}, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapStateController;-><init>(Lorg/chromium/base/UnguessableToken;Lorg/chromium/components/paintpreview/player/frame/PlayerFrameViewport;Landroid/util/Size;Lorg/chromium/components/paintpreview/player/PlayerCompositorDelegate;Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediatorDelegate;)V

    iput-object v8, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mBitmapStateController:Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapStateController;
    ...
    invoke-virtual {v7, v0, v1}, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameViewport;->offset(FF)V

    iget v0, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mInitialScaleFactor:F

    invoke-virtual {v7, v0}, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameViewport;->setScale(F)V

    move-object/from16 v0, p9

    iput-object v0, v6, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mInitialViewportSizeAvailable:Ljava/lang/Runnable;
...
.method private markAsSubframe()V
    .locals 1

    const/4 v0, 0x1

    iput-boolean v0, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mIsSubframe:Z
...
# virtual methods
.method public addSubFrame(Landroid/view/View;Landroid/graphics/Rect;Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;)V
    .locals 1
    ...
    iget-object p1, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mSubFrameRects:Ljava/util/List;

    invoke-interface {p1, p2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object p1, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mSubFrameMediators:Ljava/util/List;

    invoke-interface {p1, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object p1, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mSubFrameScaledRects:Ljava/util/List;
    ...
    invoke-direct {p3}, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->markAsSubframe()V

    iget p1, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mInitialScaleFactor:F

    invoke-direct {p3, p1}, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->setInitialScaleFactor(F)V
    ...
    iget-object p3, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mSubFrameViews:Ljava/util/List;

    invoke-virtual {p1, p2, p3}, Lorg/chromium/ui/modelutil/PropertyModel;->set(Lorg/chromium/ui/modelutil/PropertyModel$WritableObjectPropertyKey;Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mSubFrameScaledRects:Ljava/util/List;
...
.method public checkRequiredBitmapsLoadedForTest()Z
    ...
    invoke-virtual {v0}, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapState;->checkRequiredBitmapsLoadedForTest()Z
    ...
    :cond_0
    :goto_0
    iget-object v2, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mSubFrameViews:Ljava/util/List;
    ...
    :cond_1
    iget-object v2, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mSubFrameMediators:Ljava/util/List;

    invoke-interface {v2, v1}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;

    invoke-virtual {v2}, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->checkRequiredBitmapsLoadedForTest()Z
...
.method public destroy()V
    ...
    invoke-virtual {p0}, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapStateController;->destroy()V
...
.method public getBitmapStateControllerForTest()Lorg/chromium/components/paintpreview/player/frame/PlayerFrameBitmapStateController;
    .locals 0
...
.method public getContentSize()Landroid/util/Size;
    ...
    iget-object p0, p0, Lorg/chromium/components/paintpreview/player/frame/PlayerFrameMediator;->mContentSize:Landroid/util/Size;
...
.method public getViewport()Lorg/chromium/components/paintpreview/player/frame/PlayerFrameViewport;
    .locals 0

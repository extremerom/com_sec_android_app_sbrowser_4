...
# direct methods
.method public constructor <init>(Lorg/chromium/components/paintpreview/player/frame/PlayerFrameViewport;Landroid/util/Size;Landroid/util/Size;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lorg/chromium/components/paintpreview/player/accessibility/PlayerAccessibilityDelegate$PlayerAccessibilityCoordinatesImpl;->mViewport:Lorg/chromium/components/paintpreview/player/frame/PlayerFrameViewport;

    iput-object p2, p0, Lorg/chromium/components/paintpreview/player/accessibility/PlayerAccessibilityDelegate$PlayerAccessibilityCoordinatesImpl;->mContentSize:Landroid/util/Size;

    iput-object p3, p0, Lorg/chromium/components/paintpreview/player/accessibility/PlayerAccessibilityDelegate$PlayerAccessibilityCoordinatesImpl;->mConstantOffset:Landroid/util/Size;
...
.method public getScrollXPix()F
    ...
    invoke-virtual {p0}, Lorg/chromium/components/paintpreview/player/accessibility/PlayerAccessibilityDelegate$PlayerAccessibilityCoordinatesImpl;->getScrollX()F

    move-result v0

    invoke-virtual {p0, v0}, Lorg/chromium/components/paintpreview/player/accessibility/PlayerAccessibilityDelegate$PlayerAccessibilityCoordinatesImpl;->fromLocalCssToPix(F)F
...
.method public getScrollYPix()F
    ...
    invoke-virtual {p0}, Lorg/chromium/components/paintpreview/player/accessibility/PlayerAccessibilityDelegate$PlayerAccessibilityCoordinatesImpl;->getScrollY()F

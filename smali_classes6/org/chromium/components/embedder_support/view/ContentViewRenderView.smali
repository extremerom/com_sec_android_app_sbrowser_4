...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0}, Lorg/chromium/components/embedder_support/view/ContentViewRenderView;->createSurfaceBridge()Lorg/chromium/components/embedder_support/view/ContentViewRenderView$SurfaceBridge;

    move-result-object p1

    iput-object p1, p0, Lorg/chromium/components/embedder_support/view/ContentViewRenderView;->mSurfaceBridge:Lorg/chromium/components/embedder_support/view/ContentViewRenderView$SurfaceBridge;

    invoke-virtual {p1, p0}, Lorg/chromium/components/embedder_support/view/ContentViewRenderView$SurfaceBridge;->initialize(Lorg/chromium/components/embedder_support/view/ContentViewRenderView;)V
...
# virtual methods
.method public createSurfaceBridge()Lorg/chromium/components/embedder_support/view/ContentViewRenderView$SurfaceBridge;
    .locals 0

    new-instance p0, Lorg/chromium/components/embedder_support/view/ContentViewRenderView$SurfaceBridge;

    invoke-direct {p0}, Lorg/chromium/components/embedder_support/view/ContentViewRenderView$SurfaceBridge;-><init>()V

    return-object p0
.end method

.method public createSurfaceView(Landroid/content/Context;)Landroid/view/SurfaceView;
    .locals 0
...
.method public destroy()V
    ...
    iget-object v0, p0, Lorg/chromium/components/embedder_support/view/ContentViewRenderView;->mSurfaceBridge:Lorg/chromium/components/embedder_support/view/ContentViewRenderView$SurfaceBridge;

    invoke-virtual {v0}, Lorg/chromium/components/embedder_support/view/ContentViewRenderView$SurfaceBridge;->disconnect()V

    const/4 v0, 0x0

    iput-object v0, p0, Lorg/chromium/components/embedder_support/view/ContentViewRenderView;->mWindowAndroid:Lorg/chromium/ui/base/WindowAndroid;
    ...
    invoke-interface {v0, v1, v2, p0}, Lorg/chromium/components/embedder_support/view/ContentViewRenderView$Natives;->destroy(JLorg/chromium/components/embedder_support/view/ContentViewRenderView;)V

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lorg/chromium/components/embedder_support/view/ContentViewRenderView;->mNativeContentViewRenderView:J
...
.method public onNativeLibraryLoaded(Lorg/chromium/ui/base/WindowAndroid;)V
    ...
    invoke-interface {v0, p0, p1}, Lorg/chromium/components/embedder_support/view/ContentViewRenderView$Natives;->init(Lorg/chromium/components/embedder_support/view/ContentViewRenderView;Lorg/chromium/ui/base/WindowAndroid;)J

    move-result-wide v0

    iput-wide v0, p0, Lorg/chromium/components/embedder_support/view/ContentViewRenderView;->mNativeContentViewRenderView:J

    iput-object p1, p0, Lorg/chromium/components/embedder_support/view/ContentViewRenderView;->mWindowAndroid:Lorg/chromium/ui/base/WindowAndroid;

    new-instance p1, Lorg/chromium/components/embedder_support/view/ContentViewRenderView$1;

    invoke-direct {p1, p0}, Lorg/chromium/components/embedder_support/view/ContentViewRenderView$1;-><init>(Lorg/chromium/components/embedder_support/view/ContentViewRenderView;)V

    iget-object p0, p0, Lorg/chromium/components/embedder_support/view/ContentViewRenderView;->mSurfaceBridge:Lorg/chromium/components/embedder_support/view/ContentViewRenderView$SurfaceBridge;

    invoke-virtual {p0, p1}, Lorg/chromium/components/embedder_support/view/ContentViewRenderView$SurfaceBridge;->connect(Landroid/view/SurfaceHolder$Callback;)V

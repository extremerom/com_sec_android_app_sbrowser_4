...
.method public static snapshotViewHierarchy()V
    ...
    new-instance v4, Landroidx/media3/exoplayer/audio/b;

    const/4 v5, 0x6

    invoke-direct {v4, v2, v3, v1, v5}, Landroidx/media3/exoplayer/audio/b;-><init>(JLjava/lang/Object;I)V
...
.method public static startupActivityStart(JJ)V
    .locals 1
    ...
    invoke-interface {v0, p0, p1, p2, p3}, Lorg/chromium/base/TraceEvent$Natives;->startupActivityStart(JJ)V

    goto :goto_0

    :cond_0
    invoke-static {p0, p1, p2, p3}, Lorg/chromium/base/EarlyTraceEvent;->startupActivityStart(JJ)V

    :goto_0
    return-void
.end method

.method public static startupLaunchCause(JI)V
    .locals 7
    ...
    invoke-interface/range {v1 .. v6}, Lorg/chromium/base/TraceEvent$Natives;->startupLaunchCause(JJI)V

    goto :goto_0

    :cond_0
    invoke-static {p0, p1, p2}, Lorg/chromium/base/EarlyTraceEvent;->startupLaunchCause(JI)V

    :goto_0
    return-void
.end method

.method public static startupTimeToFirstVisibleContent2(JJJ)V
    .locals 8
    ...
    invoke-interface/range {v1 .. v7}, Lorg/chromium/base/TraceEvent$Natives;->startupTimeToFirstVisibleContent2(JJJ)V

    return-void
.end method

.method public static webViewStartupFirstInstance(JJZ)V
    .locals 7
    ...
    invoke-interface/range {v1 .. v6}, Lorg/chromium/base/TraceEvent$Natives;->webViewStartupFirstInstance(JJZ)V

    :cond_0
    return-void
.end method

.method public static webViewStartupNotFirstInstance(JJ)V
    .locals 1
    ...
    invoke-interface {v0, p0, p1, p2, p3}, Lorg/chromium/base/TraceEvent$Natives;->webViewStartupNotFirstInstance(JJ)V
...
.method public static webViewStartupStartChromiumLocked(JJIII)V
    .locals 9
    ...
    invoke-interface/range {v1 .. v8}, Lorg/chromium/base/TraceEvent$Natives;->webViewStartupStartChromiumLocked(JJIII)V

...
.method public static synthetic a(Lorg/chromium/base/CommandLine;Ljava/util/Map;Ljava/util/ArrayList;I)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/chromium/base/CommandLine;->lambda$resetForTesting$0(Lorg/chromium/base/CommandLine;Ljava/util/Map;Ljava/util/ArrayList;I)V
...
.method public static getJavaSwitchesForTesting()[Ljava/lang/String;
    .locals 2
...
.method private static synthetic lambda$resetForTesting$0(Lorg/chromium/base/CommandLine;Ljava/util/Map;Ljava/util/ArrayList;I)V
    .locals 0

    iput-object p1, p0, Lorg/chromium/base/CommandLine;->mSwitches:Ljava/util/Map;

    iput-object p2, p0, Lorg/chromium/base/CommandLine;->mArgs:Ljava/util/ArrayList;

    iput p3, p0, Lorg/chromium/base/CommandLine;->mArgsBegin:I
...
.method public static resetForTesting(Z)V
    .locals 6

    sget-object v1, Lorg/chromium/base/CommandLine;->sInstance:Lorg/chromium/base/CommandLine;

    iget-object v2, v1, Lorg/chromium/base/CommandLine;->mSwitches:Ljava/util/Map;

    iget-object v5, v1, Lorg/chromium/base/CommandLine;->mArgs:Ljava/util/ArrayList;

    iget v3, v1, Lorg/chromium/base/CommandLine;->mArgsBegin:I

    const/4 v0, 0x0

    iput-object v0, v1, Lorg/chromium/base/CommandLine;->mSwitches:Ljava/util/Map;

    iput-object v0, v1, Lorg/chromium/base/CommandLine;->mArgs:Ljava/util/ArrayList;

    const/4 v4, 0x0

    iput v4, v1, Lorg/chromium/base/CommandLine;->mArgsBegin:I

    if-eqz p0, :cond_0

    invoke-direct {v1, v0}, Lorg/chromium/base/CommandLine;->initInternal([Ljava/lang/String;)V

    :cond_0
    new-instance p0, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/i;

    const/4 v4, 0x2

    move-object v0, p0

    invoke-direct/range {v0 .. v5}, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/i;-><init>(Ljava/lang/Object;Ljava/lang/Object;IILjava/lang/Object;)V
...
.method public declared-synchronized appendSwitchesAndArguments([Ljava/lang/String;)V
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lorg/chromium/base/CommandLine;->mArgs:Ljava/util/ArrayList;
...
.method public getSwitches()Ljava/util/Map;
    ...
    invoke-interface {p0}, Lorg/chromium/base/CommandLine$Natives;->getSwitches()Ljava/util/Map;

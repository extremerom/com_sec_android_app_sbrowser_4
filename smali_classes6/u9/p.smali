...
# static fields
.field public static final e:Lu9/p;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lu9/p;->f:Lu9/a;

    new-instance v0, Lu9/p;

    invoke-direct {v0}, Lu9/p;-><init>()V

    sput-object v0, Lu9/p;->e:Lu9/p;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lu9/p;->b:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, Lu9/p;->c:B

    iput v0, p0, Lu9/p;->d:I

    sget-object v0, LA9/e;->a:LA9/A;

    iput-object v0, p0, Lu9/p;->a:LA9/e;
...
.method public constructor <init>(LA9/f;LA9/j;)V
    ...
    iput-object v0, p0, Lu9/p;->b:Ljava/util/List;
    ...
    iput-object v5, p0, Lu9/p;->b:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v5, p0, Lu9/p;->b:Ljava/util/List;

    sget-object v6, Lu9/t;->j:Lu9/a;
    ...
    iget-object p2, p0, Lu9/p;->b:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lu9/p;->b:Ljava/util/List;
    ...
    iput-object p2, p0, Lu9/p;->a:LA9/e;
    ...
    iget-object p1, p0, Lu9/p;->b:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lu9/p;->b:Ljava/util/List;
    ...
    iput-object p1, p0, Lu9/p;->a:LA9/e;
...
.method public final a()I
    ...
    :goto_0
    iget-object v2, p0, Lu9/p;->b:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, Lu9/p;->a:LA9/e;
...
.method public final d(LA9/h;)V
    ...
    invoke-virtual {p0}, Lu9/p;->a()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lu9/p;->b:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lu9/p;->a:LA9/e;
...
.method public final isInitialized()Z
    ...
    :goto_0
    iget-object v3, p0, Lu9/p;->b:Ljava/util/List;

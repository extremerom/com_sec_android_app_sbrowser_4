...
.method private execute(Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;Landroidx/browser/trusted/TrustedWebActivityCallback;Ljava/lang/Runnable;Ljava/lang/Runnable;)V
    .locals 9
    ...
    invoke-direct/range {v1 .. v7}, Lcom/sec/terrace/browser/browserservices/digitalgoods/TinDigitalGoodsAdapter$1;-><init>(Lcom/sec/terrace/browser/browserservices/digitalgoods/TinDigitalGoodsAdapter;Ljava/lang/String;Landroid/os/Bundle;Landroidx/browser/trusted/TrustedWebActivityCallback;Ljava/lang/Runnable;Ljava/lang/Runnable;)V
...
.method private synthetic lambda$consume$8(Ljava/lang/String;Lorg/chromium/payments/mojom/DigitalGoods$Consume_Response;Landroid/net/Uri;Ljava/lang/Runnable;Ljava/lang/Runnable;)V
    ...
    invoke-static {p2}, Lcom/sec/terrace/browser/browserservices/digitalgoods/TinAcknowledgeConverter;->convertCallback(Lorg/chromium/payments/mojom/DigitalGoods$Consume_Response;)Landroidx/browser/trusted/TrustedWebActivityCallback;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/sec/terrace/browser/browserservices/digitalgoods/TinDigitalGoodsAdapter;->execute(Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;Landroidx/browser/trusted/TrustedWebActivityCallback;Ljava/lang/Runnable;Ljava/lang/Runnable;)V
...
.method public consume(Landroid/net/Uri;Ljava/lang/String;Lorg/chromium/payments/mojom/DigitalGoods$Consume_Response;)V
    ...
    invoke-static {p3}, Lcom/sec/terrace/browser/browserservices/digitalgoods/TinConsumeConverter;->convertCallback(Lorg/chromium/payments/mojom/DigitalGoods$Consume_Response;)Landroidx/browser/trusted/TrustedWebActivityCallback;
...
.method public getDetails(Landroid/net/Uri;[Ljava/lang/String;Lorg/chromium/payments/mojom/DigitalGoods$GetDetails_Response;)V
    ...
    invoke-static {p3}, Lcom/sec/terrace/browser/browserservices/digitalgoods/TinGetDetailsConverter;->convertCallback(Lorg/chromium/payments/mojom/DigitalGoods$GetDetails_Response;)Landroidx/browser/trusted/TrustedWebActivityCallback;
...
.method public listPurchaseHistory(Landroid/net/Uri;Lorg/chromium/payments/mojom/DigitalGoods$ListPurchaseHistory_Response;)V
    ...
    invoke-static {p2}, Lcom/sec/terrace/browser/browserservices/digitalgoods/TinListPurchaseHistoryConverter;->convertCallback(Lorg/chromium/payments/mojom/DigitalGoods$ListPurchaseHistory_Response;)Landroidx/browser/trusted/TrustedWebActivityCallback;
...
.method public listPurchases(Landroid/net/Uri;Lorg/chromium/payments/mojom/DigitalGoods$ListPurchases_Response;)V
    ...
    invoke-static {p2}, Lcom/sec/terrace/browser/browserservices/digitalgoods/TinListPurchasesConverter;->convertCallback(Lorg/chromium/payments/mojom/DigitalGoods$ListPurchases_Response;)Landroidx/browser/trusted/TrustedWebActivityCallback;

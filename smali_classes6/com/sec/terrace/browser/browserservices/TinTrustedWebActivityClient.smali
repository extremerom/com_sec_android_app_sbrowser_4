...
# direct methods
.method public constructor <init>(Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;Lcom/sec/terrace/browser/browserservices/permissiondelegation/TinInstalledWebappPermissionManager;)V
    .locals 0

    invoke-static {p1}, Lcom/sec/terrace/browser/browserservices/TinTrustedWebActivityClientWrappers;->wrap(Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;)Lcom/sec/terrace/browser/browserservices/TinTrustedWebActivityClientWrappers$ConnectionPool;
...
.method public static bridge synthetic a(Lcom/sec/terrace/browser/browserservices/TinTrustedWebActivityClient;Landroidx/browser/trusted/TrustedWebActivityCallback;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/terrace/browser/browserservices/TinTrustedWebActivityClient;->notifyLocationUpdateError(Landroidx/browser/trusted/TrustedWebActivityCallback;Ljava/lang/String;)V

    return-void
.end method

.method public static bridge synthetic b(Lcom/sec/terrace/browser/browserservices/TinTrustedWebActivityClient;Lcom/sec/terrace/browser/browserservices/TinTrustedWebActivityClientWrappers$Connection;Ljava/lang/String;Landroid/os/Bundle;Landroidx/browser/trusted/TrustedWebActivityCallback;)Landroid/os/Bundle;
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/sec/terrace/browser/browserservices/TinTrustedWebActivityClient;->safeSendExtraCommand(Lcom/sec/terrace/browser/browserservices/TinTrustedWebActivityClientWrappers$Connection;Ljava/lang/String;Landroid/os/Bundle;Landroidx/browser/trusted/TrustedWebActivityCallback;)Landroid/os/Bundle;
...
.method public static get()Lcom/sec/terrace/browser/browserservices/TinTrustedWebActivityClient;
    ...
    invoke-static {v1}, Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;->create(Landroid/content/Context;)Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;
    ...
    invoke-static {v2, v3}, Lcom/sec/terrace/browser/browserservices/permissiondelegation/TinInstalledWebappPermissionManager;->get(Landroid/content/Context;Lcom/sec/terrace/browser/browserservices/permissiondelegation/TinInstalledWebappPermissionStore;)Lcom/sec/terrace/browser/browserservices/permissiondelegation/TinInstalledWebappPermissionManager;

    move-result-object v2

    invoke-direct {v0, v1, v2}, Lcom/sec/terrace/browser/browserservices/TinTrustedWebActivityClient;-><init>(Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;Lcom/sec/terrace/browser/browserservices/permissiondelegation/TinInstalledWebappPermissionManager;)V
...
.method private notifyLocationUpdateError(Landroidx/browser/trusted/TrustedWebActivityCallback;Ljava/lang/String;)V
    .locals 1
    ...
    invoke-virtual {p1, p2, p0}, Landroidx/browser/trusted/TrustedWebActivityCallback;->onExtraCallback(Ljava/lang/String;Landroid/os/Bundle;)V

    return-void
.end method

.method private safeSendExtraCommand(Lcom/sec/terrace/browser/browserservices/TinTrustedWebActivityClientWrappers$Connection;Ljava/lang/String;Landroid/os/Bundle;Landroidx/browser/trusted/TrustedWebActivityCallback;)Landroid/os/Bundle;
    .locals 0
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    :try_start_0
    invoke-interface {p1, p2, p3, p4}, Lcom/sec/terrace/browser/browserservices/TinTrustedWebActivityClientWrappers$Connection;->sendExtraCommand(Ljava/lang/String;Landroid/os/Bundle;Landroidx/browser/trusted/TrustedWebActivityCallback;)Landroid/os/Bundle;
...
.method public startListeningLocationUpdates(Ljava/lang/String;ZLandroidx/browser/trusted/TrustedWebActivityCallback;)V
    .locals 1
    ...
    invoke-direct {v0, p0, p2, p3}, Lcom/sec/terrace/browser/browserservices/TinTrustedWebActivityClient$3;-><init>(Lcom/sec/terrace/browser/browserservices/TinTrustedWebActivityClient;ZLandroidx/browser/trusted/TrustedWebActivityCallback;)V

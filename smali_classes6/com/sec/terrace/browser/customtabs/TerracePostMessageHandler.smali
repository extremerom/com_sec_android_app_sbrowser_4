...
.field private final mPostMessageBackend:Landroidx/browser/customtabs/PostMessageBackend;
...
# direct methods
.method public constructor <init>(Landroidx/browser/customtabs/PostMessageBackend;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/sec/terrace/browser/customtabs/TerracePostMessageHandler;->mPostMessageBackend:Landroidx/browser/customtabs/PostMessageBackend;

    new-instance p1, Lcom/sec/android/app/sbrowser/payments/standard/ui/c;

    const/16 v0, 0x11

    invoke-direct {p1, p0, v0}, Lcom/sec/android/app/sbrowser/payments/standard/ui/c;-><init>(Ljava/lang/Object;I)V
...
.method private disconnectChannel()V
    ...
    iget-object p0, p0, Lcom/sec/terrace/browser/customtabs/TerracePostMessageHandler;->mPostMessageBackend:Landroidx/browser/customtabs/PostMessageBackend;

    invoke-static {}, Lorg/chromium/base/ContextUtils;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    invoke-interface {p0, v0}, Landroidx/browser/customtabs/PostMessageBackend;->onDisconnectChannel(Landroid/content/Context;)V
...
.method private initializeWithWebContents(Lorg/chromium/content_public/browser/WebContents;)V
    ...
    invoke-interface {p0, v4}, Landroidx/browser/customtabs/PostMessageBackend;->onNotifyMessageChannelReady(Landroid/os/Bundle;)Z
...
.method private synthetic lambda$new$0(Lorg/chromium/content_public/browser/MessagePayload;[Lorg/chromium/content_public/browser/MessagePort;)V
    ...
    invoke-interface {p0, p1, p2}, Landroidx/browser/customtabs/PostMessageBackend;->onPostMessage(Ljava/lang/String;Landroid/os/Bundle;)Z

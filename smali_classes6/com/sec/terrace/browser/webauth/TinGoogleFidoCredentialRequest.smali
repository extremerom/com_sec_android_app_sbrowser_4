...
.field private mFido2ApiClient:LM1/b;

.field private mIntentListener:Lk2/c;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/sec/terrace/browser/webauth/TinGoogleFidoCredentialRequest;->mIntentListener:Lk2/c;
...
.method private initFido2ApiClient()Z
    ...
    iget-object v0, p0, Lcom/sec/terrace/browser/webauth/TinGoogleFidoCredentialRequest;->mFido2ApiClient:LM1/b;
    ...
    sget-object v3, Lcom/google/android/gms/common/api/c;->V:Lcom/google/android/gms/common/api/b;

    new-instance v4, Ly1/a;

    invoke-direct {v4}, Ljava/lang/Object;-><init>()V

    sget-object v5, LM1/b;->a:Lcom/google/android/gms/common/api/g;

    invoke-direct {v2, v0, v5, v3, v4}, Lcom/google/android/gms/common/api/j;-><init>(Landroid/content/Context;Lcom/google/android/gms/common/api/g;Lcom/google/android/gms/common/api/c;Ly1/a;)V

    iput-object v2, p0, Lcom/sec/terrace/browser/webauth/TinGoogleFidoCredentialRequest;->mFido2ApiClient:LM1/b;
...
.method private processIntentResult(Landroid/content/Intent;)V
    ...
    invoke-static {p1, v0}, LTa/a;->c([BLandroid/os/Parcelable$Creator;)Lcom/google/android/gms/common/internal/safeparcel/SafeParcelable;
...
.method private processKeyResponse(Landroid/content/Intent;)V
    ...
    invoke-static {p1, v2}, LTa/a;->c([BLandroid/os/Parcelable$Creator;)Lcom/google/android/gms/common/internal/safeparcel/SafeParcelable;
...
.method private processPublicKeyCredential(Landroid/content/Intent;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/fido/fido2/api/common/PublicKeyCredential;->e()Lcom/google/android/gms/fido/fido2/api/common/AuthenticatorResponse;
...
.method public handleGetAssertionRequest(Lorg/chromium/blink/mojom/PublicKeyCredentialRequestOptions;Lorg/chromium/content_public/browser/RenderFrameHost;Lorg/chromium/url/Origin;Lcom/sec/terrace/browser/webauth/TinHandlerResponseCallback;)V
    ...
    iget-object p1, p0, Lcom/sec/terrace/browser/webauth/TinGoogleFidoCredentialRequest;->mFido2ApiClient:LM1/b;
    ...
    iput p4, p2, LO5/a;->b:I

    new-instance p4, Lv1/g;

    invoke-direct {p4}, Ljava/lang/Object;-><init>()V

    iput-object p3, p4, Lv1/g;->a:Ljava/lang/Object;

    iput-object p4, p2, LO5/a;->c:Ljava/lang/Object;

    invoke-virtual {p2}, LO5/a;->c()Ly1/P;

    move-result-object p2

    invoke-virtual {p1, p2}, Lcom/google/android/gms/common/api/j;->doRead(Ly1/v;)Lk2/e;

    move-result-object p1

    iget-object p0, p0, Lcom/sec/terrace/browser/webauth/TinGoogleFidoCredentialRequest;->mIntentListener:Lk2/c;

    invoke-virtual {p1, p0}, Lk2/e;->c(Lk2/c;)Lk2/l;
...
.method public handleIsUserVerifyingPlatformAuthenticatorAvailableRequest(Lorg/chromium/content_public/browser/RenderFrameHost;Lcom/sec/terrace/browser/webauth/TinHandlerResponseCallback;)V
    ...
    invoke-direct {v0, p1}, Lcom/google/android/gms/iid/e;-><init>(LM1/b;)V

    iput-object v0, p2, LO5/a;->c:Ljava/lang/Object;

    sget-object v0, LK1/a;->a:Lcom/google/android/gms/common/Feature;
...
.method public handleMakeCredentialRequest(Lorg/chromium/blink/mojom/PublicKeyCredentialCreationOptions;Lorg/chromium/content_public/browser/RenderFrameHost;Lorg/chromium/url/Origin;Lcom/sec/terrace/browser/webauth/TinHandlerResponseCallback;)V
    ...
    iput p4, p3, LO5/a;->b:I

    new-instance p4, LB2/j;

    invoke-direct {p4, p1, p2}, LB2/j;-><init>(LM1/b;Lcom/google/android/gms/fido/fido2/api/common/BrowserPublicKeyCredentialCreationOptions;)V

    iput-object p4, p3, LO5/a;->c:Ljava/lang/Object;

    invoke-virtual {p3}, LO5/a;->c()Ly1/P;
...
.method public onIntentCompleted(ILandroid/content/Intent;)V
    ...
    invoke-static {p1, p2, v1}, Landroidx/appsearch/platformstorage/e;->A(ILjava/lang/String;Ljava/lang/String;)V

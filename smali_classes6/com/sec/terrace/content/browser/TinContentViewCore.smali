...
.field private mBottomControlsMinHeightPix:I
...
.field private mTopControlsMinHeightPix:I
...
.method public constructor <init>(Lorg/chromium/content_public/browser/WebContents;)V
    ...
    iput v0, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mTopControlsMinHeightPix:I

    iput v0, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mBottomControlsMinHeightPix:I
...
.method private handleSystemUiVisibilityChange()V
    ...
    invoke-direct {v0, p0, v2}, Lcom/sec/terrace/content/browser/c;-><init>(Ljava/lang/Object;I)V
...
.method private removeMultiSelectionJSHandler()V
    .locals 0
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/sec/terrace/content/browser/spen/multiselection/TinMultiSelectionHandler;->removeMultiSelectionJSHandler()V
...
.method private updateWebContentsSize()V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/sec/terrace/content/browser/TinContentViewCore;->getTopControlsMinHeightPix()I

    move-result v2

    invoke-virtual {p0}, Lcom/sec/terrace/content/browser/TinContentViewCore;->getBottomControlsMinHeightPix()I
    ...
    iget v4, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mSplitViewWidth:I

    sub-int v4, v1, v4

    sub-int/2addr v0, v3

    iget v3, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mSplitViewHeight:I

    sub-int/2addr v0, v3

    invoke-virtual {v2, v4, v0}, Lorg/chromium/content/browser/webcontents/WebContentsImpl;->setSize(II)V
...
.method public controlsResizeView()Z
    ...
    iget v1, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mTopControlsMinHeightPix:I
    ...
    iget p0, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mBottomControlsMinHeightPix:I
...
.method public destroy()V
    ...
    :cond_6
    invoke-direct {p0}, Lcom/sec/terrace/content/browser/TinContentViewCore;->removeMultiSelectionJSHandler()V
...
.method public disableBackgroundLayerOnToolbar(Lcom/sec/terrace/content/browser/TerraceBitmapLayer$BitmapLayer;)V
    .locals 4
    ...
    invoke-interface {v0, v1, v2, p0, p1}, Lcom/sec/terrace/content/browser/TinContentViewCore$Natives;->disableBackgroundLayerOnToolbar(JLcom/sec/terrace/content/browser/TinContentViewCore;I)V

    return-void
.end method

.method public disableBlurEffectOnToolbar(Lcom/sec/terrace/content/browser/TerraceBitmapLayer$BitmapLayer;)V
    .locals 4
    ...
    invoke-interface {v0, v1, v2, p0, p1}, Lcom/sec/terrace/content/browser/TinContentViewCore$Natives;->disableBlurEffectOnToolbar(JLcom/sec/terrace/content/browser/TinContentViewCore;I)V
...
.method public enableBackgroundLayerOnToolbar(Lcom/sec/terrace/content/browser/TerraceBitmapLayer$BitmapLayer;)V
    .locals 4
    ...
    invoke-interface {v0, v1, v2, p0, p1}, Lcom/sec/terrace/content/browser/TinContentViewCore$Natives;->enableBackgroundLayerOnToolbar(JLcom/sec/terrace/content/browser/TinContentViewCore;I)V
...
.method public enableBitmapCompositionForLayer(Lcom/sec/terrace/content/browser/TerraceBitmapLayer$BitmapLayer;ZLandroid/graphics/Bitmap;)V
    ...
    invoke-interface/range {v1 .. v7}, Lcom/sec/terrace/content/browser/TinContentViewCore$Natives;->enableBitmapCompositionForLayer(JLcom/sec/terrace/content/browser/TinContentViewCore;IZLandroid/graphics/Bitmap;)V
...
.method public getBottomControlsMinHeightPix()I
    .locals 0
    .annotation build Lorg/jni_zero/CalledByNative;
    .end annotation
...
.method public getTopControlsMinHeightPix()I
    .locals 0
    .annotation build Lorg/jni_zero/CalledByNative;
    .end annotation

    iget p0, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mTopControlsMinHeightPix:I
...
.method public onBottomControlsChanged(II)V
    ...
    iget p1, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mBottomControlsMinHeightPix:I
...
.method public onSizeChanged(IIII)V
    ...
    invoke-static {p1, p2, p3, p4, v0}, Landroidx/appcompat/graphics/drawable/a;->w(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public onTopControlsChanged(III)V
    ...
    iget p1, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mTopControlsMinHeightPix:I
...
.method public setTopControlsHeight()V
    ...
    iget v1, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mTopControlsHeightPix:I

    iget v2, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mBottomControlsHeightPix:I

    iget v3, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mTopControlsMinHeightPix:I

    iget v4, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mBottomControlsMinHeightPix:I

    invoke-virtual {p0}, Lcom/sec/terrace/content/browser/TinContentViewCore;->controlsResizeView()Z

    move-result v5

    move-object v0, p0

    invoke-virtual/range {v0 .. v5}, Lcom/sec/terrace/content/browser/TinContentViewCore;->setTopControlsHeight(IIIIZ)V

    return-void
.end method

.method public setTopControlsHeight(IIIIZ)V
    .locals 10
    ...
    iget p3, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mBottomControlsHeightPix:I

    if-ne p2, p3, :cond_4

    iget p3, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mTopControlsMinHeightPix:I

    if-ne v7, p3, :cond_4

    iget p3, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mBottomControlsMinHeightPix:I

    if-ne v8, p3, :cond_4

    iget-boolean p3, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mControlsResizeView:Z
    ...
    iput v7, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mTopControlsMinHeightPix:I

    iput v8, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mBottomControlsMinHeightPix:I

    iput-boolean p5, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mControlsResizeView:Z
    ...
    const-string p4, "setTopControlsHeight controlsResizeView "

    invoke-direct {p3, p4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-boolean p4, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mControlsResizeView:Z

    invoke-virtual {p3, p4}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string p4, " topControlsHeightPix : "

    invoke-virtual {p3, p4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget p4, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mTopControlsHeightPix:I

    invoke-virtual {p3, p4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string p4, " bottomControlsHeightPix : "

    invoke-virtual {p3, p4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget p4, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mBottomControlsHeightPix:I

    invoke-virtual {p3, p4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string p4, " topControlsMinHeightPix : "

    invoke-virtual {p3, p4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget p4, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mTopControlsMinHeightPix:I

    invoke-virtual {p3, p4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string p4, " bottomControlsMinHeightPix : "

    invoke-virtual {p3, p4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget p4, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mBottomControlsMinHeightPix:I

    const-string p5, "TinContentViewCore"

    invoke-static {p3, p4, p5}, Landroidx/appcompat/graphics/drawable/a;->A(Ljava/lang/StringBuilder;ILjava/lang/String;)V
    ...
    iget-boolean v9, p0, Lcom/sec/terrace/content/browser/TinContentViewCore;->mResizeInProgress:Z
    ...
    invoke-interface/range {v1 .. v9}, Lcom/sec/terrace/content/browser/TinContentViewCore$Natives;->setTopControlsHeight(JLcom/sec/terrace/content/browser/TinContentViewCore;IIIIZ)V
...
.method public setViewportSize(II)V
    ...
    invoke-static {p1, p2, v0, v1, v2}, Landroidx/appcompat/graphics/drawable/a;->w(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public updateBitmapToolbarLayerVisibility(Lcom/sec/terrace/content/browser/TerraceBitmapLayer$BitmapLayer;Z)V
    .locals 7
    ...
    invoke-interface/range {v1 .. v6}, Lcom/sec/terrace/content/browser/TinContentViewCore$Natives;->updateBitmapToolbarLayerVisibility(JLcom/sec/terrace/content/browser/TinContentViewCore;IZ)V
...
.method public updateCompactModeState(Z)V
    .locals 4
    ...
    invoke-interface {v0, v1, v2, p0, p1}, Lcom/sec/terrace/content/browser/TinContentViewCore$Natives;->updateCompactModeState(JLcom/sec/terrace/content/browser/TinContentViewCore;Z)V

...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "writing_toolkit"
...
.method private addSecDictionaryItem(Landroid/view/Menu;I)V
    .locals 4
    ...
    invoke-interface {p1, p2, v1, v2, v0}, Landroid/view/Menu;->add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    sget p2, Lcom/sec/terrace/content/browser/TinSelectionPopupControllerImpl;->DICTIONARY_DRAWABLE:I
...
.method public static synthetic o(Landroid/app/PendingIntent;Landroid/view/View;)V
    .locals 0
...
.method public static bridge synthetic p(Lcom/sec/terrace/content/browser/TinSelectionPopupControllerImpl;)Lcom/sec/terrace/content/browser/TinSelectionPopupControllerImpl$TinSelectionDelegate;
    .locals 0
...
.method public static bridge synthetic q(Lcom/sec/terrace/content/browser/TinSelectionPopupControllerImpl;)Z
    .locals 0
...
.method public static bridge synthetic r(Lcom/sec/terrace/content/browser/TinSelectionPopupControllerImpl;)V
    .locals 0
...
.method public static bridge synthetic s(Lcom/sec/terrace/content/browser/TinSelectionPopupControllerImpl;)V
    .locals 0
...
.method public addOrRemoveExtraMenuItems(Landroid/view/Menu;)V
    ...
    sget v2, Lcom/sec/terrace/R$id;->select_action_menu_web_search:I
    ...
    invoke-virtual {p0}, Lcom/sec/terrace/content/browser/TinSelectionPopupControllerImpl;->canShowSecClipboard()Z

    move-result v4

    if-eqz v4, :cond_1

    sget v4, Lcom/sec/terrace/R$id;->select_action_menu_default_items:I

    const/4 v5, 0x5

    sget v6, Lcom/sec/terrace/content/browser/TinSelectionPopupControllerImpl;->STR_CLIPBOARD:I

    invoke-interface {p1, v4, v5, v3, v6}, Landroid/view/Menu;->add(IIII)Landroid/view/MenuItem;
    ...
    invoke-direct {p0, p1, v4}, Lcom/sec/terrace/content/browser/TinSelectionPopupControllerImpl;->addSecDictionaryItem(Landroid/view/Menu;I)V

    :cond_2
    iget-boolean v4, p0, Lcom/sec/terrace/content/browser/TinSelectionPopupControllerImpl;->mFindEnabled:Z
    ...
    iget-boolean v0, p0, Lcom/sec/terrace/content/browser/TinSelectionPopupControllerImpl;->mIsInExtension:Z

    if-nez v0, :cond_3

    sget v0, Lcom/sec/terrace/R$id;->select_action_menu_default_items:I
    ...
    sget v0, Lcom/sec/terrace/R$drawable;->tin_select_action_popup_find:I
...
.method public isPackageAvailable(Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1, v1}, LJ7/b;->D(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public isWritingToolkitSupported()Z
    ...
    const-string p0, "Writing Toolkit not enabled."
    ...
    const-string v0, "Writing toolkit intent handling activity is not available."
    ...
    :cond_3
    :goto_0
    const-string p0, "Writing Toolkit not supported"
...
.method public updateWritingToolkit()V
    ...
    invoke-static {v0}, Lcom/sec/android/app/sbrowser/tab_bar/ui/i;->p(Landroid/view/inputmethod/InputMethodManager;)Landroid/view/inputmethod/InputMethodInfo;

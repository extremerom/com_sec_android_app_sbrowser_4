...
.method public onPerformCurrentSelection(II)V
    ...
    invoke-direct {v1, p2, p1, v2, p0}, Lcom/google/android/material/chip/g;-><init>(IIILjava/lang/Object;)V
...
.method public removeMultiSelectionJSHandler()V
    .locals 1
    ...
    const-string v0, "multiSelectionObj"

    invoke-interface {p0, v0}, Lorg/chromium/content_public/browser/JavascriptInjector;->removeInterface(Ljava/lang/String;)V

...
.method private a(Lcom/ss/android/socialbase/downloader/model/DownloadInfo;)V
    ...
    new-instance v0, Lcom/ss/android/downloadlib/addownload/c/b;

    invoke-direct {v0, p1}, Lcom/ss/android/downloadlib/addownload/c/b;-><init>(Lcom/ss/android/socialbase/downloader/model/DownloadInfo;)V

    invoke-virtual {p0, v0}, Lcom/ss/android/downloadlib/d;->b(Ljava/lang/Runnable;)V
...
.method public a(Lcom/ss/android/socialbase/downloader/model/DownloadInfo;Lcom/ss/android/socialbase/downloader/exception/BaseException;I)V
    ...
    invoke-direct {v2, p0, v1, p3}, Lcom/ss/android/downloadlib/c$2;-><init>(Lcom/ss/android/downloadlib/c;Lcom/ss/android/socialbase/downloader/setting/DownloadSetting;Lcom/ss/android/download/api/download/DownloadModel;)V
    ...
    const-string p3, "exception_msg_length"

    const/16 v0, 0x1f4

    invoke-virtual {p0, p3, v0}, Lorg/json/JSONObject;->optInt(Ljava/lang/String;I)I
    ...
    invoke-static {p3, p0}, Lcom/ss/android/downloadlib/g/m;->a(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object p0

    new-instance p3, Lcom/ss/android/socialbase/downloader/exception/BaseException;

    invoke-virtual {p2}, Lcom/ss/android/socialbase/downloader/exception/BaseException;->getErrorCode()I

    move-result v0

    invoke-direct {p3, v0, p0}, Lcom/ss/android/socialbase/downloader/exception/BaseException;-><init>(ILjava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p3}, Lcom/ss/android/downloadlib/d/a;->b(Lcom/ss/android/socialbase/downloader/model/DownloadInfo;Lcom/ss/android/socialbase/downloader/exception/BaseException;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/ss/android/downloadlib/g;->a(Lcom/ss/android/socialbase/downloader/model/DownloadInfo;Lcom/ss/android/socialbase/downloader/exception/BaseException;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v1, p2}, Lcom/ss/android/downloadlib/a;->a(Lcom/ss/android/socialbase/downloader/model/DownloadInfo;Lcom/ss/android/downloadad/api/a/b;I)V
    ...
    const-string p2, "onAppDownloadMonitorSend"

...
# static fields
.field private static final bf:Ljava/lang/String; = "taskName = %s|token = %s|handler = %s|threadName = %s|threadId = %d|priority = %d|addTime = %d|delayTime = %d|usedTime = %d|cpuTime = %d|started = %b"

.field private static final bg:Ljava/lang/String; = "taskName = %s | addTime = %s | endTime = %s | usedTime = %d | cpuTime = %d | threadCpuTime = %d | totalCpuTime = %d | threadCpuRate = %.1f"
...
# direct methods
.method public constructor <init>(Ljava/lang/Thread;Landroid/os/Handler;Ljava/lang/Runnable;Ljava/lang/Object;Lcom/tencent/mm/sdk/b/g$a;)V
    .locals 2

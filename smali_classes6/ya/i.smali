...
# instance fields
.field public final a:Lio/ktor/utils/io/jvm/javaio/i;
...
# direct methods
.method public constructor <init>(Lio/ktor/utils/io/jvm/javaio/i;Ljava/nio/charset/Charset;)V
    .locals 2
    ...
    iput-object p1, p0, Lya/i;->a:Lio/ktor/utils/io/jvm/javaio/i;
    ...
    iput-object p1, p0, Lya/i;->b:Ljava/nio/charset/CharsetDecoder;

    sget-object p1, Lya/e;->c:Lya/e;

    monitor-enter p1

    :try_start_0
    iget-object p2, p1, LB2/h;->b:Ljava/lang/Object;
    ...
    :cond_0
    invoke-virtual {p2}, Ly8/p;->removeLast()Ljava/lang/Object;
    ...
    iput-object p1, p0, Lya/i;->c:Ljava/nio/ByteBuffer;
...
.method public final a([CII)I
    ...
    iget-boolean v1, p0, Lya/i;->d:Z

    const/4 v2, 0x1

    if-eqz v1, :cond_2

    iget-char v1, p0, Lya/i;->e:C
    ...
    iget-boolean p3, p0, Lya/i;->d:Z

    if-eqz p3, :cond_3

    iput-boolean v0, p0, Lya/i;->d:Z

    iget-char p0, p0, Lya/i;->e:C
    ...
    invoke-virtual {p0, v4, v0, p3}, Lya/i;->a([CII)I
    ...
    iput-char p3, p0, Lya/i;->e:C

    iput-boolean v2, p0, Lya/i;->d:Z
    ...
    :cond_b
    :goto_2
    iget-object p2, p0, Lya/i;->b:Ljava/nio/charset/CharsetDecoder;

    iget-object p3, p0, Lya/i;->c:Ljava/nio/ByteBuffer;
    ...
    :goto_3
    iget-object v7, p0, Lya/i;->a:Lio/ktor/utils/io/jvm/javaio/i;
    ...
    invoke-virtual {v7, v8, v9, v5}, Lio/ktor/utils/io/jvm/javaio/i;->read([BII)I
    ...
    invoke-static {p2, p3, p0, v0, v0}, Landroidx/appsearch/platformstorage/e;->u(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

...
# direct methods
.method public constructor <init>(Landroidx/compose/foundation/text/KeyCommand;Landroidx/compose/foundation/text/TextFieldKeyInput;Lkotlin/jvm/internal/C;)V
    .locals 0
    ...
    iput-object p3, p0, Landroidx/compose/foundation/text/TextFieldKeyInput$process$2;->$consumed:Lkotlin/jvm/internal/C;
...
.method public final invoke(Landroidx/compose/foundation/text/selection/TextFieldPreparedSelection;)V
    ...
    invoke-static {p0}, Landroidx/compose/foundation/text/TextFieldKeyInput;->access$getOnValueChange$p(Landroidx/compose/foundation/text/TextFieldKeyInput;)LL8/k;
    ...
    :cond_1
    iget-object p0, p0, Landroidx/compose/foundation/text/TextFieldKeyInput$process$2;->$consumed:Lkotlin/jvm/internal/C;

    iput-boolean v2, p0, Lkotlin/jvm/internal/C;->a:Z
    ...
    invoke-virtual {p1, v0}, Landroidx/compose/foundation/text/selection/TextFieldPreparedSelection;->deleteIfSelectedOr(LL8/k;)Ljava/util/List;
    ...
    invoke-virtual {p1, p0}, Landroidx/compose/foundation/text/selection/BaseTextPreparedSelection;->collapseRightOr(LL8/k;)Landroidx/compose/foundation/text/selection/BaseTextPreparedSelection;
    ...
    invoke-virtual {p1, p0}, Landroidx/compose/foundation/text/selection/BaseTextPreparedSelection;->collapseLeftOr(LL8/k;)Landroidx/compose/foundation/text/selection/BaseTextPreparedSelection;

...
# instance fields
.field final synthetic $appliedChanges:Lha/n;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lha/n;"
        }
...
.method public constructor <init>(Lha/n;)V
    ...
    iput-object p1, p0, Landroidx/compose/runtime/SnapshotStateKt__SnapshotFlowKt$snapshotFlow$1$unregisterApplyObserver$1;->$appliedChanges:Lha/n;
...
.method public final invoke(Ljava/util/Set;Landroidx/compose/runtime/snapshots/Snapshot;)V
    ...
    :goto_3
    iget-object v1, v1, Landroidx/compose/runtime/SnapshotStateKt__SnapshotFlowKt$snapshotFlow$1$unregisterApplyObserver$1;->$appliedChanges:Lha/n;

    invoke-interface {v1, v0}, Lha/B;->trySend-JP2dKIU(Ljava/lang/Object;)Ljava/lang/Object;

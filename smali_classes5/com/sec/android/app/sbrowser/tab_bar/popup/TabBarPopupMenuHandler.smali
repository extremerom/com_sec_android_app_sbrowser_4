...
# instance fields
.field private mCloseConfirmDialog:Landroidx/appcompat/app/AlertDialog;
...
.method public static synthetic f(Lcom/sec/android/app/sbrowser/tab_bar/popup/TabBarPopupMenuHandler;Landroidx/appcompat/widget/PopupMenu;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/tab_bar/popup/TabBarPopupMenuHandler;->lambda$showPopupMenu$1(Landroidx/appcompat/widget/PopupMenu;)V
...
.method public static synthetic i(Lcom/sec/android/app/sbrowser/tab_bar/popup/TabBarPopupMenuHandler;Landroidx/appcompat/widget/PopupMenu;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/tab_bar/popup/TabBarPopupMenuHandler;->lambda$showMoveToGroupPopup$2(Landroidx/appcompat/widget/PopupMenu;)V

    return-void
.end method

.method public static synthetic j(Lcom/sec/android/app/sbrowser/tab_bar/popup/TabBarPopupMenuHandler;Landroidx/appcompat/widget/PopupMenu;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/tab_bar/popup/TabBarPopupMenuHandler;->lambda$showPopupMenu$0(Landroidx/appcompat/widget/PopupMenu;)V
...
.method private synthetic lambda$showMoveToGroupPopup$2(Landroidx/appcompat/widget/PopupMenu;)V
    .locals 0
...
.method private synthetic lambda$showPopupMenu$1(Landroidx/appcompat/widget/PopupMenu;)V
    .locals 0
...
.method public dismissCloseConfirmDialog()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/tab_bar/popup/TabBarPopupMenuHandler;->mCloseConfirmDialog:Landroidx/appcompat/app/AlertDialog;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/tab_bar/popup/TabBarPopupMenuHandler;->mCloseConfirmDialog:Landroidx/appcompat/app/AlertDialog;
...
.method public getCloseConfirmDialog()Landroidx/appcompat/app/AlertDialog;
    .locals 0
    .annotation build Landroidx/annotation/VisibleForTesting;
        otherwise = 0x5
    .end annotation

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/tab_bar/popup/TabBarPopupMenuHandler;->mCloseConfirmDialog:Landroidx/appcompat/app/AlertDialog;
...
.method public showCloseAllTabDialog(Landroid/content/Context;Landroid/view/View;)V
    ...
    invoke-direct {v8, p0, v0}, LE6/e;-><init>(Ljava/lang/Object;I)V

    new-instance v9, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/view/z;

    const/16 v0, 0x19

    invoke-direct {v9, v0}, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/view/z;-><init>(I)V

    move-object v4, p1

    move-object v5, p2

    invoke-static/range {v4 .. v9}, Lcom/sec/android/app/sbrowser/tab_bar/popup/TabBarCloseConfirmDialog;->showCloseAllTabDialog(Landroid/content/Context;Landroid/view/View;ZZLandroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/sbrowser/tab_bar/popup/TabBarPopupMenuHandler;->mCloseConfirmDialog:Landroidx/appcompat/app/AlertDialog;
...
.method public showCloseAllTabInGroupDialog(Landroid/content/Context;Landroid/view/View;Ljava/lang/String;)V
    ...
    :goto_1
    new-instance v5, Landroidx/media3/ui/l;

    const/16 v0, 0x8

    invoke-direct {v5, v0, p0, p3}, Landroidx/media3/ui/l;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    new-instance v6, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/view/z;

    const/16 v0, 0x1b

    invoke-direct {v6, v0}, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/view/z;-><init>(I)V
    ...
    invoke-static/range {v1 .. v6}, Lcom/sec/android/app/sbrowser/tab_bar/popup/TabBarCloseConfirmDialog;->showCloseGroupDialog(Landroid/content/Context;Landroid/view/View;Ljava/lang/String;ZLandroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog;
...
.method public showCloseOtherTabDialog(Landroid/content/Context;Landroid/view/View;I)V
    ...
    invoke-direct {v8, p0, p3, v0}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/tab_cardlist/b;-><init>(Ljava/lang/Object;II)V

    new-instance v9, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/view/z;

    const/16 p3, 0x1a

    invoke-direct {v9, p3}, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/view/z;-><init>(I)V

    move-object v4, p1

    move-object v5, p2

    invoke-static/range {v4 .. v9}, Lcom/sec/android/app/sbrowser/tab_bar/popup/TabBarCloseConfirmDialog;->showCloseAllOtherTabsDialog(Landroid/content/Context;Landroid/view/View;ZZLandroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog;
...
.method public showCreateGroupDialog(Landroid/content/Context;Landroid/view/View;I)V
    ...
    invoke-direct {v2, p0, p3, v3}, Landroidx/media3/common/g;-><init>(Ljava/lang/Object;II)V
...
.method public showRenameGroupDialog(Landroid/content/Context;Landroid/view/View;Ljava/lang/String;I)V
    ...
    invoke-direct {v2, p0, p3, p4, v3}, Landroidx/media3/common/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;II)V

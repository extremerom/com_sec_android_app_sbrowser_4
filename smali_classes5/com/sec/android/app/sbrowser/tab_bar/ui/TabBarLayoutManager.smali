...
.method private calculateTabBarWidth(III)V
    ...
    invoke-static {v9, v3, v4}, LJ7/b;->q(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v1, v0, v2}, Landroidx/appcompat/graphics/drawable/a;->A(Ljava/lang/StringBuilder;ILjava/lang/String;)V
...
.method public updateParentLayout(Lcom/sec/android/app/sbrowser/tab_bar/ui/TabBarParentLayout;I)V
    ...
    iget v0, p0, Lcom/sec/android/app/sbrowser/tab_bar/ui/TabBarLayoutManager;->mTabBarWidth:I

    iget v2, p0, Lcom/sec/android/app/sbrowser/tab_bar/ui/TabBarLayoutManager;->mOverlappedPadding:I

    mul-int/lit8 v3, v2, 0x2

    add-int/2addr v3, v0

    iput v3, p0, Lcom/sec/android/app/sbrowser/tab_bar/ui/TabBarLayoutManager;->mTabBarWidth:I

    invoke-virtual {p1, v2, v1, v2, v1}, Landroid/view/View;->setPaddingRelative(IIII)V

    goto :goto_0

    :cond_1
    iget-boolean v0, p0, Lcom/sec/android/app/sbrowser/tab_bar/ui/TabBarLayoutManager;->mIsWrapLayoutNeeded:Z

    if-eqz v0, :cond_2

    iget v0, p0, Lcom/sec/android/app/sbrowser/tab_bar/ui/TabBarLayoutManager;->mTabBarWidth:I

    iget v2, p0, Lcom/sec/android/app/sbrowser/tab_bar/ui/TabBarLayoutManager;->mTabBarParentWidth:I

    invoke-static {v0, v2}, Ljava/lang/Math;->min(II)I

    move-result v0

    iput v0, p0, Lcom/sec/android/app/sbrowser/tab_bar/ui/TabBarLayoutManager;->mTabBarWidth:I

...
.method public loadFavicon(Lcom/sec/android/app/sbrowser/tab_bar/ui/TabButtonView;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v4}, Lcom/sec/android/app/sbrowser/common/utils/IconFetcher;->getBitmapFromMemCache(Ljava/lang/String;)Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/sec/android/app/sbrowser/tab_bar/ui/util/TabButtonFaviconFetcher;->isAvailableFavicon(Landroid/graphics/Bitmap;)Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-virtual {p1, v0, p2}, Lcom/sec/android/app/sbrowser/tab_bar/ui/TabButtonView;->updateFavicon(Landroid/graphics/Bitmap;Ljava/lang/String;)V
    ...
    iget-object v8, p0, Lcom/sec/android/app/sbrowser/tab_bar/ui/util/TabButtonFaviconFetcher;->mFaviconHelper:Lcom/sec/terrace/browser/favicon/TerraceFaviconHelper;
    ...
    invoke-direct/range {v2 .. v7}, LZ6/a;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-virtual {v8, p2, v0, v1, v9}, Lcom/sec/terrace/browser/favicon/TerraceFaviconHelper;->getLargestRawFaviconForUrl(Ljava/lang/String;[IILcom/sec/terrace/browser/favicon/TerraceFaviconHelper$FaviconImageCallback;)V

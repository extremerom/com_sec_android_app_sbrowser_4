.class public final Lcom/sec/android/app/sbrowser/multi_cp_native/newsfeed/model/room/TTDiggDao_Impl$1;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "com/sec/android/app/sbrowser/multi_cp_native/newsfeed/model/room/TTDiggDao_Impl$1",
        "Landroidx/room/EntityInsertAdapter;",
        "Lcom/sec/android/app/sbrowser/multi_cp_native/newsfeed/model/room/TTDiggEntity;",
        "",
        "createQuery",
...
.method public bridge synthetic bind(Landroidx/sqlite/SQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/sec/android/app/sbrowser/multi_cp_native/newsfeed/model/room/TTDiggDao_Impl$1;->bind(Landroidx/sqlite/SQLiteStatement;Lcom/sec/android/app/sbrowser/multi_cp_native/newsfeed/model/room/TTDiggEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string p0, "INSERT OR REPLACE INTO `tt_digg` (`id`,`article_url`,`author`,`bury_count`,`duration`,`group_id`,`item_id`,`group_source`,`comment_count`,`detail_source`,`digg_count`,`share_count`,`has_video`,`watch_count`,`title`,`timestamp`,`video_id`,`publish_time`,`share_url`,`comment_url`,`cover_mode`,`cover_url`,`height`,`width`,`category`,`is_like_on`,`is_bury_on`,`article_class`,`avatar_url`,`is_secret`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"

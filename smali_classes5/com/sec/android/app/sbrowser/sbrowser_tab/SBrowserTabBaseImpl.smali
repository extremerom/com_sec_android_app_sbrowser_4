...
.method public static synthetic g(Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTabBaseImpl;Ljava/lang/Boolean;)Lw8/B;
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTabBaseImpl;->lambda$getRestrictHelper$5(Ljava/lang/Boolean;)Lw8/B;
...
.method private getRestrictHelper()Lcom/sec/android/app/sbrowser/parental_control/AbsContentRestrictHelper;
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/sbrowser_tab/k;

    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/sbrowser_tab/k;-><init>(Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTabBaseImpl;)V

    invoke-static {v0, v1}, Lcom/sec/android/app/sbrowser/parental_control/ContentRestrictHelperFactory;->getOrCreate(Lcom/sec/android/app/sbrowser/parental_control/AbsContentRestrictHelper;LL8/k;)Lcom/sec/android/app/sbrowser/parental_control/AbsContentRestrictHelper;
...
.method private initializeContextMenu()V
    ...
    new-instance v3, Lcom/sec/android/app/sbrowser/sbrowser_tab/j;

    invoke-direct {v3, p0}, Lcom/sec/android/app/sbrowser/sbrowser_tab/j;-><init>(Ljava/lang/Object;)V
...
.method private synthetic lambda$getRestrictHelper$5(Ljava/lang/Boolean;)Lw8/B;
    .locals 0
...
.method public isBookmarkAvailable()Z
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTabBaseImpl;->isMultiCpUrl()Z
...
.method public isLightThemedBackground()Z
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/sbrowser_tab/NativePageHandler;->isLightThemedBackground()Z
...
.method public isMultiCpNativeUrl()Z
    .locals 2
...
.method public isMultiCpUrl()Z
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/utils/MultiCpUtils;->isMultiCpUrl(Ljava/lang/String;)Z
...
.method public isQuickAccessNativePage()Z
    ...
    instance-of v1, v0, Lcom/sec/android/app/sbrowser/multi_cp_native/MultiCPNativePage;

    const/4 v2, 0x0

    if-eqz v1, :cond_0

    check-cast v0, Lcom/sec/android/app/sbrowser/multi_cp_native/MultiCPNativePage;

    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/multi_cp_native/MultiCPNativePage;->getView()Landroid/view/View;

    move-result-object v0

    instance-of v0, v0, Lcom/sec/android/app/sbrowser/multi_cp_native/SimpleHomePage;
    ...
    instance-of v1, v1, Lcom/sec/android/app/sbrowser/quickaccess/QuickAccessPage;
...
.method public loadParentalControlUnblockedUrl()V
    ...
    invoke-direct {v1, p0, v0, v2}, Lcom/sec/android/app/sbrowser/sbrowser_tab/l;-><init>(Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTabBase;Ljava/lang/String;I)V
...
.method public loadUrlFromQRScanResult(Landroid/content/Intent;)V
    .locals 8
    ...
    const-string v0, "SBROWSER_QR_URL_RESULT"

    invoke-virtual {p1, v0}, Landroid/content/Intent;->getStringExtra(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-static {v3}, Lcom/sec/android/app/sbrowser/qrcode/QRCodeHelper;->isSafeURL(Ljava/lang/String;)Z
...
.method public loadUrlWithRunnable(Ljava/lang/String;)V
    ...
    invoke-direct {v1, p0, p1, v2}, Lcom/sec/android/app/sbrowser/sbrowser_tab/l;-><init>(Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTabBase;Ljava/lang/String;I)V
...
.method public onReportCrash(ZI)V
    ...
    invoke-static {v3, v4, p1, v0}, Landroidx/glance/oneui/template/layout/glance/a;->p(JLjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0, v5}, Lcom/sec/android/app/sbrowser/sbrowser_tab/m;-><init>(Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTabBaseImpl;I)V
...
.method public showReloadTipCardIfNeeded()V
    ...
    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/sbrowser_tab/UserAgentOverrideManager;->checkShouldUseDesktopUserAgent()Z

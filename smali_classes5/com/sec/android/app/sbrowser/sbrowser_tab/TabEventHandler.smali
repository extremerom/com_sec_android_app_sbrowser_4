...
.field private mBitmapTextExtractor:Lcom/sec/android/app/sbrowser/image_text_extraction/BitmapTextExtractor;
...
.method public constructor <init>(Lcom/sec/android/app/sbrowser/tab/TabObserver;Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTab;)V
    ...
    new-instance p2, Lcom/sec/android/app/sbrowser/sbrowser_tab/j;

    invoke-direct {p2, p0}, Lcom/sec/android/app/sbrowser/sbrowser_tab/j;-><init>(Ljava/lang/Object;)V
...
.method private addShortcutInternal(II)V
    ...
    :cond_0
    new-instance v0, Lcom/sec/android/app/sbrowser/sbrowser_tab/o;

    const/4 v1, 0x0

    invoke-direct {v0, p0, p1, p2, v1}, Lcom/sec/android/app/sbrowser/sbrowser_tab/o;-><init>(Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler;III)V
    ...
    :cond_1
    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/sbrowser_tab/o;->run()V
...
.method private initLiveTextController()V
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler$4;

    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler$4;-><init>(Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler;)V
...
.method private initializeAppBanner()V
    ...
    new-instance v3, Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler$5;

    invoke-direct {v3, p0}, Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler$5;-><init>(Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler;)V
...
.method private initializeInfoBar()V
    ...
    new-instance v4, Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler$3;

    invoke-direct {v4, p0}, Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler$3;-><init>(Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler;)V

    invoke-direct {v1, v0, v2, v3, v4}, Lcom/sec/android/app/sbrowser/infobars/InfoBarService;-><init>(Lcom/sec/terrace/Terrace;Landroid/content/Context;Landroid/view/ViewGroup;Lcom/sec/android/app/sbrowser/infobars/InfoBarContainer$InfoBarContainerObserver;)V
...
.method public addShortcut(IILandroid/view/View;Z)V
    ...
    invoke-direct {v1, p0, p1, p2, v2}, Lcom/sec/android/app/sbrowser/sbrowser_tab/o;-><init>(Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler;III)V
...
.method public dismissDialogForNavigation()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/sec/android/app/sbrowser/externalnav/external_intents/ExternalNavigationHandler;->dismissDialogForNavigation(ZZ)V
...
.method public getBitmapTextExtractor()Lcom/sec/android/app/sbrowser/image_text_extraction/BitmapTextExtractor;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    :cond_0
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler;->mBitmapTextExtractor:Lcom/sec/android/app/sbrowser/image_text_extraction/BitmapTextExtractor;

    if-nez v0, :cond_1

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler;->mTab:Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTab;

    invoke-static {v0}, Lcom/sec/android/app/sbrowser/image_text_extraction/BitmapTextExtractor;->createBitmapTextExtractor(Lcom/sec/android/app/sbrowser/common/model/sbrowser_tab/SBrowserTabDelegate;)Lcom/sec/android/app/sbrowser/image_text_extraction/BitmapTextExtractor;

    move-result-object v0

    iput-object v0, p0, Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler;->mBitmapTextExtractor:Lcom/sec/android/app/sbrowser/image_text_extraction/BitmapTextExtractor;

    :cond_1
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler;->mBitmapTextExtractor:Lcom/sec/android/app/sbrowser/image_text_extraction/BitmapTextExtractor;
...
.method public onBackgroundColorChanged(I)V
    ...
    invoke-interface {p0, p1}, Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTab;->setContentBackgroundColor(I)V
...
.method public onOpenNewTab(Ljava/lang/String;Ljava/lang/String;IZLcom/sec/terrace/TerraceOrigin;Z)V
    ...
    invoke-static {p3, p4, p5}, Landroidx/compose/ui/input/pointer/a;->B(ILjava/lang/String;Ljava/lang/String;)V
...
.method public onPrimaryMainDocumentElementAvailable()V
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/sbrowser_tab/n;

    const/4 v2, 0x1

    invoke-direct {v1, p0, v2}, Lcom/sec/android/app/sbrowser/sbrowser_tab/n;-><init>(Lcom/sec/android/app/sbrowser/sbrowser_tab/TabEventHandler;I)V
...
.method public onWebSearch(Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, v0}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->A(Landroid/content/ActivityNotFoundException;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public supportPullToRefresh()Z
    ...
    const-string v2, "athena-dev.internet.apps.samsung.com"

...
.method public constructor <init>()V
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/settings/SettingsActivity$2;

    invoke-direct {v0, p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity$2;-><init>(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
...
.method private hideSearchView(Lcom/sec/android/app/sbrowser/settings/utils/SettingsUtils$TaskCompletionCallback;Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/settings/FragmentCommonHelper;->setRecyclerViewToFloating(Landroidx/appcompat/app/AppCompatActivity;)V

    iput-boolean v1, p0, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->mIsHideSearchViewInProgress:Z
    ...
    invoke-direct {v1, p0, v2, p2, p1}, Landroidx/media3/common/util/b;-><init>(Ljava/lang/Object;ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v2, p0}, Lcom/sec/android/app/sbrowser/settings/I;-><init>(ILcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
...
.method private initSearchDataAndLayout()V
    ...
    invoke-static {v0}, Lcom/sec/android/app/sbrowser/settings/utils/SettingsHelper;->hideAppCompatTextView(Landroidx/appcompat/widget/Toolbar;)V

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->mSettingSearchBase:Lcom/sec/android/app/sbrowser/settings/search/SettingSearchBase;

    iget-object v2, p0, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->mSearchView:Landroid/view/View;

    invoke-virtual {v0, v2}, Lcom/sec/android/app/sbrowser/settings/search/SettingSearchBase;->showSearchView(Landroid/view/View;)V
...
.method private initSecretModeChangedListener()V
    ...
    invoke-direct {v0, p0}, Lcom/sec/android/app/sbrowser/settings/H;-><init>(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
...
.method private isActivityInValidState()Z
    .locals 1
...
.method public static synthetic l(Lcom/sec/android/app/sbrowser/settings/SettingsFragment;Landroid/os/Bundle;Lcom/sec/android/app/sbrowser/settings/search/SettingSearchItem;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->lambda$setOnClickForSearchItem$10(Lcom/sec/android/app/sbrowser/settings/SettingsFragment;Landroid/os/Bundle;Lcom/sec/android/app/sbrowser/settings/search/SettingSearchItem;)V

    return-void
.end method

.method private static synthetic lambda$finishAllActivities$9(Landroid/app/Activity;Z)V
    .locals 1
...
.method private synthetic lambda$hideSearchView$6(Ljava/lang/String;Lcom/sec/android/app/sbrowser/settings/utils/SettingsUtils$TaskCompletionCallback;)V
    .locals 5
    ...
    iget-object v4, p0, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->mSearchView:Landroid/view/View;
    ...
    :cond_1
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/settings/SettingsAppBarUtil;->isToolbarShowingFloatingItemBackground(Landroid/app/Activity;)Z
    ...
    iget-boolean v2, p0, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->mIsInActionMode:Z

    invoke-static {p0, p1, v2}, Lcom/sec/android/app/sbrowser/settings/SettingsActivityHelper;->updateFloatingToolbarTitleVisibility(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;ZZ)V
...
.method private synthetic lambda$hideSearchView$7()V
    .locals 1
...
.method private synthetic lambda$initSecretModeChangedListener$5(ZLandroid/os/Bundle;)V
    .locals 0
...
.method private synthetic lambda$onBackPressed$8(Landroidx/fragment/app/Fragment;)V
    .locals 1
...
.method private synthetic lambda$safePostDelayed$0(Ljava/lang/Runnable;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->isActivityInValidState()Z
...
.method private synthetic lambda$setLayoutChangeListener$2()V
    .locals 1
...
.method private synthetic lambda$setLayoutChangeListener$3(Landroid/view/View;IIIIIIII)V
    .locals 0
    ...
    new-instance p2, Lcom/sec/android/app/sbrowser/settings/I;

    const/4 p3, 0x0

    invoke-direct {p2, p3, p0}, Lcom/sec/android/app/sbrowser/settings/I;-><init>(ILcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
...
.method private static synthetic lambda$setOnClickForSearchItem$10(Lcom/sec/android/app/sbrowser/settings/SettingsFragment;Landroid/os/Bundle;Lcom/sec/android/app/sbrowser/settings/search/SettingSearchItem;)V
    .locals 0
...
.method public static synthetic m(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;Ljava/lang/Runnable;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->lambda$safePostDelayed$0(Ljava/lang/Runnable;)V

    return-void
.end method

.method public static synthetic n(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;Landroid/view/View;IIIIIIII)V
    .locals 0

    invoke-direct/range {p0 .. p9}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->lambda$setLayoutChangeListener$3(Landroid/view/View;IIIIIIII)V
...
.method public static synthetic o()V
    ...
    invoke-static {}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->lambda$onCreate$1()V

    return-void
.end method

.method public static synthetic p(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->lambda$hideSearchView$7()V

    return-void
.end method

.method public static synthetic q(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;ZLandroid/os/Bundle;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->lambda$initSecretModeChangedListener$5(ZLandroid/os/Bundle;)V

    return-void
.end method

.method public static synthetic r(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;Ljava/lang/String;Lcom/sec/android/app/sbrowser/settings/utils/SettingsUtils$TaskCompletionCallback;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->lambda$hideSearchView$6(Ljava/lang/String;Lcom/sec/android/app/sbrowser/settings/utils/SettingsUtils$TaskCompletionCallback;)V

    return-void
.end method

.method public static synthetic s(Landroid/app/Activity;Z)V
    .locals 0

    invoke-static {p0, p1}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->lambda$finishAllActivities$9(Landroid/app/Activity;Z)V

    return-void
.end method

.method private safePostDelayed(Ljava/lang/Runnable;J)V
    .locals 3
    ...
    invoke-direct {v1, v2, p0, p1}, Lcom/sec/android/app/sbrowser/settings/j;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method private safeReplaceFragment(Ljava/lang/String;Landroid/os/Bundle;)V
    .locals 3
    ...
    const-string p0, "Activity not in valid state, skipping fragment replacement: "

    invoke-static {p0, p1, v1}, LJ7/b;->C(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v0, "Error replacing fragment: "
...
.method private setLaunchIntentIfNeeded()Landroid/os/Bundle;
    ...
    const-string v3, "com.sec.android.app.sbrowser.ACTION_SHOW_SYNC_SETTING"
...
.method public static synthetic t(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->lambda$onConfigurationChanged$4()V

    return-void
.end method

.method public static synthetic u(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->lambda$setLayoutChangeListener$2()V

    return-void
.end method

.method public static synthetic v(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;Landroidx/fragment/app/Fragment;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->lambda$onBackPressed$8(Landroidx/fragment/app/Fragment;)V

    return-void
.end method

.method public static bridge synthetic w(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)Z
    .locals 0
...
.method public finishAllActivities(Z)V
    ...
    invoke-direct {p0, v3, v4, v5}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->safePostDelayed(Ljava/lang/Runnable;J)V

    instance-of v3, v2, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;
...
.method public handleKeyCode(Landroidx/fragment/app/Fragment;Landroid/view/KeyEvent;)Z
    ...
    invoke-static {v3, p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivityHelper;->setCtrlKeyPressed(ZLandroidx/appcompat/app/AppCompatActivity;)V
    ...
    invoke-static {v2, p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivityHelper;->setCtrlKeyPressed(ZLandroidx/appcompat/app/AppCompatActivity;)V
...
.method public isAnySettingsSearchVisible()Z
    .locals 1
    ...
    iget-boolean p0, p0, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->mIsSearchViewVisible:Z
...
.method public notifyAppBarHeightChanged()V
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivityHelper;->applyWindowInsetListener(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
...
.method public onBackPressed()V
    ...
    new-instance v2, Lcom/sec/android/app/sbrowser/settings/j;

    const/4 v3, 0x1

    invoke-direct {v2, v3, p0, v0}, Lcom/sec/android/app/sbrowser/settings/j;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/settings/I;

    const/4 v1, 0x2

    invoke-direct {v0, v1, p0}, Lcom/sec/android/app/sbrowser/settings/I;-><init>(ILcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {v3, v1, v5}, LJ7/b;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v3, p0, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->mInitialFragment:Ljava/lang/String;

    invoke-static {v1, v3, v0}, Landroidx/glance/oneui/template/layout/glance/a;->A(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, v0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->safeReplaceFragment(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, p0}, Lcom/sec/android/app/sbrowser/settings/J;-><init>(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/download/ui/q;->g(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)Landroid/window/OnBackInvokedDispatcher;

    move-result-object p1

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->mBackPressManager:Lcom/sec/android/app/sbrowser/common/device/BackPressManager;
    ...
    invoke-direct {v0, p0, p1}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity$1;-><init>(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;Lcom/google/android/material/oneui/floatingactioncontainer/FloatingToolbarLayout;)V

    invoke-virtual {p1, v0}, Lcom/google/android/material/oneui/floatingactioncontainer/FloatingToolbarLayout;->setFloatingAware(Lcom/google/android/material/oneui/floatingactioncontainer/FloatingAware;)V
...
.method public onDestroy()V
    ...
    invoke-static {v0, v2}, LN4/a;->l(Landroid/window/OnBackInvokedDispatcher;Landroid/window/OnBackInvokedCallback;)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-static {v3, v5, v6, v7}, Lf/a;->r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    :cond_2
    iget-boolean v1, p0, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->mIsSearchViewVisible:Z

    if-eqz v1, :cond_3

    instance-of v1, v0, Lcom/sec/android/app/sbrowser/settings/website/WebsitePreferenceFragment;

    if-eqz v1, :cond_3

    check-cast v0, Lcom/sec/android/app/sbrowser/settings/website/WebsitePreferenceFragment;

    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/settings/website/WebsitePreferenceFragment;->onBackPressed()V
...
.method public onPreferenceStartFragment(Landroidx/preference/PreferenceFragmentCompat;Landroidx/preference/Preference;)Z
    ...
    invoke-static {p0, p1, p2}, Lcom/sec/android/app/sbrowser/settings/FragmentCommonHelper;->startFragment(Landroidx/appcompat/app/AppCompatActivity;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public onResume()V
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivityHelper;->getFloatingPositionToHide(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)Lcom/google/android/material/oneui/floatingactioncontainer/FloatingAware$PositionType;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/google/android/material/oneui/floatingactioncontainer/FloatingToolbarLayout;->addHideToolbarItemBackground(Lcom/google/android/material/oneui/floatingactioncontainer/FloatingAware$PositionType;)V
    ...
    const-string v1, "Exception while updating toolbar back key visibility on Resume"

    invoke-static {v0, v1}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    :goto_0
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->setFadeStatusBar(Landroid/content/Context;)V
...
.method public onWindowFocusChanged(Z)V
    ...
    instance-of v1, v0, Lcom/sec/android/app/sbrowser/settings/security_panel/history/DHWindowEventInterface;

    if-eqz v1, :cond_0

    move-object v1, v0

    check-cast v1, Lcom/sec/android/app/sbrowser/settings/security_panel/history/DHWindowEventInterface;

    invoke-interface {v1, p1}, Lcom/sec/android/app/sbrowser/settings/security_panel/history/DHWindowEventInterface;->onWindowFocusChanged(Z)V

    :cond_0
    if-eqz p1, :cond_1

    instance-of p1, v0, Lcom/sec/android/app/sbrowser/settings/customize_toolbar/CustomizeToolbarFragment;

    if-nez p1, :cond_1

    invoke-static {p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivityHelper;->hideBottomSystemBarAndMakeTransparent(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
...
.method public setIsInActionMode(Z)V
    ...
    invoke-static {p0, p1, v0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivityHelper;->updateFloatingToolbarTitleVisibility(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;ZZ)V
...
.method public setOnClickForSearchItem(Lcom/sec/android/app/sbrowser/settings/search/SettingSearchItem;)V
    ...
    invoke-direct {v3, v1, v4, v2, p1}, Landroidx/transition/a;-><init>(Ljava/lang/Object;ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public startActivity(Landroid/content/Intent;)V
    ...
    const-string v0, "com.sec.android.app.sbrowser.INTENT_ACTION_INTERNAL_LOADING"

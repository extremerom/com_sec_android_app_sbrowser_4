...
.method public notifyDataSetChanged()V
    ...
    iget v4, p0, Lcom/sec/android/app/sbrowser/settings/customize_toolbar/ui/view/CustomizeToolbarBottombar;->mItemSize:I
    ...
    iget-object v3, p0, Lcom/sec/android/app/sbrowser/settings/customize_toolbar/ui/view/CustomizeToolbarBottombar;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/sbrowser/settings/customize_toolbar/ui/view/CustomizeToolbarBottombar;->getItem(I)Landroid/view/MenuItem;
    ...
    new-instance v3, Lcom/sec/android/app/sbrowser/multi_cp_native/shortcut/ui/icon_view/a;

    const/4 v5, 0x1

    invoke-direct {v3, p0, v0, v5}, Lcom/sec/android/app/sbrowser/multi_cp_native/shortcut/ui/icon_view/a;-><init>(Ljava/lang/Object;II)V
    ...
    invoke-direct {p0, v4}, Lcom/sec/android/app/sbrowser/settings/customize_toolbar/ui/view/CustomizeToolbarBottombar;->shouldShowDeleteButton(Landroid/view/MenuItem;)Z
    ...
    :cond_4
    new-instance v5, Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/c;

    const/4 v6, 0x3

    invoke-direct {v5, p0, v0, v6}, Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/c;-><init>(Ljava/lang/Object;II)V
    ...
    iget-object v6, p0, Lcom/sec/android/app/sbrowser/settings/customize_toolbar/ui/view/CustomizeToolbarBottombar;->mContext:Landroid/content/Context;
    ...
    invoke-static {v6, v7}, Ljava/lang/Character;->codePointBefore(Ljava/lang/CharSequence;I)I
    ...
    invoke-static {v3, v1}, Lcom/sec/android/app/sbrowser/common/utils/ViewUtil;->setEnabledWithAlpha(Landroid/view/View;Z)V

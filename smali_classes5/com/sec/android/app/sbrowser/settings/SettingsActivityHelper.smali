...
# direct methods
.method public static bridge synthetic a(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)Z
    .locals 0

    invoke-static {p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivityHelper;->isSoftInputAdjustResize(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)Z
...
.method public static addSearchableData(Landroid/app/Activity;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, v4, v5}, Landroidx/glance/oneui/template/layout/glance/a;->v(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public static applyWindowInsetListener(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
    .locals 2
    ...
    :cond_0
    new-instance v0, Lcom/sec/android/app/sbrowser/settings/SettingsActivityHelper$1;

    invoke-direct {v0, p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivityHelper$1;-><init>(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
...
.method public static getActionMenuView(Landroidx/appcompat/widget/Toolbar;)Landroid/view/View;
    .locals 3
...
.method public static getEndFirstView(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)Landroid/view/View;
    .locals 0
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivityHelper;->getActionMenuView(Landroidx/appcompat/widget/Toolbar;)Landroid/view/View;
...
.method public static getFloatingPositionToHide(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)Lcom/google/android/material/oneui/floatingactioncontainer/FloatingAware$PositionType;
    .locals 1
    ...
    instance-of v0, v0, Lcom/sec/android/app/sbrowser/settings/SettingsFragment;

    if-eqz v0, :cond_0

    invoke-static {p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivityHelper;->isPopOverScreen(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)Z

    move-result p0

    if-eqz p0, :cond_0

    sget-object p0, Lcom/google/android/material/oneui/floatingactioncontainer/FloatingAware$PositionType;->START_FIRST:Lcom/google/android/material/oneui/floatingactioncontainer/FloatingAware$PositionType;
...
.method public static getStartFirstView(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;Z)Landroid/view/View;
    .locals 1
    ...
    instance-of v0, p1, Lcom/sec/android/app/sbrowser/settings/ActionModeToolbarViewFetcher;

    if-eqz v0, :cond_0

    check-cast p1, Lcom/sec/android/app/sbrowser/settings/ActionModeToolbarViewFetcher;

    invoke-interface {p1}, Lcom/sec/android/app/sbrowser/settings/ActionModeToolbarViewFetcher;->getStartFirstView()Landroid/view/View;
...
.method public static hideBottomSystemBarAndMakeTransparent(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
    .locals 3
    ...
    sget-object v2, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil$NavigationBarState;->NAVIGATION_TRANSPARENT:Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil$NavigationBarState;

    invoke-static {p0, v2}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->setNavigationBarColor(Landroid/content/Context;Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil$NavigationBarState;)V

    invoke-virtual {p0}, Landroid/app/Activity;->getWindow()Landroid/view/Window;

    move-result-object v2

    invoke-static {v2}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->setFadeNavigationBar(Landroid/view/Window;)V
...
.method private static isPopOverScreen(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)Z
    .locals 3
    ...
    invoke-static {p0}, Lcom/sec/sbrowser/spl/wrapper/MajoConfiguration;->semIsPopOver(Landroid/content/res/Configuration;)Z
    ...
    const-string v2, "Error getting Pop over status. Error message: "

    invoke-direct {v0, v2}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    const-string v2, "SettingsActivityHelper"

    invoke-static {p0, v0, v2}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->t(Lcom/sec/sbrowser/spl/util/FallbackException;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private static isSoftInputAdjustResize(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;)Z
    .locals 1
...
.method private static setBackKeyVisibility(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;Z)V
    ...
    :goto_0
    invoke-static {p1, p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivityHelper;->setPaddingForToolbarTitleText(ILcom/sec/android/app/sbrowser/settings/SettingsActivity;)V

    return-void
.end method

.method public static setCtrlKeyPressed(ZLandroidx/appcompat/app/AppCompatActivity;)V
    .locals 1

    invoke-static {p1}, Lcom/sec/android/app/sbrowser/settings/FragmentCommonHelper;->getTopFragment(Landroidx/appcompat/app/AppCompatActivity;)Landroidx/fragment/app/Fragment;
...
.method public static setLayoutMargin(ZILcom/sec/android/app/sbrowser/settings/SettingsActivity;Lcom/sec/android/app/sbrowser/settings/search/SettingSearchFragment;)V
    ...
    invoke-static {p2}, Lcom/sec/android/app/sbrowser/settings/FragmentCommonHelper;->getTopFragment(Landroidx/appcompat/app/AppCompatActivity;)Landroidx/fragment/app/Fragment;
    ...
    invoke-virtual {v1, p3, v0, p3, v0}, Landroidx/preference/PreferenceFragmentCompat;->setPadding(IIII)V
...
.method private static setPaddingForToolbarTitleText(ILcom/sec/android/app/sbrowser/settings/SettingsActivity;)V
    .locals 3
...
.method public static updateFloatingToolbarTitleVisibility(Lcom/sec/android/app/sbrowser/settings/SettingsActivity;ZZ)V
    .locals 4
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/settings/SettingsActivity;->isAnySettingsSearchVisible()Z
    ...
    :goto_0
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/settings/SettingsAppBarUtil;->getToolbarTitle(Landroid/app/Activity;)Landroid/widget/TextView;
    ...
    instance-of v2, v2, Lcom/sec/android/app/sbrowser/settings/ActionModeToolbarViewFetcher;
    ...
    check-cast p0, Lcom/sec/android/app/sbrowser/settings/ActionModeToolbarViewFetcher;
    ...
    :goto_2
    invoke-interface {p0, v0}, Lcom/sec/android/app/sbrowser/settings/ActionModeToolbarViewFetcher;->updateSideTextVisibility(Z)V

...
.field private mGenericBottomBarContainer:Landroid/widget/FrameLayout;
...
.method private clearUserData()V
    ...
    new-instance v2, Lcom/sec/android/app/sbrowser/settings/t;

    invoke-direct {v2, p0}, Lcom/sec/android/app/sbrowser/settings/t;-><init>(Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;)V
...
.method public static synthetic f(Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;Landroid/view/View;)V
    .locals 0
...
.method public static synthetic g(Landroid/widget/TextView;Landroid/view/View;ILandroid/view/KeyEvent;)Z
    .locals 0
...
.method public static synthetic h(Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;Landroid/content/DialogInterface;I)V
    .locals 0
...
.method public static synthetic i(Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;Ljava/lang/Boolean;)V
    .locals 0
...
.method public static synthetic j(Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;)V
    .locals 0
...
.method public static synthetic k(Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;Landroid/content/DialogInterface;I)V
    .locals 0
...
.method public static synthetic l(Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;Landroid/widget/TextView;Landroid/widget/Button;Landroid/view/View;ILandroid/view/KeyEvent;)Z
    .locals 0
...
.method public static bridge synthetic m(Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;)Landroid/view/View;
    .locals 0
...
.method public static bridge synthetic n(Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;)Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    .locals 0
...
.method public static bridge synthetic o(Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;)Landroidx/core/widget/NestedScrollView;
    .locals 0
...
.method private onDiscontinueUseButtonClicked()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->mDialog:Landroidx/appcompat/app/AlertDialog;
...
.method public static bridge synthetic p(Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;)V
    .locals 0
...
.method private requestSystemKeyEvent(Z)V
    ...
    invoke-static {p0, p1, v0}, Lf/a;->o(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V

    :goto_2
    return-void
.end method

.method private setBottombarLayoutParams(Landroid/content/res/Configuration;)V
    .locals 3

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->mGenericBottomBarContainer:Landroid/widget/FrameLayout;

    if-eqz v0, :cond_3

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->mParentLayout:Landroid/widget/RelativeLayout;
    ...
    iget-object p1, p0, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->mParentLayout:Landroid/widget/RelativeLayout;
    ...
    :goto_0
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->mGenericBottomBarContainer:Landroid/widget/FrameLayout;
...
.method private showDiscontinueDialog()V
    ...
    invoke-direct {v1, p0, v2}, Lcom/sec/android/app/sbrowser/settings/s;-><init>(Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;I)V
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->mDialog:Landroidx/appcompat/app/AlertDialog;

    invoke-static {v0}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->setSEP10Dialog(Landroid/app/Dialog;)V

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->mDialog:Landroidx/appcompat/app/AlertDialog;
...
.method private showMessage(I)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->mSnackbar:Lcom/google/android/material/snackbar/Snackbar;
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->mSnackbar:Lcom/google/android/material/snackbar/Snackbar;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->mButtonContainer:Landroid/view/View;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->setBottombarLayoutParams(Landroid/content/res/Configuration;)V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->mParentLayout:Landroid/widget/RelativeLayout;
    ...
    iput-object v1, p0, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->mGenericBottomBarContainer:Landroid/widget/FrameLayout;
    ...
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->mGenericBottomBarContainer:Landroid/widget/FrameLayout;
    ...
    invoke-direct {p0, v1}, Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;->setBottombarLayoutParams(Landroid/content/res/Configuration;)V
    ...
    new-instance p3, Lcom/sec/android/app/sbrowser/settings/e;

    const/4 v1, 0x1

    invoke-direct {p3, p0, v1}, Lcom/sec/android/app/sbrowser/settings/e;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance p3, Lcom/sec/android/app/sbrowser/settings/q;

    invoke-direct {p3, p0, v0, p1}, Lcom/sec/android/app/sbrowser/settings/q;-><init>(Lcom/sec/android/app/sbrowser/settings/LeaveInternetFragment;Landroid/widget/TextView;Landroid/widget/Button;)V

    invoke-virtual {v0, p3}, Landroid/view/View;->setOnKeyListener(Landroid/view/View$OnKeyListener;)V

    new-instance p3, Lcom/sec/android/app/sbrowser/settings/r;

    const/4 v1, 0x0

    invoke-direct {p3, v0, v1}, Lcom/sec/android/app/sbrowser/settings/r;-><init>(Ljava/lang/Object;I)V

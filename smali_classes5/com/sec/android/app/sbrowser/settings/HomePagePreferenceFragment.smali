...
.field private mDefaultSubContentPreferencesManager:Lcom/sec/android/app/sbrowser/multi_cp_native/DefaultSubContentPreferencesManager;

.field private mHomepageSettings:Lcom/sec/android/app/sbrowser/homepage/HomePageSettings;

.field private mIsMinorModeCnEnabled:Z
...
.method private disableAccessNoticeCN()V
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->setNewsFeedServiceChnEnabled(Z)V

    :cond_0
    return-void
.end method

.method public static synthetic g(Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;Landroidx/activity/result/ActivityResult;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->lambda$onCreate$0(Landroidx/activity/result/ActivityResult;)V
...
.method public static synthetic h(Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->onThirdPartyAccessPopupDismiss()V
...
.method private synthetic lambda$onCreate$0(Landroidx/activity/result/ActivityResult;)V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->onNewsFeedServiceDismiss()V
...
.method public static bridge synthetic n(Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;)V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->disableAccessNoticeCN()V

    return-void
.end method

.method private need3rdStatementShow()Z
    .locals 1
...
.method private onNewsFeedServiceDismiss()V
    .locals 2
    ...
    :cond_0
    new-instance v0, Lcom/sec/android/app/sbrowser/help_intro/popup/NewsFeedPopupWindow;

    invoke-virtual {p0}, Landroidx/fragment/app/Fragment;->getActivity()Landroidx/fragment/app/FragmentActivity;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/sec/android/app/sbrowser/help_intro/popup/NewsFeedPopupWindow;-><init>(Landroid/app/Activity;)V

    new-instance v1, Lcom/sec/android/app/sbrowser/settings/l;

    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/settings/l;-><init>(Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;)V

    invoke-virtual {v0, v1}, Lcom/sec/android/app/sbrowser/help_intro/popup/AccessNoticeBasePopupWindow;->setDismissListener(Lcom/sec/android/app/sbrowser/help_intro/popup/PopupDismissListener;)Lcom/sec/android/app/sbrowser/help_intro/popup/AccessNoticeBasePopupWindow;
...
.method private onThirdPartyAccessPopupDismiss()V
    .locals 3
    ...
    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->isNewsFeedService3rdStatementChnEnabled()Z
...
.method public static bridge synthetic p(Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;)V
    .locals 0
...
.method private reDrawHomePagePreferences()V
    ...
    invoke-static {v6, v0}, Lcom/sec/android/app/sbrowser/homepage/UnifiedHomePageConfig;->isUnifiedHomePageUrl(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v6

    if-nez v6, :cond_2

    iget-boolean v6, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mIsMinorModeCnEnabled:Z
    ...
    :cond_1
    iput-boolean v4, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mIsShowingDefaultPageOption:Z

    iput v2, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->default_index:I

    iput v4, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->pinned_index:I

    iput v5, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->current_index:I

    const/4 v6, 0x3

    iput v6, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->other_index:I

    goto :goto_2

    :cond_2
    :goto_1
    iput-boolean v2, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mIsShowingDefaultPageOption:Z

    const/4 v6, -0x1

    iput v6, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->default_index:I

    iput v2, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->pinned_index:I

    iput v4, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->current_index:I
    ...
    iget-boolean v5, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mIsShowingCurrentPageOption:Z
    ...
    invoke-static {v4, v0}, Lcom/sec/android/app/sbrowser/homepage/UnifiedHomePageConfig;->isUnifiedHomePageUrl(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    iget-boolean v4, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mIsShowingCurrentPageOption:Z
    ...
    iget-object v6, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mChoices:[Ljava/lang/String;

    aget-object v6, v6, v3

    iget-object v7, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mValues:[Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mValues:[Ljava/lang/String;
...
.method private updateHomePagePreferenceIfMinorModeChangeCn()V
    .locals 3
    ...
    iget-boolean v1, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mIsMinorModeCnEnabled:Z

    if-eq v0, v1, :cond_3

    iput-boolean v0, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mIsMinorModeCnEnabled:Z

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->reDrawHomePagePreferences()V

    iget-boolean v0, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mIsMinorModeCnEnabled:Z
    ...
    iput v0, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mLastSelectedIndex:I

    iget v2, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->default_index:I
    ...
    invoke-virtual {v0, v1}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->setChangeMainViewFromDefault(Z)V
    ...
    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->getChangeMainViewFromDefault()Z
    ...
    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/homepage/HomePageSettings;->setHomepageAsDefault()V
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->setChangeMainViewFromDefault(Z)V
...
.method private updatePreferences(ILcom/sec/android/app/sbrowser/settings/CheckBoxPreferenceRadio;)V
    ...
    invoke-static {}, Lcom/sec/android/app/sbrowser/common/parental_control/ParentalControlUtil;->getNativePageSettingsTitle()Ljava/lang/String;
...
.method public getHomepageSummary(I)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/homepage/HomePageSettings;->checkConditionToShowMultiCpDefaultHomePageCN()Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mDefaultSubContentPreferencesManager:Lcom/sec/android/app/sbrowser/multi_cp_native/DefaultSubContentPreferencesManager;

    invoke-virtual {p0, p1}, Lcom/sec/android/app/sbrowser/multi_cp_native/DefaultSubContentPreferencesManager;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v3, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mIsMinorModeCnEnabled:Z
    ...
    new-instance v4, Lcom/sec/android/app/sbrowser/settings/l;

    invoke-direct {v4, p0}, Lcom/sec/android/app/sbrowser/settings/l;-><init>(Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;)V
    ...
    iput-object v3, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mActivityResultLauncher:Landroidx/activity/result/ActivityResultLauncher;
    ...
    iget-boolean v7, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mIsMinorModeCnEnabled:Z
    ...
    iget v6, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->other_index:I
    ...
    new-instance p1, Lcom/sec/android/app/sbrowser/multi_cp_native/DefaultSubContentPreferencesManager;

    invoke-direct {p1, p0}, Lcom/sec/android/app/sbrowser/multi_cp_native/DefaultSubContentPreferencesManager;-><init>(Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;)V

    iput-object p1, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mDefaultSubContentPreferencesManager:Lcom/sec/android/app/sbrowser/multi_cp_native/DefaultSubContentPreferencesManager;

    invoke-virtual {p0}, Landroidx/fragment/app/Fragment;->getLifecycle()Landroidx/lifecycle/Lifecycle;

    move-result-object p1

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mDefaultSubContentPreferencesManager:Lcom/sec/android/app/sbrowser/multi_cp_native/DefaultSubContentPreferencesManager;
...
.method public onPreferenceTreeClick(Landroidx/preference/Preference;)Z
    ...
    :pswitch_0
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->need3rdStatementShow()Z

    move-result v1

    if-eqz v1, :cond_7

    iget-object p1, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mActivityResultLauncher:Landroidx/activity/result/ActivityResultLauncher;

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->mActivity:Landroid/app/Activity;

    invoke-static {p1, p0, v4}, Lcom/sec/android/app/sbrowser/help_intro/HelpIntroHelper;->launchSecondaryPageForSettingActivity(Landroidx/activity/result/ActivityResultLauncher;Landroid/app/Activity;I)V
...
.method public onResume()V
    ...
    :cond_1
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/HomePagePreferenceFragment;->updateHomePagePreferenceIfMinorModeChangeCn()V

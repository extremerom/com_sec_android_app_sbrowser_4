...
.method public static bridge synthetic a(Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailUnwantedPagesHistoryModel;Ljava/util/concurrent/CopyOnWriteArrayList;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailUnwantedPagesHistoryModel;->attachData(Ljava/util/concurrent/CopyOnWriteArrayList;)V
...
.method private attachData(Ljava/util/concurrent/CopyOnWriteArrayList;)V
    ...
    invoke-static {v6, v1, v3}, Landroidx/compose/ui/input/pointer/a;->B(ILjava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailUnwantedPagesHistoryModel$2;

    invoke-direct {v2, v0}, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailUnwantedPagesHistoryModel$2;-><init>(Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailUnwantedPagesHistoryModel;)V
...
.method public requestData()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailHistoryModel;->mDateRange:[Lcom/sec/android/app/sbrowser/common/utils/DateOnly;
    ...
    new-instance v3, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailUnwantedPagesHistoryModel$1;

    invoke-direct {v3, p0}, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailUnwantedPagesHistoryModel$1;-><init>(Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailUnwantedPagesHistoryModel;)V

    invoke-virtual {v2, v1, v0, v3}, Lcom/sec/android/app/sbrowser/protected_browsing/UnwantedNavigationHelper;->getUnwantedNavigationStats(Lcom/sec/android/app/sbrowser/common/utils/DateOnly;Lcom/sec/android/app/sbrowser/common/utils/DateOnly;Lcom/sec/terrace/browser/protected_browsing/unwanted_navigation/TerraceUnwantedNavigationDataFetcher$UNDataFetchCallback;)V

...
.field private mChartBarDataSet:LO0/b;
...
.method private configAxis(Lcom/github/mikephil/charting/charts/BarChart;)V
    ...
    invoke-virtual {p1}, LM0/c;->getAxisRight()LN0/r;
    ...
    :cond_0
    invoke-virtual {p1}, LM0/c;->getAxisLeft()LN0/r;
    ...
    iput v2, v0, LN0/a;->i:I

    const v2, 0x7f0609f4

    iput v2, v0, LN0/b;->e:I
    ...
    invoke-virtual {p1}, LM0/e;->getXAxis()LN0/o;

    move-result-object v0

    sget-object v2, LN0/n;->BOTTOM:LN0/n;

    iput-object v2, v0, LN0/o;->B:LN0/n;
...
.method private configChartRenderer(Lcom/github/mikephil/charting/charts/BarChart;)V
    ...
    invoke-virtual {p1, v0}, LM0/e;->setDescription(LN0/c;)V

    invoke-virtual {p1}, LM0/e;->getLegend()LN0/l;
    ...
    invoke-virtual {p1, v1}, LM0/c;->setDrawGridBackground(Z)V

    invoke-virtual {p1, v1}, LM0/c;->setScaleEnabled(Z)V

    invoke-virtual {p1, v1}, LM0/c;->setDoubleTapToZoomEnabled(Z)V

    invoke-virtual {p1, v1}, LM0/c;->setDragEnabled(Z)V
    ...
    invoke-virtual {p1, v4}, LM0/c;->f(LN0/p;)LV0/f;
    ...
    invoke-direct {v0, v2, v3, v5, v6}, Lcom/sec/android/app/sbrowser/settings/security_panel/chartui/axisrenderer/WeeklyYAxisRenderer;-><init>(LV0/h;LN0/r;LV0/f;Landroid/content/Context;)V

    invoke-virtual {p1, v0}, LM0/c;->setRendererRightYAxis(LU0/j;)V
    ...
    invoke-direct {v0, v2, v3, v4, v5}, Lcom/sec/android/app/sbrowser/settings/security_panel/chartui/axisrenderer/WeeklyXAxisRenderer;-><init>(LV0/h;LN0/o;LV0/f;Landroid/content/Context;)V
    ...
    invoke-virtual {p1, v0}, LM0/c;->setXAxisRenderer(LU0/i;)V
...
.method private configChartRendererPost(Lcom/github/mikephil/charting/charts/BarChart;)V
    ...
    invoke-virtual {p1}, LM0/e;->getAnimator()Lcom/github/mikephil/charting/animation/ChartAnimator;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/sec/android/app/sbrowser/settings/security_panel/chartui/renderer/StackedBarRenderer;-><init>(Landroid/content/Context;LR0/a;Lcom/github/mikephil/charting/animation/ChartAnimator;LV0/h;I)V
    ...
    invoke-virtual {p1, v6}, LM0/e;->setRenderer(LU0/e;)V
    ...
    iget-object p1, p1, LM0/e;->s:Lcom/github/mikephil/charting/animation/ChartAnimator;
...
.method private mergeChartData()Ljava/util/ArrayList;
    ...
    new-array v4, v4, [LQ0/e;

    iput-object v4, v5, Lcom/github/mikephil/charting/data/BarEntry;->e:[LQ0/e;
    ...
    :goto_4
    iget-object v9, v5, Lcom/github/mikephil/charting/data/BarEntry;->e:[LQ0/e;
    ...
    invoke-direct {v11, v4, v10}, LQ0/e;-><init>(FF)V
    ...
    invoke-direct {v11, v8, v10}, LQ0/e;-><init>(FF)V
...
.method private setChartData(Lcom/github/mikephil/charting/charts/BarChart;Ljava/util/concurrent/CopyOnWriteArrayList;)V
    ...
    invoke-direct {v2, v3, p2}, LO0/b;-><init>(Ljava/lang/String;Ljava/util/ArrayList;)V

    iput-object v2, p0, Lcom/sec/android/app/sbrowser/settings/security_panel/GraphPreference;->mChartBarDataSet:LO0/b;

    iput v1, v2, LO0/b;->x:I

    iget v3, v2, LO0/b;->y:I

    iput v3, p0, Lcom/sec/android/app/sbrowser/settings/security_panel/GraphPreference;->mStackSize:I

    new-instance v3, LO0/a;

    new-array v4, v0, [LS0/a;

    aput-object v2, v4, v1

    invoke-direct {v3, v4}, LO0/a;-><init>([LS0/a;)V

    const v2, 0x3ecccccd    # 0.4f

    iput v2, v3, LO0/a;->j:F

    iget-object v2, v3, LO0/d;->i:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1, v3}, LM0/e;->setData(LO0/d;)V
    ...
    invoke-direct/range {v4 .. v9}, LM0/a;-><init>(LM0/c;FFFF)V
    ...
    invoke-direct/range {v0 .. v5}, LM0/a;-><init>(LM0/c;FFFF)V

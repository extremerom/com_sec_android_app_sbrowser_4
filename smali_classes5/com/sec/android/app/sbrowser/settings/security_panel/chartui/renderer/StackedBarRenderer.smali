...
# direct methods
.method public constructor <init>(Landroid/content/Context;LR0/a;Lcom/github/mikephil/charting/animation/ChartAnimator;LV0/h;I)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/sec/android/app/sbrowser/settings/security_panel/chartui/renderer/AbsRoundBarRenderer;-><init>(Landroid/content/Context;LR0/a;Lcom/github/mikephil/charting/animation/ChartAnimator;LV0/h;)V
...
.method public drawDataSet(Landroid/graphics/Canvas;LS0/a;I)V
    ...
    invoke-super/range {p0 .. p3}, Lcom/sec/android/app/sbrowser/settings/security_panel/chartui/renderer/AbsRoundBarRenderer;->drawDataSet(Landroid/graphics/Canvas;LS0/a;I)V

    const/4 v2, 0x0

    :goto_0
    iget-object v3, v0, Lcom/sec/android/app/sbrowser/settings/security_panel/chartui/renderer/AbsRoundBarRenderer;->mBuffer:LL0/a;
    ...
    iget-object v6, v0, Lcom/sec/android/app/sbrowser/settings/security_panel/chartui/renderer/AbsRoundBarRenderer;->mBuffer:LL0/a;

    iget-object v6, v6, LL0/a;->b:[F
    ...
    iget-object v4, v0, Lcom/sec/android/app/sbrowser/settings/security_panel/chartui/renderer/AbsRoundBarRenderer;->mBuffer:LL0/a;
    ...
    iget-object v5, v0, LU0/b;->mBarBorderPaint:Landroid/graphics/Paint;
    ...
    iget-object v7, v0, LU0/h;->mViewPortHandler:LV0/h;

    add-int/lit8 v8, v4, 0x2

    aget v6, v6, v8

    invoke-virtual {v7, v6}, LV0/h;->a(F)Z
    ...
    :cond_2
    iget-object v6, v0, LU0/h;->mViewPortHandler:LV0/h;

    iget-object v7, v0, Lcom/sec/android/app/sbrowser/settings/security_panel/chartui/renderer/AbsRoundBarRenderer;->mBuffer:LL0/a;

    iget-object v7, v7, LL0/a;->b:[F

    aget v7, v7, v4

    invoke-virtual {v6, v7}, LV0/h;->b(F)Z
    ...
    :cond_3
    iget-object v6, v0, LU0/e;->mRenderPaint:Landroid/graphics/Paint;

...
.field private mMainSwitchPreference:Lcom/sec/android/app/sbrowser/common/settings/MainSwitchPreference;

.field private mPrefReadAAloud:Landroidx/preference/Preference;

.field private mPrefSummarize:Landroidx/preference/Preference;

.field private mPrefTranslate:Landroidx/preference/Preference;
...
.method public static synthetic g(Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->lambda$onPreferenceTreeClick$9(Z)V

    return-void
.end method

.method public static synthetic h(Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->lambda$initPreferences$2()V
...
.method public static synthetic i(Landroidx/preference/Preference;)Z
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->lambda$initPreferences$8(Landroidx/preference/Preference;)Z
...
.method private initPreferences()V
    ...
    const-string v0, "pref_browsing_assist_main_switch"

    invoke-virtual {p0, v0}, Landroidx/preference/PreferenceFragmentCompat;->findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;

    move-result-object v0

    check-cast v0, Lcom/sec/android/app/sbrowser/common/settings/MainSwitchPreference;

    iput-object v0, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mMainSwitchPreference:Lcom/sec/android/app/sbrowser/common/settings/MainSwitchPreference;
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mMainSwitchPreference:Lcom/sec/android/app/sbrowser/common/settings/MainSwitchPreference;
    ...
    invoke-virtual {v2}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->isBrowsingAssistFTU()Z

    move-result v2

    xor-int/2addr v2, v1

    invoke-virtual {v0, v2}, Lcom/sec/android/app/sbrowser/common/settings/MainSwitchPreference;->setChecked(Z)V

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mMainSwitchPreference:Lcom/sec/android/app/sbrowser/common/settings/MainSwitchPreference;

    iget-object v2, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mActivity:Landroid/app/Activity;
    ...
    invoke-virtual {v0, v2}, Lcom/sec/android/app/sbrowser/common/settings/MainSwitchPreference;->setAccessibilityTitle(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mMainSwitchPreference:Lcom/sec/android/app/sbrowser/common/settings/MainSwitchPreference;

    new-instance v2, Lcom/sec/android/app/sbrowser/settings/browsing_assist/b;

    const/4 v3, 0x1

    invoke-direct {v2, p0, v3}, Lcom/sec/android/app/sbrowser/settings/browsing_assist/b;-><init>(Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;I)V
    ...
    invoke-static {v4, v3, v6, v5, v2}, Lcom/sec/android/app/sbrowser/artificial_intelligence/utils/WebAssistUtil;->getLinkedText(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Landroid/text/Spannable;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mPrefSummarize:Landroidx/preference/Preference;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mPrefTranslate:Landroidx/preference/Preference;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mPrefReadAAloud:Landroidx/preference/Preference;
    ...
    iget-object v4, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mPrefSummarize:Landroidx/preference/Preference;

    if-eqz v4, :cond_4

    iget-object v5, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mPrefTranslate:Landroidx/preference/Preference;

    if-eqz v5, :cond_4

    iget-object v5, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mPrefReadAAloud:Landroidx/preference/Preference;
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mPrefTranslate:Landroidx/preference/Preference;

    invoke-virtual {v0, v3}, Landroidx/preference/Preference;->setEnabled(Z)V

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mPrefReadAAloud:Landroidx/preference/Preference;
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->updateMoreGalaxyAiFeatures()V

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mPrefSummarize:Landroidx/preference/Preference;

    if-eqz v0, :cond_5

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mPrefTranslate:Landroidx/preference/Preference;

    if-eqz v1, :cond_5

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mPrefReadAAloud:Landroidx/preference/Preference;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mPrefReadAAloud:Landroidx/preference/Preference;
...
.method public static synthetic j(Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;)V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->lambda$initPreferences$3()V
...
.method public static synthetic k(Landroidx/preference/Preference;)Z
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->lambda$initPreferences$7(Landroidx/preference/Preference;)Z
...
.method public static synthetic l(Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;)V
    .locals 0
...
.method private synthetic lambda$initPreferences$2()V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, v0}, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->setPreferenceEnabled(Z)V
...
.method private synthetic lambda$initPreferences$3()V
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/sbrowser/artificial_intelligence/consent/BrowsingAssistConsentManager;->setBrowsingAssistFTU(Z)V

    return-void
.end method

.method private synthetic lambda$initPreferences$4(Z)V
    .locals 2
    ...
    invoke-static {p1}, Lcom/sec/android/app/sbrowser/artificial_intelligence/utils/WebAssistUtil;->isPreventOnlineProcessingTurnedOn(Landroid/content/Context;)Z
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/a;

    const/4 v1, 0x1

    invoke-direct {v0, p0, v1}, Lcom/sec/android/app/sbrowser/settings/browsing_assist/a;-><init>(Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;I)V
...
.method private synthetic lambda$initPreferences$5(Landroidx/preference/Preference;Ljava/lang/Object;)Z
    .locals 3
    ...
    iget-object p2, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mActivity:Landroid/app/Activity;
    ...
    invoke-direct {v1, p0, v2}, Lcom/sec/android/app/sbrowser/settings/browsing_assist/b;-><init>(Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;I)V

    invoke-static {v0, p1, v1}, Lcom/sec/android/app/sbrowser/artificial_intelligence/utils/WebAssistUtil;->promptUserConsentAndSamsungAccountLogin(Landroid/app/Activity;ZLcom/sec/android/app/sbrowser/artificial_intelligence/utils/WebAssistUtil$PromptScreenCallback;)Z
    ...
    invoke-virtual {p1, p2}, Lcom/sec/android/app/sbrowser/artificial_intelligence/consent/BrowsingAssistConsentManager;->setBrowsingAssistFTU(Z)V
...
.method private static synthetic lambda$initPreferences$6(Landroidx/preference/Preference;)Z
    ...
    const-string p0, "Settings::BrowsingAssist::Summarize"
...
.method private static synthetic lambda$initPreferences$7(Landroidx/preference/Preference;)Z
    ...
    const-string p0, "Settings::BrowsingAssist::Translate"
...
.method private static synthetic lambda$initPreferences$8(Landroidx/preference/Preference;)Z
    .locals 0

    const-string p0, "Settings::BrowsingAssist::ReadHighlightsAloud"
...
.method private synthetic lambda$onPreferenceTreeClick$9(Z)V
    .locals 0
...
.method public static synthetic m(Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;Z)V
    .locals 0
...
.method public static synthetic n(Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;Landroidx/preference/Preference;Ljava/lang/Object;)Z
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->lambda$initPreferences$5(Landroidx/preference/Preference;Ljava/lang/Object;)Z
...
.method public static synthetic o(Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->lambda$initPreferences$4(Z)V
...
.method public static synthetic p(Landroidx/preference/Preference;)Z
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->lambda$initPreferences$6(Landroidx/preference/Preference;)Z
...
.method private setEnabledPreferences(Z)V
    .locals 4
    ...
    instance-of v2, v1, Lcom/sec/android/app/sbrowser/common/settings/MainSwitchPreference;
    ...
    :cond_0
    instance-of v2, v1, Lcom/sec/android/app/sbrowser/common/settings/AlphaAdjustablePreference;
    ...
    check-cast v2, Lcom/sec/android/app/sbrowser/common/settings/AlphaAdjustablePreference;
    ...
    :goto_1
    invoke-interface {v2, v3}, Lcom/sec/android/app/sbrowser/common/settings/AlphaAdjustablePreference;->setAlphaValue(F)V

    instance-of v2, v1, Lcom/sec/android/app/sbrowser/common/settings/PreferenceCustom;
...
.method private setPreferenceEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/sec/android/app/sbrowser/common/settings/MainSwitchPreference;->setChecked(Z)V

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mMainSwitchPreference:Lcom/sec/android/app/sbrowser/common/settings/MainSwitchPreference;

    invoke-virtual {v0, p1}, Lcom/sec/android/app/sbrowser/common/settings/MainSwitchPreference;->updateSwitchState(Z)V

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->mMainSwitchPreference:Lcom/sec/android/app/sbrowser/common/settings/MainSwitchPreference;

    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/common/settings/MainSwitchPreference;->isChecked()Z

    move-result v0

    invoke-direct {p0, v0}, Lcom/sec/android/app/sbrowser/settings/browsing_assist/BrowsingAssistFragment;->setEnabledPreferences(Z)V
...
.method private updateMoreGalaxyAiFeatures()V
    .locals 3
    ...
    const-string v2, "[updateMoreGalaxyAiFeatures] fromGlobalSetting: "
    ...
    const-string v2, "BrowsingAssistFragment"

...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "",
        "insertSILog",
        "(Lcom/sec/android/app/sbrowser/si_log/model/db/SILogEntity;LB8/d;)Ljava/lang/Object;",
        "deleteAllSILogs",
...
# instance fields
.field private final allSILogs:Lkotlinx/coroutines/flow/Flow;
...
.field private final allSILogsGroupByEventId:Lkotlinx/coroutines/flow/Flow;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lkotlinx/coroutines/flow/Flow;"
        }
...
.field private final allSILogsGroupByServiceId:Lkotlinx/coroutines/flow/Flow;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lkotlinx/coroutines/flow/Flow;"
        }
...
.field private final siLogClient$delegate:Lw8/h;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.field private final siLogDataStore$delegate:Lw8/h;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.field private final siLogPreference$delegate:Lw8/h;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository$Companion;-><init>(Lkotlin/jvm/internal/i;)V
...
.method private constructor <init>(Landroid/app/Application;Lfa/A;)V
    .locals 7
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->siLogClient$delegate:Lw8/h;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->siLogPreference$delegate:Lw8/h;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->siLogDataStore$delegate:Lw8/h;

    iput-object p2, p0, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->ioDispatcher:Lfa/A;
    ...
    invoke-static/range {v1 .. v6}, Lcom/sec/android/app/sbrowser/si_log/model/db/SILogDatabase$Companion;->getInstance$default(Lcom/sec/android/app/sbrowser/si_log/model/db/SILogDatabase$Companion;Landroid/content/Context;Lfa/E;Lcom/sec/android/app/sbrowser/si_log/model/db/SILogDatabase$Companion$Delegate;ILjava/lang/Object;)Lcom/sec/android/app/sbrowser/si_log/model/db/SILogDatabase;
    ...
    invoke-interface {p2}, Lcom/sec/android/app/sbrowser/si_log/model/db/SILogDao;->getAll()Lkotlinx/coroutines/flow/Flow;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->allSILogs:Lkotlinx/coroutines/flow/Flow;

    invoke-interface {p2}, Lcom/sec/android/app/sbrowser/si_log/model/db/SILogDao;->getAllGroupByServiceId()Lkotlinx/coroutines/flow/Flow;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->allSILogsGroupByServiceId:Lkotlinx/coroutines/flow/Flow;

    invoke-interface {p2}, Lcom/sec/android/app/sbrowser/si_log/model/db/SILogDao;->getAllGroupByEventId()Lkotlinx/coroutines/flow/Flow;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->allSILogsGroupByEventId:Lkotlinx/coroutines/flow/Flow;

    return-void
.end method

.method public synthetic constructor <init>(Landroid/app/Application;Lfa/A;Lkotlin/jvm/internal/i;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;-><init>(Landroid/app/Application;Lfa/A;)V
...
.method private final getSiLogClient()Lcom/sec/android/app/sbrowser/si_log/model/client/SILogClient;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->siLogClient$delegate:Lw8/h;
...
.method private final getSiLogDataStore()Lcom/sec/android/app/sbrowser/si_log/model/SILogDataStore;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->siLogDataStore$delegate:Lw8/h;
...
.method private final getSiLogPreference()Lcom/sec/android/app/sbrowser/si_log/model/SILogPreference;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->siLogPreference$delegate:Lw8/h;
...
# virtual methods
.method public final deleteAllSILogs(LB8/d;)Ljava/lang/Object;
    .locals 3
    .param p1    # LB8/d;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->ioDispatcher:Lfa/A;

    new-instance v1, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository$deleteAllSILogs$2;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository$deleteAllSILogs$2;-><init>(Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;LB8/d;)V
...
.method public final deleteMultipleSILogs(Ljava/util/List;LB8/d;)Ljava/lang/Object;
    .locals 3
    ...
    invoke-direct {v1, p0, p1, v2}, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository$deleteMultipleSILogs$2;-><init>(Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;Ljava/util/List;LB8/d;)V
...
.method public final deleteSILog(Lcom/sec/android/app/sbrowser/si_log/model/db/SILogEntity;LB8/d;)Ljava/lang/Object;
    .locals 3
    ...
    invoke-direct {v1, p0, p1, v2}, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository$deleteSILog$2;-><init>(Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;Lcom/sec/android/app/sbrowser/si_log/model/db/SILogEntity;LB8/d;)V
...
.method public final deleteSILogsByDaysBefore(JLB8/d;)Ljava/lang/Object;
    .locals 3
    .param p3    # LB8/d;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-direct {v1, p0, p1, p2, v2}, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository$deleteSILogsByDaysBefore$2;-><init>(Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;JLB8/d;)V

    invoke-static {v0, v1, p3}, Lfa/H;->N(LB8/i;LL8/n;LB8/d;)Ljava/lang/Object;
...
.method public final getAllSILogs()Lkotlinx/coroutines/flow/Flow;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->allSILogs:Lkotlinx/coroutines/flow/Flow;
...
.method public final getAllSILogsGroupByEventId()Lkotlinx/coroutines/flow/Flow;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->allSILogsGroupByEventId:Lkotlinx/coroutines/flow/Flow;
...
.method public final getAllSILogsGroupByServiceId()Lkotlinx/coroutines/flow/Flow;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->allSILogsGroupByServiceId:Lkotlinx/coroutines/flow/Flow;

    return-object p0
.end method

.method public final getSILogCount()Lkotlinx/coroutines/flow/Flow;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {p0}, Lcom/sec/android/app/sbrowser/si_log/model/db/SILogDao;->getCount()Lkotlinx/coroutines/flow/Flow;
...
.method public final getSILogHistoryListDisplayGroupType()Lkotlinx/coroutines/flow/Flow;
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/si_log/model/SILogDataStore;->getHistoryListDisplayGroupTypeFlow()Lkotlinx/coroutines/flow/Flow;
...
.method public final getSILogStoragePeriodDays()Lkotlinx/coroutines/flow/Flow;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final insertSILog(Lcom/sec/android/app/sbrowser/si_log/model/db/SILogEntity;LB8/d;)Ljava/lang/Object;
    .locals 3
    .param p1    # Lcom/sec/android/app/sbrowser/si_log/model/db/SILogEntity;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-direct {v1, p0, p1, v2}, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository$insertSILog$2;-><init>(Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;Lcom/sec/android/app/sbrowser/si_log/model/db/SILogEntity;LB8/d;)V
...
.method public final insertSILogHistory(IILjava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-direct/range {v1 .. v8}, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository$insertSILogHistory$1;-><init>(Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;Ljava/lang/String;IILjava/lang/String;Ljava/util/Map;LB8/d;)V

    const/4 p0, 0x3

    const/4 p1, 0x0

    invoke-static {v0, p1, p1, v9, p0}, Lfa/H;->B(Lfa/E;LB8/i;Lfa/G;LL8/n;I)Lfa/F0;
...
.method public final sendSILog(ILjava/lang/String;ILjava/lang/String;Ljava/util/Map;Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository$ResultListener;)V
    ...
    iget-object v0, v1, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;->ioDispatcher:Lfa/A;
...
.method public final sendSIStatusLogs()V
    ...
    invoke-direct {v1, p0, v2}, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository$sendSIStatusLogs$1;-><init>(Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;LB8/d;)V
...
.method public final setSILogHistoryListDisplayGroupType(Ljava/lang/String;LB8/d;)Ljava/lang/Object;
    .locals 3
    ...
    invoke-direct {v1, p0, p1, v2}, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository$setSILogHistoryListDisplayGroupType$2;-><init>(Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;Ljava/lang/String;LB8/d;)V
...
.method public final setSILogStoragePeriodDays(JLB8/d;)Ljava/lang/Object;
    .locals 3
    .param p3    # LB8/d;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-direct {v1, p0, p1, p2, v2}, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository$setSILogStoragePeriodDays$2;-><init>(Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;JLB8/d;)V
...
.method public final updateSIStatusLog(Lcom/sec/android/app/sbrowser/si_log/model/db/SIStatusLogDto;LB8/d;)Ljava/lang/Object;
    .locals 3
    ...
    invoke-direct {v1, p0, p1, v2}, Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository$updateSIStatusLog$2;-><init>(Lcom/sec/android/app/sbrowser/si_log/model/SILogRepository;Lcom/sec/android/app/sbrowser/si_log/model/db/SIStatusLogDto;LB8/d;)V

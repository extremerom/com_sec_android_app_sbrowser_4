...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchHeaderViewHolder;,
...
.field private mSitesSearchHeaderViewHolder:Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchHeaderViewHolder;
...
.method public getItemAt(I)Landroid/view/View;
    ...
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;->mViewList:Ljava/util/List;
...
.method public getSitesSearchHeaderViewHolder()Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchHeaderViewHolder;
    .locals 0

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;->mSitesSearchHeaderViewHolder:Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchHeaderViewHolder;
...
.method public onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    instance-of v0, p1, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchHeaderViewHolder;
    ...
    invoke-static {p2, p0, p1}, Landroidx/compose/ui/input/pointer/a;->B(ILjava/lang/String;Ljava/lang/String;)V
    ...
    check-cast v2, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchItemViewHolder;

    const/16 v3, 0xf

    invoke-virtual {v2, v3}, Lcom/sec/android/app/sbrowser/common/view/RoundedViewHolder;->setRoundMode(I)V

    iget-object v2, v2, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchItemViewHolder;->mDivider:Landroid/view/View;
    ...
    invoke-virtual {v2, v10}, Lcom/sec/android/app/sbrowser/common/view/RoundedViewHolder;->setRoundMode(I)V
    ...
    iget-object v11, p1, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchItemViewHolder;->mMainItemLayout:Landroid/widget/RelativeLayout;

    iget-object v3, p1, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchItemViewHolder;->mImageView:Landroid/widget/ImageView;

    iget-object v4, p1, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchItemViewHolder;->mDomaintantText:Landroid/widget/TextView;

    invoke-virtual {v1}, Lcom/sec/android/app/sbrowser/common/model/sites/SitesSearchItem;->getType()Lcom/sec/android/app/sbrowser/common/model/sites/SitesSearchItem$TYPE;

    move-result-object v2

    sget-object v5, Lcom/sec/android/app/sbrowser/common/model/sites/SitesSearchItem$TYPE;->BOOKMARK:Lcom/sec/android/app/sbrowser/common/model/sites/SitesSearchItem$TYPE;

    if-ne v2, v5, :cond_6

    iget-object p2, p0, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;->mContext:Landroid/content/Context;

    invoke-static {p2, v1, v3, v4}, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchItemIcon;->setBookmarkSearchResultIcon(Landroid/content/Context;Lcom/sec/android/app/sbrowser/common/model/sites/SitesSearchItem;Landroid/widget/ImageView;Landroid/widget/TextView;)V
    ...
    sget-object v5, Lcom/sec/android/app/sbrowser/common/model/sites/SitesSearchItem$TYPE;->HISTORY:Lcom/sec/android/app/sbrowser/common/model/sites/SitesSearchItem$TYPE;

    if-ne v2, v5, :cond_7

    iget-object v5, p0, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;->mContext:Landroid/content/Context;

    iget-object v6, p0, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;->mSitesResultList:Ljava/util/concurrent/CopyOnWriteArrayList;

    move-object v2, v1

    move v7, p2

    invoke-static/range {v2 .. v7}, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchItemIcon;->setHistorySearchResultIcon(Lcom/sec/android/app/sbrowser/common/model/sites/SitesSearchItem;Landroid/widget/ImageView;Landroid/widget/TextView;Landroid/content/Context;Ljava/util/concurrent/CopyOnWriteArrayList;I)V
    ...
    check-cast v3, Lcom/sec/android/app/sbrowser/sites/history/view/RoundCornersImageView;

    invoke-static {p2, v1, v3, v4}, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchItemIcon;->setSavedPageSearchResultIcon(Landroid/content/Context;Lcom/sec/android/app/sbrowser/common/model/sites/SitesSearchItem;Lcom/sec/android/app/sbrowser/sites/history/view/RoundCornersImageView;Landroid/widget/TextView;)V

    :cond_8
    :goto_1
    iget-object p2, p1, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchItemViewHolder;->mMainItemLayout:Landroid/widget/RelativeLayout;
    ...
    iget-object p2, p0, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;->mSitesResultList:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-virtual {p2}, Lcom/sec/android/app/sbrowser/common/model/sites/SitesSearchItem;->getTitle()Ljava/lang/String;
    ...
    invoke-direct {p0, v11, v9}, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;->setItemSelectedBackgroundHighlight(Landroid/view/View;Z)V

    goto :goto_2

    :cond_9
    invoke-direct {p0, v11, v10}, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;->setItemSelectedBackgroundHighlight(Landroid/view/View;Z)V
    ...
    invoke-direct {v5, p0, v11}, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$1;-><init>(Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;Landroid/view/View;)V
    ...
    invoke-direct {p0, v4, p2, v3}, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;->setHighlightedTextSuggestion(Landroid/widget/TextView;Ljava/lang/String;Ljava/lang/String;)V

    iget-object p2, p1, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchItemViewHolder;->mUrlView:Landroid/widget/TextView;

    invoke-direct {p0, p2, v2, v3}, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;->setHighlightedTextSuggestion(Landroid/widget/TextView;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_4
    iget-boolean p2, p0, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;->mIsShowingActionMode:Z

    if-eqz p2, :cond_d

    iget-object p2, p1, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchItemViewHolder;->mCheckBox:Landroid/widget/CheckBox;
    ...
    invoke-static {v1, p2}, Lcom/sec/android/app/sbrowser/sites/common/bookmark/BookmarkCommonQueryUtil;->isNonEditableBookmarkFolder(Lcom/sec/android/app/sbrowser/common/model/sites/SitesSearchItem;Landroid/app/Activity;)Z

    move-result p2

    if-eqz p2, :cond_c

    invoke-direct {p0, v10, p1}, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;->setItemsEnabled(ZLcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchItemViewHolder;)V
    ...
    invoke-virtual {p1, v10}, Landroid/widget/CompoundButton;->setChecked(Z)V
...
.method public onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    invoke-static {p1, p2, p1, v1}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->b(Landroid/view/ViewGroup;ILandroid/view/ViewGroup;Z)Landroid/view/View;

    move-result-object p1

    new-instance p2, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchHeaderViewHolder;

    invoke-direct {p2, p0, p1}, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchHeaderViewHolder;-><init>(Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;Landroid/view/View;)V

    iput-object p2, p0, Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter;->mSitesSearchHeaderViewHolder:Lcom/sec/android/app/sbrowser/sites/search/view/SitesSearchAdapter$SitesSearchHeaderViewHolder;

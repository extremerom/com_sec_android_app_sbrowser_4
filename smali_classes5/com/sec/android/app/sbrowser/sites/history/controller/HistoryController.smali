...
.method public static synthetic a(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;)V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;->lambda$setSearchData$4()V
...
.method public static synthetic b(Lcom/sec/terrace/browser/history/TerraceHistoryItem;)Z
    .locals 0

    invoke-static {p0}, Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;->lambda$filterHistoryItems$3(Lcom/sec/terrace/browser/history/TerraceHistoryItem;)Z
...
.method public static synthetic c(Lcom/sec/terrace/browser/history/TerraceHistoryItem;)Z
    .locals 0

    invoke-static {p0}, Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;->lambda$filterHistoryItems$2(Lcom/sec/terrace/browser/history/TerraceHistoryItem;)Z
...
.method public static synthetic d(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;)V
    .locals 0
...
.method public static synthetic e(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;)V
    .locals 0
...
.method public static bridge synthetic f(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;)Landroid/content/Context;
    .locals 0
...
.method private filterHistoryItems(Ljava/util/List;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance p1, Lcom/sec/android/app/sbrowser/sites/history/controller/b;

    const/4 v0, 0x0

    invoke-direct {p1, v0}, Lcom/sec/android/app/sbrowser/sites/history/controller/b;-><init>(I)V
...
.method public static bridge synthetic g(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;)Ljava/util/List;
    .locals 0
...
.method public static bridge synthetic h(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;)Lcom/sec/terrace/browser/history/TerraceHistoryModel;
    .locals 0
...
.method public static bridge synthetic i(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;)Lcom/sec/android/app/sbrowser/sites/history/model/HistoryUI;
    .locals 0
...
.method public static bridge synthetic j(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;)Z
    .locals 0
...
.method public static bridge synthetic k(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;)Z
    .locals 0
...
.method public static bridge synthetic l(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;)Lcom/sec/android/app/sbrowser/media/history/MHActivityLauncher;
    .locals 0
...
.method private static synthetic lambda$filterHistoryItems$2(Lcom/sec/terrace/browser/history/TerraceHistoryItem;)Z
    .locals 0

    invoke-virtual {p0}, Lcom/sec/terrace/browser/history/TerraceHistoryItem;->getUrl()Ljava/lang/String;
...
.method private static synthetic lambda$filterHistoryItems$3(Lcom/sec/terrace/browser/history/TerraceHistoryItem;)Z
    .locals 1
    ...
    const-string v0, "athena-dev.internet.apps.samsung"
...
.method private synthetic lambda$setSearchData$4()V
    .locals 1
...
.method public static bridge synthetic o(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;)V
    .locals 0
...
.method private onHistoryReceived(Ljava/util/List;)V
    ...
    invoke-virtual {v1}, Lcom/sec/terrace/browser/history/TerraceHistoryModel;->getHistoryCount()V
    ...
    const-string v4, "HistoryController"
    ...
    const-string v5, "open.toutiao.com"
    ...
    const-string v6, "eedcoop.douyin.com"
    ...
    const-string v3, "Video page Comment do not need to show on history"
    ...
    invoke-virtual {v3}, Lcom/sec/terrace/browser/history/TerraceHistoryItem;->getTitle()Ljava/lang/String;
    ...
    invoke-virtual {v4, v3}, Lcom/sec/android/app/sbrowser/sites/history/controller/HistorySyncHandler;->getHistoryItem(Ljava/lang/String;)Lcom/sec/terrace/browser/history/TerraceHistoryItem;
    ...
    const-string v2, "onHistoryDataReceived "
    ...
    iput-boolean v1, p0, Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;->mIsFromDelete:Z
...
.method public static bridge synthetic p(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;)V
    .locals 0
...
.method public static bridge synthetic q(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;Ljava/util/List;)V
    .locals 0
...
.method public static bridge synthetic r(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;Ljava/lang/String;I)V
    .locals 0
...
.method public static bridge synthetic s(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;)Ljava/lang/String;
    .locals 0
...
.method private setHistoryData(Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;->filterHistoryItems(Ljava/util/List;)Ljava/util/List;
...
.method public static bridge synthetic t(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;)V
    .locals 0
...
.method public static bridge synthetic u(Lcom/sec/android/app/sbrowser/sites/history/controller/HistoryController;Ljava/lang/String;)V
    .locals 0
...
.method public getReferenceView(Lcom/google/android/material/oneui/floatingactioncontainer/FloatingAware$PositionType;)Landroid/view/View;
    ...
    invoke-interface {p0, p1}, Lcom/sec/android/app/sbrowser/sites/history/model/HistoryUI;->getReferenceView(Lcom/google/android/material/oneui/floatingactioncontainer/FloatingAware$PositionType;)Landroid/view/View;
...
.method public updateSideTextVisibility(Z)V
    ...
    invoke-interface {p0, p1}, Lcom/sec/android/app/sbrowser/sites/history/model/HistoryUI;->updateSideTextVisibility(Z)V

...
.method private synthetic lambda$deleteFromLocal$2(Ljava/lang/String;J)V
    ...
    invoke-static {p3, p1, v2}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->o(Landroid/content/Context;Landroid/content/ContentValues;Ljava/lang/String;)V
...
.method private migrateHistoryItems(Ljava/util/List;)V
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/sites/history/controller/d;

    const/4 v1, 0x1

    invoke-direct {v0, v1, p0, p1}, Lcom/sec/android/app/sbrowser/sites/history/controller/d;-><init>(ILjava/lang/Object;Ljava/util/List;)V
...
.method private migrateIfNeeded()V
    ...
    invoke-direct {v0, p0, v1}, Lcom/sec/android/app/sbrowser/sites/history/controller/g;-><init>(Lcom/sec/android/app/sbrowser/sites/history/controller/HistorySyncHandler;I)V
...
.method public deleteFromLocal(Ljava/lang/String;J)V
    ...
    new-instance v6, Landroidx/media3/exoplayer/video/f;
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/media3/exoplayer/video/f;-><init>(IJLjava/lang/Object;Ljava/lang/Object;)V

    invoke-static {}, Lcom/sec/android/app/sbrowser/sites/model/SyncMetaInfoThread;->getMetaInfoThread()Lcom/sec/android/app/sbrowser/sites/model/SyncMetaInfoThread;

    move-result-object p0

    invoke-virtual {p0, v6}, Lcom/sec/android/app/sbrowser/sites/model/SyncMetaInfoThread;->runOnWorkerThread(Ljava/lang/Runnable;)V
...
.method public getHistoryItem(Ljava/lang/String;)Lcom/sec/terrace/browser/history/TerraceHistoryItem;
    .locals 1
    ...
    invoke-virtual {p0, v0, p1}, Lcom/sec/android/app/sbrowser/sites/model/SyncMetaInfoDbHelper;->getHistoryItem(Ljava/lang/String;[Ljava/lang/String;)Lcom/sec/terrace/browser/history/TerraceHistoryItem;
...
.method public insertFromLocal(Ljava/lang/String;Ljava/lang/String;JI)V
    ...
    new-instance v7, Lcom/sec/android/app/sbrowser/sites/history/controller/e;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/sec/android/app/sbrowser/sites/history/controller/e;-><init>(Lcom/sec/android/app/sbrowser/sites/history/controller/HistorySyncHandler;Ljava/lang/String;Ljava/lang/String;IJ)V
...
.method public updateFromLocal(Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;J)V
    ...
    new-instance p2, Lcom/sec/android/app/sbrowser/sites/history/controller/f;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/sec/android/app/sbrowser/sites/history/controller/f;-><init>(Lcom/sec/android/app/sbrowser/sites/history/controller/HistorySyncHandler;Ljava/lang/String;Ljava/lang/String;JJ)V

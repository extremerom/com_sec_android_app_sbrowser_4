...
.method public static addChildrenToDelete(JLcom/sec/android/app/sbrowser/sites/common/search/model/SitesSmartSearchData;ZLcom/google/common/collect/u0;Ljava/util/List;Ljava/lang/StringBuilder;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    invoke-interface {p4, p0}, Lcom/google/common/collect/u0;->get(Ljava/lang/Object;)Ljava/util/Collection;
    ...
    invoke-static/range {v2 .. v8}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModelHelper;->addChildrenToDelete(JLcom/sec/android/app/sbrowser/sites/common/search/model/SitesSmartSearchData;ZLcom/google/common/collect/u0;Ljava/util/List;Ljava/lang/StringBuilder;)V
...
.method public static addChildrenToInsert(JLcom/google/common/collect/u0;Lcom/sec/android/app/sbrowser/sites/common/search/model/SitesSmartSearchData;Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/FolderHierarchy;ZLjava/util/ArrayList;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    invoke-interface {p2, p0}, Lcom/google/common/collect/u0;->get(Ljava/lang/Object;)Ljava/util/Collection;
    ...
    invoke-static/range {v2 .. v8}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModelHelper;->addChildrenToInsert(JLcom/google/common/collect/u0;Lcom/sec/android/app/sbrowser/sites/common/search/model/SitesSmartSearchData;Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/FolderHierarchy;ZLjava/util/ArrayList;)V
...
.method public static bulkDelete(Landroid/app/Activity;Ljava/util/List;Lcom/sec/android/app/sbrowser/sites/common/search/model/SitesSmartSearchData;Lcom/google/common/collect/u0;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v0 .. v6}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModelHelper;->addChildrenToDelete(JLcom/sec/android/app/sbrowser/sites/common/search/model/SitesSmartSearchData;ZLcom/google/common/collect/u0;Ljava/util/List;Ljava/lang/StringBuilder;)V
...
.method public static bulkInsert(Landroid/app/Activity;Ljava/util/List;Lcom/sec/android/app/sbrowser/sites/common/search/model/SitesSmartSearchData;Lcom/google/common/collect/u0;)V
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v0 .. v6}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModelHelper;->addChildrenToInsert(JLcom/google/common/collect/u0;Lcom/sec/android/app/sbrowser/sites/common/search/model/SitesSmartSearchData;Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/FolderHierarchy;ZLjava/util/ArrayList;)V
...
.method public static getBixbySearchResults(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/bixby2/action/ResponseCallback;)V
    ...
    invoke-static {v3, v1, v4}, LJ7/b;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public static getBookmarkMap(Landroid/content/Context;Landroid/net/Uri;)Lcom/google/common/collect/u0;
    .locals 18
    ...
    invoke-virtual {v1, v4, v3}, Lcom/google/common/collect/n0;->put(Ljava/lang/Object;Ljava/lang/Object;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-static {v0, v2, v3}, Landroidx/glance/oneui/template/layout/glance/a;->v(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public static getFolderMap(Landroid/content/Context;Landroid/net/Uri;Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;J)Lcom/google/common/collect/u0;
    .locals 23
    .annotation build Landroid/annotation/SuppressLint;
        value = {
            "Range"
    ...
    new-instance v3, Lcom/google/common/collect/n0;

    invoke-direct {v3}, Lcom/google/common/collect/n0;-><init>()V
    ...
    invoke-virtual {v3, v0, v1}, Lcom/google/common/collect/n0;->put(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v3, v0, v7}, Lcom/google/common/collect/n0;->put(Ljava/lang/Object;Ljava/lang/Object;)Z
    :try_end_3
...
.method private static getSortOrder(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string p0, "FOLDER DESC, TITLE COLLATE LOCALIZED ASC"
    ...
    const-string p0, "FOLDER DESC, TITLE COLLATE LOCALIZED DESC"
...
.method public static getTotalBookmarksCount(Landroid/app/Activity;Z)V
    ...
    :cond_0
    new-instance p1, Lcom/sec/android/app/sbrowser/payments/standard/e;

    const/16 v1, 0x10

    invoke-direct {p1, v1, p0, v0}, Lcom/sec/android/app/sbrowser/payments/standard/e;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public static getTotalBookmarksCount(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    invoke-static {p0, p1, v0}, Landroidx/glance/oneui/template/layout/glance/a;->v(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public static isValidParent(Ljava/lang/Long;Ljava/lang/Long;ILjava/util/HashMap;Landroid/content/Context;)Z
    ...
    invoke-static {v4, v5, v2}, Landroidx/glance/oneui/template/layout/glance/a;->v(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public static sendAddUpdateToWearable(Landroid/content/Context;Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;)V
    ...
    const-string v0, "com.sec.android.app.sbrowser.bookmark.BOOKMARK_ADDED"

    invoke-static {v0}, Lf/a;->f(Ljava/lang/String;)Landroid/content/Intent;
    ...
    const-string p1, "com.sec.android.app.sbrowser.permission.WEARABLE_PERMISSION"
...
.method public static sendDeleteMsgToSearch(Landroid/app/Activity;Ljava/util/ArrayList;Lcom/google/common/collect/u0;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-static {p0, v1, v0, p2}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModelHelper;->bulkDelete(Landroid/app/Activity;Ljava/util/List;Lcom/sec/android/app/sbrowser/sites/common/search/model/SitesSmartSearchData;Lcom/google/common/collect/u0;)V
...
.method public static sendDeleteUpdateToWearable(Landroid/content/Context;ZLjava/util/HashMap;)V
    ...
    const-string v1, "com.sec.android.app.sbrowser.bookmark.BOOKMARK_DELETED"
...
.method public static sendEditMsgToSearch(Landroid/app/Activity;Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;)V
    ...
    invoke-static {p0, v1}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModelHelper;->getBookmarkMap(Landroid/content/Context;Landroid/net/Uri;)Lcom/google/common/collect/u0;
    ...
    invoke-static {p0, v2, v0, v1}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModelHelper;->bulkDelete(Landroid/app/Activity;Ljava/util/List;Lcom/sec/android/app/sbrowser/sites/common/search/model/SitesSmartSearchData;Lcom/google/common/collect/u0;)V
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModelHelper;->bulkInsert(Landroid/app/Activity;Ljava/util/List;Lcom/sec/android/app/sbrowser/sites/common/search/model/SitesSmartSearchData;Lcom/google/common/collect/u0;)V
...
.method public static sendEditUpdateToWearable(Landroid/content/Context;Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;)V
    ...
    const-string v0, "com.sec.android.app.sbrowser.bookmark.BOOKMARK_UPDATED"
...
.method public static sendMoveMsgToSearch(Landroid/app/Activity;Ljava/util/List;Ljava/util/List;Lcom/google/common/collect/u0;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p1, v0, p3}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModelHelper;->bulkDelete(Landroid/app/Activity;Ljava/util/List;Lcom/sec/android/app/sbrowser/sites/common/search/model/SitesSmartSearchData;Lcom/google/common/collect/u0;)V

    invoke-static {p0, p2, v0, v1}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModelHelper;->bulkInsert(Landroid/app/Activity;Ljava/util/List;Lcom/sec/android/app/sbrowser/sites/common/search/model/SitesSmartSearchData;Lcom/google/common/collect/u0;)V
...
.method public static updateDominantColor(Landroid/app/Activity;JJLandroid/net/Uri;)V
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/media3/exoplayer/audio/f;-><init>(Landroid/app/Activity;JJLandroid/net/Uri;)V
...
.method public static updateFolderState(Landroid/content/Context;Landroid/net/Uri;Ljava/util/HashMap;Ljava/util/HashMap;)V
    ...
    new-instance v6, Landroidx/media3/exoplayer/source/i;
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/media3/exoplayer/source/i;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method private static updateFolderValue(Landroid/content/Context;Landroid/net/Uri;Ljava/util/HashMap;Z)V
    ...
    invoke-static {v0, p0, p3}, Landroidx/appcompat/graphics/drawable/a;->z(Ljava/lang/String;Ljava/lang/StringBuilder;Z)V

...
.field private mEditDialog:Landroidx/appcompat/app/AlertDialog$Builder;
...
.method private synthetic lambda$showEditFolderAlertDialog$1(Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;Landroid/widget/TextView;ILandroid/view/KeyEvent;)Z
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mDialog:Landroidx/appcompat/app/AlertDialog;
...
.method private synthetic lambda$showEditFolderAlertDialog$2(Landroid/content/DialogInterface;I)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mEditDialog:Landroidx/appcompat/app/AlertDialog$Builder;
...
.method private synthetic lambda$showEditFolderAlertDialog$6(Landroid/content/DialogInterface;)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mDialog:Landroidx/appcompat/app/AlertDialog;
...
.method private updateSoftInputMode(Z)V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mDialog:Landroidx/appcompat/app/AlertDialog;
...
.method public dismissDialog()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mEditDialog:Landroidx/appcompat/app/AlertDialog$Builder;
    ...
    iput-object v1, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mEditDialog:Landroidx/appcompat/app/AlertDialog$Builder;
...
.method public getEditFolderDialog()Landroidx/appcompat/app/AlertDialog$Builder;
    .locals 0

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mEditDialog:Landroidx/appcompat/app/AlertDialog$Builder;
...
.method public showEditFolderAlertDialog(Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;)V
    ...
    iget-object v3, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mEditDialog:Landroidx/appcompat/app/AlertDialog$Builder;
    ...
    new-instance v5, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/a;

    invoke-direct {v5, p0, v2}, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/a;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v5, v2, p0, p1}, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/n;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    iput-object v4, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mEditDialog:Landroidx/appcompat/app/AlertDialog$Builder;
    ...
    invoke-direct {v4, p0, v5}, LE6/e;-><init>(Ljava/lang/Object;I)V

    const v5, 0x7f14025d

    invoke-virtual {v3, v5, v4}, Landroidx/appcompat/app/AlertDialog$Builder;->setNegativeButton(ILandroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/AlertDialog$Builder;

    iget-object v3, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mEditDialog:Landroidx/appcompat/app/AlertDialog$Builder;

    new-instance v4, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/view/z;

    invoke-direct {v4, v0}, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/view/z;-><init>(I)V
    ...
    iput-object v3, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mDialog:Landroidx/appcompat/app/AlertDialog;

    invoke-static {v3}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->setSEP10Dialog(Landroid/app/Dialog;)V

    iget-object v3, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mEditFolderView:Landroidx/appcompat/widget/AppCompatEditText;

    iget-object v4, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mTextWatcher:Landroid/text/TextWatcher;

    invoke-virtual {v3, v4}, Landroid/widget/TextView;->addTextChangedListener(Landroid/text/TextWatcher;)V

    iget-object v3, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mDialog:Landroidx/appcompat/app/AlertDialog;
    ...
    iput-object v3, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mPositiveButton:Landroid/widget/Button;

    invoke-virtual {v3, v1}, Landroid/view/View;->setEnabled(Z)V

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mPositiveButton:Landroid/widget/Button;

    new-instance v3, LX3/a;

    invoke-direct {v3, v0, p0, p1}, LX3/a;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {v1, v3}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object p1, p0, Lcom/sec/android/app/sbrowser/sites/bookmark/utils/EditFolderDialogHelper;->mDialog:Landroidx/appcompat/app/AlertDialog;

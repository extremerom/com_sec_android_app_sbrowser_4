...
.method private synthetic lambda$createPCBookmarkFolderIfNeeded$1()V
    ...
    invoke-static {v1, v0, v7}, Landroidx/glance/oneui/template/layout/glance/a;->y(Ljava/lang/String;Ljava/lang/String;Z)V
...
.method private synthetic lambda$deleteItems$9(Ljava/util/ArrayList;Ljava/util/HashMap;Ljava/util/ArrayList;)V
    ...
    invoke-static {v0, v8}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModelHelper;->getBookmarkMap(Landroid/content/Context;Landroid/net/Uri;)Lcom/google/common/collect/u0;
    ...
    invoke-static {v11, v3, v5}, LJ7/b;->q(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v3, v4, v8}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModelHelper;->sendDeleteMsgToSearch(Landroid/app/Activity;Ljava/util/ArrayList;Lcom/google/common/collect/u0;)V
...
.method private synthetic lambda$moveToFolder$2(Ljava/util/List;Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;Ljava/util/List;)V
    ...
    invoke-static {v10, v11}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModelHelper;->getBookmarkMap(Landroid/content/Context;Landroid/net/Uri;)Lcom/google/common/collect/u0;
    ...
    invoke-static {v0, v8, v11, v1}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModelHelper;->sendMoveMsgToSearch(Landroid/app/Activity;Ljava/util/List;Ljava/util/List;Lcom/google/common/collect/u0;)V
...
.method private synthetic lambda$reorderBookmarks$8(Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;[Ljava/lang/Object;Ljava/util/List;)V
    ...
    invoke-static {v13, v11, v2, v3, v14}, Landroidx/appcompat/graphics/drawable/a;->w(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private recursiveAddFoldersWithRoot(Ljava/util/List;Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;Lcom/google/common/collect/u0;I)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, v0}, Lcom/google/common/collect/u0;->get(Ljava/lang/Object;)Ljava/util/Collection;
    ...
    invoke-direct {p0, p1, v1, p3, v2}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModel;->recursiveAddFoldersWithRoot(Ljava/util/List;Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;Lcom/google/common/collect/u0;I)V
...
.method public static bridge synthetic s(Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModel;Ljava/util/ArrayList;Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;Lcom/google/common/collect/u0;)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, p2, p3, v0}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModel;->recursiveAddFoldersWithRoot(Ljava/util/List;Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;Lcom/google/common/collect/u0;I)V
...
.method public addBookmarkFolder(Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;Ljava/lang/String;ZZ)V
    ...
    new-instance v6, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/d;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/d;-><init>(Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/BookmarkModel;Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;Ljava/lang/String;ZZ)V
...
.method public editBookmarkFolder(Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;Ljava/lang/String;)V
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/c;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1, p1, p2}, Lcom/sec/android/app/sbrowser/sites/bookmark/model/bookmark/c;-><init>(Ljava/lang/Object;ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public initializeBookmarkData(Landroid/content/Context;Landroid/app/Activity;)Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkItem;
    ...
    invoke-static {p2, v1, v2}, Landroidx/appcompat/graphics/drawable/a;->A(Ljava/lang/StringBuilder;ILjava/lang/String;)V
...
.method public setRootId(Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/payments/standard/e;

    const/16 v1, 0xd

    invoke-direct {v0, v1, p0, p1}, Lcom/sec/android/app/sbrowser/payments/standard/e;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

...
.method public constructor <init>()V
    ...
    invoke-virtual {v1}, Lcom/sec/android/app/sbrowser/quickaccess/model/MostVisitedSitesRepository;->getItems()Lcom/sec/android/app/sbrowser/common/model/quickaccess/MutableListLiveData;

    move-result-object v6

    new-instance v7, Lcom/sec/android/app/sbrowser/quickaccess/ui/viewmodel/o;

    const/4 v8, 0x0

    invoke-direct {v7, v5, v4, v8}, Lcom/sec/android/app/sbrowser/quickaccess/ui/viewmodel/o;-><init>(Lcom/sec/android/app/sbrowser/quickaccess/domain/usecase/UpdateFilteredMostVisitedItemsUseCase;Landroidx/lifecycle/MediatorLiveData;I)V

    invoke-virtual {v4, v6, v7}, Landroidx/lifecycle/MediatorLiveData;->addSource(Landroidx/lifecycle/LiveData;Landroidx/lifecycle/Observer;)V
    ...
    invoke-virtual {v2, v5}, Lcom/sec/android/app/sbrowser/quickaccess/ui/viewmodel/QuickAccessIconItemMediatorLiveData;->addQuickAccessItemListSource(Landroidx/lifecycle/LiveData;)V

    invoke-virtual {v3, v4}, Lcom/sec/android/app/sbrowser/quickaccess/ui/viewmodel/MostVisitedVisibilityLiveData;->addItemListSource(Landroidx/lifecycle/LiveData;)V

    invoke-virtual {v1}, Lcom/sec/android/app/sbrowser/quickaccess/model/MostVisitedSitesRepository;->isEnabled()Landroidx/lifecycle/LiveData;

    move-result-object v1

    invoke-virtual {v3, v1}, Lcom/sec/android/app/sbrowser/quickaccess/ui/viewmodel/MostVisitedVisibilityLiveData;->addEnableStateSource(Landroidx/lifecycle/LiveData;)V

    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepository;->getItems()Lcom/sec/android/app/sbrowser/common/model/quickaccess/MutableListLiveData;

    move-result-object p0

    invoke-virtual {v0, p0}, Lcom/sec/android/app/sbrowser/quickaccess/ui/viewmodel/EmptyItemStateLiveData;->addQuickAccessStateSource(Landroidx/lifecycle/LiveData;)V

    invoke-virtual {v0, v3}, Lcom/sec/android/app/sbrowser/quickaccess/ui/viewmodel/EmptyItemStateLiveData;->addMostVisitedStateSource(Landroidx/lifecycle/LiveData;)V

    return-void
.end method

.method public static synthetic a(Lcom/sec/android/app/sbrowser/quickaccess/domain/usecase/UpdateFilteredMostVisitedItemsUseCase;Landroidx/lifecycle/MediatorLiveData;Ljava/util/List;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/sec/android/app/sbrowser/quickaccess/ui/viewmodel/QuickAccessSettingsViewModel;->lambda$new$0(Lcom/sec/android/app/sbrowser/quickaccess/domain/usecase/UpdateFilteredMostVisitedItemsUseCase;Landroidx/lifecycle/MediatorLiveData;Ljava/util/List;)V

    return-void
.end method

.method public static synthetic b(Lcom/sec/android/app/sbrowser/quickaccess/domain/usecase/UpdateFilteredMostVisitedItemsUseCase;Landroidx/lifecycle/MediatorLiveData;Ljava/util/List;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/sec/android/app/sbrowser/quickaccess/ui/viewmodel/QuickAccessSettingsViewModel;->lambda$new$1(Lcom/sec/android/app/sbrowser/quickaccess/domain/usecase/UpdateFilteredMostVisitedItemsUseCase;Landroidx/lifecycle/MediatorLiveData;Ljava/util/List;)V

    return-void
.end method

.method private static synthetic lambda$new$0(Lcom/sec/android/app/sbrowser/quickaccess/domain/usecase/UpdateFilteredMostVisitedItemsUseCase;Landroidx/lifecycle/MediatorLiveData;Ljava/util/List;)V
    .locals 2
    ...
    invoke-direct {v0, p1, v1}, Lcom/sec/android/app/sbrowser/quickaccess/ui/viewmodel/g;-><init>(Ljava/lang/Object;I)V
...
.method private static synthetic lambda$new$1(Lcom/sec/android/app/sbrowser/quickaccess/domain/usecase/UpdateFilteredMostVisitedItemsUseCase;Landroidx/lifecycle/MediatorLiveData;Ljava/util/List;)V
    .locals 2
...
.method public getEditShortcutsEnabled()Landroidx/lifecycle/LiveData;
    .locals 0

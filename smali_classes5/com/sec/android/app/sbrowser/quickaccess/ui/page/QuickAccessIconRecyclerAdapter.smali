...
.method public static bridge synthetic e(Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessIconRecyclerAdapter;)Landroidx/recyclerview/widget/ItemTouchHelper;
    .locals 0

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessIconRecyclerAdapter;->mItemTouchHelper:Landroidx/recyclerview/widget/ItemTouchHelper;
...
.method private getIconViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)Lcom/sec/android/app/sbrowser/quickaccess/ui/page/viewholder/QuickAccessIconViewHolder;
    .locals 1
...
.method private showAddShortcutDialog()V
    ...
    invoke-virtual {v0, v1}, Lcom/sec/android/app/sbrowser/quickaccess/ui/dialog/AddShortcutDialogFragment;->show(Landroidx/appcompat/app/AppCompatActivity;)V
...
.method public dragEnd(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    .locals 5
    ...
    invoke-direct {v0, p0, v1}, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/y;-><init>(Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessIconRecyclerAdapter;I)V
    ...
    new-instance v3, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/y;

    const/4 v4, 0x1

    invoke-direct {v3, p0, v4}, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/y;-><init>(Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessIconRecyclerAdapter;I)V
...
.method public dragStart(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    .locals 2
...
.method public onAttachedToRecyclerView(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessIconRecyclerAdapter;->mItemTouchHelper:Landroidx/recyclerview/widget/ItemTouchHelper;
...
.method public onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;ILjava/util/List;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessIconRecyclerAdapter;->onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
...
.method public onItemMoved(II)V
    ...
    invoke-virtual {p0, v1, v3, p1}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->notifyItemRangeChanged(IILjava/lang/Object;)V
...
.method public onMultiSelected(Ljava/util/List;)V
    ...
    invoke-direct {p0, v0}, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessIconRecyclerAdapter;->getIconViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)Lcom/sec/android/app/sbrowser/quickaccess/ui/page/viewholder/QuickAccessIconViewHolder;
    ...
    invoke-interface {v1}, Lcom/sec/android/app/sbrowser/quickaccess/ui/viewmodel/QuickAccessPageViewModel;->isEditButtonVisible()Landroidx/lifecycle/LiveData;
...
.method public requestScroll(II)V
    ...
    invoke-interface {v1}, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/icon_view/IconViewListener;->getVisibleToolbarHeight()I

    move-result v1

    iget-object v3, p0, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/BaseRecyclerAdapter;->mRecyclerView:Landroidx/recyclerview/widget/RecyclerView;

    invoke-static {v3}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->getStatusBarHeight(Landroid/view/View;)I

    move-result v3

    if-ne v1, v3, :cond_0

    new-instance v1, Lcom/sec/android/app/sbrowser/quickaccess/ui/base/QuickAccessHeightManager;

    iget-object v3, p0, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessIconRecyclerAdapter;->mContext:Landroid/content/Context;

    invoke-direct {v1, v3}, Lcom/sec/android/app/sbrowser/quickaccess/ui/base/QuickAccessHeightManager;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1}, Lcom/sec/android/app/sbrowser/quickaccess/ui/base/QuickAccessHeightManager;->checkableTopBarHeight()I
...
.method public showAddDialog(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/sec/android/app/sbrowser/quickaccess/ui/dialog/AbsQuickAccessDialogFragment;->show(Landroidx/appcompat/app/AppCompatActivity;Landroid/view/View;)V

...
.method public static synthetic c(Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessSyncRemoveDevicesAdapter;Ljava/util/List;)Lw8/B;
    .locals 0

    invoke-static {p0, p1}, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessSyncRemoveDevicesAdapter;->updateBackupListItems$lambda$3(Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessSyncRemoveDevicesAdapter;Ljava/util/List;)Lw8/B;
...
.method public static synthetic d(Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessSyncRemoveDevicesAdapter;)Lw8/B;
    .locals 0

    invoke-static {p0}, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessSyncRemoveDevicesAdapter;->updateBackupList$lambda$5(Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessSyncRemoveDevicesAdapter;)Lw8/B;
...
.method private static final updateBackupList$lambda$5(Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessSyncRemoveDevicesAdapter;)Lw8/B;
    .locals 2
    ...
    invoke-static {v0, p0}, Ly8/t;->H0(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/util/ArrayList;
...
.method private static final updateBackupListItems$lambda$3(Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessSyncRemoveDevicesAdapter;Ljava/util/List;)Lw8/B;
    .locals 1
    ...
    invoke-static {p1, v0}, Ly8/t;->r0(Ljava/lang/Iterable;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p1, p0}, Ly8/t;->r0(Ljava/lang/Iterable;Ljava/util/List;)Ljava/util/List;
...
.method public final updateBackupList()V
    ...
    new-instance v3, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/F;

    const/4 v4, 0x1

    invoke-direct {v3, p0, v4}, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/F;-><init>(Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessSyncBaseAdapter;I)V

    invoke-virtual {p0, v0, v1, v2, v3}, Lcom/sec/android/app/sbrowser/quickaccess/ui/page/QuickAccessSyncBaseAdapter;->dispatchListUpdates(Ljava/util/List;Ljava/util/List;ILL8/a;)V
...
.method public final updateBackupListItem(I)V
    ...
    invoke-virtual {p0, p1, v1, v0}, Landroidx/recyclerview/widget/AdapterListUpdateCallback;->onChanged(IILjava/lang/Object;)V
...
.method public final updateBackupListItems(Ljava/util/List;)V
    ...
    new-instance v3, Lcom/sec/android/app/sbrowser/artificial_intelligence/ai_search/model/b;

    const/4 v4, 0x4

    invoke-direct {v3, v4, p0, p1}, Lcom/sec/android/app/sbrowser/artificial_intelligence/ai_search/model/b;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

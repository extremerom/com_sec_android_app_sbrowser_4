...
# instance fields
.field private final mCachedItems:Lcom/sec/android/app/sbrowser/common/model/quickaccess/MutableListLiveData;
...
.method public constructor <init>(Landroid/content/Context;Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessModelV2;Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessUrlMigrator;Lcom/sec/android/app/sbrowser/quickaccess/model/SiteItemUpdater;)V
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepository;->mCachedItems:Lcom/sec/android/app/sbrowser/common/model/quickaccess/MutableListLiveData;
...
.method private deleteAllSpeciallyRemovedItems(Ljava/util/List;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/sec/android/app/sbrowser/quickaccess/model/t;-><init>(Ljava/lang/Object;I)V
...
.method private getItemsFromModel()Landroidx/lifecycle/LiveData;
    .locals 0
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessModelV2;->getItemsLiveData()Landroidx/lifecycle/LiveData;
...
.method private initCachedItems()V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepository;->getItemsFromModel()Landroidx/lifecycle/LiveData;
...
.method private synthetic lambda$initCachedItems$4(Ljava/util/List;)V
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepository;->getCachedItems()Lcom/sec/android/app/sbrowser/common/model/quickaccess/MutableListLiveData;

    move-result-object p0

    invoke-virtual {p0, p1}, Lcom/sec/android/app/sbrowser/common/model/quickaccess/MutableListLiveData;->updateValue(Ljava/util/List;)V
...
.method private updateIcon(Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;Ljava/lang/Integer;Lcom/sec/android/app/sbrowser/common/model/quickaccess/OnFinishedListener;)V
    ...
    invoke-direct {v8, p5, p0}, Lcom/sec/android/app/sbrowser/quickaccess/model/w;-><init>(Ljava/lang/Object;I)V
...
.method public checkUrlExists(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, p1, v1}, Lcom/sec/android/app/sbrowser/quickaccess/model/t;-><init>(Ljava/lang/Object;I)V
...
.method public getCachedItems()Lcom/sec/android/app/sbrowser/common/model/quickaccess/MutableListLiveData;
    .locals 0
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepository;->mCachedItems:Lcom/sec/android/app/sbrowser/common/model/quickaccess/MutableListLiveData;
...
.method public getItems()Lcom/sec/android/app/sbrowser/common/model/quickaccess/MutableListLiveData;
    .locals 2
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
...
.method public isDefaultListChanged(Ljava/util/List;)Z
    ...
    invoke-virtual {v3}, Lcom/sec/android/app/sbrowser/common/model/quickaccess/MutableListLiveData;->getValue()Ljava/util/List;
    ...
    invoke-virtual {v6}, Lcom/sec/android/app/sbrowser/common/model/quickaccess/MutableListLiveData;->getValue()Ljava/util/List;
...
.method public updateTitle(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p1, v0, p2}, Lcom/sec/android/app/sbrowser/quickaccess/model/w;-><init>(Ljava/lang/Object;I)V

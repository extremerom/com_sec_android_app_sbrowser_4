...
.field private final mFeaturesActiveStateList:Landroidx/lifecycle/MediatorLiveData;
...
.method public constructor <init>(Lcom/sec/android/app/sbrowser/quickaccess/model/SmartAntiTrackingDataSource;Lcom/sec/android/app/sbrowser/quickaccess/model/AdBlockerDataSource;Lcom/sec/android/app/sbrowser/quickaccess/model/BlockPopupsDataSource;Lcom/sec/android/app/sbrowser/quickaccess/model/BlockRedirectionDataSource;)V
    ...
    invoke-virtual {p1, v0}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->getAntiTrackingDefaultLevel(Z)I
    ...
    invoke-direct {p3, p2, v2, v1}, Lcom/sec/android/app/sbrowser/common/livedata/SharedPreferenceIntegerLiveData;-><init>(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    iput-object v1, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/PrivacyDashboardRepository;->mBlockBackwardRedirectionsEnabled:Lcom/sec/android/app/sbrowser/common/livedata/SharedPreferenceBooleanLiveData;
    ...
    invoke-direct {v2, p2, v3, p4}, Lcom/sec/android/app/sbrowser/common/livedata/SharedPreferenceBooleanLiveData;-><init>(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/Boolean;)V

    iput-object v2, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/PrivacyDashboardRepository;->mBlockPopupsEnabled:Lcom/sec/android/app/sbrowser/common/livedata/SharedPreferenceBooleanLiveData;
    ...
    invoke-direct {v3, p2, v4, p4}, Lcom/sec/android/app/sbrowser/common/livedata/SharedPreferenceBooleanLiveData;-><init>(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/Boolean;)V
    ...
    iput-object p2, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/PrivacyDashboardRepository;->mFeaturesActiveStateList:Landroidx/lifecycle/MediatorLiveData;

    new-instance p4, Lcom/sec/android/app/sbrowser/quickaccess/model/e;

    const/4 v4, 0x0

    invoke-direct {p4, p0, v4}, Lcom/sec/android/app/sbrowser/quickaccess/model/e;-><init>(Lcom/sec/android/app/sbrowser/quickaccess/model/PrivacyDashboardRepository;I)V

    invoke-virtual {p2, p3, p4}, Landroidx/lifecycle/MediatorLiveData;->addSource(Landroidx/lifecycle/LiveData;Landroidx/lifecycle/Observer;)V

    new-instance p3, Lcom/sec/android/app/sbrowser/quickaccess/model/e;

    const/4 p4, 0x1

    invoke-direct {p3, p0, p4}, Lcom/sec/android/app/sbrowser/quickaccess/model/e;-><init>(Lcom/sec/android/app/sbrowser/quickaccess/model/PrivacyDashboardRepository;I)V

    invoke-virtual {p2, v1, p3}, Landroidx/lifecycle/MediatorLiveData;->addSource(Landroidx/lifecycle/LiveData;Landroidx/lifecycle/Observer;)V
    ...
    invoke-virtual {p2, v2, p3}, Landroidx/lifecycle/MediatorLiveData;->addSource(Landroidx/lifecycle/LiveData;Landroidx/lifecycle/Observer;)V
    ...
    invoke-virtual {p2, v3, p3}, Landroidx/lifecycle/MediatorLiveData;->addSource(Landroidx/lifecycle/LiveData;Landroidx/lifecycle/Observer;)V
...
.method private updateFeaturesActiveStateList(Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Boolean;)V
    ...
    iget-object p1, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/PrivacyDashboardRepository;->mFeaturesActiveStateList:Landroidx/lifecycle/MediatorLiveData;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/PrivacyDashboardRepository;->mFeaturesActiveStateList:Landroidx/lifecycle/MediatorLiveData;
...
.method public getFeaturesActiveStateList()Landroidx/lifecycle/MediatorLiveData;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",

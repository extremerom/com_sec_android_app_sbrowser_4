...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "siteItemUpdater",
        "<init>",
        "(Landroid/content/Context;Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessModel;Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessModelV2;Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessUrlMigrator;Lfa/A;Lcom/sec/android/app/sbrowser/quickaccess/model/SiteItemUpdater;)V",
        "",
...
.field private final oldDbItemsInDevice$delegate:Lw8/h;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field private final quickAccessSettings$delegate:Lw8/h;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2$Companion;-><init>(Lkotlin/jvm/internal/i;)V
...
.method public constructor <init>(Landroid/content/Context;Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessModel;Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessModelV2;Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessUrlMigrator;Lfa/A;Lcom/sec/android/app/sbrowser/quickaccess/model/SiteItemUpdater;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;->coroutineDispatcher:Lfa/A;
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;->quickAccessSettings$delegate:Lw8/h;

    new-instance p1, Lcom/sec/android/app/sbrowser/quickaccess/model/j;

    const/4 p2, 0x1

    invoke-direct {p1, p0, p2}, Lcom/sec/android/app/sbrowser/quickaccess/model/j;-><init>(Ljava/lang/Object;I)V

    invoke-static {p1}, Lb2/y;->d(LL8/a;)Lw8/q;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;->oldDbItemsInDevice$delegate:Lw8/h;

    return-void
.end method

.method public synthetic constructor <init>(Landroid/content/Context;Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessModel;Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessModelV2;Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessUrlMigrator;Lfa/A;Lcom/sec/android/app/sbrowser/quickaccess/model/SiteItemUpdater;ILkotlin/jvm/internal/i;)V
    .locals 7
...
.method private final getQuickAccessSettings()Lcom/sec/android/app/sbrowser/quickaccess/settings/QuickAccessSettings;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;->quickAccessSettings$delegate:Lw8/h;
...
.method private static final oldDbItemsInDevice_delegate$lambda$1(Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;)Lkotlinx/coroutines/flow/Flow;
    .locals 2

    invoke-super {p0}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepository;->getItems()Lcom/sec/android/app/sbrowser/common/model/quickaccess/MutableListLiveData;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;->coroutineDispatcher:Lfa/A;

    invoke-static {v0, p0}, Lia/v0;->v(Lkotlinx/coroutines/flow/Flow;LB8/i;)Lkotlinx/coroutines/flow/Flow;
...
.method public static synthetic p(Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;)Lkotlinx/coroutines/flow/Flow;
    .locals 0

    invoke-static {p0}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;->oldDbItemsInDevice_delegate$lambda$1(Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;)Lkotlinx/coroutines/flow/Flow;
...
.method public final deleteDevicesFromSync(Ljava/util/Set;)V
    ...
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;->coroutineDispatcher:Lfa/A;
    ...
    invoke-direct {v2, p0, v3}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2$deleteDevicesFromSync$1;-><init>(Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;LB8/d;)V
...
.method public final getItemCountByDeviceIdOwn()Lkotlinx/coroutines/flow/Flow;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessModelV2;->getItemsByDeviceIdOwn()Lkotlinx/coroutines/flow/Flow;
    ...
    invoke-direct {v1, v0}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2$getItemCountByDeviceIdOwn$$inlined$map$1;-><init>(Lkotlinx/coroutines/flow/Flow;)V

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;->coroutineDispatcher:Lfa/A;

    invoke-static {v1, p0}, Lia/v0;->v(Lkotlinx/coroutines/flow/Flow;LB8/i;)Lkotlinx/coroutines/flow/Flow;
...
.method public final getItemDeviceNamesAndDeviceIdsNotOwn()Lkotlinx/coroutines/flow/Flow;
    ...
    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessModelV2;->getItemDeviceNamesAndDeviceIdsNotOwn()Lkotlinx/coroutines/flow/Flow;
...
.method public final getItemsGroupByDeviceIdNotOwn()Lkotlinx/coroutines/flow/Flow;
    ...
    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessModelV2;->getItemsGroupByDeviceIdNotOwn()Lkotlinx/coroutines/flow/Flow;
    ...
    invoke-direct {v1, v0, p0}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2$getItemsGroupByDeviceIdNotOwn$$inlined$map$1;-><init>(Lkotlinx/coroutines/flow/Flow;Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;)V
...
.method public final getOldDbItemDeviceNameAndDeviceIdOwn()Lkotlinx/coroutines/flow/Flow;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;->getOldDbItemsInDevice()Lkotlinx/coroutines/flow/Flow;
    ...
    invoke-direct {v1, v0}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2$getOldDbItemDeviceNameAndDeviceIdOwn$$inlined$map$1;-><init>(Lkotlinx/coroutines/flow/Flow;)V
...
.method public final getOldDbItemsByDeviceOwn()Lkotlinx/coroutines/flow/Flow;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {v1, v0}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2$getOldDbItemsByDeviceOwn$$inlined$map$1;-><init>(Lkotlinx/coroutines/flow/Flow;)V
...
.method public final getOldDbItemsInDevice()Lkotlinx/coroutines/flow/Flow;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessRepositoryV2;->oldDbItemsInDevice$delegate:Lw8/h;

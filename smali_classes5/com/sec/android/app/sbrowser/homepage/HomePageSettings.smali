...
.method private constructor <init>()V
    ...
    invoke-static {v0, v1, v3}, LJ7/b;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/homepage/HomePageSettings;->isHomepageChangedToMultiCpChecked()Z

    move-result v0

    if-nez v0, :cond_4

    invoke-virtual {p0, v2}, Lcom/sec/android/app/sbrowser/homepage/HomePageSettings;->setHomePageChangedToMultiCp(Z)V
...
.method public static getHomepageUrlForNonOperatorPreset(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p0}, Lcom/sec/android/app/sbrowser/common/utils/MultiCpUrlManager;->getMultiCpUrl(Landroid/content/Context;)Ljava/lang/String;
...
.method private initHomepageTypeIfNeeded()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/homepage/HomePageSettings;->mFactoryResetUrl:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/sec/android/app/sbrowser/common/utils/MultiCpUrlManager;->isMultiCpDomain(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v6}, Lcom/sec/android/app/sbrowser/homepage/HomePageSettings;->setHomePageChangedToMultiCp(Z)V

    invoke-virtual {p0, v5}, Lcom/sec/android/app/sbrowser/homepage/HomePageSettings;->setHomePageType(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/sec/android/app/sbrowser/common/utils/MultiCpUrlManager;->getMultiCpUrl(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v6}, Lcom/sec/android/app/sbrowser/homepage/HomePageSettings;->setNewsFeedEnabled(Z)V

    goto :goto_1

    :cond_6
    invoke-virtual {p0, v7}, Lcom/sec/android/app/sbrowser/homepage/HomePageSettings;->setHomePage(Ljava/lang/String;)V
...
.method private isContentPageAvailable(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/sec/android/app/sbrowser/common/utils/MultiCpUrlManager;->getMultiCpUrl(Landroid/content/Context;)Ljava/lang/String;
...
.method private isHomepageChangedToMultiCpChecked()Z
    .locals 1

    const-string v0, "homepage_force_changed_to_multi_cp"
...
.method private setCscHomepage(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2, v1}, LJ7/b;->C(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, p0, v1}, Landroidx/glance/oneui/template/layout/glance/a;->A(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)V
...
# virtual methods
.method public checkConditionToShowMultiCpDefaultHomePageCN()Z
    .locals 2
...
.method public checkConditionToShowMultiCpNativePageCN()Z
    .locals 2
...
.method public getHomePage()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/sec/android/app/sbrowser/common/device/setting_preference/BrowserPreferences;->mContext:Landroid/content/Context;

    invoke-static {v2}, Lcom/sec/android/app/sbrowser/common/device/CidUtil;->getClientIdForEarlyAccess(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/sec/android/app/sbrowser/common/utils/MultiCpUrlManager;->forceUpdateMultiCPUrl()Ljava/lang/String;
    ...
    invoke-virtual {v4, v0}, Lcom/sec/android/app/sbrowser/common/utils/MultiCpUrlManager;->isDeprecatedMultiCPUrl(Ljava/lang/String;)Z

    move-result v4

    if-eqz v4, :cond_4

    invoke-virtual {p0, v1, v2}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/BrowserPreferences;->persistString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4}, Lcom/sec/android/app/sbrowser/common/utils/MultiCpUrlManager;->isDeprecatedMultiCPUrl(Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_5

    iput-object v2, p0, Lcom/sec/android/app/sbrowser/homepage/HomePageSettings;->mFactoryResetUrl:Ljava/lang/String;
...
.method public isLaunchContentPageSupported(Landroid/content/Context;)Z
    ...
    invoke-virtual {p1}, Lcom/sec/android/app/sbrowser/homepage/HomePageSettings;->isNewsFeedEnabled()Z
...
.method public setFactoryResetHomeUrl(Ljava/lang/String;)V
    ...
    invoke-static {p1, p0, v2}, Landroidx/glance/oneui/template/layout/glance/a;->A(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v3, v2}, Landroidx/glance/oneui/template/layout/glance/a;->A(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)V
...
.method public setHomePageChangedToMultiCp(Z)V
    .locals 1
...
.method public setHomepageAsDefault()V
    .locals 2

    const-string v0, "HomePageSettings"

    const-string v1, "setHomepageAsDefault called"

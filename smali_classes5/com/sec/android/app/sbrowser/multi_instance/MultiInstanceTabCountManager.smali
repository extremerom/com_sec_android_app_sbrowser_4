...
.method private closeOldestTab()Z
    ...
    invoke-static {v6, v5, p0, v1, v2}, LJ7/b;->x(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private setMaxTabCount(I)V
    ...
    invoke-static {p0, p1, v0}, Landroidx/appcompat/graphics/drawable/a;->A(Ljava/lang/StringBuilder;ILjava/lang/String;)V

    return-void
.end method

.method private setReopenAction(Landroid/content/Context;Lcom/google/android/material/snackbar/Snackbar;)V
    .locals 1
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p2    # Lcom/google/android/material/snackbar/Snackbar;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    new-instance p1, Lcom/sec/android/app/sbrowser/multi_cp_native/video_tab/like/e;

    const/4 v0, 0x1

    invoke-direct {p1, p0, v0}, Lcom/sec/android/app/sbrowser/multi_cp_native/video_tab/like/e;-><init>(Ljava/lang/Object;I)V

    const p0, 0x7f1410a4

    invoke-virtual {p2, p0, p1}, Lcom/google/android/material/snackbar/Snackbar;->setAction(ILandroid/view/View$OnClickListener;)Lcom/google/android/material/snackbar/Snackbar;
...
.method private showReopenSnackBar(Landroid/content/Context;)V
    ...
    const-string v3, "seslMake failed : "

    const-string v4, "si__MultiInstanceTabCountManager"
    ...
    invoke-static {v2, v0, v1, v1, v6}, Lcom/google/android/material/snackbar/Snackbar;->seslMake(Landroid/view/View;Ljava/lang/CharSequence;IILjava/lang/Integer;)Lcom/google/android/material/snackbar/Snackbar;

    move-result-object v5

    invoke-direct {p0, p1, v5}, Lcom/sec/android/app/sbrowser/multi_instance/MultiInstanceTabCountManager;->setReopenAction(Landroid/content/Context;Lcom/google/android/material/snackbar/Snackbar;)V
    :try_end_0
    ...
    invoke-static {p1, v0, v4}, Landroidx/glance/oneui/template/layout/glance/a;->v(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {p1, v0, v1, v6, v2}, Lcom/google/android/material/snackbar/Snackbar;->seslMake(Landroid/view/View;Ljava/lang/CharSequence;IILjava/lang/Integer;)Lcom/google/android/material/snackbar/Snackbar;
    ...
    invoke-virtual {v5, p1}, Lcom/google/android/material/snackbar/BaseTransientBottomBar;->addCallback(Lcom/google/android/material/snackbar/BaseTransientBottomBar$BaseCallback;)Lcom/google/android/material/snackbar/BaseTransientBottomBar;
...
.method public getGlobalTabCount()I
    ...
    invoke-static {v2, v0, v1}, LJ7/b;->q(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

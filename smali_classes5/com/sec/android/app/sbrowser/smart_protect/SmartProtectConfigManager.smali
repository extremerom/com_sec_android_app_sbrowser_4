...
.method private getFeatureConfigs(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-static {p1, v0, p0}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->y(Lorg/json/JSONException;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private updateBlockFixedFrameEnabled()V
    ...
    const-string v2, "SmartProtectConfigManager"
    ...
    :cond_0
    invoke-static {v3}, Lcom/sec/terrace/browser/prefs/TerracePrefServiceBridge;->getAntiTrackingLevel(Z)I
    ...
    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->isBlockTrackingPopupEnable()Z
    ...
    invoke-static {v0, v3}, Lcom/sec/android/app/sbrowser/common/device/SystemProperties;->getInt(Ljava/lang/String;I)I

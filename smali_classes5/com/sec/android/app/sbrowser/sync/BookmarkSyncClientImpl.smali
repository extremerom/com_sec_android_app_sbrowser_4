...
.method private checkDuplicateSync4(Landroid/content/Context;)V
    ...
    const-string v8, "SYNC4 IS NOT NULL AND SYNC4 <> \'\' AND bookmark_type = ? AND _ID != ? AND DELETED = ?"
    ...
    invoke-direct {v1}, Lcom/google/common/collect/t;-><init>()V
    ...
    invoke-virtual {v1, v0, v6}, Lcom/google/common/collect/d;->put(Ljava/lang/Object;Ljava/lang/Object;)Z
    :try_end_2
    ...
    invoke-virtual {v1, v0}, Lcom/google/common/collect/d;->get(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-virtual {v0}, Lcom/google/common/collect/p;->iterator()Ljava/util/Iterator;

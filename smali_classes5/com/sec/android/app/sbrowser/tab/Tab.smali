...
.method public static bridge synthetic c(Lcom/sec/android/app/sbrowser/tab/Tab;)Lcom/sec/android/app/sbrowser/tab/Tab$Delegate;
    .locals 0
...
.method public static bridge synthetic d(Lcom/sec/android/app/sbrowser/tab/Tab;)Lcom/sec/android/app/sbrowser/tab/TabLayout;
    .locals 0
...
.method public static bridge synthetic e(Lcom/sec/android/app/sbrowser/tab/Tab;)Lcom/sec/terrace/Terrace;
    .locals 0
...
.method public disableBackgroundLayerOnToolbar(Lcom/sec/terrace/content/browser/TerraceBitmapLayer$BitmapLayer;)V
    ...
    invoke-virtual {p0, p1}, Lcom/sec/terrace/Terrace;->disableBackgroundLayerOnToolbar(Lcom/sec/terrace/content/browser/TerraceBitmapLayer$BitmapLayer;)V
...
.method public disableBlurEffectOnToolbar(Lcom/sec/terrace/content/browser/TerraceBitmapLayer$BitmapLayer;)V
    ...
    invoke-virtual {p0, p1}, Lcom/sec/terrace/Terrace;->disableBlurEffectOnToolbar(Lcom/sec/terrace/content/browser/TerraceBitmapLayer$BitmapLayer;)V
...
.method public enableBackgroundLayerOnToolbar(Lcom/sec/terrace/content/browser/TerraceBitmapLayer$BitmapLayer;)V
    ...
    invoke-virtual {p0, p1}, Lcom/sec/terrace/Terrace;->enableBackgroundLayerOnToolbar(Lcom/sec/terrace/content/browser/TerraceBitmapLayer$BitmapLayer;)V
...
.method public isAiSearchShowing()Z
    ...
    invoke-interface {p0}, Lcom/sec/android/app/sbrowser/tab/TabLayout;->isAiSearchViewShowing()Z
...
.method public scanImages(Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/sec/android/app/sbrowser/tab/Tab$3;

    invoke-direct {v2, p0}, Lcom/sec/android/app/sbrowser/tab/Tab$3;-><init>(Lcom/sec/android/app/sbrowser/tab/Tab;)V
...
.method public setCustomUserAgentIfNeeded(Z)V
    ...
    invoke-static {p0, v2, p1}, LJ7/b;->C(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public setTopControlsHeight(IIII)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/sec/terrace/Terrace;->setTopControlsHeight(IIII)V
...
.method public setTopControlsHeight(IIIIZ)V
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/sec/terrace/Terrace;->setTopControlsHeight(IIIIZ)V
...
.method public showRepostFormWarningDialog()V
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/tab/Tab$4;

    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/tab/Tab$4;-><init>(Lcom/sec/android/app/sbrowser/tab/Tab;)V
    ...
    invoke-virtual {v0, p0, v1}, Lcom/sec/android/app/sbrowser/tab/RepostFormWarningDialog;->show(Landroidx/fragment/app/FragmentManager;Ljava/lang/String;)V
...
.method public startFinding(Ljava/lang/String;Z)V
    ...
    :cond_0
    const-string v0, "EnableFindTextOnImage"
    ...
    new-instance v0, Lcom/sec/terrace/TerraceFindTextOnImageHandler;

    invoke-direct {v0}, Lcom/sec/terrace/TerraceFindTextOnImageHandler;-><init>()V

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/tab/Tab;->mTerrace:Lcom/sec/terrace/Terrace;

    invoke-virtual {v1}, Lcom/sec/terrace/Terrace;->getWebContents()Lcom/sec/terrace/content/browser/TinWebContentsImpl;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/sec/terrace/TerraceFindTextOnImageHandler;->setWebContents(Lorg/chromium/content_public/browser/WebContents;)V

    new-instance v1, Lcom/sec/android/app/sbrowser/tab/Tab$1;

    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/tab/Tab$1;-><init>(Lcom/sec/android/app/sbrowser/tab/Tab;)V

    invoke-virtual {v0, v1}, Lcom/sec/terrace/TerraceFindTextOnImageHandler;->getImageBitmapsForProcessing(Lcom/sec/terrace/TerraceFindTextOnImageCallback;)V
...
.method public stopFinding(Z)V
    ...
    invoke-interface {v0}, Lcom/sec/android/app/sbrowser/tab/Tab$Delegate;->getBitmapTextExtractor()Lcom/sec/android/app/sbrowser/image_text_extraction/BitmapTextExtractor;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/image_text_extraction/BitmapTextExtractor;->cancelTranslationAndPerformCleanup()V
...
.method public updateBitmapToolbarLayerVisibility(Lcom/sec/terrace/content/browser/TerraceBitmapLayer$BitmapLayer;Z)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/sec/terrace/Terrace;->updateBitmapToolbarLayerVisibility(Lcom/sec/terrace/content/browser/TerraceBitmapLayer$BitmapLayer;Z)V

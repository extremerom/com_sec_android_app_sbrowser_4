...
.method private createStatusBarBitmap(I)Landroid/graphics/Bitmap;
    .locals 2
...
.method public checkUiModeNightValidation(Landroid/content/res/Configuration;Z)V
    ...
    invoke-static {v1, v3, p2}, Landroidx/appcompat/graphics/drawable/a;->z(Ljava/lang/String;Ljava/lang/StringBuilder;Z)V
...
.method public getFullscreenBitmap(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    invoke-static {p2, p3, v0, v1, v2}, LJ7/b;->x(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lcom/sec/android/app/sbrowser/main_view/MainViewUtil;->mActivity:Landroid/app/Activity;
    ...
    iget-object p2, p0, Lcom/sec/android/app/sbrowser/main_view/MainViewUtil;->mActivity:Landroid/app/Activity;

    invoke-static {p2}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->isLandscape(Landroid/content/Context;)Z
    ...
    invoke-virtual {p3, v4}, Lcom/sec/android/app/sbrowser/hide_status_bar/HideStatusBarController;->isStatusBarHidden(Landroid/app/Activity;)Z
    ...
    invoke-direct {p0, p3}, Lcom/sec/android/app/sbrowser/main_view/MainViewUtil;->createStatusBarBitmap(I)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v3, p1, v5, p0, v0}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    ...
    invoke-virtual {v3, p2, v5, v5, v0}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    ...
    invoke-virtual {v3, p2, v5, p3, v0}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    ...
    invoke-virtual {v3, p2, v5, p0, v0}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    ...
    invoke-virtual {v3, p1, v5, p2, v0}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
...
.method public setImmersiveMode()V
    ...
    invoke-static {v2, v3, v1}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->B(Lcom/sec/sbrowser/spl/util/FallbackException;Ljava/lang/StringBuilder;Ljava/lang/String;)V

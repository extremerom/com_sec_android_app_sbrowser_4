...
# instance fields
.field protected mBottomBarDisabled:Z
...
.method private resetMinorModeControlIfRequired()V
    .locals 0

    invoke-static {}, Lcom/sec/android/app/sbrowser/common/parental_control/ParentalControlUtil;->resetMinorModeSettingsIfRequired()Z
...
.method private setParentTab(Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTab;)V
    .locals 10
    ...
    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/common/device/DeviceFeatureUtils;->isSupportBackToHomePage()Z
    ...
    const-string p1, "setParentTab: false"
    ...
    invoke-virtual {p0, v3}, Lcom/sec/android/app/sbrowser/main_view/MainViewImpl;->getHomePageUrl(Z)Ljava/lang/String;
    ...
    invoke-interface/range {v4 .. v9}, Lcom/sec/android/app/sbrowser/common/model/sbrowser_tab/SBrowserTabDelegate;->loadUrl(Ljava/lang/String;ILjava/lang/String;ZI)V

    invoke-interface {v0}, Lcom/sec/android/app/sbrowser/common/model/sbrowser_tab/SBrowserTabDelegate;->getTabId()I

    move-result p0

    invoke-interface {p1, p0}, Lcom/sec/android/app/sbrowser/common/model/sbrowser_tab/SBrowserTabDelegate;->setParentTabId(I)V
...
.method public applySecretModeStatus(ZLandroid/os/Bundle;)V
    ...
    invoke-virtual {p2}, Lcom/sec/android/app/sbrowser/main_view/MainViewMultiTab;->updateInsetsRootView()V
    ...
    invoke-virtual {p1}, Lcom/sec/android/app/sbrowser/main_view/MainViewArtificialIntelligence;->getAISearchController()Lcom/sec/android/app/sbrowser/artificial_intelligence/common/model/ISummarizeController;
...
.method public abstract synthetic getLocationBarEventListener()Lcom/sec/android/app/sbrowser/common/toolbar/LocationBarEventListener;
.end method
...
.method public isAiSearchShowing()Z
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/main_view/MainViewArtificialIntelligence;->isAiSearchShowing()Z
...
.method public isAskToolbarShowing()Z
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/main_view/MainViewArtificialIntelligence;->isAskToolbarShowing()Z
...
.method public isFullScreenForDisplayCutoutMode()Z
    ...
    invoke-static {v3, v4, v0}, Lf/a;->q(Ljava/lang/String;Ljava/lang/String;Z)V
...
.method public launchNewTab(ZLjava/lang/String;)V
    ...
    iget-boolean p0, p0, Lcom/sec/android/app/sbrowser/main_view/MainViewImpl;->mBottomBarDisabled:Z
...
.method public loadUrlWithExistingTab(Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTab;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)V
    ...
    instance-of p3, p3, Lcom/sec/android/app/sbrowser/multi_cp_native/video_tab/VideoTabFragment;

    if-eqz p3, :cond_1

    const-string p3, "si__MainViewImpl"

    const-string v0, "loadUrlWithExistingTab VideoTabFragment dismiss"

    invoke-static {p3, v0}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    const-class p3, Lcom/sec/android/app/sbrowser/multi_cp_native/video_tab/VideoTabFragment;

    const/4 v0, 0x1

    invoke-static {p1, p3, v0}, Lcom/sec/android/app/sbrowser/common/utils/FragmentUtils;->dismiss(Landroidx/fragment/app/FragmentActivity;Ljava/lang/Class;Z)Z
    ...
    invoke-static {p1}, Lcom/sec/android/app/sbrowser/qrcode/QRCodeHelper;->isQRAction(Ljava/lang/String;)Z
    ...
    invoke-static {p4}, Lcom/sec/android/app/sbrowser/qrcode/QRCodeHelper;->extractUrl(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v1, p2}, Lcom/sec/android/app/sbrowser/common/model/sbrowser_tab/SBrowserTabDelegate;->updateIntent(Landroid/content/Intent;)V
    ...
    invoke-interface/range {v1 .. v7}, Lcom/sec/android/app/sbrowser/common/model/sbrowser_tab/SBrowserTabDelegate;->loadUrl(Landroid/content/Intent;Ljava/lang/String;ILjava/lang/String;ZI)V
...
.method public loadUrlWithNewTabFromExternalApp(Ljava/lang/String;Landroid/content/Intent;ZZ)V
    ...
    :cond_1
    const-string v0, "loadUrlWithNewTab : disable secret mode"
    ...
    const-string p1, "com.sec.android.app.sbrowser.unknown_app"
    ...
    instance-of v4, v2, Lcom/sec/android/app/sbrowser/multi_cp_native/newsfeed/news_details/TTNewDetailsFragment;

    if-eqz v4, :cond_4

    check-cast v2, Lcom/sec/android/app/sbrowser/multi_cp_native/newsfeed/news_details/TTNewDetailsFragment;

    invoke-virtual {v2}, Lcom/sec/android/app/sbrowser/multi_cp_native/newsfeed/news_details/TTNewDetailsFragment;->handleFinishAndClose()V
    ...
    instance-of v1, v1, Lcom/sec/android/app/sbrowser/multi_cp_native/video_tab/VideoTabFragment;

    if-eqz v1, :cond_5

    const-class v1, Lcom/sec/android/app/sbrowser/multi_cp_native/video_tab/VideoTabFragment;
    ...
    invoke-direct {p0, p3}, Lcom/sec/android/app/sbrowser/main_view/MainViewImpl;->setParentTab(Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTab;)V
...
.method public onNativeInitializationSuccess(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/main_view/MainActivityLoggingHelper;->loggingForCloud()V
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/link_to_window/LinkToWindowManager;->registerReceiver()V
...
.method public onResume()V
    ...
    :cond_8
    iget-object v3, p0, Lcom/sec/android/app/sbrowser/main_view/MainViewLayout;->mMainViewToolbar:Lcom/sec/android/app/sbrowser/main_view/MainViewToolbar;

    invoke-virtual {v3}, Lcom/sec/android/app/sbrowser/main_view/MainViewToolbar;->onResume()V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/main_view/MainViewImpl;->resetMinorModeControlIfRequired()V
...
.method public showAskPopup()V
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/main_view/MainViewArtificialIntelligence;->showAskPopup()V

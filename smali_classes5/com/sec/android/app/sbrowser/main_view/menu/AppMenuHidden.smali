...
.field protected mCloseTabDialog:Landroidx/appcompat/app/AlertDialog;
...
.method public static synthetic b(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Ljava/lang/String;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$onReadHighlightsAloudClicked$9(Ljava/lang/String;Z)V

    return-void
.end method

.method public static synthetic c(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Ljava/lang/String;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$onSummaryClicked$3(Ljava/lang/String;Z)V
...
.method private clearAllPermissionSettings()V
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden$1;

    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden$1;-><init>(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;)V
...
.method private createAiOptionPopupController(Landroid/view/View;Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/AiOptionMenuCallback;)V
    ...
    invoke-interface {p1}, Lcom/sec/android/app/sbrowser/main_view/main_interface/MainViewInterface;->showAskPopup()V
...
.method public static synthetic d(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$onReadHighlightsAloudClicked$11(Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic e(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$runReadAloudInAwesomeIntelligence$7(Z)V

    return-void
.end method

.method public static synthetic f(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Ljava/lang/String;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$onReadHighlightsAloudClicked$12(Ljava/lang/String;Z)V

    return-void
.end method

.method public static synthetic g(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Ljava/lang/String;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$onSummaryClicked$6(Ljava/lang/String;Z)V
...
.method public static synthetic i(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Landroid/view/View;Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/AiOptionMenuCallback;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$onBrowsingAssistClicked$14(Landroid/view/View;Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/AiOptionMenuCallback;)V
...
.method public static synthetic j(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$onCloseInternetClicked$1()V

    return-void
.end method

.method public static synthetic k(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$onCloseInternetClicked$0(Z)V

    return-void
.end method

.method public static synthetic l(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Landroid/view/View;Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/AiOptionMenuCallback;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$onBrowsingAssistClicked$15(Landroid/view/View;Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/AiOptionMenuCallback;Z)V

    return-void
.end method

.method private static synthetic lambda$createAiOptionPopupController$16()Z
    .locals 1
...
.method private synthetic lambda$onBrowsingAssistClicked$13(Landroid/view/View;Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/AiOptionMenuCallback;Z)V
    .locals 0
...
.method private synthetic lambda$onBrowsingAssistClicked$14(Landroid/view/View;Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/AiOptionMenuCallback;)V
    .locals 4
    ...
    invoke-direct {v2, p0, p1, p2, v3}, Lcom/sec/android/app/sbrowser/main_view/menu/f;-><init>(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Landroid/view/View;Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/AiOptionMenuCallback;I)V
...
.method private synthetic lambda$onBrowsingAssistClicked$15(Landroid/view/View;Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/AiOptionMenuCallback;Z)V
    .locals 3
...
.method private static synthetic lambda$onCloseCurrentTab$2(Lcom/sec/android/app/sbrowser/tab_manager/TabManager;Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTab;Landroid/content/DialogInterface;I)V
    .locals 0
...
.method private synthetic lambda$onCloseInternetClicked$0(Z)V
    .locals 2
    ...
    invoke-virtual {p1, v1}, Lcom/sec/android/app/sbrowser/media/history/model/MHDatabaseController;->deleteAllMediaHistoryData(Landroid/content/Context;)Z
    ...
    invoke-virtual {p1}, Lcom/sec/android/app/sbrowser/intent_blocker/IntentBlockerHandler;->clearHistory()V
    ...
    invoke-virtual {p1}, Lcom/sec/android/app/sbrowser/protected_browsing/UnwantedNavigationHelper;->clearUnwantedNavigationData()V
...
.method private lambda$onCloseInternetClicked$1()V
    .locals 1
    ...
    iget-object p0, p0, Lcom/bumptech/glide/b;->a:LH/u;

    iget-object p0, p0, LH/u;->f:LH/t;

    invoke-virtual {p0}, LH/t;->a()LK/a;

    move-result-object p0

    invoke-interface {p0}, LK/a;->clear()V
...
.method private synthetic lambda$onReadHighlightsAloudClicked$10(Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/sec/android/app/sbrowser/main_view/menu/e;

    const/4 v3, 0x0

    invoke-direct {v2, p0, p1, v3}, Lcom/sec/android/app/sbrowser/main_view/menu/e;-><init>(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Ljava/lang/String;I)V
...
.method private synthetic lambda$onReadHighlightsAloudClicked$11(Ljava/lang/String;)V
    .locals 0
...
.method private synthetic lambda$onReadHighlightsAloudClicked$12(Ljava/lang/String;Z)V
    .locals 2
    ...
    invoke-direct {v0, p0, p1, v1}, Lcom/sec/android/app/sbrowser/main_view/menu/d;-><init>(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Ljava/lang/String;I)V
...
.method private synthetic lambda$onReadHighlightsAloudClicked$9(Ljava/lang/String;Z)V
    .locals 0
...
.method private synthetic lambda$onSummaryClicked$3(Ljava/lang/String;Z)V
    .locals 0
...
.method private synthetic lambda$onSummaryClicked$5(Ljava/lang/String;)V
    .locals 0
...
.method private synthetic lambda$onSummaryClicked$6(Ljava/lang/String;Z)V
    .locals 2
...
.method private synthetic lambda$runReadAloud$8()V
    .locals 1
...
.method private synthetic lambda$runReadAloudInAwesomeIntelligence$7(Z)V
    .locals 0
...
.method public static synthetic m(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;)V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$runReadAloud$8()V
...
.method public static synthetic n()Z
    ...
    invoke-static {}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$createAiOptionPopupController$16()Z
...
.method public static synthetic o(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Ljava/lang/String;)V
    .locals 0
...
.method public static synthetic p(Lcom/sec/android/app/sbrowser/tab_manager/TabManager;Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTab;Landroid/content/DialogInterface;I)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$onCloseCurrentTab$2(Lcom/sec/android/app/sbrowser/tab_manager/TabManager;Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTab;Landroid/content/DialogInterface;I)V

    return-void
.end method

.method public static synthetic q(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Landroid/view/View;Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/AiOptionMenuCallback;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$onBrowsingAssistClicked$13(Landroid/view/View;Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/AiOptionMenuCallback;Z)V

    return-void
.end method

.method public static synthetic r(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->lambda$onSummaryClicked$5(Ljava/lang/String;)V
...
.method private runReadAloud()V
    ...
    invoke-direct {v1, p0, v2}, Lcom/sec/android/app/sbrowser/main_view/menu/h;-><init>(Ljava/lang/Object;I)V
...
.method public dismissCloseTabDialog()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->mCloseTabDialog:Landroidx/appcompat/app/AlertDialog;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->mCloseTabDialog:Landroidx/appcompat/app/AlertDialog;
...
.method public onBrowsingAssistClicked(Landroid/view/View;Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/AiOptionMenuCallback;)V
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/main_view/menu/f;

    const/4 v2, 0x1

    invoke-direct {v1, p0, p1, p2, v2}, Lcom/sec/android/app/sbrowser/main_view/menu/f;-><init>(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Landroid/view/View;Lcom/sec/android/app/sbrowser/artificial_intelligence/menu/AiOptionMenuCallback;I)V

    const/4 p0, 0x1

    invoke-static {v0, p0, v1}, Lcom/sec/android/app/sbrowser/artificial_intelligence/utils/WebAssistUtil;->promptUserConsentAndSamsungAccountLogin(Landroid/app/Activity;ZLcom/sec/android/app/sbrowser/artificial_intelligence/utils/WebAssistUtil$PromptScreenCallback;)Z

    const-string p0, "Main::Toolbar::AI"
...
.method public onCloseCurrentTab()V
    ...
    invoke-direct {v4, v5, v1, v0}, Landroidx/media3/ui/l;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;->mCloseTabDialog:Landroidx/appcompat/app/AlertDialog;
...
.method public onCloseInternetClicked()V
    ...
    :cond_1
    new-instance v2, Lcom/sec/android/app/sbrowser/artificial_intelligence/read_aloud/H;

    const/4 v4, 0x3

    invoke-direct {v2, v4, p0, v3}, Lcom/sec/android/app/sbrowser/artificial_intelligence/read_aloud/H;-><init>(ILjava/lang/Object;Z)V
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/main_view/menu/h;

    const/4 v2, 0x0

    invoke-direct {v0, p0, v2}, Lcom/sec/android/app/sbrowser/main_view/menu/h;-><init>(Ljava/lang/Object;I)V
...
.method public onExtensionsItemClicked(ILandroid/view/View;)V
    ...
    new-instance v2, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden$2;

    invoke-direct {v2, p0}, Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden$2;-><init>(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;)V
...
.method public onReadHighlightsAloudClicked()V
    ...
    invoke-direct {v2, p0, v0, v3}, Lcom/sec/android/app/sbrowser/main_view/menu/e;-><init>(Lcom/sec/android/app/sbrowser/main_view/menu/AppMenuHidden;Ljava/lang/String;I)V
...
.method public onScanQrCode()V
    ...
    invoke-virtual {v0, p0}, Lcom/sec/android/app/sbrowser/qrcode/QRCodeHelper;->triggerQRCodeScan(Landroid/app/Activity;)V

...
# direct methods
.method public constructor <init>(Landroid/app/Activity;Lcom/sec/android/app/sbrowser/main_view/menu/MenuInterface;Lcom/sec/android/app/sbrowser/main_view/main_interface/MainViewInterface;Lcom/sec/android/app/sbrowser/common/model/tab/TabDelegate;)V
    .locals 0
    ...
    iput-object p4, p0, Lcom/sec/android/app/sbrowser/main_view/menu/ToolsMenu;->mTabDelegate:Lcom/sec/android/app/sbrowser/common/model/tab/TabDelegate;
...
.method private reloadMoreMenu()V
    ...
    invoke-interface {v0}, Lcom/sec/android/app/sbrowser/common/model/main/MoreMenuEventListener;->dismissPopup()V
...
.method public dismissToolsDialog()V
    ...
    :cond_0
    invoke-interface {p0}, Lcom/sec/android/app/sbrowser/common/model/main/MoreMenuEventListener;->dismissPopup()V
...
.method public onMenuKeyClicked()V
    ...
    invoke-interface {v0}, Lcom/sec/android/app/sbrowser/main_view/main_interface/MainViewInterface;->shouldShowMenu()Z
    ...
    iget-object v2, p0, Lcom/sec/android/app/sbrowser/main_view/menu/ToolsMenu;->mActivity:Landroid/app/Activity;

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/main_view/menu/ToolsMenu;->mMainViewInterface:Lcom/sec/android/app/sbrowser/main_view/main_interface/MainViewInterface;
    ...
    invoke-interface {v1}, Lcom/sec/android/app/sbrowser/main_view/main_interface/MainViewInterface;->getLocationBarEventListener()Lcom/sec/android/app/sbrowser/common/toolbar/LocationBarEventListener;

    move-result-object v5

    iget-object v6, p0, Lcom/sec/android/app/sbrowser/main_view/menu/ToolsMenu;->mTabDelegate:Lcom/sec/android/app/sbrowser/common/model/tab/TabDelegate;

    move-object v1, v0

    move-object v3, p0

    invoke-direct/range {v1 .. v6}, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuHandler;-><init>(Landroid/content/Context;Lcom/sec/android/app/sbrowser/toolbar/MoreMenuInterface;Lcom/sec/android/app/sbrowser/omnibox/LocationBarInterface;Lcom/sec/android/app/sbrowser/common/toolbar/LocationBarEventListener;Lcom/sec/android/app/sbrowser/common/model/tab/TabDelegate;)V
...
.method public onRealoadButtonClicked(Landroid/view/View;)V
    .locals 0

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/main_view/menu/ToolsMenu;->mMenuInterface:Lcom/sec/android/app/sbrowser/main_view/menu/MenuInterface;

    invoke-interface {p0, p1}, Lcom/sec/android/app/sbrowser/main_view/menu/MenuInterface;->performReload(Landroid/view/View;)V

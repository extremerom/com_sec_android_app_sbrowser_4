...
.method private launchMultiTabFinally(Z)V
    .locals 3
    ...
    :goto_0
    invoke-interface {v0, v1, p1}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTab;->launchMultiTab(Lcom/sec/android/app/sbrowser/multi_tab/MultiTabLaunchCallback;Z)V
...
.method private loadThumbnailsToMemCache()V
    ...
    invoke-static {v0, v3, v6}, Lcom/sec/android/app/sbrowser/common/multi_tab/MultiTabUtil;->findStartAndEndIndexes(IIZ)Landroidx/core/util/Pair;
    ...
    invoke-direct {p0, v3}, Lcom/sec/android/app/sbrowser/main_view/MainViewMultiTab;->isValidTab(Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTab;)Z
    ...
    invoke-interface {v6, v3, v7, v8}, Lcom/sec/android/app/sbrowser/main_view/main_interface/BitmapHandler;->getThumbnailBitmapFromDiskCache(Lcom/sec/android/app/sbrowser/common/model/sbrowser_tab/SBrowserTabDelegate;ZLcom/sec/android/app/sbrowser/common/model/general/GeneralCallback;)V

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/main_view/MainViewMultiTab;->getBitmapHandler()Lcom/sec/android/app/sbrowser/main_view/main_interface/BitmapHandler;

    move-result-object v6

    invoke-interface {v6, v3, v4, v8}, Lcom/sec/android/app/sbrowser/main_view/main_interface/BitmapHandler;->getThumbnailBitmapFromDiskCache(Lcom/sec/android/app/sbrowser/common/model/sbrowser_tab/SBrowserTabDelegate;ZLcom/sec/android/app/sbrowser/common/model/general/GeneralCallback;)V
...
.method private onMultiTabAttached()V
    ...
    sget-object v0, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil$NavigationBarState;->NAVIGATION_BLACK:Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil$NavigationBarState;
...
.method private onMultiTabDetached()V
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/toolbar/Bottombar;->focusOnTabs()V
...
.method private prepareAnimationLayoutIfNeeded()V
    ...
    invoke-static {v2, v3}, LT3/a;->d(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    iget-object v4, p0, Lcom/sec/android/app/sbrowser/main_view/MainViewMultiTab;->mActivity:Landroid/app/Activity;

    invoke-virtual {v3, v4}, Lcom/sec/android/app/sbrowser/hide_status_bar/HideStatusBarController;->isEnabled(Landroid/app/Activity;)Z

    move-result v3

    if-nez v3, :cond_2

    iget-object v3, p0, Lcom/sec/android/app/sbrowser/main_view/MainViewMultiTab;->mContext:Landroid/content/Context;
...
.method public launchMultiTabStackInternal(Lcom/sec/android/app/sbrowser/multi_tab/MultiTabLaunchCallback;Z)Z
    .locals 5
    ...
    new-instance p1, Lcom/sec/android/app/sbrowser/main_view/M;

    const/4 v0, 0x0

    invoke-direct {p1, p0, v0}, Lcom/sec/android/app/sbrowser/main_view/M;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {p0, p2}, Lcom/sec/android/app/sbrowser/main_view/MainViewMultiTab;->launchMultiTabFinally(Z)V
...
.method public updateInsetsRootView()V
    ...
    :cond_0
    invoke-interface {p0}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTab;->updateInsetsRootView()V

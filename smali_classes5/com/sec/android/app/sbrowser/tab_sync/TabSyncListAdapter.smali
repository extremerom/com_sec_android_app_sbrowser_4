...
.method private collapseGroup(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$HeaderViewHolder;)V
    ...
    :goto_0
    iget-boolean p0, p0, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->mIsMakeOverNewUIEnabled:Z
...
.method public static synthetic d(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;ILandroid/view/View;)Z
    .locals 0
...
.method public static synthetic e(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;Landroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->lambda$onBindNormalViewHolder$7(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;Landroid/view/View;)V
...
.method public static synthetic g(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$ChildViewHolder;Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;Landroid/os/Message;)Z
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->lambda$handleIconRequestForNewUI$6(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$ChildViewHolder;Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;Landroid/os/Message;)Z
...
.method private getHideSelectModeAnimListener(Landroid/view/View;)Landroid/animation/AnimatorListenerAdapter;
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$2;

    invoke-direct {v0, p0, p1}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$2;-><init>(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;Landroid/view/View;)V
...
.method private getShowSelectModeListener(Landroid/view/View;Landroid/widget/LinearLayout$LayoutParams;)Landroid/animation/AnimatorListenerAdapter;
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$4;

    invoke-direct {v0, p0, p1, p2}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$4;-><init>(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;Landroid/view/View;Landroid/widget/LinearLayout$LayoutParams;)V

    return-object v0
.end method

.method public static synthetic h(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$HeaderViewHolder;Landroid/widget/CompoundButton;Z)V
    .locals 0
...
.method private handleIconRequestForNewUI(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$ChildViewHolder;Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;)V
    ...
    iget-object p0, p1, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$ChildViewHolder;->mFavIcon:Landroid/widget/ImageView;
    ...
    iget-object p0, p1, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$ChildViewHolder;->mDominantText:Landroid/widget/TextView;

    invoke-virtual {p2}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;->getDominantText()Ljava/lang/String;
    ...
    invoke-direct {v0, p1, p2}, Lcom/sec/android/app/sbrowser/tab_sync/g;-><init>(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$ChildViewHolder;Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;)V
...
.method public static bridge synthetic i(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;)Landroid/content/Context;
    .locals 0
...
.method public static bridge synthetic j(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;)Landroidx/recyclerview/widget/RecyclerView;
    .locals 0
...
.method public static bridge synthetic k(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;)Lcom/sec/android/app/sbrowser/tab_sync/TabSyncActivityUI;
    .locals 0
...
.method public static bridge synthetic l(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;Z)V
    .locals 0
...
.method private static synthetic lambda$handleIconRequestForNewUI$6(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$ChildViewHolder;Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;Landroid/os/Message;)Z
    .locals 2

    iget-object p2, p0, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$ChildViewHolder;->mViewHolderData:Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$ChildViewHolder;->mViewHolderData:Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;

    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;->getUrl()Ljava/lang/String;
    ...
    invoke-virtual {p2, p1, v1, v0}, Lcom/sec/android/app/sbrowser/common/utils/IconFetcher;->getIcon(Ljava/lang/String;II)Landroid/graphics/Bitmap;

    move-result-object p1

    if-eqz p1, :cond_0

    iget-object p2, p0, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$ChildViewHolder;->mFavIcon:Landroid/widget/ImageView;

    invoke-virtual {p2, p1}, Landroid/widget/ImageView;->setImageBitmap(Landroid/graphics/Bitmap;)V

    iget-object p1, p0, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$ChildViewHolder;->mFavIcon:Landroid/widget/ImageView;

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$ChildViewHolder;->mDominantText:Landroid/widget/TextView;
...
.method private synthetic lambda$onBindNormalViewHolder$7(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;Landroid/view/View;)V
    .locals 0
...
.method public static bridge synthetic n(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;)Z
    .locals 0
...
.method private onBindCategoryViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;ILcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;)V
    .locals 16
    ...
    iput-object v9, v8, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$HeaderViewHolder;->mViewHolderData:Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;

    iget-object v0, v8, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$HeaderViewHolder;->mTitle:Landroid/widget/TextView;

    invoke-virtual/range {p3 .. p3}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;->getTitle()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    invoke-virtual/range {p3 .. p3}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;->getGroupIndex()I

    move-result v1

    iget-object v2, v6, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->mTabSyncList:Ljava/util/List;
    ...
    :cond_0
    iget-object v1, v6, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->mTabSyncList:Ljava/util/List;
    ...
    :cond_1
    iget-object v2, v8, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$HeaderViewHolder;->mCheckBox:Lcom/sec/android/app/sbrowser/common/widget/ListItemCheckBox;
    ...
    iget-object v1, v6, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->mUi:Lcom/sec/android/app/sbrowser/tab_sync/TabSyncActivityUI;
    ...
    iget-object v1, v8, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$HeaderViewHolder;->mGroupIndicator:Landroid/widget/ImageView;

    invoke-virtual {v1, v10}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object v1, v8, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$HeaderViewHolder;->mGroupDivider:Landroid/widget/ImageView;
    ...
    invoke-direct {v6, v1, v3}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->setBackgroundByCheck(Landroid/view/View;Z)V
    ...
    invoke-virtual/range {p3 .. p3}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;->getInvisibleChildren()Ljava/util/List;
    ...
    invoke-virtual {v6, v1, v11, v12}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->setHeaderIndicatorAnimation(Landroid/view/View;ZZ)V
    ...
    invoke-virtual {v6, v1, v12, v12}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->setHeaderIndicatorAnimation(Landroid/view/View;ZZ)V
    ...
    iget-object v3, v6, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->mContext:Landroid/content/Context;
    ...
    invoke-direct {v0, v6, v8}, Lcom/sec/android/app/sbrowser/tab_sync/d;-><init>(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$HeaderViewHolder;)V
    ...
    new-instance v14, Lcom/sec/android/app/sbrowser/tab_sync/e;
    ...
    check-cast v13, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$HeaderViewHolder;

    iget-object v14, v13, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$HeaderViewHolder;->mGroupIndicator:Landroid/widget/ImageView;

    new-instance v15, Lcom/sec/android/app/sbrowser/tab_sync/e;
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/multi_cp_native/shortcut/ui/icon_view/a;

    const/4 v2, 0x2

    move/from16 v3, p2

    invoke-direct {v1, v6, v3, v2}, Lcom/sec/android/app/sbrowser/multi_cp_native/shortcut/ui/icon_view/a;-><init>(Ljava/lang/Object;II)V

    invoke-virtual {v0, v1}, Landroid/view/View;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V

    iget-object v0, v13, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$HeaderViewHolder;->mGroupIndicator:Landroid/widget/ImageView;
    ...
    invoke-direct {v6, v0, v1}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->setGroupIndicatorContentDescription(Landroid/view/View;Z)V

    iget-object v0, v6, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->mTabSyncList:Ljava/util/List;
    ...
    :goto_2
    iget-boolean v0, v6, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->mIsMakeOverNewUIEnabled:Z

    if-eqz v0, :cond_5

    if-eqz v11, :cond_5

    iget-object v0, v8, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$HeaderViewHolder;->mGroupDivider:Landroid/widget/ImageView;
...
.method private onBindNormalViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;)V
    .locals 6
    ...
    :goto_3
    iget-boolean v4, p0, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->mIsMakeOverNewUIEnabled:Z

    if-eqz v4, :cond_6

    iget-object v4, p0, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->mContext:Landroid/content/Context;
    ...
    invoke-static {p2, v1, p0}, Landroid/util/TypedValue;->applyDimension(IFLandroid/util/DisplayMetrics;)F
    ...
    invoke-virtual {p1, v3, v0, v3, p0}, Landroid/view/View;->setPadding(IIII)V
...
.method private runShowSelectModeAnim()Z
    ...
    invoke-static {v1, v2, v9}, Lf/a;->q(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-interface {v1, v2}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncActivityUI;->showActionBarCheckBox(Z)V
...
.method private sortTabByGroup(Ljava/util/List;)Ljava/util/List;
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/tab_sync/h;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/sec/android/app/sbrowser/tab_sync/h;-><init>(I)V
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/tab_sync/i;
...
.method public onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    :cond_0
    invoke-direct {p0, p1, v0}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->onBindNormalViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Lcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;)V

    goto :goto_0

    :cond_1
    invoke-direct {p0, p1, p2, v0}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;->onBindCategoryViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;ILcom/sec/android/app/sbrowser/tab_sync/TabSyncViewData;)V
...
.method public setShowSelectModeAnimation()V
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$3;

    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter$3;-><init>(Lcom/sec/android/app/sbrowser/tab_sync/TabSyncListAdapter;)V

...
.field private mDirectSearchAdapter:Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/DirectSearchListAdapter;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v7, Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/DirectSearchListAdapter;

    invoke-direct {v7, p1}, Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/DirectSearchListAdapter;-><init>(Landroid/content/Context;)V

    iput-object v7, p0, Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/SuggestionListView;->mDirectSearchAdapter:Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/DirectSearchListAdapter;

    invoke-virtual {v5, v7}, Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/MergeAdapter;->addAdapter(Landroidx/recyclerview/widget/RecyclerView$Adapter;)V

    add-int/lit8 v6, v6, 0x1

    :cond_0
    invoke-virtual {v5, v1}, Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/MergeAdapter;->addAdapter(Landroidx/recyclerview/widget/RecyclerView$Adapter;)V

    invoke-virtual {v5, v2}, Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/MergeAdapter;->addAdapter(Landroidx/recyclerview/widget/RecyclerView$Adapter;)V

    invoke-virtual {v5, v4}, Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/MergeAdapter;->addAdapter(Landroidx/recyclerview/widget/RecyclerView$Adapter;)V

    invoke-virtual {v5, v3}, Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/MergeAdapter;->addAdapter(Landroidx/recyclerview/widget/RecyclerView$Adapter;)V

    invoke-virtual {v5, v6, v0}, Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/MergeAdapter;->addAdapter(ILandroidx/recyclerview/widget/RecyclerView$Adapter;)V
...
.method private notifyNewThemeChanged(I)V
    ...
    :cond_3
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/SuggestionListView;->mDirectSearchAdapter:Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/DirectSearchListAdapter;

    if-eqz v1, :cond_4

    invoke-virtual {v1, p1}, Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/DirectSearchListAdapter;->setReaderTheme(I)V
...
.method public setDirectSearchData(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/SuggestionListView;->mDirectSearchAdapter:Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/DirectSearchListAdapter;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1}, Lcom/sec/android/app/sbrowser/search_window/ui/suggestion_list/DirectSearchListAdapter;->setDirectSearchData(Ljava/util/List;)V

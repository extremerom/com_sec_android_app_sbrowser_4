...
.field private final mOkHttpClient:LAa/L;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/scloud/account/SamsungAccountServerAPI;->mOkHttpClient:LAa/L;
...
.method private getProfileAsync(Lcom/sec/android/app/sbrowser/scloud/account/SamsungAccountAPICallback;)V
    ...
    const-string v2, "https://cn-api.samsungosp.com/v2/profile/user/user/"
    ...
    invoke-virtual {v0, v2, v1}, LAa/O;->a(Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "x-osp-appId"

    const-string v2, "4oe3617251"

    invoke-virtual {v0, v1, v2}, LAa/O;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/scloud/account/SamsungAccountServerAPI;->mOkHttpClient:LAa/L;

    invoke-virtual {v1, v0}, LAa/L;->a(LAa/P;)LEa/j;

    move-result-object v0

    new-instance v1, Lcom/sec/android/app/sbrowser/scloud/account/SamsungAccountServerAPI$2;

    invoke-direct {v1, p0, p1}, Lcom/sec/android/app/sbrowser/scloud/account/SamsungAccountServerAPI$2;-><init>(Lcom/sec/android/app/sbrowser/scloud/account/SamsungAccountServerAPI;Lcom/sec/android/app/sbrowser/scloud/account/SamsungAccountAPICallback;)V

    invoke-virtual {v0, v1}, LEa/j;->d(LAa/l;)V
...
.method private setAccountInfo()V
    ...
    const-string v0, "cn-auth2.samsungosp.com.cn"
...
.method public getTokenAsync(Lcom/sec/android/app/sbrowser/scloud/account/SamsungAccountAPICallback;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v2}, LAa/v;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p2}, LAa/v;->a(Ljava/lang/String;Ljava/lang/String;)V

    const-string p2, "code_verifier"

    invoke-virtual {v0, p2, p3}, LAa/v;->a(Ljava/lang/String;Ljava/lang/String;)V

    new-instance p2, LAa/w;

    iget-object p3, v0, LAa/v;->a:Ljava/util/ArrayList;

    iget-object v0, v0, LAa/v;->b:Ljava/util/ArrayList;

    invoke-direct {p2, p3, v0}, LAa/w;-><init>(Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    new-instance p3, LAa/O;

    invoke-direct {p3}, LAa/O;-><init>()V

    const-string v0, "https://cn-auth.samsungosp.com/auth/oauth2/token"

    invoke-virtual {p3, v0}, LAa/O;->f(Ljava/lang/String;)V

    const-string v0, "POST"

    invoke-virtual {p3, v0, p2}, LAa/O;->d(Ljava/lang/String;LAa/U;)V

    invoke-virtual {p3}, LAa/O;->b()LAa/P;

    move-result-object p2

    iget-object p3, p0, Lcom/sec/android/app/sbrowser/scloud/account/SamsungAccountServerAPI;->mOkHttpClient:LAa/L;

    invoke-virtual {p3, p2}, LAa/L;->a(LAa/P;)LEa/j;

    move-result-object p2

    new-instance p3, Lcom/sec/android/app/sbrowser/scloud/account/SamsungAccountServerAPI$1;

    invoke-direct {p3, p0, p1}, Lcom/sec/android/app/sbrowser/scloud/account/SamsungAccountServerAPI$1;-><init>(Lcom/sec/android/app/sbrowser/scloud/account/SamsungAccountServerAPI;Lcom/sec/android/app/sbrowser/scloud/account/SamsungAccountAPICallback;)V

    invoke-virtual {p2, p3}, LEa/j;->d(LAa/l;)V

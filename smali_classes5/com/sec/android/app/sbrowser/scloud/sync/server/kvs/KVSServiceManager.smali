...
.method public deleteItems(Ljava/util/List;)Lcom/sec/android/app/sbrowser/scloud/sync/common/records/KVSResponse;
    ...
    const-string v1, "/kvs/?action=delete&"
    ...
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/scloud/sync/server/kvs/AbstractServiceManager;->mCloudServiceManager:Lcom/sec/android/app/sbrowser/scloud/sync/server/kvs/ICloudServiceManager;

    invoke-interface {v1}, Lcom/sec/android/app/sbrowser/scloud/sync/server/kvs/ICloudServiceManager;->getAuthManager()Lcom/sec/android/app/sbrowser/scloud/sync/common/auth/AuthData;

    move-result-object v1

    iget-object v2, p0, Lcom/sec/android/app/sbrowser/scloud/sync/server/kvs/AbstractServiceManager;->mCid:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/sec/android/app/sbrowser/scloud/sync/common/auth/AuthData;->getApiParamsWithCid(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v1}, Lcom/sec/android/app/sbrowser/scloud/sync/server/kvs/ICloudServiceManager;->getCtid()Ljava/lang/String;

    move-result-object v1

    const-string v2, "ctid"

    invoke-static {v0, v2, v1}, Lcom/sec/android/app/sbrowser/scloud/sync/common/utils/UriTool;->addUriParameter(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public getItems(Ljava/util/List;)Lcom/sec/android/app/sbrowser/scloud/sync/common/records/KVSResponse;
    ...
    invoke-static {v0, v2, v1, v3}, Lcom/sec/android/app/sbrowser/scloud/sync/common/utils/UriTool;->addUrlParameter(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/StringBuilder;
...
.method public getKeys(Ljava/lang/String;I)Lcom/sec/android/app/sbrowser/scloud/sync/common/records/KVSResponse;
    ...
    invoke-static {v0, p2, p1}, Lcom/sec/android/app/sbrowser/scloud/sync/common/utils/UriTool;->addUriParameter(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;

    move-result-object v3

    iget-object v4, p0, Lcom/sec/android/app/sbrowser/scloud/sync/server/kvs/KVSServiceManager;->mKVSResponse:Lcom/sec/android/app/sbrowser/scloud/sync/common/records/KVSResponse;
    ...
    invoke-virtual/range {v1 .. v7}, Lcom/sec/android/app/sbrowser/scloud/sync/server/kvs/AbstractServiceManager;->handleRequest(ILjava/lang/String;Lcom/sec/android/app/sbrowser/scloud/sync/common/records/AbstractJSON;Ljava/lang/String;ILcom/sec/android/app/sbrowser/scloud/sync/common/auth/AuthData;)V
...
.method public getServerTimeStamp()J
    ...
    invoke-static {v0, v1, v2, p0}, Landroidx/glance/oneui/template/layout/glance/a;->p(JLjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, p0}, Landroidx/compose/ui/input/pointer/a;->B(ILjava/lang/String;Ljava/lang/String;)V
...
.method public getUpdates(Ljava/lang/String;Ljava/lang/String;I)Lcom/sec/android/app/sbrowser/scloud/sync/common/records/KVSResponse;
    ...
    invoke-static {v0, p1, p2, v1}, Lcom/sec/android/app/sbrowser/scloud/sync/common/utils/UriTool;->addUrlParameter(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/StringBuilder;
...
.method public setItems(Ljava/util/List;)Lcom/sec/android/app/sbrowser/scloud/sync/common/records/KVSResponse;
    ...
    const-string v1, "/kvs/?action=set&"

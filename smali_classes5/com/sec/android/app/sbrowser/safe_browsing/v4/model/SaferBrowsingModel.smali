...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lw8/B;",
        "updateDescriptors",
        "(Ljava/util/Set;Ljava/util/Set;Ljava/util/HashMap;LB8/d;)Ljava/lang/Object;",
        "insertNewDescriptors",
        "deleteUnusedDescriptors",
        "(Ljava/util/Set;Ljava/util/Set;LB8/d;)Ljava/lang/Object;",
        ...
        "update",
        "(Ljava/util/Set;Ljava/util/HashMap;LB8/d;)Ljava/lang/Object;",
...
.method private final deleteUnusedDescriptors(Ljava/util/Set;Ljava/util/Set;LB8/d;)Ljava/lang/Object;
    .locals 4
    ...
    invoke-static {p1, p2}, Ly8/P;->d(Ljava/util/Set;Ljava/util/Collection;)Ljava/util/Set;
    ...
    invoke-interface {p0, p1, p3}, Lcom/sec/android/app/sbrowser/safe_browsing/v4/model/dao/SaferBrowsingDatabaseDao;->deleteThreatDescriptorEntityByIdIn(Ljava/util/List;LB8/d;)Ljava/lang/Object;
...
.method private final insertNewDescriptors(Ljava/util/Set;Ljava/util/Set;Ljava/util/HashMap;LB8/d;)Ljava/lang/Object;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    invoke-interface {p0, p2, p4}, Lcom/sec/android/app/sbrowser/safe_browsing/v4/model/dao/SaferBrowsingDatabaseDao;->insertThreatDescriptorsWithHashes(Ljava/util/Map;LB8/d;)Ljava/lang/Object;
...
.method private final updateDescriptors(Ljava/util/Set;Ljava/util/Set;Ljava/util/HashMap;LB8/d;)Ljava/lang/Object;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p2}, Ly8/z;->z(Ljava/lang/Iterable;)Ljava/util/Collection;
    ...
    invoke-interface {p0, p2, p4}, Lcom/sec/android/app/sbrowser/safe_browsing/v4/model/dao/SaferBrowsingDatabaseDao;->updateThreatDescriptorHashes(Ljava/util/Map;LB8/d;)Ljava/lang/Object;
...
# virtual methods
.method public final getThreatDescriptorWithHashes(LB8/d;)Ljava/lang/Object;
    .locals 0
    .param p1    # LB8/d;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-interface {p0, p1}, Lcom/sec/android/app/sbrowser/safe_browsing/v4/model/dao/SaferBrowsingDatabaseDao;->getThreatDescriptorsWithHashes(LB8/d;)Ljava/lang/Object;
...
.method public final getThreatDescriptors(LB8/d;)Ljava/lang/Object;
    .locals 4
    .param p1    # LB8/d;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-direct {v0, p0, p1}, Lcom/sec/android/app/sbrowser/safe_browsing/v4/model/SaferBrowsingModel$getThreatDescriptors$1;-><init>(Lcom/sec/android/app/sbrowser/safe_browsing/v4/model/SaferBrowsingModel;LB8/d;)V
    ...
    invoke-interface {p0, v0}, Lcom/sec/android/app/sbrowser/safe_browsing/v4/model/dao/SaferBrowsingDatabaseDao;->getThreatDescriptors(LB8/d;)Ljava/lang/Object;
...
.method public final update(Ljava/util/Set;Ljava/util/HashMap;LB8/d;)Ljava/lang/Object;
    .locals 7
    ...
    invoke-direct {v0, p0, p3}, Lcom/sec/android/app/sbrowser/safe_browsing/v4/model/SaferBrowsingModel$update$1;-><init>(Lcom/sec/android/app/sbrowser/safe_browsing/v4/model/SaferBrowsingModel;LB8/d;)V
    ...
    invoke-static {p3}, Ly8/t;->F0(Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-direct {p0, p1, p3, p2, v0}, Lcom/sec/android/app/sbrowser/safe_browsing/v4/model/SaferBrowsingModel;->updateDescriptors(Ljava/util/Set;Ljava/util/Set;Ljava/util/HashMap;LB8/d;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p3, v0}, Lcom/sec/android/app/sbrowser/safe_browsing/v4/model/SaferBrowsingModel;->deleteUnusedDescriptors(Ljava/util/Set;Ljava/util/Set;LB8/d;)Ljava/lang/Object;
    ...
    invoke-direct {v2, p0, p2, p1, v0}, Lcom/sec/android/app/sbrowser/safe_browsing/v4/model/SaferBrowsingModel;->insertNewDescriptors(Ljava/util/Set;Ljava/util/Set;Ljava/util/HashMap;LB8/d;)Ljava/lang/Object;

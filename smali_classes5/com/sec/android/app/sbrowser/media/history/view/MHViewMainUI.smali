...
.method private finishActionMode()V
    ...
    new-instance v2, Lcom/sec/android/app/sbrowser/media/history/view/e;

    const/4 v3, 0x2

    invoke-direct {v2, p0, v3}, Lcom/sec/android/app/sbrowser/media/history/view/e;-><init>(Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;I)V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;->mDeleteDialog:Landroidx/appcompat/app/AlertDialog;
    ...
    invoke-static {v0, p0, v1}, Lcom/sec/android/app/sbrowser/sites/SitesHelper;->updateActionMenuViewVisibility(Landroidx/appcompat/app/ActionBar;Landroid/app/Activity;Z)V
...
.method public static bridge synthetic i(Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;)Lcom/sec/android/app/sbrowser/media/history/view/MHViewAppBar;
    .locals 0
...
.method private initializeList()V
    ...
    new-instance v2, Lcom/sec/android/app/sbrowser/media/history/view/i;

    invoke-direct {v2, p0}, Lcom/sec/android/app/sbrowser/media/history/view/i;-><init>(Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;)V
...
.method public static bridge synthetic j(Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;)Lcom/sec/android/app/sbrowser/media/history/view/MHViewBottomBar;
    .locals 0
...
.method public static bridge synthetic k(Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;)Z
    .locals 0
...
.method public static bridge synthetic l(Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;)Landroidx/recyclerview/widget/RecyclerView;
    .locals 0
...
.method public static bridge synthetic m(Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;)Lcom/sec/android/app/sbrowser/media/history/view/MHViewAdapter;
    .locals 0
...
.method public static bridge synthetic n(Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;)I
    .locals 0
...
.method public static bridge synthetic p(Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;I)V
    .locals 0
...
.method public static bridge synthetic r(Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;II)Landroid/view/View;
    .locals 0
...
.method private setOnContextMenuItemClickListener(Landroid/view/MenuItem;I)V
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/media/history/view/f;

    invoke-direct {v1, p0, v0, p2}, Lcom/sec/android/app/sbrowser/media/history/view/f;-><init>(Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;Lcom/sec/android/app/sbrowser/media/history/model/MHDatabaseModel;I)V
...
.method private updateMainLayout(Z)V
    ...
    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/media/history/view/MHViewAppBar;->getAppBarLayout()Lcom/google/android/material/appbar/AppBarLayout;

    move-result-object v0

    xor-int/lit8 p1, p1, 0x1

    invoke-virtual {v0, p1}, Lcom/google/android/material/appbar/AppBarLayout;->seslSetAllowStateToHide(Z)V
...
.method public onCreate()V
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;->getItemCount()I
...
.method public onDeleteButtonClicked()V
    ...
    new-instance v3, Lcom/sec/android/app/sbrowser/media/history/view/g;

    invoke-direct {v3, p0}, Lcom/sec/android/app/sbrowser/media/history/view/g;-><init>(Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;)V
    ...
    invoke-direct {v2, v3}, Lcom/sec/android/app/sbrowser/artificial_intelligence/summarize/view/z;-><init>(I)V
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/media/history/view/h;

    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/media/history/view/h;-><init>(Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;)V
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;->mDeleteDialog:Landroidx/appcompat/app/AlertDialog;

    invoke-static {v0}, Lcom/sec/android/app/sbrowser/media/history/common/MHUtils;->setSEP10Dialog(Landroidx/appcompat/app/AlertDialog;)V
...
.method public onResume()V
    ...
    invoke-virtual {v0, v1}, Lcom/sec/android/app/sbrowser/media/history/view/MHViewAppBar;->setRecyclerViewForFloatingToolbar(Landroidx/recyclerview/widget/RecyclerView;)V

    :cond_0
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;->mBottomBarView:Lcom/sec/android/app/sbrowser/media/history/view/MHViewBottomBar;

    if-eqz v0, :cond_1

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/media/history/view/MHViewMainUI;->mMHList:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v0, v1}, Lcom/sec/android/app/sbrowser/media/history/view/MHViewBottomBar;->setRecyclerViewForFloatingBottomBar(Landroidx/recyclerview/widget/RecyclerView;)V

...
# instance fields
.field private mBgLoadingAnimation:Lcom/sec/android/app/sbrowser/trans_bar/TransBarBgLoadingAnimation;
...
.field private mTransBarBackground:Lcom/sec/android/app/sbrowser/trans_bar/TransBarBackgroundDrawable;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v1, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mIsLayoutRtl:Z
...
.method private calculatePopupWidth(ZF)I
    .locals 1
    ...
    :cond_0
    iget-object p1, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mContext:Landroid/content/Context;

    invoke-static {p1}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->isPhoneLandscapeOrTablet(Landroid/content/Context;)Z
...
.method private calculateTranslationX(IZ)I
    .locals 1
    ...
    iget-object p2, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mContext:Landroid/content/Context;
    ...
    :cond_0
    iget-boolean p0, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mIsLayoutRtl:Z
...
.method private changeBg(II)V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->updateBackgroundAnimationCornerRadius()V
...
.method private changeContainerBackground(Z)V
    ...
    iget-boolean v2, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mIsAddrBarAtBottom:Z
    ...
    iget-object v2, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mSplitSwitcher:Lcom/sec/android/app/sbrowser/trans_bar/TransBarSplitSwitcher;
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->isCompactLayoutType()Z

    move-result v2

    if-eqz v2, :cond_4

    iget-object v2, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mTransBarBackground:Lcom/sec/android/app/sbrowser/trans_bar/TransBarBackgroundDrawable;
    ...
    :goto_1
    invoke-virtual {v2, p1}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarBackgroundDrawable;->setBackgroundColor(I)V

    iget-object p1, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mTransBarBackground:Lcom/sec/android/app/sbrowser/trans_bar/TransBarBackgroundDrawable;
...
.method private configureTargetLayout(Landroid/view/ViewGroup$MarginLayoutParams;IF)V
    .locals 1
    ...
    const-string p0, "container width : MATCH_PARENT"
    ...
    const-string p0, "container width : 840"
    ...
    :cond_1
    const-string p0, "container width : 86% of width"
...
.method private configureTranslationPosition(IFZZ)V
    .locals 0
    ...
    :cond_0
    invoke-direct {p0, p4, p2}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->calculatePopupWidth(ZF)I
    ...
    invoke-direct {p0, p1, p4}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->calculateTranslationX(IZ)I
    ...
    invoke-direct {p0, p2}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->updateTargetLayout(F)V

    return-void
.end method

.method private configureViewStubLayout(ZF)V
    .locals 2

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mTransBarViewStub:Landroid/view/View;
    ...
    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->calculatePopupWidth(ZF)I
    ...
    :cond_2
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mTransBarViewStub:Landroid/view/View;
...
.method private endLoadingAnimation(Z)V
    ...
    iget-object p1, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mBgLoadingAnimation:Lcom/sec/android/app/sbrowser/trans_bar/TransBarBgLoadingAnimation;

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarBgLoadingAnimation;->cancelAnimation()V
...
.method private getAnimationShown()Z
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mBgLoadingAnimation:Lcom/sec/android/app/sbrowser/trans_bar/TransBarBgLoadingAnimation;

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarBgLoadingAnimation;->getAnimationShown()Z
...
.method private init()V
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarBackgroundDrawable;

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarBackgroundDrawable;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mTransBarBackground:Lcom/sec/android/app/sbrowser/trans_bar/TransBarBackgroundDrawable;
...
.method private isAnimating()Z
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarBgLoadingAnimation;->isAnimating()Z
...
.method private isCompactLayoutType()Z
    .locals 1
    ...
    invoke-virtual {v0, p0}, Lcom/sec/android/app/sbrowser/common/extensions/SixStatus;->isCompactLayoutType(Landroid/content/Context;)Z
...
.method private isSupportedLoading()Z
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/utils/DeviceUtil;->isAnimationEnabled(Landroid/content/Context;)Z
...
.method private onChangeWindowSize(ZI)V
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarSplitSwitcher;->onChangeWindowSize(Landroid/view/View;Landroid/view/View;ZIZZ)V
...
.method private resetContainerLayoutIfNeeded(I)V
    ...
    invoke-direct {p0, v3, p1, v0}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->configureTargetLayout(Landroid/view/ViewGroup$MarginLayoutParams;IF)V

    iget-object v4, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mTransBarTarget:Landroid/widget/LinearLayout;

    invoke-virtual {v4, v3}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-direct {p0, v1, v0}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->configureViewStubLayout(ZF)V

    invoke-direct {p0, p1, v0, v2, v1}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->configureTranslationPosition(IFZZ)V

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mTransBtnHandler:Lcom/sec/android/app/sbrowser/trans_bar/TransBarTransButtonHandler;

    if-eqz p0, :cond_2

    invoke-virtual {p0, p1, v0, v2}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarTransButtonHandler;->resetTransBtnLayoutIfNeeded(IFZ)V
...
.method private runOnTranslatePage()V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->runRevertToOriginal()V

    goto :goto_0

    :cond_2
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->runTranslatePage()V
...
.method private runRevertToOriginal()V
    .locals 1
...
.method private runTranslatePage()V
    .locals 1
...
.method private updateBackgroundAnimationCornerRadius()V
    .locals 0
...
.method private updateTargetLayout(F)V
    .locals 2

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mTransBarTarget:Landroid/widget/LinearLayout;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mTransBarTarget:Landroid/widget/LinearLayout;
...
.method public getTransBarButtons()Ljava/util/List;
    .locals 2
    ...
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mTransBarSourceButton:Landroid/widget/TextView;
    ...
    :cond_0
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mTransBarTargetButton:Landroid/widget/TextView;
    ...
    :cond_1
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mMoreBtn:Lcom/sec/android/app/sbrowser/trans_bar/TransBarMoreButton;
    ...
    :cond_3
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mTransBarHandler:Lcom/sec/android/app/sbrowser/trans_bar/TransBarHandler;
...
.method public notifyCurrentUrlChanged(Ljava/lang/String;Z)V
    ...
    invoke-static {v0, v1, p2}, Landroidx/glance/oneui/template/layout/glance/a;->y(Ljava/lang/String;Ljava/lang/String;Z)V
...
.method public onFinishInflate()V
    ...
    iput-boolean v0, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mIsLayoutRtl:Z
    ...
    iget-boolean v1, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mIsLayoutRtl:Z
    ...
    :cond_3
    new-instance v0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarBgLoadingAnimation;

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mContext:Landroid/content/Context;

    check-cast v1, Landroid/app/Activity;

    iget-boolean v2, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mIsLayoutRtl:Z

    invoke-direct {v0, v1, p0, p0, v2}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarBgLoadingAnimation;-><init>(Landroid/app/Activity;Landroid/view/View;Lcom/sec/android/app/sbrowser/trans_bar/TransBarLoadingAnimationClient;Z)V

    iput-object v0, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mBgLoadingAnimation:Lcom/sec/android/app/sbrowser/trans_bar/TransBarBgLoadingAnimation;
...
.method public onPlayAnimation()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->mBgLoadingAnimation:Lcom/sec/android/app/sbrowser/trans_bar/TransBarBgLoadingAnimation;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarBgLoadingAnimation;->onPlayAnimation()V
...
.method public onVisibilityDelayed(ZZ)V
    ...
    invoke-virtual {p1}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarHandler;->runShowCallbackDelayed()V
...
.method public setupPopupLayout(Landroid/view/View;Landroid/view/View;)V
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainerV2;->configureViewStubLayout(ZF)V
...
.method public startLoadingAnimation()V
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarBgLoadingAnimation;->startLoadingAnimation()V
...
.method public updatedData(ZLjava/util/ArrayList;Lcom/sec/android/app/sbrowser/trans_bar/TransBarInfo;)V
    ...
    invoke-virtual {v0, p0, p2, p3, p1}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerLayout;->updatedData(Landroid/content/Context;Ljava/util/ArrayList;Lcom/sec/android/app/sbrowser/trans_bar/TransBarInfo;Z)V

...
.method private addAutoDetectToSourceLangList(Landroid/content/Context;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/common/extensions/SixStatus;->isShowAutoDetectEnabled()Z
    ...
    new-instance p2, Lcom/sec/android/app/sbrowser/trans_bar/TransBarInfo;

    const-string v0, "und"

    invoke-direct {p2, p1, v0}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarInfo;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static bridge synthetic f(Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerLayout;Landroid/content/Context;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerLayout;->addAutoDetectToSourceLangList(Landroid/content/Context;Ljava/util/ArrayList;)Ljava/util/ArrayList;
...
.method public static bridge synthetic g(Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerLayout;Landroid/content/Context;Landroidx/appcompat/widget/AppCompatSpinner;ILandroid/view/ViewGroup;Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerDelegate;)Landroidx/appcompat/widget/SeslCheckedTextView;
    .locals 0
...
.method private getLangListView(Landroid/content/Context;Landroidx/appcompat/widget/AppCompatSpinner;ILandroid/view/ViewGroup;Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerDelegate;)Landroidx/appcompat/widget/SeslCheckedTextView;
    ...
    invoke-direct {p0, p1, v3}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerLayout;->addAutoDetectToSourceLangList(Landroid/content/Context;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-direct {v0, p0, p5, p1, p3}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerLayout$7;-><init>(Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerLayout;Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerDelegate;Landroid/content/Context;I)V
    ...
    check-cast p5, Lcom/sec/android/app/sbrowser/trans_bar/TransBarInfo;

    invoke-virtual {p5}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarInfo;->toString()Ljava/lang/String;
    ...
    invoke-direct {p2, p0, v0, p1, p4}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerLayout$8;-><init>(Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerLayout;ZLandroid/content/Context;Landroidx/appcompat/widget/SeslCheckedTextView;)V
...
.method public static bridge synthetic h(Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerLayout;Landroid/content/Context;Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerDelegate;)Landroid/view/View;
    .locals 0
...
.method public initializeSourceSpinner(Landroid/view/View;Landroid/view/ViewGroup;Lcom/sec/android/app/sbrowser/trans_bar/TransBarInfo;Ljava/util/ArrayList;)V
    ...
    invoke-direct {p0, v0, p4}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerLayout;->addAutoDetectToSourceLangList(Landroid/content/Context;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v1}, Landroidx/appcompat/widget/AppCompatSpinner;-><init>(Landroid/content/Context;)V
...
.method public updatedData(Landroid/content/Context;Ljava/util/ArrayList;Lcom/sec/android/app/sbrowser/trans_bar/TransBarInfo;Z)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p4, p0, Lcom/sec/android/app/sbrowser/trans_bar/TransBarSpinnerLayout;->mSourceAdapter:Landroid/widget/ArrayAdapter;
    ...
    invoke-virtual {p4, p2, v0}, Landroid/widget/ArrayAdapter;->insert(Ljava/lang/Object;I)V

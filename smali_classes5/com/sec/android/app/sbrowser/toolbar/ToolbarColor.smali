...
.method private getButtonRippleResId(Lcom/sec/android/app/sbrowser/common/toolbar/ThemeParam;)I
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->isToolbarAtBottom(Landroid/content/Context;)Z
...
.method private getNavigationBarState(Lcom/sec/android/app/sbrowser/common/toolbar/ThemeParam;)Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil$NavigationBarState;
    .locals 4
    ...
    iget-object p1, p0, Lcom/sec/android/app/sbrowser/toolbar/ToolbarColor;->mMainViewToolbar:Lcom/sec/android/app/sbrowser/toolbar/MainViewToolbarDelegate;

    invoke-interface {p1}, Lcom/sec/android/app/sbrowser/toolbar/MainViewToolbarDelegate;->getMultiTabNavigationBarState()Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil$NavigationBarState;
    ...
    sget-object v0, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil$NavigationBarState;->NAVIGATION_MALICIOUS_SITE:Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil$NavigationBarState;

    goto/16 :goto_0

    :cond_6
    iget-object p1, p0, Lcom/sec/android/app/sbrowser/toolbar/ToolbarColor;->mContext:Landroid/content/Context;
    ...
    sget-object v0, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil$NavigationBarState;->NAVIGATION_TRANSPARENT_DARK:Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil$NavigationBarState;
    ...
    invoke-interface {p1}, Lcom/sec/android/app/sbrowser/toolbar/MainViewToolbarDelegate;->isReadAloudToolbarMaximized()Z
    ...
    :cond_9
    iget p1, p0, Lcom/sec/android/app/sbrowser/toolbar/ToolbarColor;->mTaskId:I
    ...
    :cond_d
    iget-object p1, p0, Lcom/sec/android/app/sbrowser/toolbar/ToolbarColor;->mTabDelegate:Lcom/sec/android/app/sbrowser/common/model/tab/TabDelegate;

    invoke-interface {p1}, Lcom/sec/android/app/sbrowser/common/model/tab/TabDelegate;->isNewQuickAccessPage()Z
    ...
    invoke-interface {p1}, Lcom/sec/android/app/sbrowser/toolbar/MainViewToolbarDelegate;->isMultiTabClosing()Z
...
.method private updateNavigationBarColor(Lcom/sec/android/app/sbrowser/common/toolbar/ThemeParam;)V
    .locals 1
    ...
    invoke-interface {v0}, Lcom/sec/android/app/sbrowser/toolbar/MainViewToolbarDelegate;->isAiSearchViewShowing()Z
    ...
    invoke-interface {v0}, Lcom/sec/android/app/sbrowser/toolbar/MainViewToolbarDelegate;->isReadAloudToolbarMaximized()Z
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->setFadeNavigationBar(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/toolbar/ToolbarColor;->getNavigationBarState(Lcom/sec/android/app/sbrowser/common/toolbar/ThemeParam;)Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil$NavigationBarState;
...
.method public setBackground(Lcom/sec/android/app/sbrowser/common/toolbar/ThemeParam;Z)V
    ...
    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/toolbar/ToolbarColor;->updateNavigationBarColor(Lcom/sec/android/app/sbrowser/common/toolbar/ThemeParam;)V

...
.field protected mOuterLayout:Landroid/view/ViewGroup;
...
.method private getTopMarginForMultiWindowHandle()I
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/toolbar/Toolbar;->mOuterLayout:Landroid/view/ViewGroup;
...
.method private synthetic lambda$onFinishInflate$0(Landroid/view/View;IIIIIIII)V
    ...
    invoke-static {p3, p7, p1, p2, p4}, Landroidx/appsearch/platformstorage/e;->u(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method private updateTabBarLayout()V
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/toolbar/ToolbarButtonLayout;->makeThemeParam()Lcom/sec/android/app/sbrowser/common/toolbar/ThemeParam;
...
.method public captureToolbarBitmap()Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/toolbar/Toolbar;->mOuterLayout:Landroid/view/ViewGroup;
    ...
    :cond_1
    iget-object v2, p0, Lcom/sec/android/app/sbrowser/toolbar/Toolbar;->mOuterLayout:Landroid/view/ViewGroup;

    invoke-virtual {v2}, Landroid/view/View;->getMeasuredWidth()I

    move-result v3

    iget-object v4, p0, Lcom/sec/android/app/sbrowser/toolbar/Toolbar;->mOuterLayout:Landroid/view/ViewGroup;
    ...
    invoke-virtual {v2, v1, v0, v3, v4}, Landroid/view/ViewGroup;->layout(IIII)V
...
.method public getContentLayout()Landroid/view/View;
    ...
    invoke-interface {p0}, Lcom/sec/android/app/sbrowser/toolbar/MainViewToolbarDelegate;->getContentLayout()Landroid/view/View;
...
.method public getToolbarButtons()Ljava/util/List;
    ...
    invoke-virtual {v1}, Lcom/sec/android/app/sbrowser/bookmark_bar/view/BookmarkBarContainer;->getBookmarkBarButtons()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/trans_bar/TransBarContainer;->getTransBarButtons()Ljava/util/List;
...
.method public getVisibleHeight()I
    ...
    iget-object v2, p0, Lcom/sec/android/app/sbrowser/toolbar/Toolbar;->mMainViewToolbar:Lcom/sec/android/app/sbrowser/toolbar/MainViewToolbarDelegate;

    invoke-interface {v2}, Lcom/sec/android/app/sbrowser/toolbar/MainViewToolbarDelegate;->isDecorFitsSystemWindows()Z
...
.method public notifyBackgroundColorChanged()V
    ...
    invoke-direct {v1, p0, v2}, Lcom/sec/android/app/sbrowser/toolbar/n;-><init>(Ljava/lang/Object;I)V
...
.method public onFinishInflate()V
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/toolbar/Toolbar;->mOuterLayout:Landroid/view/ViewGroup;

...
.method public getNegotiateToken(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-virtual {p3, p0, p1}, Lh7/b;->c(Landroid/content/Context;Ljava/lang/String;)Lb9/B;

    move-result-object p0

    iget-object p0, p0, Lb9/B;->b:Ljava/lang/String;
    :try_end_0
    .catch Lh7/c; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {p0, p1, p3}, Lf/a;->o(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V

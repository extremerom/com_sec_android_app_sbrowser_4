...
.field private mDeepLinkIcon:Landroid/widget/ImageView;
...
.method public static synthetic d(Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;Landroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;->lambda$inflateDeepLinkButton$0(Landroid/view/View;)V

    return-void
.end method

.method public static synthetic e(Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;Ljava/lang/String;)V
    .locals 0
...
.method private getDeepLinkContainer()Landroid/widget/FrameLayout;
    .locals 1

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;->mButtonContainer:Landroid/widget/FrameLayout;

    if-nez v0, :cond_0

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;->inflateDeepLinkButton()V

    :cond_0
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;->mButtonContainer:Landroid/widget/FrameLayout;

    return-object p0
.end method

.method private getDeepLinkIconView()Landroid/widget/ImageView;
    .locals 1
    ...
    :cond_0
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;->mDeepLinkIcon:Landroid/widget/ImageView;

    return-object p0
.end method

.method private inflateDeepLinkButton()V
    .locals 3
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;->mButtonContainer:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;->mDeepLinkIcon:Landroid/widget/ImageView;
...
.method private synthetic lambda$inflateDeepLinkButton$0(Landroid/view/View;)V
    .locals 0

    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;->onDeepLinkButtonClick()V
...
.method private synthetic lambda$onDeepLinkButtonClick$1()V
    ...
    invoke-static {p0, v0, v1}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->A(Landroid/content/ActivityNotFoundException;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private setDeepLinkButtonVisibility(I)V
    ...
    :cond_1
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;->getDeepLinkContainer()Landroid/widget/FrameLayout;
...
.method private updateDeepLinkButton()V
    ...
    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/common/model/app/SBrowserDeepLinkAppInfo;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v2}, Lcom/sec/android/app/sbrowser/common/model/app/SBrowserDeepLinkAppInfo;->getSize()I
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;->getDeepLinkIconView()Landroid/widget/ImageView;
    ...
    invoke-direct {p0, v3}, Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;->updateDeepLinkButtonColor(Z)V
...
.method private updateDeepLinkButtonColor(Z)V
    ...
    iget-object p1, p0, Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;->mDeepLinkIcon:Landroid/widget/ImageView;
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;->mDeepLinkIcon:Landroid/widget/ImageView;
    ...
    :goto_0
    iget-object p1, p0, Lcom/sec/android/app/sbrowser/omnibox/DeepLinkButton;->mButtonContainer:Landroid/widget/FrameLayout;
...
# virtual methods
.method public onDeepLinkButtonClick()V
    .locals 4

...
.field private mImmersiveMode:Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/multi_cp_native/newsfeed/news_details/a;

    const/4 v1, 0x2

    invoke-direct {v0, p0, v1}, Lcom/sec/android/app/sbrowser/multi_cp_native/newsfeed/news_details/a;-><init>(Ljava/lang/Object;I)V
...
.method public static synthetic C(Lcom/sec/android/app/sbrowser/webapp/WebappActivity;Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkConstants$Messages;Ljava/lang/Object;)V
    .locals 0
...
.method public static bridge synthetic E(Lcom/sec/android/app/sbrowser/webapp/WebappActivity;)Z
    .locals 0
...
.method public static bridge synthetic F(Lcom/sec/android/app/sbrowser/webapp/WebappActivity;)Lcom/sec/android/app/sbrowser/webapp/Webapp;
    .locals 0
...
.method public static bridge synthetic G(Lcom/sec/android/app/sbrowser/webapp/WebappActivity;)V
    .locals 1
...
.method public static bridge synthetic H(Lcom/sec/android/app/sbrowser/webapp/WebappActivity;Lcom/sec/terrace/Terrace;Ljava/lang/String;ZZLcom/sec/terrace/TerraceOrigin;)V
    .locals 0
...
.method public static bridge synthetic I(Lcom/sec/android/app/sbrowser/webapp/WebappActivity;Ljava/lang/String;)Z
    .locals 0
...
.method private computeImmersiveMode(Lcom/sec/terrace/browser/browserservices/intents/TerraceBrowserServicesIntentDataProvider;)Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;
    .locals 0

    invoke-virtual {p1}, Lcom/sec/terrace/browser/browserservices/intents/TerraceBrowserServicesIntentDataProvider;->getTwaDisplayMode()Landroidx/browser/trusted/TrustedWebActivityDisplayMode;

    move-result-object p0

    instance-of p1, p0, Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;

    if-eqz p1, :cond_0

    check-cast p0, Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;
...
.method private synthetic lambda$new$1(Lcom/sec/android/app/sbrowser/common/constants/sites/BookmarkConstants$Messages;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p2, p1}, Lcom/sec/android/app/sbrowser/common/utils/SnackbarUtil;->make(Landroid/content/Context;Landroid/view/View;Ljava/lang/String;)Lcom/google/android/material/snackbar/Snackbar;
...
.method private launchCustomTabActivity(Lcom/sec/terrace/Terrace;Ljava/lang/String;ZZLcom/sec/terrace/TerraceOrigin;)V
    ...
    invoke-static {p0, p1, p5}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->A(Landroid/content/ActivityNotFoundException;Ljava/lang/StringBuilder;Ljava/lang/String;)V

    :goto_0
    return-void
.end method

.method private loadUrlIfPostShareTarget(Landroidx/browser/trusted/sharing/ShareData;Lcom/sec/terrace/browser/browserservices/intents/TerraceWebApkShareTarget;)Z
    .locals 1
    ...
    invoke-static {v0, p2, p1, p0}, Lcom/sec/terrace/browser/webapps/TerraceWebApkPostShareTargetNavigator;->navigateIfPostShareTarget(Ljava/lang/String;Lcom/sec/terrace/browser/browserservices/intents/TerraceWebApkShareTarget;Landroidx/browser/trusted/sharing/ShareData;Lcom/sec/terrace/Terrace;)Z
...
.method private maybeStartExternalActivity(Ljava/lang/String;)Z
    ...
    invoke-static {v2, v0, v3}, LJ7/b;->C(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private preInflationStartup()V
    ...
    invoke-direct {p0, v0}, Lcom/sec/android/app/sbrowser/webapp/WebappActivity;->computeImmersiveMode(Lcom/sec/terrace/browser/browserservices/intents/TerraceBrowserServicesIntentDataProvider;)Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;

    move-result-object v0

    iput-object v0, p0, Lcom/sec/android/app/sbrowser/webapp/WebappActivity;->mImmersiveMode:Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;
    ...
    :cond_1
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/webapp/WebappActivity;->mImmersiveModeController:Lcom/sec/android/app/sbrowser/customtabs/features/ImmersiveModeController;

    invoke-virtual {v0}, Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;->layoutInDisplayCutoutMode()I

    move-result v0

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/webapp/WebappActivity;->mImmersiveMode:Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;

    invoke-virtual {p0}, Landroidx/browser/trusted/TrustedWebActivityDisplayMode$ImmersiveMode;->isSticky()Z

    move-result p0

    invoke-virtual {v1, v0, p0}, Lcom/sec/android/app/sbrowser/customtabs/features/ImmersiveModeController;->enterImmersiveMode(IZ)V
...
.method public loadUrl(Ljava/lang/String;Landroidx/browser/trusted/sharing/ShareData;Lcom/sec/terrace/browser/browserservices/intents/TerraceWebApkShareTarget;)V
    .locals 0

    invoke-direct {p0, p2, p3}, Lcom/sec/android/app/sbrowser/webapp/WebappActivity;->loadUrlIfPostShareTarget(Landroidx/browser/trusted/sharing/ShareData;Lcom/sec/terrace/browser/browserservices/intents/TerraceWebApkShareTarget;)Z
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-static {p1, p3, v0}, Landroidx/compose/ui/input/pointer/a;->B(ILjava/lang/String;Ljava/lang/String;)V
...
.method public onNewIntent(Landroid/content/Intent;)V
    ...
    invoke-virtual {p1}, Lcom/sec/terrace/browser/browserservices/intents/TerraceBrowserServicesIntentDataProvider;->getShareData()Landroidx/browser/trusted/sharing/ShareData;
    ...
    invoke-virtual {p0, v0, v1, p1}, Lcom/sec/android/app/sbrowser/webapp/WebappActivity;->loadUrl(Ljava/lang/String;Landroidx/browser/trusted/sharing/ShareData;Lcom/sec/terrace/browser/browserservices/intents/TerraceWebApkShareTarget;)V
...
.method public onPostInflation()V
    ...
    invoke-static {v0, v1, v2}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->p(Landroid/database/sqlite/SQLiteException;Ljava/lang/StringBuilder;Ljava/lang/String;)V

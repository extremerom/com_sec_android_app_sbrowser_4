...
.method private synthetic lambda$setOnDragListener$1(Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/model/TabListItem;Landroid/view/View;Landroid/view/View;Landroid/view/DragEvent;)Z
    ...
    invoke-interface {p1, v0}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter$TabRecyclerAdapterListener;->setIsTabDragging(Z)V

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter;->mListener:Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter$TabRecyclerAdapterListener;

    invoke-interface {p0, v2}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter$TabRecyclerAdapterListener;->setBottomButtonEnabled(Z)V
    ...
    invoke-interface {p1, v2}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter$TabRecyclerAdapterListener;->setIsTabDragging(Z)V

    iget-object p1, p0, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter;->mListener:Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter$TabRecyclerAdapterListener;

    invoke-interface {p1, v0}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter$TabRecyclerAdapterListener;->setBottomButtonEnabled(Z)V
...
.method private onDrop(Landroid/view/DragEvent;I)V
    ...
    invoke-static {p1, p2, v1, v2, v0}, Landroidx/appcompat/graphics/drawable/a;->w(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public abstract cleanUpViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
.end method
...
.method public clearView(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {p0, p2, p1}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter;->highlightOnReorder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Z)V
...
.method public abstract getTabId(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)I
.end method
...
.method public abstract highlightOnReorder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Z)V
.end method
...
.method public onMove(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;II)Z
    ...
    invoke-static {p4, p5, p1, p2, p3}, Landroidx/appcompat/graphics/drawable/a;->w(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p4, p5}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->notifyItemMoved(II)V
...
.method public onSelectedChanged(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter;->highlightOnReorder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Z)V
...
.method public onViewRecycled(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {p0, p1}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter;->getTabId(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)I
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter;->cleanUpViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
...
.method public performCustomActionReorder(II)V
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter;->onMove(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;II)Z
...
.method public postNotifyDataSetChanged()V
    ...
    invoke-direct {v1, p0, v2}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/h;-><init>(Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter;I)V
...
.method public setOnDragListener(Landroid/view/View;Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/model/TabListItem;)V
    ...
    :cond_0
    new-instance v0, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/i;

    invoke-direct {v0, p0, p1, p2}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/i;-><init>(Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabRecyclerAdapter;Landroid/view/View;Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/model/TabListItem;)V

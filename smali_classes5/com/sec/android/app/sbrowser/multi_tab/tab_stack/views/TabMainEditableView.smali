...
.field protected mLongPressMultiSelectionListener:Landroidx/recyclerview/widget/RecyclerView$SeslLongPressMultiSelectionListener;
...
.field protected mTouchHelper:Landroidx/recyclerview/widget/ItemTouchHelper;
...
.method private dragTabToTab(II)V
    ...
    invoke-direct {v1, p0, p2, p1}, Landroidx/media3/exoplayer/analytics/v;-><init>(Ljava/lang/Object;II)V
...
.method public getLPMultiSelectionListener()Landroidx/recyclerview/widget/RecyclerView$SeslLongPressMultiSelectionListener;
    .locals 1

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabMainEditableView;->mLongPressMultiSelectionListener:Landroidx/recyclerview/widget/RecyclerView$SeslLongPressMultiSelectionListener;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabMainEditableView;->mLongPressMultiSelectionListener:Landroidx/recyclerview/widget/RecyclerView$SeslLongPressMultiSelectionListener;

    return-object v0
.end method

.method public getSPenMultiSelectedListener()Landroidx/recyclerview/widget/RecyclerView$SeslOnMultiSelectedListener;
    .locals 1

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabMainEditableView;->mSPenMultiSelectedListener:Landroidx/recyclerview/widget/RecyclerView$SeslOnMultiSelectedListener;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabMainEditableView;->mSPenMultiSelectedListener:Landroidx/recyclerview/widget/RecyclerView$SeslOnMultiSelectedListener;
...
.method public moveTabToGroup(Ljava/lang/String;IZ)V
    ...
    :goto_0
    new-instance p2, Lcom/sec/android/app/sbrowser/download/d;

    const/16 p3, 0x19

    invoke-direct {p2, p3, p0, p1}, Lcom/sec/android/app/sbrowser/download/d;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public setListBottomPadding(I)Z
    ...
    invoke-direct {p0, v0}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabMainEditableView;->setBottomPadding(I)V
    ...
    const-string v4, "[setListBottomPadding] itemHeight:"
    ...
    invoke-interface {v5}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabMainView$Delegate;->getCoordinatorContentHeight()I

    move-result v5

    const-string v6, "[setListBottomPadding] contentHeight:"

    invoke-static {v5, v6, v4}, Landroidx/appcompat/graphics/drawable/a;->x(ILjava/lang/String;Ljava/lang/String;)V
    ...
    :cond_4
    iget-object v6, p0, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabMainView;->mDelegate:Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabMainView$Delegate;

    invoke-interface {v6}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabMainView$Delegate;->getGroupPathHeight()I

    move-result v6

    const-string v7, "[setListBottomPadding] groupPathHeight:"

    invoke-static {v6, v7, v4}, Landroidx/appcompat/graphics/drawable/a;->x(ILjava/lang/String;Ljava/lang/String;)V
    ...
    const-string v8, "[setListBottomPadding] topMargin:"
    ...
    invoke-static {v5, v0, v4}, Landroidx/appcompat/graphics/drawable/a;->x(ILjava/lang/String;Ljava/lang/String;)V
    ...
    const-string v7, "[setListBottomPadding] bottomBarHeight:"
    ...
    const-string v7, "[setListBottomPadding] newBottomPadding:"
    ...
    invoke-static {v1, p0, v4}, Landroidx/compose/ui/input/pointer/a;->B(ILjava/lang/String;Ljava/lang/String;)V
...
.method public setLongPressMultiSelectedListener()V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabMainEditableView;->getLPMultiSelectionListener()Landroidx/recyclerview/widget/RecyclerView$SeslLongPressMultiSelectionListener;
...
.method public setOnMultiSelectedListener()V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/multi_tab/tab_stack/views/TabMainEditableView;->getSPenMultiSelectedListener()Landroidx/recyclerview/widget/RecyclerView$SeslOnMultiSelectedListener;
...
.method public setScrollPositionWithGroup(Ljava/lang/String;)V
    ...
    invoke-static {p1, v0, v1}, Landroidx/compose/ui/input/pointer/a;->u(Ljava/lang/StringBuilder;ILjava/lang/String;)V

...
.method private backStackMultiTabFragment()V
    ...
    :cond_0
    const-string v0, "backStackMultiTabFragment"
    ...
    :cond_1
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabController;->getFragmentManager()Landroidx/fragment/app/FragmentManager;
    ...
    const-string v0, "popBackStackImmediate"
...
.method private beginFragmentTransaction(Z)V
    .locals 1
    ...
    invoke-virtual {v0, p0, p1}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewBase;->beginFragmentTransaction(Landroidx/fragment/app/FragmentManager;Z)V
...
.method public static bridge synthetic e(Lcom/sec/android/app/sbrowser/multi_tab/MultiTabController;Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTab;Lcom/sec/android/app/sbrowser/multi_tab/i;)V
    .locals 0
...
.method public static getMultiTabModeFromOldPref(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v2, v3, v1}, Landroidx/glance/oneui/template/layout/glance/a;->y(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-static {v4, v3, v0}, Landroidx/glance/oneui/template/layout/glance/a;->y(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-static {v1, v3, v0}, Landroidx/glance/oneui/template/layout/glance/a;->y(Ljava/lang/String;Ljava/lang/String;Z)V
...
.method private onBitmapReceived(Lcom/sec/android/app/sbrowser/sbrowser_tab/SBrowserTab;)V
    ...
    :cond_0
    invoke-static {v1, v5, v0}, Landroidx/appcompat/graphics/drawable/a;->C(Ljava/lang/String;Ljava/lang/StringBuilder;Z)V
...
.method public closeGroupList()V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewControl;->closeGroupList()V
...
.method public createNewTab(ZZLjava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabController;->mMultiTabViewDelegate:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewDelegate;

    invoke-interface {p0, p1, p2, p3}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewDelegate;->createNewTab(ZZLjava/lang/String;)V
...
.method public filterOptionsMenu(Landroid/view/Menu;)V
    ...
    invoke-virtual {v7}, Lcom/sec/android/app/sbrowser/tab_manager/TabManager;->hasClosedTab()Z
    ...
    iget-object v7, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabController;->mMultiTabDelegate:Lcom/sec/android/app/sbrowser/multi_tab/MultiTab$MultiTabDelegate;

    if-eqz v7, :cond_a

    invoke-interface {v7}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTab$MultiTabDelegate;->getTabManager()Lcom/sec/android/app/sbrowser/tab_manager/TabManager;
    ...
    iget-object v7, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabController;->mMultiTabView:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewKeyImpl;

    invoke-virtual {v7}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewBase;->hasClosableTabInCurrentOrChildGroup()Z
    ...
    invoke-virtual {v6}, Lcom/sec/android/app/sbrowser/tab_manager/TabManager;->getUngroupedTabCount()I
    ...
    invoke-virtual {v1}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewBase;->isNoTabsShowing()Z
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabController;->isTabSyncListLayout()Z
...
.method public isTabSyncListLayout()Z
    .locals 2
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncPhoneView;->getCurrentLayoutState()Lcom/sec/android/app/sbrowser/tab_sync/TabSyncPhoneView$TabSyncLayoutState;

    move-result-object p0

    sget-object v1, Lcom/sec/android/app/sbrowser/tab_sync/TabSyncPhoneView$TabSyncLayoutState;->LIST_LAYOUT:Lcom/sec/android/app/sbrowser/tab_sync/TabSyncPhoneView$TabSyncLayoutState;
...
.method public launchMultiTab(Lcom/sec/android/app/sbrowser/multi_tab/MultiTabLaunchCallback;Z)V
    .locals 2
    ...
    invoke-direct {p0, p2}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabController;->beginFragmentTransaction(Z)V
...
.method public notifyTabGroupNameChanged(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-virtual {v0, p1, p2}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewBase;->changeGroupName(Ljava/lang/String;Ljava/lang/String;)V
...
.method public removeSyncedDevice()V
    ...
    iget-object v1, v0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewControl;->mTabSyncUi:Lcom/sec/android/app/sbrowser/tab_sync/TabSyncActivityUI;
    ...
    :cond_0
    iget-object v1, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabController;->mSyncDeviceRemovalHandler:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSyncToolbarHandler;

    if-nez v1, :cond_1

    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewControl;->initSyncDeviceRemovalHandler()V

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabController;->mMultiTabView:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewKeyImpl;

    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewControl;->initSyncedDeviceDeleteFloatingButton()V

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabController;->mMultiTabView:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewKeyImpl;

    iget-object v0, v0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewControl;->mSyncDeviceRemovalHandler:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSyncToolbarHandler;

    iput-object v0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabController;->mSyncDeviceRemovalHandler:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSyncToolbarHandler;

    :cond_1
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabController;->mSyncDeviceRemovalHandler:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSyncToolbarHandler;

    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSyncToolbarHandler;->enterSyncDeviceRemovalMode()V
...
.method public startOutroAnimation(Z)V
    ...
    invoke-direct {v2, p0, v3}, Lcom/sec/android/app/sbrowser/multi_tab/a;-><init>(Ljava/lang/Object;I)V
...
.method public updateInsetsRootView()V
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabViewBase;->updateInsetsRootView()V

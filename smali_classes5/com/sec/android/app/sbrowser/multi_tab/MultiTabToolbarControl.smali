...
.field mFloatingSearchToolbar:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar;
...
.field mSearchFloatingBottomLayout:Lcom/google/android/material/oneui/floatingactioncontainer/FloatingBottomLayout;

.field private mSearchToolbarListener:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar$Listener;

.field private mSyncToolbarHandler:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSyncToolbarHandler;
...
.method public static bridge synthetic b(Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;)Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSyncToolbarHandler;
    .locals 0

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mSyncToolbarHandler:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSyncToolbarHandler;
...
.method private initSearchToolbar()V
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mSearchBackButtonContainer:Landroid/widget/LinearLayout;

    new-instance v0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar;

    invoke-direct {v0}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar;-><init>()V

    iput-object v0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mFloatingSearchToolbar:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar;
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mSearchFloatingBottomLayout:Lcom/google/android/material/oneui/floatingactioncontainer/FloatingBottomLayout;

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mFloatingSearchToolbar:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar;

    if-eqz v1, :cond_0

    iget-object v2, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mContext:Landroid/content/Context;

    iget-object v3, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mSearchToolbarListener:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar$Listener;

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mSearchBackButtonContainer:Landroid/widget/LinearLayout;

    invoke-virtual {v1, v2, v3, v0, p0}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar;->init(Landroid/content/Context;Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar$Listener;Lcom/google/android/material/oneui/floatingactioncontainer/FloatingBottomLayout;Landroid/widget/LinearLayout;)V
...
.method public announceForSyncSelectAll(IZ)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabEditToolbar;->announceForSyncSelectAll(IZ)V
...
.method public clearSearchText()V
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mFloatingSearchToolbar:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar;
...
.method public isInSyncDeviceRemovalMode()Z
    .locals 0
...
.method public isSearchBarShowing()Z
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar;->getFloatingSearchBarVisibility()I
...
.method public onDestroyView()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mFloatingSearchToolbar:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar;
    ...
    iput-object v1, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mFloatingSearchToolbar:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar;
...
.method public onWindowFocusChanged(Z)V
    ...
    iget-object p1, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mFloatingSearchToolbar:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar;
...
.method public restoreSearchToolbarFromEditMode()V
    ...
    invoke-virtual {v0, v1}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar;->setFloatingSearchBarVisibility(I)V

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mFloatingSearchToolbar:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar;

    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSearchToolbar;->requestFocus()V
...
.method public setEditToolbarTitle(I)V
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->isInSyncDeviceRemovalMode()Z

    move-result p0

    invoke-virtual {v0, p1, p0}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabEditToolbar;->setEditToolbarTitle(IZ)V

    :cond_0
    return-void
.end method

.method public setFloatingDeleteButtonVisibility(Z)V
    .locals 0

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mDelegate:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl$Delegate;

    invoke-interface {p0, p1}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl$Delegate;->setSyncDeleteButtonVisibility(Z)V

    return-void
.end method

.method public setFloatingMenuVisibility(Z)V
    .locals 0

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mDelegate:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl$Delegate;

    invoke-interface {p0, p1}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl$Delegate;->setFloatingMenuVisibility(Z)V
...
.method public setSyncToolbarHandler(Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSyncToolbarHandler;)V
    .locals 0

    iput-object p1, p0, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabToolbarControl;->mSyncToolbarHandler:Lcom/sec/android/app/sbrowser/multi_tab/MultiTabSyncToolbarHandler;
...
.method public showNewTabButton(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/sec/android/app/sbrowser/multi_tab/MultiTabNormalToolbar;->showNewTabButton(Z)V

...
.field public transient f:LP0/c;
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    iput-object v0, p0, LO0/b;->c:Ljava/lang/String;

    sget-object v0, LN0/p;->LEFT:LN0/p;

    iput-object v0, p0, LO0/b;->d:LN0/p;
    ...
    iput-object v1, p0, LO0/b;->g:LN0/g;

    const/high16 v1, 0x7fc00000    # Float.NaN

    iput v1, p0, LO0/b;->h:F

    iput v1, p0, LO0/b;->i:F

    iput-boolean v0, p0, LO0/b;->j:Z

    iput-boolean v0, p0, LO0/b;->k:Z

    new-instance v1, LV0/c;

    invoke-direct {v1}, LV0/d;-><init>()V

    iput-object v1, p0, LO0/b;->l:LV0/c;

    const/high16 v1, 0x41880000    # 17.0f

    iput v1, p0, LO0/b;->m:F
    ...
    iput-object v1, p0, LO0/b;->a:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, LO0/b;->b:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, LO0/b;->c:Ljava/lang/String;

    const p1, -0x800001

    iput p1, p0, LO0/b;->p:F

    const v2, 0x7f7fffff    # Float.MAX_VALUE

    iput v2, p0, LO0/b;->q:F

    iput p1, p0, LO0/b;->r:F

    iput v2, p0, LO0/b;->s:F

    iput-object p2, p0, LO0/b;->o:Ljava/util/ArrayList;
    ...
    iput-object v3, p0, LO0/b;->o:Ljava/util/ArrayList;

    :cond_0
    iget-object v3, p0, LO0/b;->o:Ljava/util/ArrayList;
    ...
    iget v4, p0, LO0/b;->q:F

    cmpg-float v4, v3, v4

    if-gez v4, :cond_3

    iput v3, p0, LO0/b;->q:F

    :cond_3
    iget v4, p0, LO0/b;->p:F

    cmpl-float v4, v3, v4

    if-lez v4, :cond_6

    iput v3, p0, LO0/b;->p:F
    ...
    :cond_7
    iget v3, p0, LO0/b;->r:F

    cmpl-float v3, v2, v3

    if-lez v3, :cond_2

    iput v2, p0, LO0/b;->r:F
    ...
    iput p1, p0, LO0/b;->v:I

    iput v1, p0, LO0/b;->w:I

    const/16 p1, 0x78

    iput p1, p0, LO0/b;->x:I

    const/4 p1, 0x0

    iput p1, p0, LO0/b;->y:I
    ...
    iput-object v1, p0, LO0/b;->z:[Ljava/lang/String;
    ...
    iget v4, p0, LO0/b;->u:I

    if-le v3, v4, :cond_9

    array-length v2, v2

    iput v2, p0, LO0/b;->u:I
    ...
    iget v1, p0, LO0/b;->y:I

    add-int/2addr v1, v0

    iput v1, p0, LO0/b;->y:I

    goto :goto_5

    :cond_b
    iget v2, p0, LO0/b;->y:I

    array-length v1, v1

    add-int/2addr v2, v1

    iput v2, p0, LO0/b;->y:I
...
.method public final a(F)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, LO0/b;->o:Ljava/util/ArrayList;
...
.method public final b(FFLO0/e;)Lcom/github/mikephil/charting/data/Entry;
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, LO0/b;->c(FFLO0/e;)I
...
.method public final c(FFLO0/e;)I
    .locals 10
    ...
    :cond_6
    sget-object v2, LO0/e;->DOWN:LO0/e;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v3, p0, LO0/b;->c:Ljava/lang/String;

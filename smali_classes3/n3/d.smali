...
.method public final declared-synchronized a(Landroid/content/Context;)Lcom/google/vr/dynamite/client/ILoadedInstanceCreator;
    ...
    :try_start_0
    iget-object v0, p0, Ln3/d;->b:Lcom/google/vr/dynamite/client/ILoadedInstanceCreator;

    if-nez v0, :cond_2

    invoke-virtual {p0, p1}, Ln3/d;->b(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-static {p1}, Ln3/d;->c(Ljava/lang/ClassLoader;)Landroid/os/IBinder;
    ...
    :goto_0
    iput-object p1, p0, Ln3/d;->b:Lcom/google/vr/dynamite/client/ILoadedInstanceCreator;

    :cond_2
    iget-object p1, p0, Ln3/d;->b:Lcom/google/vr/dynamite/client/ILoadedInstanceCreator;
    :try_end_0
...
.method public final declared-synchronized b(Landroid/content/Context;)Landroid/content/Context;
    ...
    :cond_0
    :goto_0
    iget-object p1, p0, Ln3/d;->a:Landroid/content/Context;
    :try_end_2

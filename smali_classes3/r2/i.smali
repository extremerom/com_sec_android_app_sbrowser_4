...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lr2/i;->zzf:Ljava/lang/Object;
    ...
    invoke-direct {v0, v1}, Ls2/e;-><init>(LB2/j;)V

    iput-object v0, p0, Lr2/i;->zzh:Ls2/e;

    return-void
.end method

.method public static bridge synthetic zza(Lr2/i;)Landroid/content/ComponentName;
    .locals 0

    iget-object p0, p0, Lr2/i;->zza:Landroid/content/ComponentName;

    return-object p0
.end method

.method public static bridge synthetic zzb(Lr2/i;)Landroid/content/Intent;
    .locals 0

    iget-object p0, p0, Lr2/i;->zzd:Landroid/content/Intent;

    return-object p0
.end method

.method public static bridge synthetic zzc(Lr2/i;)Lr2/n;
    .locals 0

    iget-object p0, p0, Lr2/i;->zzb:Lr2/n;

    return-object p0
.end method

.method public static bridge synthetic zzd(Lr2/i;)Ls2/e;
    .locals 0

    iget-object p0, p0, Lr2/i;->zzh:Ls2/e;

    return-object p0
.end method

.method public static bridge synthetic zze(Lr2/i;)Ljava/lang/Object;
    .locals 0

    iget-object p0, p0, Lr2/i;->zzf:Ljava/lang/Object;

    return-object p0
.end method

.method public static bridge synthetic zzf(Lr2/i;)Z
    .locals 0

    iget-boolean p0, p0, Lr2/i;->zzg:Z
...
.method public getLooper()Landroid/os/Looper;
    ...
    iget-object v0, p0, Lr2/i;->zze:Landroid/os/Looper;
    ...
    iput-object v0, p0, Lr2/i;->zze:Landroid/os/Looper;

    :cond_0
    iget-object p0, p0, Lr2/i;->zze:Landroid/os/Looper;
...
.method public final onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    :cond_4
    iget-object p0, p0, Lr2/i;->zzc:Landroid/os/IBinder;
...
.method public onCapabilityChanged(Lr2/a;)V
    .locals 0
    .param p1    # Lr2/a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public onCreate()V
    ...
    iput-object v0, p0, Lr2/i;->zza:Landroid/content/ComponentName;
    ...
    iget-object v1, p0, Lr2/i;->zza:Landroid/content/ComponentName;
    ...
    invoke-virtual {p0}, Lr2/i;->getLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lr2/n;-><init>(Lr2/i;Landroid/os/Looper;)V

    iput-object v0, p0, Lr2/i;->zzb:Lr2/n;
    ...
    iput-object v0, p0, Lr2/i;->zzd:Landroid/content/Intent;
    ...
    invoke-direct {v0, p0}, Lr2/k;-><init>(Lr2/i;)V

    iput-object v0, p0, Lr2/i;->zzc:Landroid/os/IBinder;

    return-void
.end method

.method public onDataChanged(Lr2/c;)V
    .locals 0
    .param p1    # Lr2/c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public onDestroy()V
    ...
    iget-object v3, p0, Lr2/i;->zza:Landroid/content/ComponentName;
    ...
    :cond_0
    iget-object v1, p0, Lr2/i;->zzf:Ljava/lang/Object;
    ...
    :try_start_0
    iput-boolean v2, p0, Lr2/i;->zzg:Z

    iget-object v2, p0, Lr2/i;->zzb:Lr2/n;
    ...
    invoke-virtual {v2, v0}, Lr2/n;->a(Ljava/lang/String;)V
...
.method public onEntityUpdate(Lr2/j;)V
    .locals 0
...
.method public onMessageReceived(Lr2/e;)V
    .locals 0
    .param p1    # Lr2/e;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public onNotificationReceived(Lr2/l;)V
    .locals 0
    .annotation build Lcom/google/android/gms/common/internal/ShowFirstParty;
    .end annotation
...
.method public onPeerConnected(Lr2/f;)V
    .locals 0
    .param p1    # Lr2/f;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public onPeerDisconnected(Lr2/f;)V
    .locals 0
    .param p1    # Lr2/f;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public onRequest(Ljava/lang/String;Ljava/lang/String;[B)Lk2/e;
    .locals 0

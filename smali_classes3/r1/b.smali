...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lr1/b;->b:Landroid/content/ComponentName;
    ...
    invoke-direct {v1, v2, v0}, LB7/c;-><init>(Ljava/lang/String;[Ljava/lang/String;)V

    sput-object v1, Lr1/b;->c:LB7/c;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lr1/b;->h(Landroid/content/Context;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/internal/auth/x0;->b()Lcom/google/android/gms/internal/auth/y0;
    ...
    invoke-static {p0}, Lr1/b;->j(Landroid/content/Context;)Z
    ...
    sget-object v6, Lcom/google/android/gms/common/api/c;->V:Lcom/google/android/gms/common/api/b;

    sget-object v7, Lcom/google/android/gms/common/api/i;->c:Lcom/google/android/gms/common/api/i;

    const/4 v4, 0x0

    sget-object v5, Lcom/google/android/gms/internal/auth/a;->a:Lcom/google/android/gms/common/api/g;

    move-object v2, v1

    move-object v3, p0

    invoke-direct/range {v2 .. v7}, Lcom/google/android/gms/common/api/j;-><init>(Landroid/content/Context;Landroid/app/Activity;Lcom/google/android/gms/common/api/g;Lcom/google/android/gms/common/api/c;Lcom/google/android/gms/common/api/i;)V
    ...
    sget-object v4, Lr1/e;->b:Lcom/google/android/gms/common/Feature;

    filled-new-array {v4}, [Lcom/google/android/gms/common/Feature;

    move-result-object v4

    iput-object v4, v3, LO5/a;->d:Ljava/lang/Object;
    ...
    iput-object v4, v3, LO5/a;->c:Ljava/lang/Object;

    const/16 v2, 0x5e9

    iput v2, v3, LO5/a;->b:I

    invoke-virtual {v3}, LO5/a;->c()Ly1/P;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/google/android/gms/common/api/j;->doWrite(Ly1/v;)Lk2/e;
    ...
    :try_start_0
    invoke-static {v1, v2}, Lr1/b;->g(Lk2/e;Ljava/lang/String;)Ljava/lang/Object;
    :try_end_0
    .catch Lcom/google/android/gms/common/api/h; {:try_start_0 .. :try_end_0} :catch_0
    ...
    sget-object v3, Lr1/b;->c:LB7/c;

    invoke-virtual {v3, v2, v1}, LB7/c;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v2, p1, v0}, Lo7/b;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    sget-object p1, Lr1/b;->b:Landroid/content/ComponentName;

    invoke-static {p0, p1, v1}, Lr1/b;->f(Landroid/content/Context;Landroid/content/ComponentName;Lr1/f;)Ljava/lang/Object;
...
.method public static b(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lr1/b;->i(Landroid/accounts/Account;)V

    const-string p1, "^^_account_id_^^"

    invoke-static {p0, v1, p1, v0}, Lr1/b;->d(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
...
.method public static c(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v2, "User intervention required. Notification has been pushed."
    ...
    :try_start_0
    invoke-static {p0, p1, p2, v0}, Lr1/b;->d(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;

    move-result-object p1

    invoke-static {p0}, Lx1/f;->a(Landroid/content/Context;)V
    :try_end_0
    .catch Lr1/c; {:try_start_0 .. :try_end_0} :catch_1
    ...
    sget-object p2, Lx1/b;->d:Lx1/b;

    const/16 v0, 0x12

    const/4 v5, 0x0

    iget v6, p1, Lr1/c;->a:I
    ...
    invoke-static {p0, v0}, Lx1/f;->d(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-virtual {p2, p0, v6, v0}, Lx1/c;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    :goto_4
    invoke-virtual {p2, p0, v6, v0}, Lx1/b;->f(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-direct {v0, p2, p0}, Lx1/h;-><init>(Lx1/b;Landroid/content/Context;)V
...
.method public static d(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {p1}, Lr1/b;->i(Landroid/accounts/Account;)V
    ...
    invoke-virtual {p3}, Lcom/google/android/gms/internal/auth/x0;->b()Lcom/google/android/gms/internal/auth/y0;
    ...
    sget-object v3, Lr1/e;->b:Lcom/google/android/gms/common/Feature;

    filled-new-array {v3}, [Lcom/google/android/gms/common/Feature;

    move-result-object v3

    iput-object v3, v2, LO5/a;->d:Ljava/lang/Object;
    ...
    iput-object v3, v2, LO5/a;->c:Ljava/lang/Object;

    const/16 v3, 0x5e8

    iput v3, v2, LO5/a;->b:I

    invoke-virtual {v2}, LO5/a;->c()Ly1/P;

    move-result-object v2

    invoke-virtual {p3, v2}, Lcom/google/android/gms/common/api/j;->doWrite(Ly1/v;)Lk2/e;
    ...
    :try_start_0
    invoke-static {p3, v2}, Lr1/b;->g(Lk2/e;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {p3}, Lr1/b;->e(Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-virtual {v0, v3, p3}, LB7/c;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v2, p3}, LB7/c;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {p3, p1, v0, p2, v1}, Lk1/a;-><init>(Ljava/lang/Object;ILjava/lang/Object;Ljava/lang/Object;)V

    sget-object p1, Lr1/b;->b:Landroid/content/ComponentName;

    invoke-static {p0, p1, p3}, Lr1/b;->f(Landroid/content/Context;Landroid/content/ComponentName;Lr1/f;)Ljava/lang/Object;
...
.method public static e(Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {v2, v1, p0}, LJ7/b;->o(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v2, Lr1/b;->c:LB7/c;

    invoke-virtual {v2, v1, p0}, LB7/c;->c(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static f(Landroid/content/Context;Landroid/content/ComponentName;Lr1/f;)Ljava/lang/Object;
    .locals 5
    ...
    :try_start_1
    invoke-virtual {v2}, Lh7/a;->a()Landroid/os/IBinder;

    move-result-object v3

    invoke-interface {p2, v3}, Lr1/f;->b(Landroid/os/IBinder;)Ljava/lang/Object;
...
.method public static g(Lk2/e;Ljava/lang/String;)Ljava/lang/Object;
    .locals 4

    const-string v0, " to finish."

    sget-object v1, Lr1/b;->c:LB7/c;

    const/4 v2, 0x0

    :try_start_0
    invoke-static {p0}, Lb2/p3;->a(Lk2/e;)Ljava/lang/Object;
    ...
    invoke-static {v3, p1, v0}, LJ7/b;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    new-array v0, v2, [Ljava/lang/Object;

    invoke-virtual {v1, p1, v0}, LB7/c;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    instance-of v3, v0, Lcom/google/android/gms/common/api/h;
    ...
    invoke-static {v0, p1, v3}, LJ7/b;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static h(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lx1/f;->b(Landroid/content/Context;)V
    :try_end_0
    .catch Lx1/e; {:try_start_0 .. :try_end_0} :catch_1
    .catch Lx1/d; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v3, p0, Lx1/e;->a:Landroid/content/Intent;

    invoke-direct {v2, v3}, Landroid/content/Intent;-><init>(Landroid/content/Intent;)V

    iget p0, p0, Lx1/e;->b:I

    invoke-direct {v0, p0, v1}, Lr1/c;-><init>(ILjava/lang/String;)V
...
.method public static j(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/internal/auth/x0;->b()Lcom/google/android/gms/internal/auth/y0;

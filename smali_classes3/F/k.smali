...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LF/k;->b:Lcom/bumptech/glide/util/CachedHashCodeArrayMap;
...
# virtual methods
.method public final a(LF/j;)Ljava/lang/Object;
    .locals 1
    ...
    :cond_0
    iget-object p0, p1, LF/j;->a:Ljava/lang/Object;
...
.method public final updateDiskCacheKey(Ljava/security/MessageDigest;)V
    ...
    :goto_0
    iget-object v1, p0, LF/k;->b:Lcom/bumptech/glide/util/CachedHashCodeArrayMap;
    ...
    iget-object v2, p0, LF/k;->b:Lcom/bumptech/glide/util/CachedHashCodeArrayMap;

    invoke-virtual {v2, v0}, Landroidx/collection/SimpleArrayMap;->valueAt(I)Ljava/lang/Object;

    move-result-object v2

    iget-object v3, v1, LF/j;->b:LF/i;

    iget-object v4, v1, LF/j;->d:[B

    if-nez v4, :cond_0

    iget-object v4, v1, LF/j;->c:Ljava/lang/String;

    sget-object v5, LF/g;->a:Ljava/nio/charset/Charset;

    invoke-virtual {v4, v5}, Ljava/lang/String;->getBytes(Ljava/nio/charset/Charset;)[B

    move-result-object v4

    iput-object v4, v1, LF/j;->d:[B

    :cond_0
    iget-object v1, v1, LF/j;->d:[B

    invoke-interface {v3, v1, v2, p1}, LF/i;->e([BLjava/lang/Object;Ljava/security/MessageDigest;)V

...
.method public static synthetic access$300(Lcom/osp/app/signin/sasdk/http/HttpRequestClient;Lretrofit2/Retrofit;LAa/a0;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/osp/app/signin/sasdk/http/HttpRequestClient;->showErrorResponseWithJSONResult(Lretrofit2/Retrofit;LAa/a0;)V

    return-void
.end method

.method public static synthetic access$400(Lcom/osp/app/signin/sasdk/http/HttpRequestClient;LAa/a0;)Lcom/osp/app/signin/sasdk/response/LinkingResponseData;
    .locals 0

    invoke-direct {p0, p1}, Lcom/osp/app/signin/sasdk/http/HttpRequestClient;->parseErrorResponseWithXMLResult(LAa/a0;)Lcom/osp/app/signin/sasdk/response/LinkingResponseData;
...
.method private makeHttpClient()LAa/K;
    .locals 5
    ...
    sget-object v2, LOa/a;->BASIC:LOa/a;

    invoke-virtual {v1, v2}, LOa/c;->c(LOa/a;)V
    ...
    iget-object v3, v0, LAa/K;->m:Ljava/net/Proxy;
    ...
    iput-object v4, v0, LAa/K;->C:Lv1/g;

    :cond_0
    iput-object v2, v0, LAa/K;->m:Ljava/net/Proxy;
    ...
    iget-object v3, v0, LAa/K;->q:Ljavax/net/ssl/SSLSocketFactory;
    ...
    iget-object v3, v0, LAa/K;->r:Ljavax/net/ssl/X509TrustManager;
    ...
    :cond_2
    iput-object p0, v0, LAa/K;->q:Ljavax/net/ssl/SSLSocketFactory;

    sget-object p0, LJa/n;->a:LJa/n;

    sget-object p0, LJa/n;->a:LJa/n;

    invoke-virtual {p0, v2}, LJa/n;->b(Ljavax/net/ssl/X509TrustManager;)Lb2/F2;

    move-result-object p0

    iput-object p0, v0, LAa/K;->w:Lb2/F2;

    iput-object v2, v0, LAa/K;->r:Ljavax/net/ssl/X509TrustManager;
...
.method private makeRetrofitInstance(ILjava/lang/String;)Lretrofit2/Retrofit;
    ...
    invoke-direct {p0}, Lcom/osp/app/signin/sasdk/http/HttpRequestClient;->makeHttpClient()LAa/K;
    ...
    invoke-direct {p2, p0}, LAa/L;-><init>(LAa/K;)V

    invoke-virtual {p1, p2}, Lretrofit2/Retrofit$Builder;->client(LAa/L;)Lretrofit2/Retrofit$Builder;
    ...
    iput-object v0, p1, LC7/a;->b:Lb6/a;

    iput-boolean p2, p1, LC7/a;->c:Z
    ...
    invoke-direct {p1, p2}, LD7/a;-><init>(LA3/f;)V
    ...
    invoke-virtual {p1, v0}, Lretrofit2/Retrofit$Builder;->client(LAa/L;)Lretrofit2/Retrofit$Builder;
...
.method private parseErrorResponseWithXMLResult(LAa/a0;)Lcom/osp/app/signin/sasdk/response/LinkingResponseData;
    .locals 3
    ...
    iput-object v1, p0, LC7/a;->b:Lb6/a;

    iput-boolean v0, p0, LC7/a;->c:Z
    ...
    invoke-direct {v0, p1}, LC7/h;-><init>(LPa/l;)V

    invoke-virtual {v0}, LC7/h;->a()V

    invoke-virtual {v0}, LC7/h;->k()Ljava/lang/String;

    iget-object p1, p0, LC7/a;->b:Lb6/a;

    const-class v1, Lcom/osp/app/signin/sasdk/response/LinkingResponseData;

    invoke-virtual {p1, v1}, Lb6/a;->n(Ljava/lang/Class;)LE7/b;

    move-result-object p1

    invoke-interface {p1, v0, p0}, LE7/b;->fromXml(LC7/h;LC7/a;)Ljava/lang/Object;

    move-result-object p0

    invoke-virtual {v0}, LC7/h;->c()V
...
.method private showErrorResponseWithJSONResult(Lretrofit2/Retrofit;LAa/a0;)V
    .locals 2

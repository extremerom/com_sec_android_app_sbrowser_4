...
.method public static a(Lcom/google/common/cache/P;Lcom/google/common/cache/P;)V
    .locals 2

    invoke-interface {p0}, Lcom/google/common/cache/P;->m()J

    move-result-wide v0

    invoke-interface {p1, v0, v1}, Lcom/google/common/cache/P;->g(J)V

    invoke-interface {p0}, Lcom/google/common/cache/P;->i()Lcom/google/common/cache/P;
    ...
    invoke-interface {p0}, Lcom/google/common/cache/P;->k()Lcom/google/common/cache/P;

    move-result-object v0

    invoke-interface {p1, v0}, Lcom/google/common/cache/P;->n(Lcom/google/common/cache/P;)V

    invoke-interface {v0, p1}, Lcom/google/common/cache/P;->c(Lcom/google/common/cache/P;)V

    sget-object p1, Lcom/google/common/cache/w;->INSTANCE:Lcom/google/common/cache/w;

    invoke-interface {p0, p1}, Lcom/google/common/cache/P;->n(Lcom/google/common/cache/P;)V

    invoke-interface {p0, p1}, Lcom/google/common/cache/P;->c(Lcom/google/common/cache/P;)V

    return-void
.end method

.method public static d(Lcom/google/common/cache/P;Lcom/google/common/cache/P;)V
    .locals 2

    invoke-interface {p0}, Lcom/google/common/cache/P;->f()J

    move-result-wide v0

    invoke-interface {p1, v0, v1}, Lcom/google/common/cache/P;->h(J)V

    invoke-interface {p0}, Lcom/google/common/cache/P;->d()Lcom/google/common/cache/P;

    move-result-object v0

    sget-object v1, Lcom/google/common/cache/O;->r:Ljava/util/logging/Logger;

    invoke-interface {v0, p1}, Lcom/google/common/cache/P;->o(Lcom/google/common/cache/P;)V

    invoke-interface {p1, v0}, Lcom/google/common/cache/P;->p(Lcom/google/common/cache/P;)V

    invoke-interface {p0}, Lcom/google/common/cache/P;->j()Lcom/google/common/cache/P;

    move-result-object v0

    invoke-interface {p1, v0}, Lcom/google/common/cache/P;->o(Lcom/google/common/cache/P;)V

    invoke-interface {v0, p1}, Lcom/google/common/cache/P;->p(Lcom/google/common/cache/P;)V

    sget-object p1, Lcom/google/common/cache/w;->INSTANCE:Lcom/google/common/cache/w;

    invoke-interface {p0, p1}, Lcom/google/common/cache/P;->o(Lcom/google/common/cache/P;)V
...
# virtual methods
.method public c(Lcom/google/common/cache/x;Lcom/google/common/cache/P;Lcom/google/common/cache/P;Ljava/lang/Object;)Lcom/google/common/cache/P;
    .locals 0

    invoke-interface {p2}, Lcom/google/common/cache/P;->l()I

    move-result p2

    invoke-virtual {p0, p1, p4, p2, p3}, Lcom/google/common/cache/s;->e(Lcom/google/common/cache/x;Ljava/lang/Object;ILcom/google/common/cache/P;)Lcom/google/common/cache/P;
...
.method public abstract e(Lcom/google/common/cache/x;Ljava/lang/Object;ILcom/google/common/cache/P;)Lcom/google/common/cache/P;
.end method

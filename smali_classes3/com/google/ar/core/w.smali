...
# static fields
.field public static final m:Lcom/google/ar/core/w;
...
.field public i:Lcom/google/ar/core/I;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/ar/core/w;->m:Lcom/google/ar/core/w;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/ar/core/w;->a:Landroid/os/Handler;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/google/ar/core/w;->d:Z
...
# virtual methods
.method public final declared-synchronized a(Landroid/content/Context;)Lcom/google/ar/core/I;
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/google/ar/core/w;->i:Lcom/google/ar/core/I;

    if-nez v0, :cond_0

    new-instance v0, Lcom/google/ar/core/I;

    invoke-direct {v0}, Lcom/google/ar/core/I;-><init>()V

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    invoke-virtual {v0, p1}, Lcom/google/ar/core/I;->a(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/ar/core/w;->i:Lcom/google/ar/core/I;
    ...
    :cond_0
    :goto_0
    iget-object p1, p0, Lcom/google/ar/core/w;->i:Lcom/google/ar/core/I;
    :try_end_0
...
.method public final declared-synchronized b()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/ar/core/w;->b:Ljava/lang/Exception;

    const/4 v1, 0x0

    if-nez v0, :cond_0

    iput v1, p0, Lcom/google/ar/core/w;->e:I
    ...
    :cond_0
    :goto_0
    iput-boolean v1, p0, Lcom/google/ar/core/w;->c:Z

    iget-object v0, p0, Lcom/google/ar/core/w;->i:Lcom/google/ar/core/I;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lcom/google/ar/core/I;->b()V
...
.method public final c(Landroid/content/Context;Lcom/google/ar/core/t;)V
    .locals 2

    :try_start_0
    invoke-virtual {p0, p1}, Lcom/google/ar/core/w;->e(Landroid/content/Context;)V

    invoke-static {p1}, Lcom/google/ar/core/w;->d(Landroid/content/Context;)I
    ...
    iget v1, p0, Lcom/google/ar/core/w;->l:I
    ...
    invoke-virtual {p0}, Lcom/google/ar/core/w;->b()V
    :try_end_0
    ...
    :goto_2
    invoke-interface {p2, p0}, Lcom/google/ar/core/t;->a(Lcom/google/ar/core/ArCoreApk$Availability;)V
    ...
    iget-boolean v0, p0, Lcom/google/ar/core/w;->k:Z
    ...
    :cond_5
    invoke-virtual {p0, p1}, Lcom/google/ar/core/w;->a(Landroid/content/Context;)Lcom/google/ar/core/I;

    move-result-object p0

    invoke-virtual {p0, p1, p2}, Lcom/google/ar/core/I;->c(Landroid/content/Context;Lcom/google/ar/core/t;)V
    :try_end_2
...
.method public final checkAvailability(Landroid/content/Context;)Lcom/google/ar/core/ArCoreApk$Availability;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/ar/core/w;->g:Lcom/google/ar/core/ArCoreApk$Availability;
    ...
    :cond_0
    :goto_0
    iget-boolean v0, p0, Lcom/google/ar/core/w;->h:Z

    if-nez v0, :cond_1

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/google/ar/core/w;->h:Z

    new-instance v0, Lcom/google/ar/core/u;

    invoke-direct {v0, p0}, Lcom/google/ar/core/u;-><init>(Lcom/google/ar/core/w;)V

    invoke-virtual {p0, p1, v0}, Lcom/google/ar/core/w;->c(Landroid/content/Context;Lcom/google/ar/core/t;)V

    :cond_1
    iget-object p1, p0, Lcom/google/ar/core/w;->g:Lcom/google/ar/core/ArCoreApk$Availability;
    ...
    iput-object v0, p0, Lcom/google/ar/core/w;->g:Lcom/google/ar/core/ArCoreApk$Availability;
    ...
    :cond_3
    iget-boolean p1, p0, Lcom/google/ar/core/w;->h:Z
...
.method public final checkAvailabilityAsync(Landroid/content/Context;Ljava/util/function/Consumer;)V
    ...
    invoke-direct {v0, p0, p2}, Lcom/google/ar/core/v;-><init>(Lcom/google/ar/core/w;Ljava/util/function/Consumer;)V
...
.method public final declared-synchronized e(Landroid/content/Context;)V
    ...
    :try_start_0
    iget-boolean v0, p0, Lcom/google/ar/core/w;->j:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iput-boolean v2, p0, Lcom/google/ar/core/w;->k:Z
    ...
    iput v1, p0, Lcom/google/ar/core/w;->l:I
    ...
    :try_start_5
    iput-boolean v2, p0, Lcom/google/ar/core/w;->j:Z
    :try_end_5
...
.method public final requestInstall(Landroid/app/Activity;Z)Lcom/google/ar/core/ArCoreApk$InstallStatus;
    ...
    iget-boolean v1, p0, Lcom/google/ar/core/w;->k:Z
    ...
    :goto_1
    invoke-virtual {p0, p1, p2, v0, v1}, Lcom/google/ar/core/w;->requestInstall(Landroid/app/Activity;ZLcom/google/ar/core/ArCoreApk$InstallBehavior;Lcom/google/ar/core/ArCoreApk$UserMessageType;)Lcom/google/ar/core/ArCoreApk$InstallStatus;
...
.method public final requestInstall(Landroid/app/Activity;ZLcom/google/ar/core/ArCoreApk$InstallBehavior;Lcom/google/ar/core/ArCoreApk$UserMessageType;)Lcom/google/ar/core/ArCoreApk$InstallStatus;
    ...
    iget v3, p0, Lcom/google/ar/core/w;->l:I
    ...
    :cond_3
    iget-boolean v0, p0, Lcom/google/ar/core/w;->c:Z
    ...
    iput-object p2, p0, Lcom/google/ar/core/w;->b:Ljava/lang/Exception;
    ...
    iget-wide v5, p0, Lcom/google/ar/core/w;->f:J
    ...
    iput v2, p0, Lcom/google/ar/core/w;->e:I

    :cond_9
    iget p2, p0, Lcom/google/ar/core/w;->e:I

    add-int/2addr p2, v1

    iput p2, p0, Lcom/google/ar/core/w;->e:I

    iput-wide v3, p0, Lcom/google/ar/core/w;->f:J

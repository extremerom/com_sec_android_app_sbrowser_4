...
.method public final bridge synthetic b(Ljava/lang/Object;IILF/k;)LH/G;
    .locals 0

    check-cast p1, Landroid/net/Uri;

    invoke-virtual {p0, p1, p4}, LR/d;->c(Landroid/net/Uri;LF/k;)LH/G;
...
.method public final c(Landroid/net/Uri;LF/k;)LH/G;
    .locals 7
    ...
    iget-object p0, p0, LR/d;->a:Landroid/content/Context;
    ...
    invoke-static {p2, p1}, Landroidx/appcompat/graphics/drawable/a;->m(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-virtual {p2, p1}, LF/k;->a(LF/j;)Ljava/lang/Object;
    ...
    invoke-static {p0, v1, v4, v0}, Lb2/U2;->b(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_5
    invoke-static {p0, p0, v4, p1}, Lb2/U2;->b(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, p0, p1}, LR/c;-><init>(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-static {v4, p1}, Landroidx/appcompat/graphics/drawable/a;->m(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;

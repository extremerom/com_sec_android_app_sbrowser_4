...
.method public final createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    invoke-static {v1, p1}, LR5/b;->x(ILandroid/os/Parcel;)V

    goto :goto_0

    :cond_0
    invoke-static {v1, p1}, LR5/b;->t(ILandroid/os/Parcel;)I
    ...
    invoke-static {v4, p1}, LR5/b;->x(ILandroid/os/Parcel;)V

    goto :goto_1

    :cond_2
    invoke-static {v4, p1}, LR5/b;->j(ILandroid/os/Parcel;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {v4, p1}, LR5/b;->f(ILandroid/os/Parcel;)[B
    ...
    :cond_5
    invoke-static {v4, p1}, LR5/b;->t(ILandroid/os/Parcel;)I
    ...
    invoke-static {v3, p1}, LR5/b;->x(ILandroid/os/Parcel;)V

    goto :goto_2

    :cond_7
    invoke-static {v3, p1}, LR5/b;->t(ILandroid/os/Parcel;)I
    ...
    :cond_9
    invoke-static {v3, p1}, LR5/b;->j(ILandroid/os/Parcel;)Ljava/lang/String;
    ...
    invoke-static {p1, v2, v1}, LR5/b;->i(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
    ...
    invoke-static {p1, v2, v1}, LR5/b;->n(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Ljava/util/ArrayList;
    ...
    invoke-static {p1, v2, v1}, LR5/b;->m(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)[Ljava/lang/Object;
    ...
    invoke-static {p1, v4, v1}, LR5/b;->m(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)[Ljava/lang/Object;
    ...
    :cond_29
    invoke-static {v4, p1}, LR5/b;->s(ILandroid/os/Parcel;)Landroid/os/IBinder;
    ...
    :cond_2b
    invoke-static {v2, p1}, LR5/b;->p(ILandroid/os/Parcel;)Z
    ...
    :cond_2e
    invoke-static {v3, p1}, LR5/b;->p(ILandroid/os/Parcel;)Z
    ...
    :cond_44
    invoke-static {v3, p1}, LR5/b;->f(ILandroid/os/Parcel;)[B
    ...
    :cond_45
    invoke-static {v3, p1}, LR5/b;->e(ILandroid/os/Parcel;)Landroid/os/Bundle;
    ...
    invoke-static {p1, v3, v0}, LR5/b;->i(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
    ...
    :cond_4b
    invoke-static {v0, p1}, LR5/b;->p(ILandroid/os/Parcel;)Z
    ...
    invoke-static {p1, v4, v0}, LR5/b;->i(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Landroid/os/Parcelable;

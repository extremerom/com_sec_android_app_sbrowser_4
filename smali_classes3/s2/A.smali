...
.field public final i:LB2/j;

.field public final j:LB2/j;

.field public final k:LB2/j;

.field public final l:Ls2/B;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/google/android/gms/common/internal/h;Ly1/B;Ly1/B;)V
    ...
    invoke-static {p1}, Ls2/B;->a(Landroid/content/Context;)Ls2/B;
    ...
    invoke-direct/range {v2 .. v8}, Lcom/google/android/gms/common/internal/i;-><init>(Landroid/content/Context;Landroid/os/Looper;ILcom/google/android/gms/common/internal/h;Ly1/f;Ly1/p;)V

    new-instance p2, LB2/j;

    const/16 p3, 0x17

    invoke-direct {p2, p3}, LB2/j;-><init>(I)V

    iput-object p2, p0, Ls2/A;->b:LB2/j;

    new-instance p2, LB2/j;

    invoke-direct {p2, p3}, LB2/j;-><init>(I)V

    iput-object p2, p0, Ls2/A;->c:LB2/j;

    new-instance p2, LB2/j;

    invoke-direct {p2, p3}, LB2/j;-><init>(I)V

    iput-object p2, p0, Ls2/A;->d:LB2/j;

    new-instance p2, LB2/j;

    invoke-direct {p2, p3}, LB2/j;-><init>(I)V

    iput-object p2, p0, Ls2/A;->e:LB2/j;

    new-instance p2, LB2/j;

    invoke-direct {p2, p3}, LB2/j;-><init>(I)V

    iput-object p2, p0, Ls2/A;->f:LB2/j;

    new-instance p2, LB2/j;

    invoke-direct {p2, p3}, LB2/j;-><init>(I)V

    iput-object p2, p0, Ls2/A;->g:LB2/j;

    new-instance p2, LB2/j;

    invoke-direct {p2, p3}, LB2/j;-><init>(I)V

    iput-object p2, p0, Ls2/A;->h:LB2/j;

    new-instance p2, LB2/j;

    invoke-direct {p2, p3}, LB2/j;-><init>(I)V

    iput-object p2, p0, Ls2/A;->i:LB2/j;

    new-instance p2, LB2/j;

    invoke-direct {p2, p3}, LB2/j;-><init>(I)V

    iput-object p2, p0, Ls2/A;->j:LB2/j;

    new-instance p2, LB2/j;

    invoke-direct {p2, p3}, LB2/j;-><init>(I)V

    iput-object p2, p0, Ls2/A;->k:LB2/j;

    invoke-static {v0}, Lcom/google/android/gms/common/internal/o;->f(Ljava/lang/Object;)V

    iput-object v0, p0, Ls2/A;->a:Ljava/util/concurrent/ExecutorService;

    iput-object v1, p0, Ls2/A;->l:Ls2/B;
...
.method public final connect(Lcom/google/android/gms/common/internal/d;)V
    ...
    invoke-virtual {p0}, Ls2/A;->requiresGooglePlayServices()Z
...
.method public final getApiFeatures()[Lcom/google/android/gms/common/Feature;
    ...
    sget-object p0, Lr2/h;->b:[Lcom/google/android/gms/common/Feature;
...
.method public final getStartServicePackage()Ljava/lang/String;
    ...
    iget-object p0, p0, Ls2/A;->l:Ls2/B;

    invoke-virtual {p0}, Ls2/B;->b()Z
...
.method public final onPostInitHandler(ILandroid/os/IBinder;Landroid/os/Bundle;I)V
    ...
    iget-object p1, p0, Ls2/A;->b:LB2/j;

    invoke-virtual {p1, p2}, LB2/j;->n(Landroid/os/IBinder;)V

    iget-object p1, p0, Ls2/A;->c:LB2/j;

    invoke-virtual {p1, p2}, LB2/j;->n(Landroid/os/IBinder;)V

    iget-object p1, p0, Ls2/A;->d:LB2/j;

    invoke-virtual {p1, p2}, LB2/j;->n(Landroid/os/IBinder;)V

    iget-object p1, p0, Ls2/A;->f:LB2/j;

    invoke-virtual {p1, p2}, LB2/j;->n(Landroid/os/IBinder;)V

    iget-object p1, p0, Ls2/A;->g:LB2/j;

    invoke-virtual {p1, p2}, LB2/j;->n(Landroid/os/IBinder;)V

    iget-object p1, p0, Ls2/A;->h:LB2/j;

    invoke-virtual {p1, p2}, LB2/j;->n(Landroid/os/IBinder;)V

    iget-object p1, p0, Ls2/A;->i:LB2/j;

    invoke-virtual {p1, p2}, LB2/j;->n(Landroid/os/IBinder;)V

    iget-object p1, p0, Ls2/A;->j:LB2/j;

    invoke-virtual {p1, p2}, LB2/j;->n(Landroid/os/IBinder;)V

    iget-object p1, p0, Ls2/A;->k:LB2/j;

    invoke-virtual {p1, p2}, LB2/j;->n(Landroid/os/IBinder;)V

    iget-object p1, p0, Ls2/A;->e:LB2/j;

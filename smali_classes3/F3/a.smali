...
.method public final b(ILw3/a;Ljava/util/Map;)Lo3/k;
    ...
    invoke-virtual {v1, v3}, Lw3/a;->a(I)Z
    ...
    sget-object v4, Lo3/c;->RETURN_CODABAR_START_END:Lo3/c;
    ...
    invoke-direct {v4, v2, v5}, Lo3/m;-><init>(FF)V

    new-instance v2, Lo3/m;

    invoke-direct {v2, v0, v5}, Lo3/m;-><init>(FF)V

    filled-new-array {v4, v2}, [Lo3/m;

    move-result-object v0

    sget-object v2, Lo3/a;->CODABAR:Lo3/a;

    const/4 v4, 0x0

    invoke-direct {v1, v3, v4, v0, v2}, Lo3/k;-><init>(Ljava/lang/String;[B[Lo3/m;Lo3/a;)V

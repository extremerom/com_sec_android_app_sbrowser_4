...
.method public final e(LB2/h;Lorg/jsoup/parser/b;)Z
    ...
    iget-object v8, v1, LB2/h;->b:Ljava/lang/Object;
    ...
    iput-object v1, v2, Lorg/jsoup/parser/b;->g:LB2/h;

    invoke-virtual {v0, v1, v2}, Lorg/jsoup/parser/C;->e(LB2/h;Lorg/jsoup/parser/b;)Z
    ...
    invoke-static {v1}, Lorg/jsoup/parser/C;->a(LB2/h;)Z
    ...
    invoke-static {v13, v1}, Ljb/b;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v1}, Lorg/jsoup/parser/b;->k(Ljava/lang/String;)Lkb/n;

    move-result-object v5

    if-nez v5, :cond_15

    invoke-virtual/range {p0 .. p2}, Lorg/jsoup/parser/y;->f(LB2/h;Lorg/jsoup/parser/b;)Z
    ...
    invoke-static {v7, v5}, Lorg/jsoup/parser/b;->A(Ljava/util/ArrayList;Lkb/n;)Z
    ...
    invoke-virtual {v2, v5}, Lorg/jsoup/parser/b;->M(Lkb/n;)V

    goto/16 :goto_1d

    :cond_16
    iget-object v7, v5, Lkb/n;->d:Lorg/jsoup/parser/F;
    ...
    :cond_17
    invoke-virtual/range {p2 .. p2}, Lorg/jsoup/parser/b;->f()Lkb/n;
    ...
    iget-object v14, v13, Lkb/n;->d:Lorg/jsoup/parser/F;

    iget-object v14, v14, Lorg/jsoup/parser/F;->b:Ljava/lang/String;

    move-object/from16 v15, v22

    invoke-static {v14, v15}, Ljb/b;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-static {v6, v11}, Lorg/jsoup/parser/b;->A(Ljava/util/ArrayList;Lkb/n;)Z

    move-result v6

    if-eqz v6, :cond_20

    invoke-virtual {v2, v11}, Lorg/jsoup/parser/b;->a(Lkb/n;)Lkb/n;
    ...
    invoke-virtual {v2, v11}, Lorg/jsoup/parser/b;->N(Lkb/n;)V
    ...
    :cond_23
    new-instance v6, Lkb/n;

    invoke-virtual {v11}, Lkb/n;->p()Ljava/lang/String;
    ...
    invoke-direct {v6, v1, v14, v3}, Lkb/n;-><init>(Lorg/jsoup/parser/F;Ljava/lang/String;Lkb/c;)V
    ...
    :goto_f
    invoke-static/range {v18 .. v18}, Lib/b;->a(Z)V
    ...
    :cond_28
    iget-object v1, v12, Lkb/u;->a:Lkb/u;

    check-cast v1, Lkb/n;

    if-eqz v1, :cond_29

    invoke-virtual {v12}, Lkb/u;->w()V

    :cond_29
    invoke-virtual {v6, v12}, Lkb/n;->z(Lkb/u;)V
    ...
    :cond_2a
    invoke-virtual {v2, v12}, Lorg/jsoup/parser/b;->x(Lkb/u;)V
    ...
    :cond_2c
    invoke-virtual {v9, v12}, Lkb/n;->z(Lkb/u;)V
    ...
    invoke-direct {v1, v7, v3, v6}, Lkb/n;-><init>(Lorg/jsoup/parser/F;Ljava/lang/String;Lkb/c;)V

    invoke-virtual {v1}, Lkb/n;->e()Lkb/c;

    move-result-object v3

    invoke-virtual {v5}, Lkb/n;->e()Lkb/c;

    move-result-object v6

    invoke-virtual {v3, v6}, Lkb/c;->d(Lkb/c;)V

    invoke-virtual {v13}, Lkb/n;->g()I

    move-result v3

    if-nez v3, :cond_2e

    sget-object v3, Lkb/u;->c:Ljava/util/List;

    goto :goto_16

    :cond_2e
    invoke-virtual {v13}, Lkb/n;->k()Ljava/util/List;
    ...
    iget-object v6, v1, Lkb/n;->f:Ljava/util/List;
    ...
    invoke-virtual {v1, v6, v3}, Lkb/u;->b(I[Lkb/u;)V

    invoke-virtual {v13, v1}, Lkb/n;->z(Lkb/u;)V

    invoke-virtual {v2, v5}, Lorg/jsoup/parser/b;->M(Lkb/n;)V

    invoke-virtual {v2, v1}, Lorg/jsoup/parser/b;->b(Lkb/n;)V
    ...
    :goto_18
    invoke-virtual {v2, v5}, Lorg/jsoup/parser/b;->N(Lkb/n;)V
    ...
    invoke-virtual {v2, v8}, Lorg/jsoup/parser/b;->G(LB2/h;)Z
    ...
    iget-object v1, v2, Lorg/jsoup/parser/b;->p:Lkb/s;

    const/4 v3, 0x0

    iput-object v3, v2, Lorg/jsoup/parser/b;->p:Lkb/s;
    ...
    :cond_3d
    invoke-virtual {v2, v1}, Lorg/jsoup/parser/b;->N(Lkb/n;)V
    ...
    invoke-virtual {v2, v8, v0}, Lorg/jsoup/parser/b;->H(LB2/h;Lorg/jsoup/parser/C;)Z
    ...
    invoke-virtual {v2, v6}, Lorg/jsoup/parser/b;->r(Lorg/jsoup/parser/M;)Lkb/n;
    ...
    iput-object v8, v2, Lorg/jsoup/parser/b;->g:LB2/h;

    invoke-virtual {v0, v8, v2}, Lorg/jsoup/parser/C;->e(LB2/h;Lorg/jsoup/parser/b;)Z
    ...
    invoke-virtual {v2, v6}, Lorg/jsoup/parser/b;->v(Lorg/jsoup/parser/M;)Lkb/n;
    ...
    iget-object v0, v2, Lorg/jsoup/parser/b;->p:Lkb/s;
    ...
    iget-object v0, v6, Lorg/jsoup/parser/N;->m:Lkb/c;
    ...
    iget-object v4, v6, Lorg/jsoup/parser/N;->m:Lkb/c;

    if-eqz v4, :cond_8f

    invoke-virtual {v4, v1}, Lkb/c;->q(Ljava/lang/String;)I

    move-result v4

    if-eq v4, v3, :cond_8f

    iget-object v3, v6, Lorg/jsoup/parser/N;->m:Lkb/c;

    invoke-virtual {v3, v1}, Lkb/c;->n(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v3}, Lkb/c;->u(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v4}, Lkb/c;->q(Ljava/lang/String;)I
    ...
    invoke-virtual {v3, v4}, Lkb/c;->n(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v4}, Lorg/jsoup/parser/b;->G(LB2/h;)Z

    new-instance v3, Lkb/c;

    invoke-direct {v3}, Lkb/c;-><init>()V

    invoke-virtual {v6}, Lorg/jsoup/parser/N;->Q0()Z
    ...
    :cond_91
    :goto_24
    iget v5, v4, Lkb/c;->a:I

    if-ge v13, v5, :cond_92

    iget-object v5, v4, Lkb/c;->b:[Ljava/lang/String;

    aget-object v5, v5, v13

    invoke-static {v5}, Lkb/c;->t(Ljava/lang/String;)Z
    ...
    iget-object v6, v4, Lkb/c;->b:[Ljava/lang/String;

    aget-object v6, v6, v13

    iget-object v7, v4, Lkb/c;->c:[Ljava/lang/Object;

    aget-object v7, v7, v13

    check-cast v7, Ljava/lang/String;

    invoke-direct {v5, v6, v7, v4}, Lkb/a;-><init>(Ljava/lang/String;Ljava/lang/String;Lkb/c;)V

    const/4 v6, 0x1

    add-int/2addr v13, v6

    iget-object v6, v5, Lkb/a;->a:Ljava/lang/String;

    sget-object v7, Lorg/jsoup/parser/B;->n:[Ljava/lang/String;

    invoke-static {v6, v7}, Ljb/b;->c(Ljava/lang/String;[Ljava/lang/String;)Z

    move-result v6

    if-nez v6, :cond_91

    invoke-virtual {v3, v5}, Lkb/c;->v(Lkb/a;)V
    ...
    invoke-virtual {v3, v5, v4}, Lkb/c;->u(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v4, v2, Lorg/jsoup/parser/b;->g:LB2/h;
    ...
    iput-object v3, v4, Lorg/jsoup/parser/N;->m:Lkb/c;

    invoke-static {v6}, Lb2/o3;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_94
    invoke-virtual {v5}, Lorg/jsoup/parser/M;->U0()Lorg/jsoup/parser/N;

    iput-object v6, v5, Lorg/jsoup/parser/N;->c:Ljava/lang/String;

    iput-object v3, v5, Lorg/jsoup/parser/N;->m:Lkb/c;
    ...
    invoke-virtual {v2, v5}, Lorg/jsoup/parser/b;->G(LB2/h;)Z
    ...
    :pswitch_11
    iget-object v0, v2, Lorg/jsoup/parser/b;->d:Lkb/j;

    iget-object v0, v0, Lkb/j;->l:Lkb/i;

    sget-object v1, Lkb/i;->quirks:Lkb/i;
    ...
    invoke-virtual {v0, v1}, Lkb/u;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lorg/jsoup/parser/b;->l(Ljava/lang/String;)Lkb/n;
    ...
    invoke-virtual {v6, v0}, Lorg/jsoup/parser/N;->S0(Ljava/lang/String;)V

    invoke-virtual {v2, v6}, Lorg/jsoup/parser/b;->G(LB2/h;)Z
    ...
    invoke-virtual {v2, v0}, Lorg/jsoup/parser/b;->b(Lkb/n;)V
    ...
    iget-object v1, v6, Lorg/jsoup/parser/N;->m:Lkb/c;
    ...
    invoke-static {v2}, Lkb/c;->t(Ljava/lang/String;)Z
    ...
    iget-object v3, v1, Lkb/c;->b:[Ljava/lang/String;
    ...
    invoke-direct {v2, v3, v4, v1}, Lkb/a;-><init>(Ljava/lang/String;Ljava/lang/String;Lkb/c;)V

    const/4 v3, 0x1

    add-int/2addr v13, v3

    iget-object v3, v2, Lkb/a;->a:Ljava/lang/String;

    invoke-virtual {v0, v3}, Lkb/u;->l(Ljava/lang/String;)Z
    ...
    invoke-virtual {v3, v2}, Lkb/c;->v(Lkb/a;)V
    ...
    iget-object v3, v2, Lorg/jsoup/parser/b;->p:Lkb/s;
    ...
    invoke-virtual {v2, v4}, Lorg/jsoup/parser/b;->l(Ljava/lang/String;)Lkb/n;
    ...
    iget-object v4, v3, Lkb/n;->d:Lorg/jsoup/parser/F;
    ...
    :cond_a7
    iget-object v3, v3, Lkb/n;->d:Lorg/jsoup/parser/F;

    iget-object v4, v3, Lorg/jsoup/parser/F;->b:Ljava/lang/String;

    move-object/from16 v5, v22

    invoke-static {v4, v5}, Ljb/b;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-static {v3, v4}, Ljb/b;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-static {v8, v5}, Ljb/b;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v1}, Lorg/jsoup/parser/b;->l(Ljava/lang/String;)Lkb/n;

    move-result-object v0

    if-eqz v0, :cond_b4

    invoke-virtual {v2, v0}, Lorg/jsoup/parser/b;->M(Lkb/n;)V

    invoke-virtual {v2, v0}, Lorg/jsoup/parser/b;->N(Lkb/n;)V
...
.method public final f(LB2/h;Lorg/jsoup/parser/b;)Z
    .locals 6
    ...
    invoke-virtual {p2, p1}, Lorg/jsoup/parser/b;->l(Ljava/lang/String;)Lkb/n;
    ...
    iget-object v5, v4, Lkb/n;->d:Lorg/jsoup/parser/F;

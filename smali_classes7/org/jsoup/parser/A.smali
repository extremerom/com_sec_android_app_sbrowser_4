...
.method public final e(LB2/h;Lorg/jsoup/parser/b;)Z
    ...
    iget-object v0, p1, LB2/h;->b:Ljava/lang/Object;
    ...
    invoke-virtual {p2}, Lorg/jsoup/parser/b;->f()Lkb/n;
    ...
    invoke-virtual {p2, v0}, Lorg/jsoup/parser/b;->r(Lorg/jsoup/parser/M;)Lkb/n;
    ...
    invoke-static {v5, v6}, Ljb/b;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-static {v5, v4}, Ljb/b;->c(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-virtual {v0}, Lorg/jsoup/parser/N;->Q0()Z

    move-result v2

    if-eqz v2, :cond_d

    iget-object v2, v0, Lorg/jsoup/parser/N;->m:Lkb/c;

    const-string v3, "type"

    invoke-virtual {v2, v3}, Lkb/c;->n(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_c
    invoke-virtual {p2, v0}, Lorg/jsoup/parser/b;->v(Lorg/jsoup/parser/M;)Lkb/n;

    goto :goto_1

    :cond_d
    :goto_0
    invoke-virtual {p0, p1, p2}, Lorg/jsoup/parser/A;->f(LB2/h;Lorg/jsoup/parser/b;)V
    ...
    iget-object p0, p2, Lorg/jsoup/parser/b;->p:Lkb/s;
    ...
    invoke-static {v0, v4}, Ljb/b;->c(Ljava/lang/String;[Ljava/lang/String;)Z
...
.method public final f(LB2/h;Lorg/jsoup/parser/b;)V
    .locals 0

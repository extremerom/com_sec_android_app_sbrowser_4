...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lorg/chromium/network/mojom/SriMessageSignature;-><init>(I)V
...
.method public static decode(Lorg/chromium/mojo/bindings/Decoder;)Lorg/chromium/network/mojom/SriMessageSignature;
    .locals 9
    ...
    :try_start_0
    sget-object v1, Lorg/chromium/network/mojom/SriMessageSignature;->VERSION_ARRAY:[Lorg/chromium/mojo/bindings/DataHeader;
    ...
    new-instance v2, Lorg/chromium/network/mojom/SriMessageSignature;

    invoke-direct {v2, v1}, Lorg/chromium/network/mojom/SriMessageSignature;-><init>(I)V
    ...
    iput-object v4, v2, Lorg/chromium/network/mojom/SriMessageSignature;->label:Ljava/lang/String;
    ...
    iput-object v4, v2, Lorg/chromium/network/mojom/SriMessageSignature;->signature:[B
    ...
    new-array v6, v6, [Lorg/chromium/network/mojom/SriMessageSignatureComponent;

    iput-object v6, v2, Lorg/chromium/network/mojom/SriMessageSignature;->components:[Lorg/chromium/network/mojom/SriMessageSignatureComponent;
    ...
    invoke-static {v6, v7, v1, v4, v3}, Lcom/samsung/android/sdk/moneta/basicdomain/service/a;->i(IIILorg/chromium/mojo/bindings/Decoder;Z)Lorg/chromium/mojo/bindings/Decoder;

    move-result-object v7

    iget-object v8, v2, Lorg/chromium/network/mojom/SriMessageSignature;->components:[Lorg/chromium/network/mojom/SriMessageSignatureComponent;

    invoke-static {v7}, Lorg/chromium/network/mojom/SriMessageSignatureComponent;->decode(Lorg/chromium/mojo/bindings/Decoder;)Lorg/chromium/network/mojom/SriMessageSignatureComponent;
    ...
    iput-object v4, v2, Lorg/chromium/network/mojom/SriMessageSignature;->created:Ljava/lang/Long;

    goto :goto_1

    :cond_2
    iput-object v0, v2, Lorg/chromium/network/mojom/SriMessageSignature;->created:Ljava/lang/Long;
    ...
    iput-object v0, v2, Lorg/chromium/network/mojom/SriMessageSignature;->expires:Ljava/lang/Long;
    ...
    iput-object v0, v2, Lorg/chromium/network/mojom/SriMessageSignature;->keyid:Ljava/lang/String;
    ...
    iput-object v0, v2, Lorg/chromium/network/mojom/SriMessageSignature;->nonce:Ljava/lang/String;
    ...
    iput-object v0, v2, Lorg/chromium/network/mojom/SriMessageSignature;->tag:Ljava/lang/String;
    ...
    iput-object v0, v2, Lorg/chromium/network/mojom/SriMessageSignature;->serializedSignatureParams:Ljava/lang/String;
    :try_end_0
...
.method public static deserialize(Ljava/nio/ByteBuffer;)Lorg/chromium/network/mojom/SriMessageSignature;
    .locals 2
    ...
    invoke-static {v0}, Lorg/chromium/network/mojom/SriMessageSignature;->deserialize(Lorg/chromium/mojo/bindings/Message;)Lorg/chromium/network/mojom/SriMessageSignature;
...
.method public static deserialize(Lorg/chromium/mojo/bindings/Message;)Lorg/chromium/network/mojom/SriMessageSignature;
    .locals 1
    ...
    invoke-static {v0}, Lorg/chromium/network/mojom/SriMessageSignature;->decode(Lorg/chromium/mojo/bindings/Decoder;)Lorg/chromium/network/mojom/SriMessageSignature;

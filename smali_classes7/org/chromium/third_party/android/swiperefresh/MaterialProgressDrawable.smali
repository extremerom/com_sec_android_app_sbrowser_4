...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;)V
    ...
    iput-object v1, p0, Lorg/chromium/third_party/android/swiperefresh/MaterialProgressDrawable;->mAnimators:Ljava/util/ArrayList;

    new-instance v1, Lorg/chromium/third_party/android/swiperefresh/MaterialProgressDrawable$3;

    invoke-direct {v1, p0}, Lorg/chromium/third_party/android/swiperefresh/MaterialProgressDrawable$3;-><init>(Lorg/chromium/third_party/android/swiperefresh/MaterialProgressDrawable;)V

    iput-object v1, p0, Lorg/chromium/third_party/android/swiperefresh/MaterialProgressDrawable;->mCallback:Landroid/graphics/drawable/Drawable$Callback;
    ...
    iput-object p1, p0, Lorg/chromium/third_party/android/swiperefresh/MaterialProgressDrawable;->mResources:Landroid/content/res/Resources;

    new-instance p1, Lorg/chromium/third_party/android/swiperefresh/MaterialProgressDrawable$Ring;

    invoke-direct {p1, v1}, Lorg/chromium/third_party/android/swiperefresh/MaterialProgressDrawable$Ring;-><init>(Landroid/graphics/drawable/Drawable$Callback;)V

    iput-object p1, p0, Lorg/chromium/third_party/android/swiperefresh/MaterialProgressDrawable;->mRing:Lorg/chromium/third_party/android/swiperefresh/MaterialProgressDrawable$Ring;

    invoke-virtual {p1, v0}, Lorg/chromium/third_party/android/swiperefresh/MaterialProgressDrawable$Ring;->setColors([I)V

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, Lorg/chromium/third_party/android/swiperefresh/MaterialProgressDrawable;->updateSizes(I)V
...
.method private applyFinishTranslation(FLorg/chromium/third_party/android/swiperefresh/MaterialProgressDrawable$Ring;)V
    ...
    invoke-static {v2, p0, p1, v1}, Landroidx/appcompat/graphics/drawable/a;->a(FFFF)F
...
.method private getRotation()F
    ...
    iget p0, p0, Lorg/chromium/third_party/android/swiperefresh/MaterialProgressDrawable;->mRotation:F

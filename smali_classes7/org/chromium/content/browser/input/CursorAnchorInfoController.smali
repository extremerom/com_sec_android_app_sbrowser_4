...
.method private updateCursorAnchorInfo(Landroid/view/View;)V
    ...
    invoke-static {v6, v8, v10, v7, v5}, LE6/a;->y(Landroid/view/inputmethod/CursorAnchorInfo$Builder;FFFF)V
    ...
    invoke-static {}, Lorg/chromium/components/webauthn/cred_man/a;->h()Landroid/view/inputmethod/TextAppearanceInfo$Builder;
    ...
    invoke-static {v3, v4}, Lorg/chromium/components/webauthn/cred_man/a;->i(Landroid/view/inputmethod/TextAppearanceInfo$Builder;I)Landroid/view/inputmethod/TextAppearanceInfo$Builder;

    move-result-object v3

    invoke-static {v3}, Lorg/chromium/components/webauthn/cred_man/a;->j(Landroid/view/inputmethod/TextAppearanceInfo$Builder;)Landroid/view/inputmethod/TextAppearanceInfo;

    move-result-object v3

    invoke-static {v1, v3}, Lorg/chromium/components/webauthn/cred_man/a;->p(Landroid/view/inputmethod/CursorAnchorInfo$Builder;Landroid/view/inputmethod/TextAppearanceInfo;)V
    ...
    invoke-static {}, Landroidx/compose/ui/text/android/a;->f()Landroid/view/inputmethod/EditorBoundsInfo$Builder;
    ...
    invoke-static {v5, v6}, Landroidx/compose/ui/text/android/a;->g(Landroid/view/inputmethod/EditorBoundsInfo$Builder;Landroid/graphics/RectF;)Landroid/view/inputmethod/EditorBoundsInfo$Builder;
    ...
    invoke-static {v3, v5}, Landroidx/compose/ui/text/android/a;->r(Landroid/view/inputmethod/EditorBoundsInfo$Builder;Landroid/graphics/RectF;)Landroid/view/inputmethod/EditorBoundsInfo$Builder;

    move-result-object v1

    invoke-static {v1}, Landroidx/compose/ui/text/android/a;->h(Landroid/view/inputmethod/EditorBoundsInfo$Builder;)Landroid/view/inputmethod/EditorBoundsInfo;

    move-result-object v1

    invoke-static {v4, v1}, Lorg/chromium/components/stylus_handwriting/a;->d(Landroid/view/inputmethod/CursorAnchorInfo$Builder;Landroid/view/inputmethod/EditorBoundsInfo;)V

...
.field private static final PERMISSION_ACCESS_ADSERVICES_ATTRIBUTION:Ljava/lang/String; = "android.permission.ACCESS_ADSERVICES_ATTRIBUTION"

.field private static final TAG:Ljava/lang/String; = "AttributionManager"

.field private static sManagerForTesting:Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;


# instance fields
.field private mManager:Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;
...
.method public static synthetic a()V
    ...
    invoke-static {}, Lorg/chromium/content/browser/AttributionOsLevelManager;->lambda$setManagerForTesting$1()V

    return-void
.end method

.method private addRegistrationFutureCallback(IILcom/google/common/util/concurrent/B;)V
    .locals 1
    ...
    invoke-static {p3, v0, p0}, Lb2/j2;->c(Lcom/google/common/util/concurrent/B;Lcom/google/common/util/concurrent/v;Ljava/util/concurrent/Executor;)V
...
.method private static addWebSourceParams(Ljava/util/List;Lorg/chromium/url/GURL;Z)V
    ...
    :cond_0
    new-instance v0, Landroidx/privacysandbox/ads/adservices/measurement/WebSourceParams;
    ...
    invoke-direct {v0, p1, p2}, Landroidx/privacysandbox/ads/adservices/measurement/WebSourceParams;-><init>(Landroid/net/Uri;Z)V
...
.method private static addWebTriggerParams(Ljava/util/List;Lorg/chromium/url/GURL;Z)V
    ...
    :cond_0
    new-instance v0, Landroidx/privacysandbox/ads/adservices/measurement/WebTriggerParams;
    ...
    invoke-direct {v0, p1, p2}, Landroidx/privacysandbox/ads/adservices/measurement/WebTriggerParams;-><init>(Landroid/net/Uri;Z)V
...
.method public static synthetic b()V
    ...
    invoke-static {}, Lorg/chromium/content/browser/AttributionOsLevelManager;->lambda$setManagerForTesting$0()V
...
.method public static synthetic c()V
    ...
    invoke-static {}, Lorg/chromium/content/browser/AttributionOsLevelManager;->lambda$setManagerForTesting$2()V
...
.method private static convertToOperationResult(Ljava/lang/Throwable;)I
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/device/a;->y(Ljava/lang/Throwable;)Z
...
.method public static bridge synthetic d(Lorg/chromium/content/browser/AttributionOsLevelManager;I)V
    .locals 0
...
.method private deleteRegistrations(IJJ[Lorg/chromium/url/GURL;[Ljava/lang/String;II)V
    ...
    :cond_0
    invoke-direct {p0}, Lorg/chromium/content/browser/AttributionOsLevelManager;->getManager()Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;
    ...
    invoke-static {v2, v4}, Lcom/google/common/collect/P;->A(Ljava/lang/Object;Ljava/lang/Object;)Lcom/google/common/collect/B0;
    ...
    invoke-static {v2}, Lcom/google/common/collect/P;->z(Ljava/lang/Object;)Lcom/google/common/collect/B0;
    ...
    :cond_6
    iget v1, v2, Lcom/google/common/collect/B0;->d:I
    ...
    invoke-virtual {v2, v6}, Lcom/google/common/collect/P;->v(I)Lcom/google/common/collect/N;
    ...
    new-instance v2, Landroidx/privacysandbox/ads/adservices/measurement/DeletionRequest;
    ...
    invoke-direct/range {v7 .. v13}, Landroidx/privacysandbox/ads/adservices/measurement/DeletionRequest;-><init>(IILjava/time/Instant;Ljava/time/Instant;Ljava/util/List;Ljava/util/List;)V

    invoke-virtual {v3, v2}, Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;->deleteRegistrationsAsync(Landroidx/privacysandbox/ads/adservices/measurement/DeletionRequest;)Lcom/google/common/util/concurrent/B;
    ...
    new-instance v7, Lcom/google/common/util/concurrent/w;

    const/4 v8, 0x0

    invoke-direct {v7, v8, v2, v5}, Lcom/google/common/util/concurrent/w;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-interface {v2, v7, v6}, Lcom/google/common/util/concurrent/B;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method public static bridge synthetic e(Lorg/chromium/content/browser/AttributionOsLevelManager;III)V
    .locals 0
...
.method public static bridge synthetic f(Ljava/lang/Throwable;)I
    .locals 0
...
.method public static bridge synthetic g(II)V
    .locals 0
...
.method private getManager()Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;
    .locals 3
    ...
    :cond_0
    sget-object v0, Lorg/chromium/content/browser/AttributionOsLevelManager;->sManagerForTesting:Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;
    ...
    :cond_1
    iget-object v0, p0, Lorg/chromium/content/browser/AttributionOsLevelManager;->mManager:Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;
    ...
    iput-object v0, p0, Lorg/chromium/content/browser/AttributionOsLevelManager;->mManager:Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;
    :try_end_0
    ...
    :goto_0
    iget-object p0, p0, Lorg/chromium/content/browser/AttributionOsLevelManager;->mManager:Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;
...
.method private static getMeasurementApiStatus()V
    ...
    sget-object v1, Lorg/chromium/content/browser/AttributionOsLevelManager;->sManagerForTesting:Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;
    ...
    :cond_3
    :try_start_1
    invoke-virtual {v3}, Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;->getMeasurementApiStatusAsync()Lcom/google/common/util/concurrent/B;
    ...
    invoke-static {v1, v0, v2}, Lb2/j2;->c(Lcom/google/common/util/concurrent/B;Lcom/google/common/util/concurrent/v;Ljava/util/concurrent/Executor;)V
...
.method private static synthetic lambda$setManagerForTesting$0()V
    .locals 0

    invoke-static {}, Lorg/chromium/content/browser/AttributionOsLevelManager;->getMeasurementApiStatus()V

    return-void
.end method

.method private static synthetic lambda$setManagerForTesting$1()V
    .locals 0
...
.method private static synthetic lambda$setManagerForTesting$2()V
    .locals 2

    const/4 v0, 0x0

    sput-object v0, Lorg/chromium/content/browser/AttributionOsLevelManager;->sManagerForTesting:Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;

    new-instance v0, Lorg/chromium/content/browser/b;

    const/4 v1, 0x3

    invoke-direct {v0, v1}, Lorg/chromium/content/browser/b;-><init>(I)V
...
.method private registerAttributionSource(I[Lorg/chromium/url/GURL;Landroid/view/MotionEvent;)V
    ...
    :cond_2
    new-instance p2, Landroidx/privacysandbox/ads/adservices/measurement/SourceRegistrationRequest;

    invoke-direct {p2, v2, p3}, Landroidx/privacysandbox/ads/adservices/measurement/SourceRegistrationRequest;-><init>(Ljava/util/List;Landroid/view/InputEvent;)V

    invoke-virtual {v0, p2}, Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;->registerSourceAsync(Landroidx/privacysandbox/ads/adservices/measurement/SourceRegistrationRequest;)Lcom/google/common/util/concurrent/B;

    move-result-object p2

    invoke-direct {p0, p1, v1, p2}, Lorg/chromium/content/browser/AttributionOsLevelManager;->addRegistrationFutureCallback(IILcom/google/common/util/concurrent/B;)V
...
.method private registerAttributionTrigger(ILorg/chromium/url/GURL;)V
    ...
    invoke-virtual {v0, p2}, Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;->registerTriggerAsync(Landroid/net/Uri;)Lcom/google/common/util/concurrent/B;
...
.method private registerWebAttributionSource(ILjava/util/List;Lorg/chromium/url/GURL;Landroid/view/MotionEvent;)V
    ...
    :cond_1
    new-instance v9, Landroidx/privacysandbox/ads/adservices/measurement/WebSourceRegistrationRequest;
    ...
    invoke-virtual {v0, v9}, Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;->registerWebSourceAsync(Landroidx/privacysandbox/ads/adservices/measurement/WebSourceRegistrationRequest;)Lcom/google/common/util/concurrent/B;
...
.method private registerWebAttributionTrigger(ILjava/util/List;Lorg/chromium/url/GURL;)V
    ...
    :cond_1
    new-instance v2, Landroidx/privacysandbox/ads/adservices/measurement/WebTriggerRegistrationRequest;
    ...
    invoke-direct {v2, p2, p3}, Landroidx/privacysandbox/ads/adservices/measurement/WebTriggerRegistrationRequest;-><init>(Ljava/util/List;Landroid/net/Uri;)V

    invoke-virtual {v0, v2}, Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;->registerWebTriggerAsync(Landroidx/privacysandbox/ads/adservices/measurement/WebTriggerRegistrationRequest;)Lcom/google/common/util/concurrent/B;
...
.method public static setManagerForTesting(Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;)V
    .locals 1

    sput-object p0, Lorg/chromium/content/browser/AttributionOsLevelManager;->sManagerForTesting:Landroidx/privacysandbox/ads/adservices/java/measurement/MeasurementManagerFutures;

...
.method public getBoundConnection(Lorg/chromium/base/process_launcher/ChildConnectionAllocator;Lorg/chromium/base/process_launcher/ChildProcessConnection$ServiceCallback;)Lorg/chromium/base/process_launcher/ChildProcessConnection;
    ...
    invoke-static {v0}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->l(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)Z
    ...
    invoke-static {p0}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->p(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)Z

    move-result p0

    if-eqz p0, :cond_1

    invoke-static {}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->v()Lorg/chromium/content/browser/SpareChildConnection;
...
.method public onBeforeConnectionAllocated(Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->A(Landroid/os/Bundle;)V
...
.method public onBeforeConnectionSetup(Landroid/os/Bundle;)V
    ...
    invoke-static {}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->w()Landroid/os/Bundle;
...
.method public onConnectionEstablished(Lorg/chromium/base/process_launcher/ChildProcessConnection;)V
    ...
    invoke-static {}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->t()Ljava/util/Map;
    ...
    invoke-static {v0}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->n(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)Lorg/chromium/content/browser/ChildProcessRanking;
    ...
    invoke-static {v0}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->k(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)Lorg/chromium/content/browser/BindingManager;
    ...
    invoke-static {v0}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->p(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)Z
    ...
    invoke-static {v0}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->r(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)V

    :cond_2
    iget-object v0, p0, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl$1;->this$0:Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;

    invoke-static {v0}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->m(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)J
    ...
    invoke-static {v1}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->m(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)J
    ...
    invoke-static {p0}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->q(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)V
...
.method public onConnectionLost(Lorg/chromium/base/process_launcher/ChildProcessConnection;)V
    ...
    invoke-static {v0}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->z(I)V
...
.method public onReceivedZygoteInfo(Lorg/chromium/base/process_launcher/ChildProcessConnection;Landroid/os/Bundle;)V
    ...
    invoke-static {p1, p2}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->y(Lorg/chromium/base/process_launcher/ChildProcessConnection;Landroid/os/Bundle;)V

...
.field private static final TAG:Ljava/lang/String; = "WebContentsImpl"
...
.method public static bridge synthetic b(Lorg/chromium/content/browser/webcontents/WebContentsImpl;)Lorg/chromium/content_public/browser/StylusWritingHandler;
    .locals 0
...
.method public static bridge synthetic d()Ljava/util/UUID;
    .locals 1
...
.method public addMessageToDevToolsConsole(ILjava/lang/String;)V
    ...
    invoke-interface {v0, v1, v2, p1, p2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->addMessageToDevToolsConsole(JILjava/lang/String;)V
...
.method public captureContentAsBitmapForTesting(Lorg/chromium/base/Callback;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v0, v1, v2, p1}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->captureContentAsBitmapForTesting(JLorg/chromium/base/Callback;)V
...
.method public clearJavaWebContentsObservers()V
    .locals 1
    ...
    invoke-virtual {v0}, Lorg/chromium/content/browser/webcontents/WebContentsObserverProxy;->webContentsDestroyed()V
...
.method public clearNativeReference()V
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->clearNativeReference(J)V
...
.method public destroy()V
    ...
    invoke-virtual {v0}, Lorg/chromium/content/browser/webcontents/WebContentsObserverProxy;->isHandlingObserverCall()Z
    ...
    const-string v0, "Attempting to destroy WebContents while handling observer calls"
    ...
    const-string v0, "Attempting to destroy WebContents on non-UI thread"
...
.method public dispatchBeforeUnload(Z)V
    ...
    invoke-interface {v0, v1, v2, p1}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->dispatchBeforeUnload(JZ)V
...
.method public focusLocationBarByDefault()Z
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->focusLocationBarByDefault(J)Z
...
.method public getAllRenderFrameHosts()Ljava/util/List;
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->getAllRenderFrameHosts(J)[Lorg/chromium/content_public/browser/RenderFrameHost;
...
.method public getBackgroundColor()I
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->getBackgroundColor(J)I
...
.method public getCurrentBackForwardTransitionStage()I
    .locals 3
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->getCurrentBackForwardTransitionStage(J)I
...
.method public getEncoding()Ljava/lang/String;
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->getEncoding(J)Ljava/lang/String;
...
.method public getFocusedFrame()Lorg/chromium/content_public/browser/RenderFrameHost;
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->getFocusedFrame(J)Lorg/chromium/content_public/browser/RenderFrameHost;
...
.method public getHeight()I
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->getHeight(J)I
...
.method public getLoadProgress()F
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->getLoadProgress(J)F
...
.method public getRenderFrameHostFromId(Lorg/chromium/content_public/browser/GlobalRenderFrameHostId;)Lorg/chromium/content_public/browser/RenderFrameHost;
    .locals 3
    ...
    invoke-virtual {p1}, Lorg/chromium/content_public/browser/GlobalRenderFrameHostId;->childId()I

    move-result p0

    invoke-virtual {p1}, Lorg/chromium/content_public/browser/GlobalRenderFrameHostId;->frameRoutingId()I

    move-result p1

    invoke-interface {v0, v1, v2, p0, p1}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->getRenderFrameHostFromId(JII)Lorg/chromium/content_public/browser/RenderFrameHost;
...
.method public getWidth()I
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->getWidth(J)I
...
.method public hasAccessedInitialDocument()Z
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->hasAccessedInitialDocument(J)Z
...
.method public hasUncommittedNavigationInPrimaryMainFrame()Z
    .locals 3
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->hasUncommittedNavigationInPrimaryMainFrame(J)Z
...
.method public hasViewTransitionOptIn()Z
    .locals 3
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->hasViewTransitionOptIn(J)Z
...
.method public initializeForTesting()V
    .locals 2
    ...
    iput-object v0, p0, Lorg/chromium/content/browser/webcontents/WebContentsImpl;->mInternalsHolder:Lorg/chromium/content_public/browser/WebContents$InternalsHolder;
    ...
    new-instance v0, Lorg/chromium/content/browser/webcontents/WebContentsImpl$WebContentsInternalsImpl;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$WebContentsInternalsImpl;-><init>(I)V

    :cond_1
    iget-object v1, p0, Lorg/chromium/content/browser/webcontents/WebContentsImpl;->mInternalsHolder:Lorg/chromium/content_public/browser/WebContents$InternalsHolder;

    invoke-interface {v1, v0}, Lorg/chromium/content_public/browser/WebContents$InternalsHolder;->set(Lorg/chromium/content_public/browser/WebContentsInternals;)V

    const/4 v0, 0x1

    iput-boolean v0, p0, Lorg/chromium/content/browser/webcontents/WebContentsImpl;->mInitialized:Z
...
.method public isAudioMuted()Z
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->isAudioMuted(J)Z
...
.method public isFocusedElementEditable()Z
    .locals 3
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->isFocusedElementEditable(J)Z
...
.method public isFullscreenForCurrentTab()Z
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->isFullscreenForCurrentTab(J)Z
...
.method public isLoading()Z
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->isLoading(J)Z
...
.method public needToFireBeforeUnloadOrUnloadEvents()Z
    .locals 4
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->needToFireBeforeUnloadOrUnloadEvents(J)Z
...
.method public notifyBrowserControlsHeightChanged()V
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->notifyBrowserControlsHeightChanged(J)V
...
.method public onContentForNavigationEntryShown()V
    .locals 3
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->onContentForNavigationEntryShown(J)V
...
.method public resumeLoadingCreatedWebContents()V
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->resumeLoadingCreatedWebContents(J)V
...
.method public selectAroundCaret(IZZIII)V
    .locals 9
    ...
    invoke-interface/range {v0 .. v8}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->selectAroundCaret(JIZZIII)V
...
.method public setAudioMuted(Z)V
    ...
    invoke-interface {v0, v1, v2, p1}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->setAudioMuted(JZ)V

    return-void
.end method

.method public setContextMenuInsets(Landroid/graphics/Rect;)V
    .locals 8
    ...
    invoke-interface/range {v1 .. v7}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->setContextMenuInsets(JIIII)V
...
.method public setDisplayCutoutSafeArea(Landroid/graphics/Rect;)V
    ...
    invoke-interface/range {v1 .. v7}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->setDisplayCutoutSafeArea(JIIII)V
...
.method public setLongPressLinkSelectText(Z)V
    .locals 3
    ...
    invoke-interface {v0, v1, v2, p1}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->setLongPressLinkSelectText(JZ)V
...
.method public setSpatialNavigationDisabled(Z)V
    ...
    invoke-interface {v0, v1, v2, p1}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->setSpatialNavigationDisabled(JZ)V
...
.method public setSupportsForwardTransitionAnimation(Z)V
    .locals 3
    ...
    invoke-interface {v0, v1, v2, p1}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->setSupportsForwardTransitionAnimation(JZ)V
...
.method public setUserDataForTesting(Ljava/lang/Class;Lorg/chromium/base/UserData;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T::",
    ...
    invoke-virtual {p0, p1, p2}, Lorg/chromium/base/UserDataHost;->setUserData(Ljava/lang/Class;Lorg/chromium/base/UserData;)Lorg/chromium/base/UserData;

    return-void
.end method

.method public shouldShowLoadingUI()Z
    .locals 3
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->shouldShowLoadingUI(J)Z
...
.method public simulateRendererKilledForTesting()V
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lorg/chromium/content/browser/webcontents/WebContentsObserverProxy;->primaryMainFrameRenderProcessGone(I)V
...
.method public suspendAllMediaPlayers()V
    ...
    invoke-interface {v0, v1, v2}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->suspendAllMediaPlayers(J)V
...
.method public tearDownDialogOverlays()V
    .locals 1
...
.method public updateOffsetTagDefinitions(Lorg/chromium/ui/BrowserControlsOffsetTagDefinitions;)V
    .locals 4
    ...
    invoke-interface {v0, v1, v2, p1}, Lorg/chromium/content/browser/webcontents/WebContentsImpl$Natives;->updateOffsetTagDefinitions(JLorg/chromium/ui/BrowserControlsOffsetTagDefinitions;)V

...
.field private static final REDUCE_PRIORITY_ON_BACKGROUND_DELAY_MS:I = 0x2328

.field private static final REMOVE_BINDING_DELAY_MS:I = 0x1f4

.field private static final TAG:Ljava/lang/String; = "ChildProcLH"

.field private static final TIMEOUT_FOR_DELAY_BINDING_REMOVE_MS:I = 0x3e8

.field private static final TRACE_EARLY_JAVA_IN_CHILD_SWITCH:Ljava/lang/String; = "--trace-early-java-in-child"
...
.method private constructor <init>(J[Ljava/lang/String;[Lorg/chromium/base/process_launcher/FileDescriptorInfo;ZZZLandroid/os/IBinder;Landroid/os/IBinder;)V
    ...
    iput v2, v0, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->mEffectiveImportance:I

    move-wide v5, p1

    iput-wide v5, v0, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->mNativeChildProcessLauncherHelper:J

    iput-boolean v1, v0, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->mSandboxed:Z

    move/from16 v3, p6

    iput-boolean v3, v0, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->mReducePriorityOnBackground:Z

    move/from16 v3, p7

    iput-boolean v3, v0, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->mCanUseWarmUpConnection:Z

    invoke-static {}, Lorg/chromium/base/ContextUtils;->getApplicationContext()Landroid/content/Context;

    move-result-object v3

    invoke-static {v3, v1}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->getConnectionAllocator(Landroid/content/Context;Z)Lorg/chromium/base/process_launcher/ChildConnectionAllocator;

    move-result-object v7

    new-instance v10, Lorg/chromium/base/process_launcher/ChildProcessLauncher;
    ...
    iput-object v10, v0, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->mLauncher:Lorg/chromium/base/process_launcher/ChildProcessLauncher;

    const-string v2, "type"

    move-object v3, p3

    invoke-static {p3, v2}, Lorg/chromium/content/common/ContentSwitchUtils;->getSwitchValue([Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    iput-object v11, v0, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->mRanking:Lorg/chromium/content/browser/ChildProcessRanking;

    iput-object v11, v0, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->mBindingManager:Lorg/chromium/content/browser/BindingManager;
...
.method public static bridge synthetic A(Landroid/os/Bundle;)V
    .locals 0
...
.method public static createAndStartForTesting([Ljava/lang/String;[Lorg/chromium/base/process_launcher/FileDescriptorInfo;ZZZLandroid/os/IBinder;Z)Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;
    .locals 11
    ...
    invoke-direct/range {v0 .. v9}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;-><init>(J[Ljava/lang/String;[Lorg/chromium/base/process_launcher/FileDescriptorInfo;ZZZLandroid/os/IBinder;Landroid/os/IBinder;)V

    iget-object v0, v10, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->mLauncher:Lorg/chromium/base/process_launcher/ChildProcessLauncher;

    const/4 v1, 0x1

    move/from16 v2, p6

    invoke-virtual {v0, v2, v1}, Lorg/chromium/base/process_launcher/ChildProcessLauncher;->start(ZZ)Z

    return-object v10
.end method

.method public static synthetic d(Landroid/os/Handler;Lorg/chromium/base/Callback;)V
    .locals 0

    invoke-static {p0, p1}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->lambda$getProcessIdsByType$8(Landroid/os/Handler;Lorg/chromium/base/Callback;)V
...
.method public static synthetic f(ILorg/chromium/base/process_launcher/ChildProcessConnection;)V
    .locals 0
...
.method public static getConnectionAllocator(Landroid/content/Context;Z)Lorg/chromium/base/process_launcher/ChildConnectionAllocator;
    ...
    new-instance v2, Lorg/chromium/content/browser/b;

    const/16 v0, 0x8

    invoke-direct {v2, v0}, Lorg/chromium/content/browser/b;-><init>(I)V
...
.method public static getProcessIdsByType(Lorg/chromium/base/Callback;)V
    ...
    invoke-direct {v1, v2, v0, p0}, Lorg/chromium/content/browser/j;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method private getProcessType()Ljava/lang/String;
    ...
    :cond_0
    iget-object p0, p0, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->mProcessType:Ljava/lang/String;
...
.method private getTerminationInfoAndStop(J)V
    ...
    new-instance v3, Lorg/chromium/content/browser/k;

    const/4 v4, 0x1

    invoke-direct {v3, v1, v4}, Lorg/chromium/content/browser/k;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance p1, Lorg/chromium/content/browser/k;

    const/4 p2, 0x2

    invoke-direct {p1, p0, p2}, Lorg/chromium/content/browser/k;-><init>(Ljava/lang/Object;I)V
...
.method public static getWarmUpConnectionForTesting()Lorg/chromium/base/process_launcher/ChildProcessConnection;
    .locals 1
    ...
    :cond_0
    invoke-virtual {v0}, Lorg/chromium/content/browser/SpareChildConnection;->getConnection()Lorg/chromium/base/process_launcher/ChildProcessConnection;
...
.method public static synthetic j(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)V
    .locals 0
...
.method public static bridge synthetic k(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)Lorg/chromium/content/browser/BindingManager;
    .locals 0
...
.method public static bridge synthetic l(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)Z
    .locals 0
...
.method private static synthetic lambda$getProcessIdsByType$8(Landroid/os/Handler;Lorg/chromium/base/Callback;)V
    .locals 5
    ...
    check-cast v3, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;

    invoke-direct {v3}, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->getProcessType()Ljava/lang/String;
...
.method public static bridge synthetic m(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)J
    .locals 2
...
.method public static bridge synthetic n(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)Lorg/chromium/content/browser/ChildProcessRanking;
    .locals 0
...
.method public static bridge synthetic p(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)Z
    .locals 0
...
.method public static bridge synthetic r(Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;)V
    .locals 0
...
.method public static bridge synthetic s()Lorg/chromium/content/browser/BindingManager;
    .locals 1
...
.method public static setIgnoreMainFrameVisibilityForImportance()V
    ...
    sput-boolean v0, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->sIgnoreMainFrameVisibilityForImportance:Z
...
.method public static setSkipDelayForReducePriorityOnBackgroundForTesting()V
    .locals 1

    const/4 v0, 0x1

    sput-boolean v0, Lorg/chromium/content/browser/ChildProcessLauncherHelperImpl;->sSkipDelayForReducePriorityOnBackgroundForTesting:Z
...
.method public static bridge synthetic u()Lorg/chromium/content/browser/ChildProcessRanking;
    .locals 1
...
.method public static bridge synthetic v()Lorg/chromium/content/browser/SpareChildConnection;
    .locals 1
...
.method public static bridge synthetic w()Landroid/os/Bundle;
    .locals 1
...
.method public static bridge synthetic x(Lorg/chromium/content/browser/BindingManager;)V
    .locals 0
...
.method public static bridge synthetic y(Lorg/chromium/base/process_launcher/ChildProcessConnection;Landroid/os/Bundle;)V
    .locals 0
...
.method public static bridge synthetic z(I)V
    .locals 0
...
.method public getChildConnectionAllocatorForTesting()Lorg/chromium/base/process_launcher/ChildConnectionAllocator;
    ...
    invoke-virtual {p0}, Lorg/chromium/base/process_launcher/ChildProcessLauncher;->getConnectionAllocator()Lorg/chromium/base/process_launcher/ChildConnectionAllocator;
...
.method public setPriority(IZZZZJZZZZI)V
    ...
    new-instance v2, Lorg/chromium/base/process_launcher/c;

    invoke-direct {v2, v1, v8}, Lorg/chromium/base/process_launcher/c;-><init>(ILorg/chromium/base/process_launcher/ChildProcessConnection;)V
    ...
    :cond_10
    invoke-virtual {v2}, Lorg/chromium/base/process_launcher/c;->run()V

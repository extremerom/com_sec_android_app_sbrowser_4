...
.method public onClassified(Lorg/chromium/content_public/browser/SelectionClient$Result;)V
    ...
    :cond_2
    invoke-static {v1}, Lorg/chromium/content/browser/selection/SelectionPopupControllerImpl;->k(Lorg/chromium/content/browser/selection/SelectionPopupControllerImpl;)Lorg/chromium/content/browser/selection/SmartSelectionEventProcessor;
    ...
    invoke-static {p1}, Lorg/chromium/content/browser/selection/SelectionPopupControllerImpl;->k(Lorg/chromium/content/browser/selection/SelectionPopupControllerImpl;)Lorg/chromium/content/browser/selection/SmartSelectionEventProcessor;

    move-result-object p1

    iget-object v0, p0, Lorg/chromium/content/browser/selection/SelectionPopupControllerImpl$SmartSelectionCallback;->this$0:Lorg/chromium/content/browser/selection/SelectionPopupControllerImpl;

    invoke-static {v0}, Lorg/chromium/content/browser/selection/SelectionPopupControllerImpl;->h(Lorg/chromium/content/browser/selection/SelectionPopupControllerImpl;)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lorg/chromium/content/browser/selection/SelectionPopupControllerImpl$SmartSelectionCallback;->this$0:Lorg/chromium/content/browser/selection/SelectionPopupControllerImpl;

    invoke-static {v1}, Lorg/chromium/content/browser/selection/SelectionPopupControllerImpl;->i(Lorg/chromium/content/browser/selection/SelectionPopupControllerImpl;)I
    ...
    invoke-static {p0}, Lorg/chromium/content/browser/selection/SelectionPopupControllerImpl;->n(Lorg/chromium/content/browser/selection/SelectionPopupControllerImpl;)V

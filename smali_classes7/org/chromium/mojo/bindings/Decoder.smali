...
.method private static readBitfield(IILjava/nio/ByteBuffer;)[Z
    .locals 5
    ...
    invoke-static {v1, v2, p1}, Lorg/chromium/mojo/bindings/BindingsHelper;->computeBitfieldSize(JI)I
...
.method private readDataHeaderForArray(JIZ)Lorg/chromium/mojo/bindings/DataHeader;
    ...
    invoke-static {p3, p2, p4}, LJ7/b;->q(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p2, p0, p3}, LJ7/b;->m(Ljava/lang/StringBuilder;ILjava/lang/String;)Ljava/lang/String;
...
.method public readBooleanNullables(III)[Ljava/lang/Boolean;
    .locals 3
    ...
    invoke-direct {p0, p3, p2}, Lorg/chromium/mojo/bindings/Decoder;->readDataHeaderForBooleanArray(IZ)Lorg/chromium/mojo/bindings/DataHeader;
    ...
    iget v0, p3, Lorg/chromium/mojo/bindings/DataHeader;->elementsOrVersion:I
    ...
    invoke-static {p2, v0, v1}, Lorg/chromium/mojo/bindings/Decoder;->readBitfield(IILjava/nio/ByteBuffer;)[Z

    move-result-object v0

    iget v1, p3, Lorg/chromium/mojo/bindings/DataHeader;->elementsOrVersion:I
    ...
    invoke-static {p2, v1, p0}, Lorg/chromium/mojo/bindings/Decoder;->readBitfield(IILjava/nio/ByteBuffer;)[Z

    move-result-object p0

    iget p2, p3, Lorg/chromium/mojo/bindings/DataHeader;->elementsOrVersion:I
    ...
    :goto_0
    iget v2, p3, Lorg/chromium/mojo/bindings/DataHeader;->elementsOrVersion:I
...
.method public readByteNullables(III)[Ljava/lang/Byte;
    .locals 3
    ...
    invoke-direct {p0, v0, v1, p3, p2}, Lorg/chromium/mojo/bindings/Decoder;->readDataHeaderForArray(JIZ)Lorg/chromium/mojo/bindings/DataHeader;
    ...
    iget p0, p3, Lorg/chromium/mojo/bindings/DataHeader;->elementsOrVersion:I
...
.method public readConsumerHandles(III)[Lorg/chromium/mojo/system/DataPipe$ConsumerHandle;
    ...
    invoke-virtual {p0, v1, v2}, Lorg/chromium/mojo/bindings/Decoder;->readConsumerHandle(IZ)Lorg/chromium/mojo/system/DataPipe$ConsumerHandle;
...
.method public readDoubleNullables(III)[Ljava/lang/Double;
    .locals 4
    ...
    iget-object p3, p0, Lorg/chromium/mojo/bindings/Decoder;->mMessage:Lorg/chromium/mojo/bindings/Message;
    ...
    invoke-static {v1, p3, v0}, Lorg/chromium/mojo/bindings/Decoder;->readBitfield(IILjava/nio/ByteBuffer;)[Z

    move-result-object p3

    iget v0, p2, Lorg/chromium/mojo/bindings/DataHeader;->elementsOrVersion:I
    ...
    :goto_0
    iget v2, p2, Lorg/chromium/mojo/bindings/DataHeader;->elementsOrVersion:I
...
.method public readFloatNullables(III)[Ljava/lang/Float;
    .locals 3
...
.method public readHandles(III)[Lorg/chromium/mojo/system/Handle;
    ...
    invoke-virtual {p0, v1, v2}, Lorg/chromium/mojo/bindings/Decoder;->readHandle(IZ)Lorg/chromium/mojo/system/Handle;
...
.method public readIntNullables(III)[Ljava/lang/Integer;
    .locals 3
...
.method public readLongNullables(III)[Ljava/lang/Long;
    .locals 4
...
.method public readMessagePipeHandles(III)[Lorg/chromium/mojo/system/MessagePipeHandle;
    ...
    invoke-virtual {p0, v1, v2}, Lorg/chromium/mojo/bindings/Decoder;->readMessagePipeHandle(IZ)Lorg/chromium/mojo/system/MessagePipeHandle;
...
.method public readProducerHandles(III)[Lorg/chromium/mojo/system/DataPipe$ProducerHandle;
    ...
    invoke-virtual {p0, v1, v2}, Lorg/chromium/mojo/bindings/Decoder;->readProducerHandle(IZ)Lorg/chromium/mojo/system/DataPipe$ProducerHandle;
...
.method public readSharedBufferHandles(III)[Lorg/chromium/mojo/system/SharedBufferHandle;
    ...
    invoke-virtual {p0, v1, v2}, Lorg/chromium/mojo/bindings/Decoder;->readSharedBufferHandle(IZ)Lorg/chromium/mojo/system/SharedBufferHandle;
...
.method public readShortNullables(III)[Ljava/lang/Short;
    .locals 3
...
.method public readUntypedHandles(III)[Lorg/chromium/mojo/system/UntypedHandle;
    ...
    invoke-virtual {p0, v1, v2}, Lorg/chromium/mojo/bindings/Decoder;->readUntypedHandle(IZ)Lorg/chromium/mojo/system/UntypedHandle;

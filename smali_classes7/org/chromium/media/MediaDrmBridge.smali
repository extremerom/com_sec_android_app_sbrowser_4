...
.field private static final CURRENT_HDCP_LEVEL:Ljava/lang/String; = "hdcpLevel"
...
.method private setPropertyStringForTesting(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 1
    ...
    const-string v0, "Failed to set property %s"

    invoke-static {p2, v0, p1, p0}, Lorg/chromium/base/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method private startProvisioningPreQ()Z
    .locals 10
    .annotation build Lorg/chromium/build/annotations/RequiresNonNull;
        value = {
            "mMediaDrm"
    ...
    iget-boolean v2, p0, Lorg/chromium/media/MediaDrmBridge;->mOriginSet:Z
    ...
    :goto_0
    const-string v3, "Provisioning origin ID %s"

    invoke-static {v0, v3, v2}, Lorg/chromium/base/Log;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    invoke-static {}, Lorg/chromium/media/MediaDrmBridgeJni;->get()Lorg/chromium/media/MediaDrmBridge$Natives;

    move-result-object v4

    iget-wide v5, p0, Lorg/chromium/media/MediaDrmBridge;->mNativeMediaDrmBridge:J
    ...
    invoke-interface/range {v4 .. v9}, Lorg/chromium/media/MediaDrmBridge$Natives;->onProvisionRequest(JLorg/chromium/media/MediaDrmBridge;Ljava/lang/String;[B)V
...
.method private startProvisioningQorLater(Z)Z
    ...
    invoke-static {v3}, Lorg/chromium/content/browser/input/c;->A(Landroid/media/MediaDrm$SessionException;)Z

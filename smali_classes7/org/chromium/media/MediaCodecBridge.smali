...
.field private static final MEDIA_CODEC_UNKNOWN_CIPHER_MODE:I = -0x1

.field private static final QUEUE_SECURE_INPUT_BLOCK_ERR_MSG:Ljava/lang/String; = "Failed to queue secure input block: "
...
.method private obtainBlock(I)Lorg/chromium/media/MediaCodecBridge$ObtainBlockResult;
    ...
    invoke-static {p1, p0}, Lcom/sec/android/app/sbrowser/common/device/a;->e(I[Ljava/lang/String;)Landroid/media/MediaCodec$LinearBlock;
    ...
    :try_start_1
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/device/a;->m(Landroid/media/MediaCodec$LinearBlock;)Ljava/nio/ByteBuffer;
    ...
    :try_start_2
    invoke-static {p1}, Lcom/sec/android/app/sbrowser/common/device/a;->n(Landroid/media/MediaCodec$LinearBlock;)V
    :try_end_2
...
.method private queueInputBlock(ILandroid/media/MediaCodec$LinearBlock;IIJI)I
    ...
    invoke-static {p0, p1}, Lcom/sec/android/app/sbrowser/common/device/a;->f(Landroid/media/MediaCodec;I)Landroid/media/MediaCodec$QueueRequest;

    move-result-object p0

    invoke-static {p0, p2, p3, p4}, Lcom/sec/android/app/sbrowser/common/device/a;->r(Landroid/media/MediaCodec$QueueRequest;Landroid/media/MediaCodec$LinearBlock;II)V

    invoke-static {p0, p5, p6}, Lcom/sec/android/app/sbrowser/common/device/a;->q(Landroid/media/MediaCodec$QueueRequest;J)V

    invoke-static {p0, p7}, Lcom/sec/android/app/sbrowser/common/device/a;->p(Landroid/media/MediaCodec$QueueRequest;I)V

    invoke-static {p0}, Lcom/sec/android/app/sbrowser/common/device/a;->o(Landroid/media/MediaCodec$QueueRequest;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private queueSecureInputBlock(ILandroid/media/MediaCodec$LinearBlock;II[B[B[I[IIIIIJI)I
    ...
    invoke-static {v0, p1}, Lcom/sec/android/app/sbrowser/common/device/a;->f(Landroid/media/MediaCodec;I)Landroid/media/MediaCodec$QueueRequest;
    ...
    invoke-static {v0, p2, v3, v4, v1}, Lcom/sec/android/app/sbrowser/common/device/a;->s(Landroid/media/MediaCodec$QueueRequest;Landroid/media/MediaCodec$LinearBlock;IILandroid/media/MediaCodec$CryptoInfo;)V

    move-wide/from16 v1, p13

    invoke-static {v0, v1, v2}, Lcom/sec/android/app/sbrowser/common/device/a;->q(Landroid/media/MediaCodec$QueueRequest;J)V

    move/from16 v1, p15

    invoke-static {v0, v1}, Lcom/sec/android/app/sbrowser/common/device/a;->p(Landroid/media/MediaCodec$QueueRequest;I)V

    invoke-static {v0}, Lcom/sec/android/app/sbrowser/common/device/a;->o(Landroid/media/MediaCodec$QueueRequest;)V
    :try_end_0
...
.method private setVideoBitrate(II)V
    ...
    invoke-static {v1, v2}, LJ7/b;->e(ILjava/lang/String;)Landroid/os/Bundle;

...
# static fields
.field private static final IS_AUTO_SELECT_ALLOWED:Ljava/lang/String; = "androidx.credentials.BUNDLE_KEY_IS_AUTO_SELECT_ALLOWED"

.field private static final TYPE_PASSWORD_CREDENTIAL:Ljava/lang/String; = "android.credentials.TYPE_PASSWORD_CREDENTIAL"
...
.method private getBasePublicKeyCredentialOptionBundle()Landroid/os/Bundle;
    ...
    invoke-static {v0, v1}, Landroidx/glance/oneui/template/layout/glance/a;->e(Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;
...
.method private getPasswordCredentialOption(Lorg/chromium/components/webauthn/cred_man/CredManRequestDecorator;)Landroid/credentials/CredentialOption;
    ...
    :cond_1
    invoke-static {v0, v0}, Lcom/sec/android/app/sbrowser/tab_bar/ui/i;->B(Landroid/os/Bundle;Landroid/os/Bundle;)Landroid/credentials/CredentialOption$Builder;
    ...
    :cond_2
    invoke-static {v0}, Lcom/sec/android/app/sbrowser/tab_bar/ui/i;->i(Landroid/credentials/CredentialOption$Builder;)Landroid/credentials/CredentialOption;
...
.method private getPublicKeyCredentialOption(Lorg/chromium/components/webauthn/cred_man/CredManRequestDecorator;)Landroid/credentials/CredentialOption;
    ...
    :cond_0
    invoke-static {v0, v0}, Lcom/sec/android/app/sbrowser/tab_bar/ui/i;->h(Landroid/os/Bundle;Landroid/os/Bundle;)Landroid/credentials/CredentialOption$Builder;

    move-result-object p0

    invoke-static {p0}, Lcom/sec/android/app/sbrowser/tab_bar/ui/i;->i(Landroid/credentials/CredentialOption$Builder;)Landroid/credentials/CredentialOption;
...
.method public static setInstanceForTesting(Lorg/chromium/components/webauthn/cred_man/CredManGetCredentialRequestHelper;)V
    .locals 0

    sput-object p0, Lorg/chromium/components/webauthn/cred_man/CredManGetCredentialRequestHelper;->sInstanceForTesting:Lorg/chromium/components/webauthn/cred_man/CredManGetCredentialRequestHelper;
...
.method public getGetCredentialRequest(Lorg/chromium/components/webauthn/cred_man/CredManRequestDecorator;)Landroid/credentials/GetCredentialRequest;
    ...
    invoke-static {v0}, Lcom/sec/android/app/sbrowser/tab_bar/ui/i;->j(Landroid/os/Bundle;)Landroid/credentials/GetCredentialRequest$Builder;
    ...
    :cond_0
    invoke-static {v0, v1}, Lcom/sec/android/app/sbrowser/tab_bar/ui/i;->x(Landroid/credentials/GetCredentialRequest$Builder;Landroid/credentials/CredentialOption;)V

    if-eqz v2, :cond_1

    invoke-static {v0, v2}, Lcom/sec/android/app/sbrowser/tab_bar/ui/i;->x(Landroid/credentials/GetCredentialRequest$Builder;Landroid/credentials/CredentialOption;)V

    :cond_1
    invoke-static {v0}, Lcom/sec/android/app/sbrowser/tab_bar/ui/i;->k(Landroid/credentials/GetCredentialRequest$Builder;)Landroid/credentials/GetCredentialRequest;

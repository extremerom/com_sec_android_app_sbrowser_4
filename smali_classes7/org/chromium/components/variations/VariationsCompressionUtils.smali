...
.field private static final TAG:Ljava/lang/String; = "VariationsUtils"
...
.method public static getInstanceManipulations(Ljava/lang/String;)Lorg/chromium/components/variations/VariationsCompressionUtils$InstanceManipulations;
    .locals 6
    ...
    :cond_3
    new-instance p0, Lorg/chromium/components/variations/VariationsCompressionUtils$InvalidImHeaderException;

    const-string v0, "Unsupported instance manipulations order: expected x-bm,gzip, but received gzip,x-bm"

    invoke-direct {p0, v0}, Lorg/chromium/components/variations/VariationsCompressionUtils$InvalidImHeaderException;-><init>(Ljava/lang/String;)V

    throw p0

    :cond_4
    :goto_1
    new-instance p0, Lorg/chromium/components/variations/VariationsCompressionUtils$InstanceManipulations;

    invoke-direct {p0, v3, v5}, Lorg/chromium/components/variations/VariationsCompressionUtils$InstanceManipulations;-><init>(ZZ)V

    return-object p0

    :cond_5
    new-instance v0, Lorg/chromium/components/variations/VariationsCompressionUtils$InvalidImHeaderException;

    const-string v1, "Unrecognized instance manipulations in "

    const-string v2, "; only x-bm and gzip are supported"

    invoke-static {v1, p0, v2}, LJ7/b;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    invoke-direct {v0, p0}, Lorg/chromium/components/variations/VariationsCompressionUtils$InvalidImHeaderException;-><init>(Ljava/lang/String;)V

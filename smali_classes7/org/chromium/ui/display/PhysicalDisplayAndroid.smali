...
.field private static final TAG:Ljava/lang/String; = "DisplayAndroid"
...
.method public constructor <init>(Landroid/view/Display;Z)V
    ...
    :try_start_0
    invoke-static {v0, p1}, Lorg/chromium/content/browser/input/c;->d(Landroid/content/Context;Landroid/view/Display;)Landroid/content/Context;
    ...
    invoke-static {p1}, Lcom/sec/android/app/sbrowser/common/device/a;->g(Landroid/content/Context;)Landroid/view/Display;
    ...
    invoke-static {p1}, Lorg/chromium/ui/display/a;->f(Landroid/view/Display;)Z
    ...
    new-instance p1, Lorg/chromium/ui/display/b;

    invoke-direct {p1, p0}, Lorg/chromium/ui/display/b;-><init>(Lorg/chromium/ui/display/PhysicalDisplayAndroid;)V
    ...
    new-instance p2, Lorg/chromium/ui/display/c;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    invoke-static {p0, p2, p1}, Lorg/chromium/ui/display/a;->e(Landroid/view/Display;Lorg/chromium/ui/display/c;Lorg/chromium/ui/display/b;)V
...
.method private static getHdrSdrRatio(Landroid/view/Display;)Ljava/lang/Float;
    ...
    :cond_0
    invoke-static {p0}, Lorg/chromium/ui/display/a;->a(Landroid/view/Display;)F
...
.method private static isHdr(Landroid/view/Display;)Z
    ...
    invoke-static {p0}, Lorg/chromium/ui/display/a;->f(Landroid/view/Display;)Z
...
.method private updateCommon(Landroid/graphics/Rect;Landroid/graphics/Insets;FFFLandroid/view/Display;)V
    ...
    invoke-static/range {p6 .. p6}, Lorg/chromium/content/browser/input/c;->f(Landroid/view/Display;)Landroid/hardware/display/DeviceProductInfo;

    move-result-object v4

    if-eqz v4, :cond_2

    invoke-static {v4}, Lorg/chromium/content/browser/input/c;->c(Landroid/hardware/display/DeviceProductInfo;)I
...
.method private updateFromConfiguration()V
    ...
    invoke-static {v0}, Lcom/sec/android/app/sbrowser/common/device/a;->i(Landroid/view/WindowManager;)Landroid/view/WindowMetrics;

    move-result-object v1

    invoke-static {v1}, Landroidx/core/content/pm/a;->g(Landroid/view/WindowMetrics;)Landroid/graphics/Rect;
    ...
    invoke-static {v0, v1}, Landroidx/core/view/t;->d(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    invoke-static {v0}, Lcom/sec/android/app/sbrowser/common/device/a;->g(Landroid/content/Context;)Landroid/view/Display;

...
# static fields
.field private static final CONFIDENCE_THRESHOLD_FOR_URL_DETECTION:F = 0.99f

.field private static final MAX_ALLOWED_PNG_SIZE_BYTES:J = 0x5f5e100L

.field private static final PLAIN_TEXT_MIME_TYPE:Ljava/lang/String; = "text/plain"

.field private static final PNG_MIME_TYPE:Ljava/lang/String; = "image/png"

.field private static final TEXT_MIME_TYPE:Ljava/lang/String; = "text/*"

.field private static final URL_MIME_TYPE:Ljava/lang/String; = "text/x-moz-url"
...
.method public static synthetic b()V
    ...
    invoke-static {}, Lorg/chromium/ui/base/ClipboardImpl;->lambda$setSkipImageMimeTypeCheckForTesting$1()V

    return-void
.end method

.method public static bridge synthetic c(Lorg/chromium/ui/base/ClipboardImpl;)Lorg/chromium/ui/base/Clipboard$ImageFileProvider;
    .locals 0
...
.method public static bridge synthetic d(Lorg/chromium/ui/base/ClipboardImpl;Lorg/chromium/ui/base/Clipboard$ImageFileProvider$ClipboardFileMetadata;)V
    .locals 0
...
.method public static bridge synthetic e(Lorg/chromium/ui/base/ClipboardImpl;)J
    .locals 2
...
.method public static bridge synthetic f(Lorg/chromium/ui/base/ClipboardImpl;I)V
    .locals 0
...
.method private hasStyledText(Landroid/content/ClipDescription;)Z
    ...
    invoke-static {p1}, Lorg/chromium/content/browser/input/c;->y(Landroid/content/ClipDescription;)Z
...
.method private static synthetic lambda$setSkipImageMimeTypeCheckForTesting$1()V
    .locals 1

    const/4 v0, 0x0

    sput-object v0, Lorg/chromium/ui/base/ClipboardImpl;->sSkipImageMimeTypeCheckForTesting:Ljava/lang/Boolean;
...
.method public static setSkipImageMimeTypeCheckForTesting(Ljava/lang/Boolean;)V
    .locals 2
    ...
    sput-object p0, Lorg/chromium/ui/base/ClipboardImpl;->sSkipImageMimeTypeCheckForTesting:Ljava/lang/Boolean;
...
.method public copyUrlToClipboard(Lorg/chromium/url/GURL;)V
    .locals 3
    ...
    sget p1, Lorg/chromium/ui/R$string;->link_copied:I
...
.method public getImageUriIfSharedByThisApp()Landroid/net/Uri;
    .locals 6
    ...
    :cond_0
    invoke-interface {v0}, Lorg/chromium/ui/base/Clipboard$ImageFileProvider;->getLastCopiedImageMetadata()Lorg/chromium/ui/base/Clipboard$ImageFileProvider$ClipboardFileMetadata;

    move-result-object v0

    if-eqz v0, :cond_4

    iget-object v2, v0, Lorg/chromium/ui/base/Clipboard$ImageFileProvider$ClipboardFileMetadata;->uri:Landroid/net/Uri;
    ...
    :cond_2
    iget-wide v4, v0, Lorg/chromium/ui/base/Clipboard$ImageFileProvider$ClipboardFileMetadata;->timestamp:J

    cmp-long v2, v2, v4

    if-eqz v2, :cond_3

    invoke-interface {p0}, Lorg/chromium/ui/base/Clipboard$ImageFileProvider;->clearLastCopiedImageMetadata()V

    return-object v1

    :cond_3
    iget-object p0, v0, Lorg/chromium/ui/base/Clipboard$ImageFileProvider$ClipboardFileMetadata;->uri:Landroid/net/Uri;
...
.method public getLastModifiedTimeMs()J
    ...
    invoke-virtual {p0}, Lorg/chromium/ui/base/Clipboard;->getLastModifiedTimeToJavaTime()J
...
.method public getUrl()Ljava/lang/String;
    ...
    invoke-static {p0}, Lorg/chromium/content/browser/input/c;->p(Landroid/content/ClipData$Item;)Landroid/view/textclassifier/TextLinks;
...
.method public hasUrl()Z
    ...
    invoke-static {p0}, Lorg/chromium/content/browser/input/c;->b(Landroid/content/ClipDescription;)I
    ...
    :cond_2
    invoke-static {p0}, Lorg/chromium/content/browser/input/c;->a(Landroid/content/ClipDescription;)F
...
.method public setImage([BLjava/lang/String;)V
    ...
    invoke-direct {v1, p0, v2}, Lcom/sec/terrace/a;-><init>(Ljava/lang/Object;I)V
...
.method public setImageFileProvider(Lorg/chromium/ui/base/Clipboard$ImageFileProvider;)V
    ...
    iput-object p1, p0, Lorg/chromium/ui/base/ClipboardImpl;->mImageFileProvider:Lorg/chromium/ui/base/Clipboard$ImageFileProvider;

    iget-object v0, p0, Lorg/chromium/ui/base/ClipboardImpl;->mPendingCopiedImageMetadata:Lorg/chromium/ui/base/Clipboard$ImageFileProvider$ClipboardFileMetadata;

    if-eqz v0, :cond_0

    invoke-interface {p1, v0}, Lorg/chromium/ui/base/Clipboard$ImageFileProvider;->storeLastCopiedImageMetadata(Lorg/chromium/ui/base/Clipboard$ImageFileProvider$ClipboardFileMetadata;)V
...
.method public setText(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lorg/chromium/ui/base/ClipboardImpl;->setText(Ljava/lang/String;Ljava/lang/String;Z)V

...
.method public constructor <init>(ILandroid/view/InputDevice;)V
    ...
    invoke-static {p2}, Lorg/chromium/content/browser/input/c;->k(Landroid/view/InputDevice;)Landroid/os/VibratorManager;

    move-result-object p1

    invoke-static {p1}, Lorg/chromium/content/browser/input/c;->B(Landroid/os/VibratorManager;)[I
    ...
    invoke-static {p1, v1}, Lorg/chromium/content/browser/input/c;->j(Landroid/os/VibratorManager;I)Landroid/os/Vibrator;
    ...
    invoke-static {p1, p2}, Lorg/chromium/content/browser/input/c;->j(Landroid/os/VibratorManager;I)Landroid/os/Vibrator;
...
.method public cancelVibration()V
    ...
    invoke-static {p0}, Lorg/chromium/content/browser/input/c;->l(Ljava/lang/Object;)Landroid/os/VibratorManager;

    move-result-object p0

    invoke-static {p0}, Lorg/chromium/content/browser/input/c;->v(Landroid/os/VibratorManager;)V
...
.method public doVibration(DD)V
    ...
    :cond_0
    invoke-static {}, Lorg/chromium/content/browser/input/c;->h()Landroid/os/CombinedVibration$ParallelCombination;
    ...
    invoke-static {p3, p1}, Lorg/chromium/content/browser/input/c;->u(Landroid/os/CombinedVibration$ParallelCombination;Landroid/os/VibrationEffect;)V
    ...
    invoke-static {p3, p1}, Lorg/chromium/content/browser/input/c;->C(Landroid/os/CombinedVibration$ParallelCombination;Landroid/os/VibrationEffect;)V
    ...
    invoke-static {p3}, Lorg/chromium/content/browser/input/c;->i(Landroid/os/CombinedVibration$ParallelCombination;)Landroid/os/CombinedVibration;

    move-result-object p1

    invoke-static {p0, p1}, Lorg/chromium/content/browser/input/c;->w(Landroid/os/VibratorManager;Landroid/os/CombinedVibration;)V

...
# static fields
.field private static final MICROSECONDS_IN_SECOND:D = 1000000.0

.field private static final SECONDS_IN_MICROSECOND:D = 1.0E-6

.field private static final SECONDS_IN_NANOSECOND:D = 1.0E-9

.field private static final SENSOR_FREQUENCY_NORMAL:D = 5.0

.field private static final TAG:Ljava/lang/String; = "PlatformSensor"
...
.method public simulateSensorEventForTesting(I)V
    .locals 7
    ...
    iput-wide v1, v0, Landroid/hardware/SensorEvent;->timestamp:J
    ...
    :cond_0
    invoke-virtual {p0, v0}, Lorg/chromium/device/sensors/PlatformSensor;->onSensorChanged(Landroid/hardware/SensorEvent;)V
    :try_end_0
    ...
    :goto_1
    const-string p1, "PlatformSensor"

    const-string v0, "Failed to create simulated SensorEvent."

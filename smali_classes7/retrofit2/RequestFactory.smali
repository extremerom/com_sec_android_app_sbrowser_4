...
.field private final headers:LAa/B;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Lretrofit2/RequestFactory$Builder;)V
    ...
    iget-object v0, v0, Lretrofit2/Retrofit;->baseUrl:LAa/D;

    iput-object v0, p0, Lretrofit2/RequestFactory;->baseUrl:LAa/D;
    ...
    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->headers:LAa/B;

    iput-object v0, p0, Lretrofit2/RequestFactory;->headers:LAa/B;

    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->contentType:LAa/G;

    iput-object v0, p0, Lretrofit2/RequestFactory;->contentType:LAa/G;
...
# virtual methods
.method public create([Ljava/lang/Object;)LAa/P;
    .locals 12
    ...
    iget-object v5, p0, Lretrofit2/RequestFactory;->baseUrl:LAa/D;

    iget-object v6, p0, Lretrofit2/RequestFactory;->relativeUrl:Ljava/lang/String;

    iget-object v7, p0, Lretrofit2/RequestFactory;->headers:LAa/B;

    iget-object v8, p0, Lretrofit2/RequestFactory;->contentType:LAa/G;
    ...
    invoke-direct/range {v3 .. v11}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;LAa/D;Ljava/lang/String;LAa/B;LAa/G;ZZZ)V
    ...
    :cond_1
    invoke-virtual {v2}, Lretrofit2/RequestBuilder;->get()LAa/O;
    ...
    invoke-virtual {p1, p0, v0}, LAa/O;->e(Ljava/lang/Class;Ljava/lang/Object;)V
    ...
    invoke-static {v1, p1, v2}, LJ7/b;->q(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p1, v0, v1}, LJ7/b;->m(Ljava/lang/StringBuilder;ILjava/lang/String;)Ljava/lang/String;

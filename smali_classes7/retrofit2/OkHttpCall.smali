...
.field private final callFactory:LAa/j;
...
# direct methods
.method public constructor <init>(Lretrofit2/RequestFactory;[Ljava/lang/Object;LAa/j;Lretrofit2/Converter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Lretrofit2/OkHttpCall;->callFactory:LAa/j;
...
.method private createRawCall()LAa/k;
    .locals 2

    iget-object v0, p0, Lretrofit2/OkHttpCall;->callFactory:LAa/j;
    ...
    invoke-virtual {v1, p0}, Lretrofit2/RequestFactory;->create([Ljava/lang/Object;)LAa/P;

    move-result-object p0

    check-cast v0, LAa/L;

    invoke-virtual {v0, p0}, LAa/L;->a(LAa/P;)LEa/j;
...
.method private getRawCall()LAa/k;
    .locals 1
    .annotation build Ljavax/annotation/concurrent/GuardedBy;
    .end annotation

    iget-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:LAa/k;
    ...
    :cond_3
    :try_start_0
    invoke-direct {p0}, Lretrofit2/OkHttpCall;->createRawCall()LAa/k;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:LAa/k;
    :try_end_0
...
.method public cancel()V
    ...
    invoke-virtual {v0}, LEa/j;->cancel()V
...
.method public clone()Lretrofit2/OkHttpCall;
    ...
    iget-object v3, p0, Lretrofit2/OkHttpCall;->callFactory:LAa/j;

    iget-object p0, p0, Lretrofit2/OkHttpCall;->responseConverter:Lretrofit2/Converter;

    invoke-direct {v0, v1, v2, v3, p0}, Lretrofit2/OkHttpCall;-><init>(Lretrofit2/RequestFactory;[Ljava/lang/Object;LAa/j;Lretrofit2/Converter;)V
...
.method public enqueue(Lretrofit2/Callback;)V
    ...
    iput-object v2, p0, Lretrofit2/OkHttpCall;->rawCall:LAa/k;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {v1}, LEa/j;->cancel()V
...
.method public execute()Lretrofit2/Response;
    ...
    invoke-direct {p0}, Lretrofit2/OkHttpCall;->getRawCall()LAa/k;
    ...
    invoke-virtual {v0}, LEa/j;->e()LAa/W;

    move-result-object v0

    invoke-virtual {p0, v0}, Lretrofit2/OkHttpCall;->parseResponse(LAa/W;)Lretrofit2/Response;
...
.method public parseResponse(LAa/W;)Lretrofit2/Response;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p1, LAa/W;->g:LAa/a0;

    invoke-virtual {p1}, LAa/W;->e()LAa/V;

    move-result-object p1

    new-instance v1, Lretrofit2/OkHttpCall$NoContentResponseBody;

    invoke-virtual {v0}, LAa/a0;->contentType()LAa/G;
    ...
    invoke-direct {v1, v2, v3, v4}, Lretrofit2/OkHttpCall$NoContentResponseBody;-><init>(LAa/G;J)V

    iput-object v1, p1, LAa/V;->g:LAa/a0;

    invoke-virtual {p1}, LAa/V;->a()LAa/W;
    ...
    invoke-direct {v1, v0}, Lretrofit2/OkHttpCall$ExceptionCatchingResponseBody;-><init>(LAa/a0;)V
    ...
    :goto_1
    :try_start_1
    invoke-static {v0}, Lretrofit2/Utils;->buffer(LAa/a0;)LAa/a0;

    move-result-object p0

    invoke-static {p0, p1}, Lretrofit2/Response;->error(LAa/a0;LAa/W;)Lretrofit2/Response;
...
.method public declared-synchronized request()LAa/P;
    .locals 3
    ...
    iget-object v0, v0, LEa/j;->b:LAa/P;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized timeout()LPa/E;
    .locals 3
    ...
    iget-object v0, v0, LEa/j;->e:LEa/i;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
